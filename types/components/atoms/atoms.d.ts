 ...
 * @returns {object}
 */
export const Video: (...args: any[]) => any;
export const GridPanel: (...args: any[]) => any;
import { A } from '@base-framework/atoms';
import { Br } from '@base-framework/atoms';
import { Div } from '@base-framework/atoms';
import { Fieldset } from '@base-framework/atoms';
...
import { Legend } from '@base-framework/atoms';
...
import { Strong } from '@base-framework/atoms';
import { Textarea } from '@base-framework/atoms';
import { Ul } from '@base-framework/atoms';
export { A, Br, Div, Fieldset, Form, H1, H2, Header, Input, Label, Legend, Li, Nav, P, Span, Strong, Textarea, Ul };
