...
export const OverviewDashboard = () => (
	Div({ class: 'mt-2 lg:mt-0 flex flex-auto flex-col ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 gap-y-4' }, [

		DashboardSummaryCards(),
		Div({ class: 'grid md:gap-4 gap-y-4 md:gap-y-0 grid-cols-1 md:grid-cols-2 lg:grid-cols-7' }, [
			OverviewCard(),
			RecentSalesCard(),
		]),
		Div({ class: 'grid md:gap-4 gap-y-4 md:gap-y-0 grid-cols-1 md:grid-cols-2 lg:grid-cols-7' }, [
		...
		KpiCardsRow(),
		Div({ class: 'grid md:gap-4 gap-y-4 md:gap-y-0 grid-cols-1 md:grid-cols-4 lg:grid-cols-7' }, [
			VisitorsCard(),
