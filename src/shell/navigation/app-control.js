...
const AppContainer = Atom((props, children) => ({
    ...props,
    class: 'app-nav-container fixed sm:top-0 bottom-0 left-0 w-full base-sub md:w-[64px] lg:hover:w-[330px] sm:h-full z-10 sm:overflow-y-auto overflow-x-hidden drop-shadow',
    children
}));
