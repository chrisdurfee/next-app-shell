...
const AppContainer = Atom((props, children) => ({
    ...props,
    class: 'app-nav-container fixed md:top-0 bottom-0 left-0 w-full base-sub md:w-[64px] lg:hover:w-[330px] lg:h-full z-10 lg:overflow-y-auto overflow-x-hidden drop-shadow',
    children
}));
