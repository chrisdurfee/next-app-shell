...
export const ActionTimer =
{
    ...
    /**
     * Initializes the global state for tracking user status and binds it to app user data.
     *
     * @returns {void}
     */
    setupState()
    ...
    /**
     * Starts or stops tracking activity based on the user's current state.
     *
    ...
    setupEvents()
    {
        ...
        this.on = () =>
        {
            for (let i = 0, length = events.length; i < length; i++)
            {
                ...
                base.on(event[0], event[1], event[2]);
            }
        };
        ...
        this.off = () =>
        {
            ...
            {
                const event = events[i];
                base.off(event[0], event[1], event[2]);
            }
        };
    },
