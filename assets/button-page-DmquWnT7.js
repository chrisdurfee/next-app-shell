import{b as e,a as s,j as c,s as t,aQ as m,_ as n,aR as r,aS as i,aT as a}from"./index-QyzxKzz3.js";import{D as o}from"./doc-section-U_ZjOgqZ.js";import{D as l}from"./doc-page-DTE49KIs.js";import"./signature-panel-BWHC9V2v-Bg9o8u0i.js";import"./sidebar-menu-page-D12NEBpp-BRVrydSd.js";import"./sidebar-menu-BHHp2hXa-BXUYjmKm.js";const v=()=>l({title:"Button",description:"Displays a button or a component that looks like a button."},[o({title:"Usage",description:"Import the button atom and use it in your components. This platform has variants for different use cases. The variant can be set using the `variant` prop.",preview:[e({variant:"primary"},"Click Me")],code:`import {  Button  } from "@base-framework/ui/atoms";
...
// Swap icon on toggle
new CircleToggleButton({ icon: Icons.bookmark, activeIcon: Icons.bookmarkSolid, size: 'md' })`})]);export{v as ButtonPage,v as default};
