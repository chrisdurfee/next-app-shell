import{J as h,Y as s,f as I,a as o,o as t,z as r,a8 as b,G as u,ar as g,ap as y}from"./index-JROklvyp.js";import"./tooltip-DcnXGw52-BKMBeZUI.js";import{D as m}from"./doc-section-CaPs4XXL.js";import{D as w}from"./doc-page-DHnKkhRQ.js";import"./signature-panel-CuUlwQzE-Be4xOY0u.js";import"./sidebar-menu-page-B1YSAs3o-C2jB1KBf.js";import"./mobile-nav-wrapper-m9eu2YJR-DHx52BZk.js";const x=(c,n,e=null)=>(e="Icons"+(e?"."+e:""),s({class:"flex flex-auto flex-col items-center gap-2 w-full max-w-[150px] h-[8.5rem] cursor-pointer"},[s({class:"flex flex-auto w-full h-full justify-center items-center flex-wrap rounded-lg border bg-card text-base shadow-sm hover:bg-muted/50",click:()=>{navigator.clipboard.writeText(`${e}.${n}`),app.notify({title:"Icon copied",description:`The icon '${e}.${n}' has been copied to your clipboard.`,icon:o.clipboard.checked})}},[t(c)]),s({class:"text-muted-foreground"},n)])),d=(c,n,e)=>{const l=typeof c=="object";l&&n.push(u({class:"text-muted-foreground"},"path: "+e+".{icon}"));const i=[];if(n.push(s({class:"flex flex-auto flex-wrap gap-2 my-8"},i)),l===!1)i.push(x(c,e));else for(var a in c){if(c.hasOwnProperty(a)===!1)continue;const f=c[a];if(typeof f!="object"){i.push(x(f,a,e));continue}const p=`${e}.${a}`;d(f,n,p)}},z=c=>{if(!c||typeof c!="object")return;const n=[];for(let[e,l]of Object.entries(c)){if(e==="parse")continue;n.push(g({id:e.toLowerCase(),class:"text-2xl font-bold"},y.titleCase(e))),d(l,n,e)}return n},D=()=>w({title:"Icons",description:"The icons are from the Hericon library. They are SVG icons that can be used in your project. This icon set uses the outline style."},[h({href:"https://heroicons.com/",target:"_blank",class:"bttn link"},"link: Hericons"),m({title:"Icons",description:"This is an icon.",preview:[I({html:o.home})],code:`
...
Span('3X Large (16x16)')`}),m({title:"Icon Colors",description:"Icons can be rendered in various colors using the `class` property to apply Tailwind CSS classes. The following colors are available: `primary`, `secondary`, `accent`, `muted`, and `destructive`.",preview:[s({class:"flex flex-wrap gap-4 items-center"},[t({class:"text-red-500"},o.phone.missed),t({class:"text-blue-500"},o.phone.inbound),t({class:"text-yellow-500"},o.phone.outbound)])],code:`
import {  Icon  } from "@base-framework/ui/atoms";
