import{G as p,Y as t,ad as o,w as e}from"./index-CMRUlLug.js";import{D as i}from"./doc-section-B3pKlK06.js";import{D as l}from"./doc-page-lz3wGX1V.js";import"./sidebar-menu-page-nCAVFk3R-C6_ag80F.js";import"./mobile-nav-wrapper-BE_hr65B-SSoaBUQw.js";const m=()=>l({title:"Tooltips",description:"Tooltips are small popups that appear when a user hovers over an element."},[i({title:"Usage",description:"Import the tooltip atom and use it in your components.",preview:[t({class:"flex gap-2 flex-wrap"},[o({content:"This is a tooltip."},[e("Hover me")])])],code:`import {  Button  } from "@base-framework/ui/atoms";
...
Tooltip({ content: 'This is a tooltip.' }, [
    ...
    Button('Hover me')
])`}),p({class:"text-muted-foreground text-sm mt-4"},"The tooltip position can be set to: top, top-right, top-left, bottom, bottom-right, bottom-left, left, right.")]);export{m as TooltipPage,m as default};
