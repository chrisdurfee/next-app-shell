import{Y as t}from"./index-DPghUsg_.js";import{T as e}from"./tooltip-DcnXGw52-CrzgSVws.js";import{D as r}from"./doc-section-Dap_pZTN.js";import{D as p}from"./doc-page-dtKnpgam.js";import"./signature-panel-Dl_Tkisq-Dujl8u5u.js";import"./sidebar-menu-page-DyIwNFwe-_6v_EzUu.js";import"./mobile-nav-wrapper-CuATTfqK-DdgUhLMi.js";const x=()=>p({title:"Badges",description:"Badges can be used to display a status or a count."},[r({title:"Badge",description:"This is a badge.",preview:[t({class:"flex gap-2 flex-wrap"},[e({type:"gray"},"Text"),e({type:"red"},"Text"),e({type:"yellow"},"Text"),e({type:"green"},"Text"),e({type:"blue"},"Text"),e({type:"indigo"},"Text"),e({type:"purple"},"Text"),e({type:"pink"},"Text"),e({type:"primary"},"Text"),e({type:"secondary"},"Text"),e({type:"destructive"},"Text"),e({type:"warning"},"Text"),e({type:"outline"},"Text"),e({type:"ghost"},"Text"),e({type:"link"},"Text")])],code:`
