  ...
  links: [
	{
	  ...
	  options: [
		{ label: 'Docs', href: 'docs', icon: Icons.document.text, mobileOrder: 5 }
					...
					them an excellent place to store constants or environment-specific values.`),i({class:"text-muted-foreground"},"Below is an example of how the Configs object is structured by default:"),T(`/**
 * Configs
 *
