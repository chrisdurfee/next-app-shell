...
new Confirmation({
    ...
    confirmed: () => console.log('Confirmed!')
        ...
        `,click:()=>t(e)},[e.icon&&d({class:"flex w-4 h-4",html:e.icon}),d({class:"flex-auto"},e.label),e.shortcut&&d({class:"ml-auto text-xs tracking-widest opacity-60"},e.shortcut)]),jt=e=>s({class:"absolute mt-2 w-full border rounded-md shadow-lg bg-background z-10"},[L({class:"max-h-60 overflow-y-auto p-1 grid gap-2",for:["items",t=>It(t,e)]})]),St=h({setData(){return new $({items:this.items||[]})},state:{open:!1,selectedItem:null},toggleDropdown(){this.state.open=!this.state.open},handleSelect(e){this.state.selectedItem=e,this.state.open=!1,typeof this.onSelect=="function"&&this.onSelect(e)},render(){return s({class:"relative w-[200px]"},[D({class:`inline-flex items-center justify-between w-full rounded-md border border-input
                    ...
                    focus:outline-none transition duration-150 ease-in-out`,click:()=>this.toggleDropdown()},[d(this.label||"Open Menu"),g({html:r.chevron.down})]),s({class:"mt-2",onState:["open",e=>e?jt(this.handleSelect.bind(this)):null]})])}}),Dt=()=>l({title:"Comboboxes",description:"Comboboxes are used to allow users to select an option from a dropdown list or enter a custom value."},[a({title:"Usage",description:"To use the Combobox component, import it from the components library and use it in your application.",preview:[new St({label:"My Account",items:[{icon:r.user.default,label:"Profile",shortcut:"⌘P",value:"profile"},{icon:r.creditCard,label:"Billing",shortcut:"⌘B",value:"billing"},{icon:r.cog,label:"Settings",shortcut:"⌘S",value:"settings"},{icon:r.computerDesktop,label:"Keyboard shortcuts",shortcut:"⌘K",value:"shortcuts"},{type:"divider"},{icon:r.user.multiple,label:"Team",value:"team"},{icon:r.user.plus,label:"Invite users",value:"invite"},{icon:r.plus,label:"New Team",shortcut:"⌘T",value:"new_team"},{type:"divider"},{icon:r.github,label:"GitHub",value:"github"},{icon:r.helpCircle,label:"Support",value:"support"},{icon:r.api,label:"API",value:"api"},{type:"divider"}],onSelect:e=>{console.log("Selected item:",e)}})],code:`@components/molecules/combobox/combobox.js';
import { Icons } from "@components/icons/icons.js";
...
export const ExampleTab = () => (
	new Tab({
        ...
        options: [
            ...
            `},t)])}),_t=()=>l({title:"Tooltips",description:"This is a tooltip."},[a({title:"Usage",description:"Import the card atom and use it in your components.",preview:[s({class:"flex gap-2 flex-wrap"},[q({content:"This is a tooltip."},[c("Hover me")])])],code:`import { Button } from "@components/atoms/buttons/buttons.js";
