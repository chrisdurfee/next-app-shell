...
Textarea({
    placeholder: 'Enter your text here...'
})`}),t({title:"Search Dropdown",description:"This is a search dropdown.",preview:[o({class:"relative w-full max-w-md"},[new H({options:O,onSelect:e=>console.log(e)})])],code:`import {  SearchDropdown  } from "@base-framework/ui/organisms";
...
`}),t({title:"Search Input",description:"This is a search input.",preview:[o({class:"relative w-full max-w-md"},[G({placeholder:"Search...",bind:"",keyup:(e,i)=>{},icon:f.magnifyingGlass.default})])],code:`import {  SearchInput  } from "@base-framework/ui/organisms";
...
})`}),t({title:"Select",description:"This is a select input.",preview:[a([M({options:K,change:e=>console.log(e.target.value)})])],code:`import {  Select  } from "@base-framework/ui/atoms";
