import{O as W,A as Y}from"./overlay-3OApFUXM.js";import{X as i,m as n,q as v,y as h,S as b,w as M,R as C,a as _,D,H as P,b as z,p as X,c as q,U as f,I as T,B as F,d as K,C as L,e as m,A as J,f as r,g as j,h as Q,i as Z,j as ee,k as N,V as E,n as te,l as oe,P as k,T as H,M as O,o as ne,G as se}from"./index-R1cPadIn.js";const ae=e=>n({class:"flex items-center justify-center h-6 w-6 mr-3"},[v({html:e})]),re=e=>h({class:"font-semibold text-muted-foreground"},e),le=e=>b({class:"text-sm text-muted-foreground"},e),ie=i(({title:e,description:t,icon:o})=>n({class:"flex items-start p-4 border rounded-lg bg-muted/10 border-muted-foreground/20"},[o&&ae(o),n({class:"flex flex-col"},[re(e),le(t)])])),ce=e=>P({class:"inline-flex flex-auto items-center justify-center whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm",dataSet:["selected",["state",e.value,"active"]]},[z({class:"flex flex-auto justify-center items-center px-3 py-1.5",onSet:["selected",{selected:e.value}],click:t=>e.callBack(e.value)},e.label)]),de=(e,t)=>(e.callBack=t,ce(e)),ue=e=>_({class:`tab items-center justify-center rounded-md bg-muted p-1 text-muted-foreground ${e.class}`},[D({class:"flex flex-auto flex-row",map:[e.options,t=>de(t,e.callBack)]})]);class U extends M{render(){const t=this.select.bind(this);return n({class:""},[ue({class:this.class,options:this.options,callBack:t}),C({class:"tab-content",onState:["selected",this.updateContent.bind(this)]})])}afterSetup(){const t=this.options[0].value;this.select(t)}update(){const t=this.state.get("selected");this.select(null),this.select(t)}select(t){this.state.selected=t}updateContent(t){const o=this.options;if(!o||o.length<1)return;const a=o[0];for(const p of o)if(p.value===t)return p.layout;return a.layout}setupStates(){const t=this.callBack,o=typeof t;return{selected:{state:null,callBack(a){o==="function"&&t(a)}}}}}const pe=i((e,t)=>X({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces cursor-pointer"},[q({class:"font-mono text-sm",click:()=>navigator.clipboard.writeText(t[0].textContent)},t)])),me=i((e,t)=>n({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-card"},[n({class:"preview flex w-full justify-center items-center"},t)])),I=i((e,t)=>n({class:"py-4"},t)),be=e=>new U({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:I([me(e.preview)])},{label:"Code",value:"code",layout:I([pe(e.code)])}]}),fe=i(({title:e,description:t})=>f({class:"flex flex-col"},[T({class:"scroll-m-20 text-2xl font-bold tracking-tight"},e),t&&b({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),s=i((e,t)=>C({class:"py-4"},[fe({title:e.title,description:e.description}),be({preview:e.preview,code:e.code})]));class ge extends F{render(){return K([n({class:"contained px-4 flex flex-auto flex-col"},this.children)])}}const xe=i(({title:e,description:t})=>f({class:"flex flex-col"},[L({class:"scroll-m-20 text-3xl font-bold tracking-tight"},e),b({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),he=i((e,t)=>n({class:"contained py-8"},[xe(e),C({class:"pb-12 pt-8"},t)])),d=i((e,t)=>new ge([he(e,t)])),ve=()=>d({title:"Alerts",description:"Alerts are used to provide feedback to the user about the outcome of an action or to inform them of important information."},[s({title:"Usage",description:"To use the Alert component, import it from the components library and use it in your application.",preview:[ie({title:"Heads up!",description:"You can add components to your app using the cli.",icon:m.information})],code:`import { Button } from '@components/atoms/form/input.js';
...
})`})]),A=i((e,t)=>n({class:"py-4"},t)),We=()=>d({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[s({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new U({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:A([])},{label:"Code",value:"code",layout:A([])}]})],code:`
