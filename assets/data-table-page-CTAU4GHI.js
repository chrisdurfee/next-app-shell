...
});`}),s({class:"gap-y-4 mt-8"},[o({class:"text-lg font-bold"},"Dynamic Data Table Features"),a({class:"text-muted-foreground"},"DynamicDataTable provides automatic data management with built-in loading states, error handling, and model integration."),l(`// Key features of DynamicDataTable:
...
new DataTable({
	...
	rowItem: userRowItem,
	key: 'id'
});`}),s({class:"gap-y-4 mt-8"},[o({class:"text-lg font-bold"},"Skeleton API and Control"),a({class:"text-muted-foreground"},"The skeleton system provides automatic and manual control methods for managing loading states."),l(`// Skeleton configuration options
...
`)]),s({class:"gap-y-4 mt-8"},[o({class:"text-lg font-bold"},"Selecting and Resetting Rows"),a({class:"text-muted-foreground"},"DataTable supports toggling all rows, clearing selections, and retrieving selected rows."),l(`// Suppose 'dt' is your DataTable instance
...
`)]),s({class:"gap-y-4 mt-8"},[o({class:"text-lg font-bold"},"Removing Items"),a({class:"text-muted-foreground"},"Use remove() to delete rows by passing an array of items (or a single item)."),l(`// dt is your DataTable instance
...
`)]),s({class:"gap-y-4 mt-8"},[o({class:"text-lg font-bold"},"Appending Items"),a({class:"text-muted-foreground"},"Use append() to add rows at the end of the list. Accepts an array or single object."),l(`// dt is your DataTable instance
...
`)]),s({class:"gap-y-4 mt-8"},[o({class:"text-lg font-bold"},"Mingling Items"),a({class:"text-muted-foreground"},"Mingle merges new items with existing items by matching keys. If withDelete = true, items not in newItems are removed."),l(`// dt is your DataTable instance
const newItems = [
...
`)]),s({class:"gap-y-4 mt-8"},[o({class:"text-lg font-bold"},"Prepending Items"),a({class:"text-muted-foreground"},"Use prepend() to add new rows at the beginning of the list, shifting existing rows down."),l(`// dt is your DataTable instance
