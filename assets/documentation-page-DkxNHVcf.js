import{Z as x,M as fe,N as he,o as s,Y as o,w as ge,u as m,l as O,s as se,G as i,y as Fe,e as $e,A as L,m as k,B as c,z as r,C as Ee,E as Re,H as b,I as Ne,O as He,r as l,a as be,P as ze,Q as Ue,R as qe,U as Oe,W as We,X as Ge,a0 as C,$ as w,a1 as P,f as d,a2 as X,a3 as W,a4 as ie,_ as we,a5 as _e,c as I,a6 as T,a7 as E,a8 as xe,a9 as Ye,h as ve,aa as Je,i as ee,ab as Ve,ac as J,j as B,k as G,ad as ye,ae as re,af as ke,K as q,ag as Ke,ah as Qe,L as R,ai as te,aj as oe,ak as Te,al as Ze,am as Xe,an as V,ao as et,ap as tt,aq as ot,ar as at,as as st,at as it,au as rt,av as lt,aw as nt,ax as ct,ay as mt,T as dt,az as pt,p as ut,aA as ft,aB as ht,x as _,aC as gt,aD as le,aE as F,aF as bt,aG as wt,F as xt,aH as M,aI as vt,aJ as yt,V as S,aK as kt,b as Tt,q as St,D as A,J as D,aL as It,aM as ae,v as Ct,aN as At,aO as Dt}from"./index-BY2AbmgO.js";const y=x((e,a)=>fe({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces break-all cursor-pointer"},[he({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(a[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:s.clipboard.checked})}},a)])),Bt=x((e,a)=>o({class:"flex flex-auto p-4 min-h-[350px] max-h-[650px] overflow-x-auto max-w-[90vw] rounded-lg border bg-card"},[o({class:"preview flex flex-auto justify-center items-center"},a)])),ne=x((e,a)=>o({class:"py-4"},a)),Pt=e=>new ge({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:ne([Bt(e.preview)])},{label:"Code",value:"code",layout:ne([y(e.code)])}]}),jt=x(({title:e,description:a})=>O({class:"flex flex-col"},[se({class:"scroll-m-20 text-2xl font-bold tracking-tight"},e),a&&i({class:"text-base text-muted-foreground py-2 max-w-[700px]"},a)])),t=x((e,a)=>m({class:"grid py-4"},[jt({title:e.title,description:e.description}),Pt({preview:e.preview,code:e.code})])),Mt=x(({title:e,description:a})=>O({class:"flex flex-col"},[$e({class:"scroll-m-20 text-3xl font-bold tracking-tight"},e),i({class:"text-base text-muted-foreground py-2 max-w-[700px]"},a)])),Lt=x((e,a)=>o({class:"contained py-8"},[Mt(e),m({class:"pb-12 pt-8"},a)])),f=x((e,a)=>new Fe([Lt(e,a)])),Ft=()=>f({title:"Alerts",description:"Alerts are used to provide feedback to the user about the outcome of an action or to inform them of important information."},[t({title:"Default Alert",description:"This is a standard alert without any specific type.",preview:[L({title:"Notice",description:"This is a default alert without a specific type.",icon:s.information})],code:`import {  Alert  } from "@base-framework/ui/molecules";
...
})`})]),j=({title:e,description:a})=>O({class:"text-left"},[be({class:"font-semibold tracking-tight text-2xl"},e),i({class:"text-sm text-muted-foreground"},a)]),qt=()=>o({class:"flex items-center justify-center gap-4"},[l({variant:"outline",class:"gap-2 w-full",click:()=>console.log("Sign in with Github"),"aria-label":"Sign in with Github"},[w(s.companies.gitHub),r("Github")]),l({variant:"outline",class:"gap-2 w-full",click:()=>console.log("Sign in with Google"),"aria-label":"Sign in with Google"},[w(s.companies.google),r("Google")])]),Ot=()=>P({class:"space-y-4",submit:e=>{e.preventDefault(),console.log("Account created")}},[new d({name:"email",label:"Email"},[X({type:"email",placeholder:"m@example.com",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),new d({name:"password",label:"Password"},[X({type:"password",placeholder:"Your password",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),l({type:"submit",class:"w-full mt-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition"},"Create account")]),Se=()=>C({class:"w-full max-w-md mx-auto p-8 bg-card space-y-6"},[j({title:"Create an account",description:"Enter your email below to create your account"}),qt(),o({class:"relative"},[o({class:"absolute inset-0 flex items-center"},[r({class:"flex-grow border-t"})]),o({class:"relative flex justify-center text-xs uppercase"},[r({class:"bg-background px-2 text-muted-foreground"},"or continue with")])]),Ot()]),K=({title:e,description:a,defaultState:n,onChange:p})=>o({class:"flex items-start justify-between gap-2"},[o({class:"text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex flex-col space-y-1"},[r({class:"font-medium text-foreground"},e),r({class:"font-normal leading-snug text-muted-foreground"},a)]),new W({active:n,change:p})]),Ie=()=>C({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[j({title:"Cookie Settings",description:"Manage your cookie settings here."}),o({class:"pt-0 grid gap-6"},[K({title:"Strictly Necessary",description:"These cookies are essential in order to use the website and use its features.",defaultState:!0,onChange:e=>console.log("Strictly Necessary:",e)}),K({title:"Functional Cookies",description:"These cookies allow the website to provide personalized functionality.",defaultState:!1,onChange:e=>console.log("Functional Cookies:",e)}),K({title:"Performance Cookies",description:"These cookies help to improve the performance of the website.",defaultState:!1,onChange:e=>console.log("Performance Cookies:",e)})]),l({variant:"outline",class:"w-full",click:()=>console.log("Preferences saved")},"Save preferences")]),Ce=({startDate:e})=>C({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[j({title:"Pick a Date",description:"When is the event?"}),o({class:"font-medium text-foreground"},[new ie({selectedDate:e,selectedCallBack:a=>console.log(a)})])]),Q=x(({value:e,label:a,icon:n})=>_e({class:'text-sm gap-1 font-medium leading-none disabled:cursor-not-allowed disabled:opacity-70 flex flex-col items-center justify-between rounded-md border-2 border-muted bg-popover p-4 hover:bg-muted data-[state="active"]:border-primary [&:has([data-state="active"])]:border-primary',onState:["method",{active:e}],dataSet:["method",["state",e,"active"]],click:(p,{state:g})=>g.method=e},[w(n),r(a)])),Wt=we({render(){return o({class:"flex flex-auto flex-col"},[o({class:"grid grid-cols-3 gap-4"},[Q({label:"Card",value:"card",icon:s.creditCard}),Q({label:"Paypal",value:"paypal",icon:s.companies.paypal}),Q({label:"Apple",value:"apple",icon:s.companies.apple})])])},state(){return{method:null}}}),Gt=()=>o({class:"flex items-center justify-center gap-4"},[new Wt]),_t=()=>P({class:"space-y-4",submit:e=>{e.preventDefault(),console.log("Payment method added")}},[new d({name:"name",label:"Name"},[I({type:"text",placeholder:"First Last",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),new d({name:"card_number",label:"Card number"},[I({type:"text",placeholder:"1234 5678 9012 3456",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),o({class:"flex gap-4 mt-4"},[new d({name:"month",label:"Expires"},[T({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"",label:"Month",disabled:!0},...Array.from({length:12},(e,a)=>({value:`${a+1}`,label:`${a+1}`.padStart(2,"0")}))]})]),new d({name:"year",label:"Year"},[T({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"",label:"Year",disabled:!0},...Array.from({length:10},(e,a)=>({value:`${new Date().getFullYear()+a}`,label:`${new Date().getFullYear()+a}`}))]})]),new d({name:"cvc",label:"CVC"},[I({type:"text",placeholder:"CVC",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})])]),l({type:"submit",class:"w-full mt-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition"},"Continue")]),Ae=()=>C({class:"w-full max-w-md mx-auto p-8 bg-card space-y-6"},[j({title:"Payment Method",description:"Add a new payment method to your account."}),Gt(),o({class:"space-y-4"},[_t()])]),Yt=({name:e,description:a,stars:n,language:p,lastUpdated:g})=>o({class:"flex items-start justify-between py-4 border-b border-muted last:border-b-0"},[o({class:"flex flex-col"},[r({class:"font-semibold text-foreground"},e),r({class:"text-sm text-muted-foreground"},a),o({class:"flex space-x-4 text-sm text-muted-foreground mt-3"},[o({class:"flex items-center gap-2"},[w({class:" text-blue-500"},s.document.text),r(` ${p}`)]),o({class:"flex items-center"},[w(s.star),r(` ${n}`)]),o(`Updated ${g}`)])]),l({variant:"secondary",class:"px-3 py-1 gap-1 flex items-center rounded-md",click:()=>console.log(`Starred ${e}`)},[w(s.star),r("Star")])]),Jt=({projects:e})=>o({class:"space-y-3"},e.map(a=>Yt(a))),Vt=[{name:"shadcn/ui",description:"Beautifully designed components that you can copy and paste into your apps. Accessible. Customizable. Open Source.",stars:"20k",language:"TypeScript",lastUpdated:"April 2023"},{name:"base-framework",description:"A robust framework for building and structuring large-scale applications with ease.",stars:"2",language:"JavaScript",lastUpdated:"June 2024"}],Kt=()=>C({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[o({class:"font-semibold text-lg text-foreground"},"Projects"),Jt({projects:Vt})]),Qt=()=>P({class:"space-y-4",submit:e=>{e.preventDefault(),console.log("Issue reported")}},[o({class:"flex flex-auto w-full gap-4"},[new d({name:"area",label:"Area"},[T({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"billing",label:"Billing"},{value:"technical",label:"Technical"},{value:"account",label:"Account"},{value:"other",label:"Other"}],defaultValue:"billing",change:e=>console.log(`Area selected: ${e.target.value}`)})]),new d({name:"security_level",label:"Security Level"},[T({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"severity_1",label:"Severity 1"},{value:"severity_2",label:"Severity 2"},{value:"severity_3",label:"Severity 3"}],defaultValue:"severity_2",change:e=>console.log(`Security Level selected: ${e.target.value}`)})])]),new d({name:"subject",label:"Subject"},[I({type:"text",placeholder:"I need help with...",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),new d({name:"description",label:"Description"},[E({placeholder:"Please include all information relevant to your issue.",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),o({class:"flex justify-end gap-4 mt-4"},[l({variant:"outline",class:"px-4 py-2",click:()=>console.log("Cancel clicked")},"Cancel"),l({type:"submit",class:"px-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition"},"Submit")])]),De=()=>C({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[j({title:"Report an issue",description:"What area are you having problems with?"}),Qt()]),Zt=({link:e})=>o({class:"flex items-center gap-4 py-2"},[X({type:"text",value:e,readOnly:!0,class:"border p-2 rounded-md w-full bg-background text-foreground"}),l({variant:"secondary",class:"px-4 py-2",click:()=>{navigator.clipboard.writeText(e),app.notify({title:"Link copied",description:"The link has been copied to your clipboard.",icon:s.clipboard.checked})}},"Copy Link")]),Xt=({name:e,email:a,access:n,image:p})=>o({class:"flex items-center justify-between gap-4 py-2"},[o({class:"flex items-center gap-3"},[k({src:p,alt:e,fallbackText:e.split(" ").map(g=>g[0]).join("")}),o({},[r({class:"font-medium text-foreground"},e),r({class:"block text-sm text-muted-foreground"},a)])]),T({class:"border rounded-md bg-background text-foreground px-3 py-1",options:[{value:"edit",label:"Can edit"},{value:"view",label:"Can view"},{value:"comment",label:"Can comment"}],defaultValue:n,change:g=>console.log(`Access level changed for ${e}: ${g.target.value}`)})]),eo=({people:e})=>o({class:"space-y-3"},e.map(a=>Xt(a))),Be=({link:e,people:a})=>C({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[j({title:"Share this document",description:"Anyone with the link can view this document."}),Zt({link:e}),o({class:"border-t my-4"}),o({class:"font-medium text-foreground"},"People with access"),eo({people:a})]),to=e=>e.split(" ").map(n=>n[0]).join(""),oo=({name:e,email:a,role:n,image:p})=>o({class:"flex items-center justify-between gap-4 py-2"},[o({class:"flex items-center gap-3"},[k({src:p,alt:e,fallbackText:to(e)}),o({},[r({class:"font-medium text-foreground"},e),r({class:"block text-sm text-muted-foreground"},a)])]),T({class:"border rounded-md bg-background text-foreground px-3 py-1",options:[{value:"owner",label:"Owner"},{value:"member",label:"Member"}],defaultValue:n,change:g=>console.log(`Role changed for ${e}: ${g.target.value}`)})]),ao=({members:e})=>o({class:"space-y-3"},e.map(a=>oo(a))),Pe=({members:e})=>C({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[j({title:"Team Member",description:"Invite your team members to collaborate."}),ao({members:e})]),so=()=>f({title:"Cards",description:"Cards are a great way to display content in a concise and organized manner."},[t({title:"Usage",description:"Import the card atom and use it in your components.",preview:[C()],code:`import {  Button  } from "@base-framework/ui/atoms";
...
})`})]),lo=()=>{const e=[{id:1,status:"Active",email:"user1@example.com",amount:500.5},{id:2,status:"Inactive",email:"user2@example.com",amount:250.75},{id:3,status:"Active",email:"user3@example.com",amount:300}],a=()=>Je([ee({class:"text-muted-foreground border-b"},[Ve({}),J({key:"status",label:"Custom Status"}),J({key:"email",label:"User Email"}),J({key:"amount",label:"Amount (USD)",align:"justify-end"})])]),n=(p,g)=>ee({class:"items-center px-4 py-2 hover:bg-muted/50"},[B({class:"p-4"},[new G({checked:p.selected,class:"mr-2",click:()=>g(p)})]),B({class:"p-4 justify-center"},p.status),B({class:"p-4"},p.email),B({class:"p-4 text-right"},`$${p.amount.toFixed(2)}`)]);return o({class:"w-full mt-4"},[o({class:"w-full rounded-md border overflow-x-auto"},[Ye({class:"w-full"},[new ve({key:"id",customHeader:a(),rows:e,rowItem:n})])])])},no=[{label:"checkbox",key:""},{label:"Status",key:"status"},{label:"Email",key:"email"},{label:"Amount",key:"amount",align:"justify-end"}],co=[{id:1,status:"Success",email:"ken99@yahoo.com",amount:316,selected:!1},{id:2,status:"Success",email:"abe45@gmail.com",amount:242,selected:!1},{id:3,status:"Processing",email:"monserrat44@gmail.com",amount:837,selected:!1},{id:4,status:"Success",email:"silas22@gmail.com",amount:874,selected:!1},{id:5,status:"Failed",email:"carmella@hotmail.com",amount:721,selected:!1}],mo=(e,a)=>ee({class:"items-center px-4 py-2 hover:bg-muted/50"},[B({class:"p-4"},[new G({checked:e.selected,class:"mr-2",onChange:()=>a(e)})]),B({class:"p-4 "},[r({class:"text-muted-foreground"},e.status)]),B({class:"p-4 "},e.email),B({class:"p-4 text-right"},`$${e.amount.toFixed(2)}`)]),po=()=>f({title:"Data Tables",description:"Data tables are used to display or manipulate lists of items in tabular form."},[t({title:"Usage",description:"The DataTable component displays items in a structured format, supporting selection, custom row items, and more.",preview:[new ve({headers:no,rows:co,rowItem:mo,key:"id"})],code:`import {  DataTable  } from "@base-framework/ui/organisms";
...
};`}),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Selecting and Resetting Rows"),i({class:"text-muted-foreground"},"DataTable supports toggling all rows, clearing selections, and retrieving selected rows."),y(`// Suppose 'dt' is your DataTable instance
...
`)]),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Removing Items"),i({class:"text-muted-foreground"},"Use remove() to delete rows by passing an array of items (or a single item)."),y(`// dt is your DataTable instance
...
`)]),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Appending Items"),i({class:"text-muted-foreground"},"Use append() to add rows at the end of the list. Accepts an array or single object."),y(`// dt is your DataTable instance
...
`)]),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Mingling Items"),i({class:"text-muted-foreground"},"Mingle merges new items with existing items by matching keys. If withDelete = true, items not in newItems are removed."),y(`// dt is your DataTable instance
const newItems = [
...
`)]),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Prepending Items"),i({class:"text-muted-foreground"},"Use prepend() to add new rows at the beginning of the list, shifting existing rows down."),y(`// dt is your DataTable instance
...
});`}),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Removing Items"),i({class:"text-muted-foreground"},"Use remove() to delete items by their key. You can pass an array of items."),y(`// Suppose 'list' is an instance of the List component.

// Removing a single item:
list.remove([ item ]);

// Removing multiple items:
list.remove([ item1, item2 ]);`)]),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Setting Rows"),i({class:"text-muted-foreground"},"Use setRows() to directly replace the entire items array in the list."),y(`const newData = [
    { name: 'Alice', email: 'alice@example.com' },
    { name: 'Bob', email: 'bob@example.com' }
];
list.setRows(newData); // Replaces entire list with newData
`)]),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Getting Rows"),i({class:"text-muted-foreground"},"Use getRows() to retrieve the current items array in the list."),y(`const currentItems = list.getRows();
console.log('Current list items:', currentItems);
`)]),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Resetting the List"),i({class:"text-muted-foreground"},"Use reset() to clear all items, returning it to an empty list. Dividers are also reset, if any."),y(`list.reset(); // Empties the list's items array
`)]),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Appending Items"),i({class:"text-muted-foreground"},"Use append() to add new items to the end of the list. Accepts an array or single object."),y(`// Single item
...
`)]),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Mingling Items"),i({class:"text-muted-foreground"},"Use mingle(newItems, withDelete) to merge new items into existing ones, removing old ones if not present when withDelete = true. Compares based on the key property."),y(`const newItems = [
...
`)]),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Prepending Items"),i({class:"text-muted-foreground"},"Use prepend() to add new items at the beginning of the list, shifting existing items down."),y(`// Single item
...
`)])]),z=[{label:"Large",buttonStyle:"primary",size:"lg"},{label:"Small",buttonStyle:"secondary",size:"sm"},{label:"Medium",buttonStyle:"destructive",size:"md"},{label:"XL",buttonStyle:"primary",size:"xl"},{label:"Right",buttonStyle:"ghost",type:"right"},{label:"Left",buttonStyle:"link",type:"left"}],U=({label:e,buttonStyle:a,size:n,type:p})=>l({text:e,class:`m-1 ${a}`,click:()=>new _({title:"Are you absolutely sure?",size:n,type:p},[o({class:"flex flex-col max-w-lg lg:p-4 space-y-8"},[new d({name:"popover-test",label:"Popover Test"},[new ie]),new d({name:"dialog-test",label:"Dialog Test"},[l({click:()=>{new re({title:"Are you absolutely sure?",description:"This action cannot be undone.",confirmTextLabel:"Save",confirmed:()=>{app.notify({icon:s.trash,title:"Action complete",description:"You confirmed your selection.",type:"destructive"})}}).open()}},"Confirm")])])]).open()}),Po=({size:e="md",type:a="center"})=>new _({title:"Report an Issue",icon:s.warning,description:"What area are you having problems with?",size:e,type:a,onSubmit:()=>console.log("Form submitted")},[o({class:"flex flex-col lg:p-4 space-y-8"},[R({legend:"Issue Details"},[o({class:"flex flex-auto w-full gap-4"},[new d({name:"area",label:"Area"},[T({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"billing",label:"Billing"},{value:"technical",label:"Technical"},{value:"account",label:"Account"},{value:"other",label:"Other"}],defaultValue:"billing"})]),new d({name:"security_level",label:"Security Level"},[T({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"severity_1",label:"Severity 1"},{value:"severity_2",label:"Severity 2"},{value:"severity_3",label:"Severity 3"}],defaultValue:"severity_2"})])]),new d({name:"subject",label:"Subject"},[I({type:"text",placeholder:"I need help with...",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),new d({name:"description",label:"Description"},[E({placeholder:"Please include all information relevant to your issue.",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})])])])]),de=({label:e,buttonStyle:a,size:n,type:p})=>l({text:e,class:`m-1 ${a}`,click:()=>Po({size:n,type:p}).open()}),je=()=>[new ke({icon:s.ellipsis.vertical,groups:[[{icon:s.mapPin,label:"Track Item",value:"track-item"},{icon:s.trash,label:"Delete Item",value:"delete-item"}]],onSelect:e=>{console.log("Selected item from header:",e)}})],jo=()=>new _({title:"Detail Example",description:"This is a detailed view of an item.",icon:s.information,size:"md",headerOptions:je,hidePrimaryButton:!0},[gt([le({title:"Overview"},[F("Label","Value"),F("Date","2024-11-02"),o({class:"my-2 border-t"}),F("Status","Pending")]),le({title:"More Info"},[F("Description","This is a multi-line snippet."),F("Comments","No comments available.")])])]),Mo=()=>l({text:"Detail Modal",variant:"outline",click:()=>jo().open()}),Lo=()=>f({title:"Modals",description:"Displays modals or modal-like components with various sizes, forms, and header options."},[t({title:"Detail Modal Atoms",description:"Demonstrates usage of DetailBody, DetailSection, and SplitRow within a modal.",preview:[Mo()],code:`
...
`}),t({title:"Header Options",description:"You can pass `headerOptions` as an array of atoms for the modal’s top-right actions. Below is an example with a DropdownMenu in the modal header.",preview:[l({text:"Open Modal with Header Options",variant:"secondary",click:()=>new _({title:"Modal with Header Options",icon:s.settings,headerOptions:je,hidePrimaryButton:!0},[o({class:"p-4"},"This modal has an ellipsis menu in the header.")]).open()})],code:`
...
Tooltip({ content: 'This is a tooltip.' }, [
    ...
    Button('Hover me')
])`}),i({class:"text-muted-foreground text-sm mt-4"},"The tooltip position can be set to: top, top-right, top-left, bottom, bottom-right, bottom-left, left, right.")]),$=x((e,a)=>fe({...e,class:`flex p-4 max-h-[650px] max-w-[1024px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces break-all cursor-pointer mt-4 ${e.class}`},[he({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(a[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:s.clipboard.checked})}},a)])),Uo=()=>f({title:"Get Started",description:"This page will help you get started with the App Shell project."},[m({class:"space-y-4"},[c({class:"text-lg font-bold"},"About the Project"),i({class:"text-muted-foreground"},"This project is a PWA (Progressive Web App) that serves as a foundational framework for building web applications. It is designed to be modular, scalable, and easy to use, making it an ideal starting point for new projects.")]),m({class:"space-y-4 mt-12"},[c({class:"text-lg font-bold"},"Theme Setup"),i({class:"text-muted-foreground"},{html:'This project uses Tailwind and supported light and dark themes. The theme can be modified to fit the application style by changing a few fils in the project with the desired light and dark theme colors. The <a href="/docs/theme" class="underline">"Theme"</a> page outlines the types of properties that are themeable and how they are applied. '}),$(`
/**
 * /src/css/base.css
 */
@layer base {
	...
	@media (prefers-color-scheme: dark) {
		:root:not(.light) {
            ...
            ...
                ...
                `),c({class:"text-lg font-bold"},"Index Meta Tags"),i({class:"text-muted-foreground"},{html:"The theme colors should also be added to the index.html meta tags. The other meta tags like description and title can also be edited. "}),$(`
<meta name="theme-color" content="#09090b">
<meta name="msapplication-TileColor" content="#09090b">
                `),c({class:"text-lg font-bold"},"Manifest Colors and Settings"),i({class:"text-muted-foreground"},{html:`All PWA's need to have a manifiest that outlines the app settings. Edit the app theme and settings in the "public/manifest.json" file. `}),$(`
{
...
});`),c({class:"text-lg font-bold"},"Example Modules"),i({class:"text-muted-foreground"},[r('The App Shell project includes several example modules that demonstrate how to create and register modules. These examples can be found in the "src/modules" folder. Each module is self-contained and can be easily integrated into any project using the App Shell framework. The "main" module is a good starting point for understanding how to create and register modules. ')])])]),ue=(e,a,n)=>(n="Icons"+(n?"."+n:""),o({class:"flex flex-auto flex-col items-center gap-2 w-full max-w-[150px] h-[8.5rem] cursor-pointer"},[o({class:"flex flex-auto w-full h-full justify-center items-center flex-wrap rounded-lg border bg-card text-base shadow-sm hover:bg-muted/50",click:()=>{navigator.clipboard.writeText(`${n}.${a}`),app.notify({title:"Icon copied",description:`The icon '${n}.${a}' has been copied to your clipboard.`,icon:s.clipboard.checked})}},[w(e)]),o({class:"text-muted-foreground"},a)])),Me=(e,a,n)=>{const p=typeof e=="object";p&&a.push(i({class:"text-muted-foreground"},"path: "+n+".{icon}"));const g=[];if(a.push(o({class:"flex flex-auto flex-wrap gap-2 my-8"},g)),p===!1)g.push(ue(e,n));else for(var N in e){if(e.hasOwnProperty(N)===!1)continue;const Y=e[N];if(typeof Y!="object"){g.push(ue(Y,N,n));continue}const Le=`${n}.${N}`;Me(Y,a,Le)}},qo=e=>{if(!e||typeof e!="object")return;const a=[];for(let[n,p]of Object.entries(e)){if(n==="parse")continue;a.push(ae({id:n.toLowerCase(),class:"text-2xl font-bold"},Ct.titleCase(n))),Me(p,a,n)}return a},Oo=()=>f({title:"Icons",description:"The icons are from the Hericon library. They are SVG icons that can be used in your project. This icon set uses the outline style."},[D({href:"https://heroicons.com/",target:"_blank",class:"bttn link"},"link: Hericons"),t({title:"Icons",description:"This is an icon.",preview:[It({html:s.home})],code:`
import {  Icons  } from "@base-framework/ui/icons";
