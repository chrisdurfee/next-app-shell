import{t as h,J as s,i as I,o,l as t,Z as r,a9 as b,_ as u,ax as g,aq as w}from"./index-FyEWRJ98.js";import"./tooltip-Pwsjx1Gp-DMkxnO-U.js";import{D as m}from"./doc-section-SOQ6iBgK.js";import{D as y}from"./doc-page-CN40b5sS.js";import"./signature-panel-BRxjdz83-DnGczPaR.js";import"./sidebar-menu-page-BtUJdw-T-BbtKFyk7.js";import"./mobile-nav-wrapper-C7RyGC5a-DEjNwmFZ.js";const f=(c,n,e=null)=>(e="Icons"+(e?"."+e:""),s({class:"flex flex-auto flex-col items-center gap-2 w-full max-w-[150px] h-[8.5rem] cursor-pointer"},[s({class:"flex flex-auto w-full h-full justify-center items-center flex-wrap rounded-lg border bg-card text-base shadow-sm hover:bg-muted/50",click:()=>{navigator.clipboard.writeText(`${e}.${n}`),app.notify({title:"Icon copied",description:`The icon '${e}.${n}' has been copied to your clipboard.`,icon:o.clipboard.checked})}},[t(c)]),s({class:"text-muted-foreground"},n)])),d=(c,n,e)=>{const l=typeof c=="object";l&&n.push(u({class:"text-muted-foreground"},"path: "+e+".{icon}"));const i=[];if(n.push(s({class:"flex flex-auto flex-wrap gap-2 my-8"},i)),l===!1)i.push(f(c,e));else for(var a in c){if(c.hasOwnProperty(a)===!1)continue;const x=c[a];if(typeof x!="object"){i.push(f(x,a,e));continue}const p=`${e}.${a}`;d(x,n,p)}},z=c=>{if(!c||typeof c!="object")return;const n=[];for(let[e,l]of Object.entries(c)){if(e==="parse")continue;n.push(g({id:e.toLowerCase(),class:"text-2xl font-bold"},w.titleCase(e))),d(l,n,e)}return n},D=()=>y({title:"Icons",description:"The icons are from the Hericon library. They are SVG icons that can be used in your project. This icon set uses the outline style."},[h({href:"https://heroicons.com/",target:"_blank",class:"bttn link"},"link: Hericons"),m({title:"Icons",description:"This is an icon.",preview:[I({html:o.home})],code:`
