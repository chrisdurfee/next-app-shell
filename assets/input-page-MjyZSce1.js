import{H as o,F as s,i as u,a$ as c,aE as p,b0 as h,b1 as f,b2 as w,b3 as v,b4 as I,b5 as x,b6 as k,b7 as T,ad as l,U as i,aj as y,b8 as S,s as C,b9 as F,ba as D,bb as r,bc as E,bd as P,be as R,bf as U,bg as N,bh as X,bi as j,bj as L,aG as A,av as H,a3 as M,aF as q,bk as W,M as G,ao as B,bl as K,a0 as V,al as d,b as Z,aD as _,w as J}from"./index-CV4GSeLQ.js";import{F as Q}from"./signature-panel-C0enb6BJ-CIx1wzMo.js";import{D as a}from"./doc-section-zCj_deO5.js";import{D as Y}from"./doc-page-WcS71eV4.js";import"./sidebar-menu-page-CPoNqLGD-CLruaz4N.js";import"./sidebar-menu-Qw5a8TeQ-CWvaRbSr.js";const $=[{value:"next.js",label:"Next.js"},{value:"sveltekit",label:"SvelteKit"},{value:"nuxt.js",label:"Nuxt.js"},{value:"remix",label:"Remix"},{value:"astro",label:"Astro"}],z=[{value:"us",label:"United States"},{value:"ca",label:"Canada"},{value:"uk",label:"United Kingdom"},{value:"au",label:"Australia"},{value:"de",label:"Germany"}],t=J((e,n)=>o({...e,class:"flex flex-auto items-center justify-center w-full max-w-[350px]"},n)),m=({label:e,description:n,active:g,onChange:b})=>o({class:"flex items-center justify-between p-4 border rounded-md bg-muted/10 border-muted-foreground/20 mb-4"},[o({class:"flex flex-col pr-8"},[l({class:"font-semibold"},e),i({class:"text-sm text-muted-foreground"},n)]),new d({active:g,change:b})]),O=[{label:"Apple",value:"apple"},{label:"Banana",value:"banana"},{label:"Cherry",value:"cherry"},{label:"Date",value:"date"},{label:"Elderberry",value:"elderberry"},{label:"Fig",value:"fig"},{label:"Grape",value:"grape"},{label:"Honeydew",value:"honeydew"}],ne=()=>Y({title:"Inputs",description:"Inputs are essential for gathering user data in forms."},[a({title:"Usage",description:"Import the input atom and use it in your components. The input can be of various types: text, password, email, etc.",preview:[o({class:"grid gap-2 w-full max-w-[350px]"},[s({type:"text",placeholder:"Enter your text here...",change:e=>console.log(e.target.value)}),u({}),c({}),p({placeholder:"Enter your text here..."})])],code:`import {  Input, EmailInput, TelInput, Textarea  } from "@base-framework/ui/atoms";
...
})`}),a({title:"Select",description:"This is a select input.",preview:[t([q({options:$,change:e=>console.log(e.target.value)})])],code:`import {  Select  } from "@base-framework/ui/atoms";
...
Textarea({
    placeholder: 'Enter your text here...'
})`}),a({title:"Time Picker",description:"This is a time picker input.",preview:[t([new W({selectedTime:"12:00 am",change:e=>console.log(e)})])],code:`
...
})`}),a({title:"Date Picker",description:"This is a date picker input.",preview:[t([new G({blockPriorDates:!1,selectedDate:"2022-01-01",onChange:e=>console.log(e)})])],code:`
...
})`}),a({title:"Counter",description:"This is a counter input.",preview:[t([new V({class:"max-w-[300px]",initialCount:5,min:0,max:1e5,readonly:!1,bind:"count",change:e=>console.log(e)})])],code:`
...
]);`}),a({title:"Logo Uploader",description:"This is a logo uploader.",preview:[t([new _({src:"",onChange:(e,n)=>console.log(e,n)})])],code:`
import {  LogoUploader  } from "@base-framework/ui/molecules";

new LogoUploader({
    src: '',
    onChange: (file, parent) => console.log(file, parent)
})`}),a({title:"Signature Pad",description:"This is a signature pad input.",preview:[t([new Q({lineWidth:1,lineColor:"#CCCCCC",baseLineWidth:1,baseStrokeColor:"#333333"})])],code:`
