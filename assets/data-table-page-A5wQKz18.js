import{Y as u,M as y,W as d,ai as t,N as x,u as s,a7 as o,G as l,z as k}from"./index-tUNdxma0.js";import{F as g}from"./tooltip-CESEqMCU-5SZT0R-G.js";import{x as f,p as T,b as c,i as D}from"./signature-panel-rfv7cz7U-CACUI0ep.js";import{D as n,C as r}from"./doc-section-cszB_SaM.js";import{D as S}from"./doc-page-D5E1ak4m.js";import"./sidebar-menu-page-BVryQj2Z-CXoaAGwW.js";import"./mobile-nav-wrapper-Dj67Pb8l-C8B9uqZO.js";const I=()=>{const e=[{id:1,status:"Active",email:"user1@example.com",amount:500.5},{id:2,status:"Inactive",email:"user2@example.com",amount:250.75},{id:3,status:"Active",email:"user3@example.com",amount:300}],m=()=>x([d({class:"text-muted-foreground border-b"},[T({}),c({key:"status",label:"Custom Status"}),c({key:"email",label:"User Email"}),c({key:"amount",label:"Amount (USD)",align:"justify-end"})])]),i=(a,h)=>d({class:"items-center px-4 py-2 hover:bg-muted/50"},[t({class:"p-4"},[new g({checked:a.selected,class:"mr-2",click:()=>h(a)})]),t({class:"p-4 justify-center"},a.status),t({class:"p-4"},a.email),t({class:"p-4 text-right"},`$${a.amount.toFixed(2)}`)]);return u({class:"w-full mt-4"},[u({class:"w-full rounded-md border overflow-x-auto"},[y({class:"w-full"},[new f({key:"id",customHeader:m(),rows:e,rowItem:i})])])])},p=[{label:"checkbox",key:""},{label:"Status",key:"status"},{label:"Email",key:"email"},{label:"Amount",key:"amount",align:"justify-end"}],b=[{id:1,status:"Success",email:"ken99@yahoo.com",amount:316,selected:!1},{id:2,status:"Success",email:"abe45@gmail.com",amount:242,selected:!1},{id:3,status:"Processing",email:"monserrat44@gmail.com",amount:837,selected:!1},{id:4,status:"Success",email:"silas22@gmail.com",amount:874,selected:!1},{id:5,status:"Failed",email:"carmella@hotmail.com",amount:721,selected:!1}],w=(e,m)=>d({class:"items-center px-4 py-2 hover:bg-muted/50"},[t({class:"p-4"},[new g({checked:e.selected,class:"mr-2",onChange:()=>m(e)})]),t({class:"p-4 "},[k({class:"text-muted-foreground"},e.status)]),t({class:"p-4 "},e.email),t({class:"p-4 text-right"},`$${e.amount.toFixed(2)}`)]),U=()=>S({title:"Data Tables",description:"Data tables are used to display or manipulate lists of items in tabular form."},[n({title:"Usage",description:"The DataTable component displays items in a structured format, supporting selection, custom row items, and more.",preview:[new f({headers:p,rows:b,rowItem:w,key:"id"})],code:`import { DataTable } from "@base-framework/ui/organisms";
