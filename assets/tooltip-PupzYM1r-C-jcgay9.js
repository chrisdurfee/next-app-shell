import{a as o,i as n,d as v,P as s,Z as x,t as w,H as p,J as P,f as H,o as q,E,g as S,h as I,j as $,l as k,m as D}from"./index-CD4VvKaS.js";const F="flex h-10 w-full px-3 py-2 text-sm",d="rounded-md border border-border bg-input",c="focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 ring-offset-background",i="disabled:cursor-not-allowed disabled:opacity-50 [&:user-invalid]:border-destructive",u="placeholder:text-muted-foreground",b=`${F} ${d} ${c} ${u} ${i}`,M=({id:e,checked:r,bind:t,required:l})=>w({id:e,cache:"checkbox",class:"absolute opacity-0 w-full h-full cursor-pointer pointer-events-none",aria:{checked:["checked"]},required:l,checked:r,bind:t}),O=()=>p({class:"absolute text-xs pointer-events-none"},[P("checked",e=>e?H({class:"w-2 h-2 pointer-events-none",html:q.check}):null)]),T=({id:e,bind:r,checked:t,required:l,clickHandler:a})=>s({class:`relative flex items-center justify-center w-5 h-5 transition-colors duration-200 hover:border-accent-foreground
			rounded-md border
			${c}
