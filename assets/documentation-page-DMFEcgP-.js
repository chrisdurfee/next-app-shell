import{G as Je,S as Qe}from"./molecules-Dq0cVDwe.js";import{o as Z,Y as o,u as C,p as Ie,Z as de,q as me,w as B,Q as b,x as Ke,N as Ze,a as r,l as O,s as ue,G as d,y as Xe,E as et,r as je,H as W,A as S,K as k,z as l,L as tt,_ as X,R as U,J as D,B as c,b as Ae,U as ot,V as at,W as Be,X as st,$ as nt,a0 as rt,a1 as F,I as w,a2 as N,c as u,a3 as R,a4 as ee,a5 as pe,d as P,a6 as I,a7 as q,a8 as _,a9 as fe,aa as ge,ab as it,D as Pe,ac as lt,j as re,ad as ct,ae as oe,k as $,C as te,af as Fe,ag as he,P as z,ah as be,F as G,ai as ie,aj as le,ak as dt,al as mt,am as ae,an as ut,ao as pt,ap as ft,aq as gt,ar as ht,as as bt,at as xt,au as wt,av as vt,aw as yt,M as Me,ax as kt,ay as Tt,h as St,az as H,S as A,m as Le,T as Ct,e as L,aA as ce,v as Dt,aB as It,O as jt}from"./index-CRLv3ELd.js";import{C as At}from"./counter-BC19X8xo.js";import{U as Bt}from"./user-list-DCXebY85.js";const Pt=e=>me({class:"inline-flex flex-auto items-center justify-center whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm",dataSet:["selected",["state",e.value,"active"]]},[B({class:"flex flex-auto justify-center items-center px-3 py-1.5",onSet:["selected",{selected:e.value}],click:t=>e.callBack(e.value)},e.label)]),Ft=(e,t)=>(e.callBack=t,Pt(e)),Mt=e=>Ie({class:`tab items-center justify-center rounded-md bg-muted p-1 text-muted-foreground ${e.class}`},[de({class:"flex flex-auto flex-row",map:[e.options,t=>Ft(t,e.callBack)]})]);class $e extends Z{render(){const t=this.select.bind(this);return o({class:""},[Mt({class:this.class,options:this.options,callBack:t}),C({class:"tab-content",onState:["selected",this.updateContent.bind(this)]})])}getFirstValue(){var t;return(t=this.options[0])==null?void 0:t.value}update(){const t=this.state.get("selected");this.select(null),this.select(t)}select(t){this.state.selected=t}updateContent(t){const a=this.options;if(!a||a.length<1)return;const n=a[0];for(const i of a)if(i.value===t)return i.layout;return n.layout}setupStates(){const t=this.callBack,a=typeof t;return{selected:{state:this.getFirstValue(),callBack(n){a==="function"&&t(n)}}}}}const Ne=b((e,t)=>Ke({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces break-all cursor-pointer"},[Ze({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(t[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:r.clipboard.checked})}},t)])),Lt=b((e,t)=>o({class:"flex flex-auto p-4 min-h-[350px] max-h-[650px] overflow-x-auto max-w-[90vw] rounded-lg border bg-card"},[o({class:"preview flex flex-auto justify-center items-center"},t)])),xe=b((e,t)=>o({class:"py-4"},t)),$t=e=>new $e({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:xe([Lt(e.preview)])},{label:"Code",value:"code",layout:xe([Ne(e.code)])}]}),Nt=b(({title:e,description:t})=>O({class:"flex flex-col"},[ue({class:"scroll-m-20 text-2xl font-bold tracking-tight"},e),t&&d({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),s=b((e,t)=>C({class:"grid py-4"},[Nt({title:e.title,description:e.description}),$t({preview:e.preview,code:e.code})]));class Et extends Xe{render(){return et([o({class:"contained px-4 flex flex-auto flex-col"},this.children)])}}const Ht=b(({title:e,description:t})=>O({class:"flex flex-col"},[je({class:"scroll-m-20 text-3xl font-bold tracking-tight"},e),d({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),Rt=b((e,t)=>o({class:"contained py-8"},[Ht(e),C({class:"pb-12 pt-8"},t)])),f=b((e,t)=>new Et([Rt(e,t)])),Wt=()=>f({title:"Alerts",description:"Alerts are used to provide feedback to the user about the outcome of an action or to inform them of important information."},[s({title:"Default Alert",description:"This is a standard alert without any specific type.",preview:[W({title:"Notice",description:"This is a default alert without a specific type.",icon:r.information})],code:`import { Alert } from "@components/molecules/alert.js";
...
Button({ ...props, variant: 'secondary' }, primary)`}),O({class:"flex flex-col py-8"},[Ae({class:"text-3xl font-bold tracking-tight border-b pb-2"},"Variants")]),s({title:"Primary Button",description:"This is a primary button.",preview:[c({variant:"primary"},"Click Me")],code:`
...
LoadingButton('With Icon')`})]),Zt=e=>{const t=new Date(e.valueOf()),a=(t.getDay()+6)%7;t.setDate(t.getDate()-a+3);const n=new Date(t.getFullYear(),0,4);n.setDate(n.getDate()-(n.getDay()+6)%7);const i=Math.ceil((t-n)/6048e5)+1;return i>52&&!Xt(t.getFullYear())?1:i},Xt=e=>{const t=new Date(e,11,31),a=new Date(e,0,1);return t.getDay()===4||a.getDay()===4},ve=(e,t)=>{const a=new Date(t,0,4),n=(a.getDay()+6)%7,i=new Date(a);i.setDate(a.getDate()-n);const m=new Date(i);return m.setDate(i.getDate()+(e-1)*7),m},eo=(e,t,a)=>{if(a===0)return[];const n=new Date(e,t,0).getDate();return Array.from({length:a},(i,m)=>new Date(e,t-1,n-a+m+1))},to=(e,t,a)=>Array.from({length:a},(n,i)=>new Date(e,t+1,i+1)),oo=(e,t,a)=>{const n=new Date;return n.getDate()===e&&n.getMonth()===t&&n.getFullYear()===a},ao=({day:e,week:t,month:a,year:n,weekNumber:i,currentDate:m,selectWeek:h})=>{const M=oo(e,a,n),v=t.some(j=>(j==null?void 0:j.getDate())===m);return B({text:e||"",disabled:!e,class:`
            px-2 py-1 text-center rounded-md
            ${M?"bg-accent text-accent-foreground":""}
            ${v&&!M?"border border-accent":""}
            hover:bg-primary hover:text-primary-foreground
        `,click:()=>h(i,n)})},so=(e,t)=>{const a=new Date(e,t,1).getDay(),n=new Date(e,t+1,0).getDate(),i=eo(e,t,a),m=Array.from({length:n},(T,V)=>new Date(e,t,V+1)),h=7-((i.length+m.length)%7||7),M=to(e,t,h),v=[...i,...m,...M],j=[];for(let T=0;T<v.length;T+=7){const V=v.slice(T,T+7);j.push({weekNumber:Zt(V.find(Ye=>Ye)||new Date(e,t,1)),days:V})}return j},no=({selectWeek:e})=>at("month",(t,a,{data:n})=>{const{year:i,month:m,currentDate:h}=n,M=so(i,m);return o({class:"grid grid-cols-8 gap-1 text-sm px-4 py-2"},[o({class:"text-xs text-center col-span-1 text-muted-foreground flex items-center"},"Week"),o({class:"grid grid-cols-7 col-span-7 text-center text-muted-foreground items-center"},["Su","Mo","Tu","We","Th","Fr","Sa"].map(v=>l({class:"px-1 py-1",text:v}))),...M.map(({weekNumber:v,days:j})=>o({class:"grid grid-cols-8 col-span-8 items-center"},[o({class:"font-medium text-center col-span-1 rounded-sm cursor-pointer",click:()=>e(v,i),onSet:["currentWeek",{"text-primary-foreground":v,"bg-primary":v}],text:v?`W${v}`:""}),o({class:"grid grid-cols-7 col-span-7 text-center"},j.map(T=>ao({year:T?T.getFullYear():null,month:T?T.getMonth():null,day:T?T.getDate():null,week:j,weekNumber:v,currentDate:h,selectWeek:e})))]))])}),ye=({label:e,click:t})=>c({class:`
            inline-flex items-center justify-center h-7 w-7 bg-transparent p-0
            opacity-50 hover:opacity-100 text-muted-foreground absolute
            ${e==="Previous"?"left-1":"right-1"}
            focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2
          `,click:t,"aria-label":`${e} month`,variant:"icon",icon:e==="Previous"?r.chevron.single.left:r.chevron.single.right}),ro=({next:e,previous:t})=>o({class:"flex flex-auto min-h-12 text-sm font-medium relative justify-center items-center"},[l("[[monthName]] [[year]]"),ye({label:"Previous",click:t}),ye({label:"Next",click:e})]);class io extends Z{setData(){const t=new Date,a=this.selectedWeek||this.calculateCurrentWeek(t),n=ve(a,t.getFullYear());return new U({monthName:this.getMonthName(n.getMonth()),year:n.getFullYear(),month:n.getMonth(),currentDate:n.getDate(),currentWeek:a})}getSelectedDate(t){const a=this.selectedDate?new Date(this.selectedDate):t;return new Date(a.getFullYear(),a.getMonth(),a.getDate())}calculateCurrentWeek(t){const a=new Date(t.valueOf()),n=(t.getDay()+6)%7;a.setDate(a.getDate()-n+3);const i=a.valueOf();return a.setMonth(0,1),a.getDay()!==4&&a.setMonth(0,1+(4-a.getDay()+7)%7),1+Math.ceil((i-a)/6048e5)}getMonthName(t){return Be.monthNames[t]}goToPreviousMonth(){const t=this.data;let{year:a,month:n}=t;n===0?(n=11,a--):n--,this.setDate(n,a)}goToNextMonth(){const t=this.data;let{year:a,month:n}=t;n===11?(n=0,a++):n++,this.setDate(n,a)}setDate(t,a,n){this.data.set({year:a,month:t,monthName:this.getMonthName(t)}),n&&(this.data.currentDate=n)}selectWeek(t,a){this.data.currentWeek=t;const n=ve(t,a);this.setDate(n.getMonth(),n.getFullYear(),n.getDate()),typeof this.selectedCallBack=="function"&&this.selectedCallBack(t)}render(){return o({class:"week-calendar-container border rounded-md bg-background p-3"},[ro({next:()=>this.goToNextMonth(),previous:()=>this.goToPreviousMonth()}),no({selectWeek:(t,a)=>this.selectWeek(t,a)})])}}const lo=()=>Be.formatTime("",24),co=()=>f({title:"Calendars",description:"This is the calendar component documentation."},[s({title:"Usage",description:"This is how you can use the calendar component.",preview:[new st],code:`@components/organisms/calendar/calendar.js';
...
Textarea({
    placeholder: 'Enter your text here...'
})`}),s({title:"Time Picker",description:"This is a time picker input.",preview:[g([new ca({selectedTime:"12:00 am",change:e=>console.log(e)})])],code:`
...
])`}),s({title:"Text Input",description:"This is a text input.",preview:[g([P({type:"text",placeholder:"Enter your text here..."})])],code:`
import { EmailInput, FileInput, Input, TelInput, Textarea } from "@components/atoms/form/input.js";
...
})`}),s({title:"Select",description:"This is a select input.",preview:[g([I({options:da,change:e=>console.log(e.target.value)})])],code:`import { Select } from "@components/atoms/form/select.js";
...
})`})]),wa=e=>!e||isNaN(e)?null:e,Se=(e,t)=>{const a=e,n=16,i=2*Math.PI*n,m=a/100*i,h=`
...
Tooltip({ content: 'This is a tooltip.' }, [
    ...
    Button('Hover me')
])`}),d({class:"text-muted-foreground text-sm mt-4"},"The tooltip position can be set to: top, top-right, top-left, bottom, bottom-right, bottom-left, left, right.")]),De=(e,t,a)=>(a="Icons"+(a?"."+a:""),o({class:"flex flex-auto flex-col items-center gap-2 w-full max-w-[150px] h-[8.5rem] cursor-pointer"},[o({class:"flex flex-auto w-full h-full justify-center items-center flex-wrap rounded-lg border bg-card text-base shadow-sm hover:bg-muted/50",click:()=>{navigator.clipboard.writeText(`${a}.${t}`),app.notify({title:"Icon copied",description:`The icon '${a}.${t}' has been copied to your clipboard.`,icon:r.clipboard.checked})}},[w(e)]),o({class:"text-muted-foreground"},t)])),Ve=(e,t,a)=>{const n=typeof e=="object";n&&t.push(d({class:"text-muted-foreground"},"path: "+a+".{icon}"));const i=[];if(t.push(o({class:"flex flex-auto flex-wrap gap-2 my-8"},i)),n===!1)i.push(De(e,a));else for(var m in e){if(e.hasOwnProperty(m)===!1)continue;const h=e[m];if(typeof h!="object"){i.push(De(h,m,a));continue}const M=`${a}.${m}`;Ve(h,t,M)}},Aa=e=>{if(!e||typeof e!="object")return;const t=[];for(let[a,n]of Object.entries(e)){if(a==="parse")continue;t.push(ce({id:a.toLowerCase(),class:"text-2xl font-bold"},Dt.titleCase(a))),Ve(n,t,a)}return t},Ba=()=>f({title:"Icons",description:"The icons are from the Hericon library. They are SVG icons that can be used in your project. This icon set uses the outline style."},[D({href:"https://heroicons.com/",target:"_blank",class:"bttn link"},"link: Hericons"),s({title:"Icons",description:"This is an icon.",preview:[_({html:r.home})],code:`
import { Icons } from '@components/icons/icons.js';
