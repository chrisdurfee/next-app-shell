import{G as l,s as n,w as o,n as r,ae as a,Y as c,o as s,c as p}from"./index-DDW7XYOj.js";import{D as i}from"./doc-section-Cixoiu-a.js";import{D as d}from"./doc-page-Dos4Al3q.js";import"./sidebar-menu-page-nCAVFk3R-CfzmPBT3.js";import"./mobile-nav-wrapper-BE_hr65B-BwlYgnmR.js";const m=n((e,t)=>o({text:"Open",class:"m-1",click:()=>new r(e,t).open()})),u=e=>o({text:"Open",class:"m-1",click:()=>new a(e).open()}),f=n((e,t)=>o({text:"Open",class:"m-1",click:()=>new a({icon:s.signOut,type:"destructive",title:"Are you absoultely sure?",description:"This will sign you out of the application.",confirmTextLabel:"Sign Out",confirmed:()=>console.log("Confirmed!")}).open()})),h=({link:e})=>c({class:"flex items-center gap-4 py-2"},[p({type:"text",value:e,readOnly:!0,class:"border p-2 rounded-md w-full bg-background text-foreground"}),o({variant:"secondary",class:"px-4 py-2",click:()=>{navigator.clipboard.writeText(e),app.notify({title:"Link copied",description:"The link has been copied to your clipboard.",icon:s.clipboard.checked})}},"Copy Link")]),y=e=>o({text:"Open",class:"m-1",click:()=>new r(e,[h({link:"https://example.com"})]).open()}),v=()=>d({title:"Dialogs",description:"Displays a dialog or a component that looks like a dialog. Dialogs can be opened and closed. They will be closed if the user clicks outside of the dialog or if the user clicks the close button."},[i({title:"Usage",description:"Import the dialog atom and use it in your components.",preview:[m({title:"Title",description:"this is the description.",hideFooter:!1},[])],code:`import {  Dialog  } from "@base-framework/ui/molecules";
...
`}),l("The types are `destructive`, `warning`, `info`, `success`, and `default`. Dialogs can also have an icon in the header. The icon can be any icon from the icon library.")]);export{v as DialogPage,v as default};
