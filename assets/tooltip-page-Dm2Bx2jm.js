import{Y as t,W as o,w as e,G as p}from"./index-Co9id9_l.js";import{D as i}from"./doc-section-BwyIo5jC.js";import{D as l}from"./doc-page-CGFcqYyM.js";const a=()=>l({title:"Tooltips",description:"Tooltips are small popups that appear when a user hovers over an element."},[i({title:"Usage",description:"Import the tooltip atom and use it in your components.",preview:[t({class:"flex gap-2 flex-wrap"},[o({content:"This is a tooltip."},[e("Hover me")])])],code:`import {  Button  } from "@base-framework/ui/atoms";
