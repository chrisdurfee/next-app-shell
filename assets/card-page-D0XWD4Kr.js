import{R as c,_ as a,e as t,d as s,s as i,b as n,ad as p,I as f}from"./index-BOO5Pnj0.js";import{D as e}from"./doc-section-BYWZkHEJ.js";import{D as u}from"./doc-page-DSSU-fnG.js";import{A as x,P as h,T as b,S as g,D as C,R as y,C as w}from"./team-member-card-vJW2SZL3.js";import"./signature-panel-BWHC9V2v-CAplkTPP.js";import"./sidebar-menu-page-D12NEBpp-CYabCRqd.js";import"./sidebar-menu-BHHp2hXa-BfYRJzQL.js";const j=({name:o,description:r,stars:m,language:l,lastUpdated:d})=>a({class:"flex items-start justify-between py-4 border-b border-muted last:border-b-0"},[a({class:"flex flex-col"},[t({class:"font-semibold text-foreground"},o),t({class:"text-sm text-muted-foreground"},r),a({class:"flex gap-x-4 text-sm text-muted-foreground mt-3"},[a({class:"flex items-center gap-2"},[s({class:" text-blue-500"},i.document.text),t(` ${l}`)]),a({class:"flex items-center"},[s(i.star),t(` ${m}`)]),a(`Updated ${d}`)])]),n({variant:"secondary",class:"px-3 py-1 gap-1 flex items-center rounded-md",click:()=>console.log(`Starred ${o}`)},[s(i.star),t("Star")])]),D=({projects:o})=>a({class:"flex flex-col gap-y-3"},o.map(r=>j(r))),S=[{name:"shadcn/ui",description:"Beautifully designed components that you can copy and paste into your apps. Accessible. Customizable. Open Source.",stars:"20k",language:"TypeScript",lastUpdated:"April 2023"},{name:"base-framework",description:"A robust framework for building and structuring large-scale applications with ease.",stars:"2",language:"JavaScript",lastUpdated:"June 2024"}],A=()=>c({class:"w-full max-w-md mx-auto p-6 bg-card flex flex-col gap-y-6"},[a({class:"font-semibold text-lg text-foreground"},"Projects"),D({projects:S})]),E=()=>u({title:"Cards",description:"Cards are a great way to display content in a concise and organized manner."},[e({title:"Usage",description:"Import the card atom and use it in your components.",preview:[c()],code:`import {  Button  } from "@base-framework/ui/atoms";
...
CookieSettingsCard()`})]);export{E as CardPage,E as default};
