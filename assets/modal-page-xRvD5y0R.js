import{b as r,ac as d,ad as h,o,J as s,a as l,B as g,al as y,ae as M,af as p,ag as i,at as v}from"./index-BwF0wPkX.js";import{I as k,R as b,c as x,q as D}from"./tooltip-CESEqMCU-JmWqAxV4.js";import"./signature-panel-C8UM0F7Y-CAVDUO-N.js";import{D as e}from"./doc-section-Ces5yGST.js";import{D as S}from"./doc-page-Bz9QcxeM.js";import"./sidebar-menu-page-BVryQj2Z-BCyQNzl3.js";import"./mobile-nav-wrapper-Dj67Pb8l-CpGhJBUQ.js";const n=[{label:"Large",buttonStyle:"primary",size:"lg"},{label:"Small",buttonStyle:"secondary",size:"sm"},{label:"Medium",buttonStyle:"destructive",size:"md"},{label:"XL",buttonStyle:"primary",size:"xl"},{label:"Right",buttonStyle:"ghost",type:"right"},{label:"Left",buttonStyle:"link",type:"left"}],m=({label:t,buttonStyle:a,size:c,type:u})=>r({text:t,class:`m-1 ${a}`,click:()=>new d({title:"Are you absolutely sure?",size:c,type:u},[s({class:"flex flex-col max-w-lg lg:p-4 space-y-8"},[new l({name:"popover-test",label:"Popover Test"},[new g]),new l({name:"dialog-test",label:"Dialog Test"},[r({click:()=>{new y({title:"Are you absolutely sure?",description:"This action cannot be undone.",confirmTextLabel:"Save",confirmed:()=>{app.notify({icon:o.trash,title:"Action complete",description:"You confirmed your selection.",type:"destructive"})}}).open()}},"Confirm")])])]).open()}),B=({size:t="md",type:a="center"})=>new d({title:"Report an Issue",icon:o.warning,description:"What area are you having problems with?",size:t,type:a,onSubmit:()=>console.log("Form submitted")},[s({class:"flex flex-col lg:p-4 space-y-8"},[k({legend:"Issue Details"},[s({class:"flex flex-auto w-full gap-4"},[new l({name:"area",label:"Area"},[b({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"billing",label:"Billing"},{value:"technical",label:"Technical"},{value:"account",label:"Account"},{value:"other",label:"Other"}],defaultValue:"billing"})]),new l({name:"security_level",label:"Security Level"},[b({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"severity_1",label:"Severity 1"},{value:"severity_2",label:"Severity 2"},{value:"severity_3",label:"Severity 3"}],defaultValue:"severity_2"})])]),new l({name:"subject",label:"Subject"},[x({type:"text",placeholder:"I need help with...",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),new l({name:"description",label:"Description"},[D({placeholder:"Please include all information relevant to your issue.",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})])])])]),f=({label:t,buttonStyle:a,size:c,type:u})=>r({text:t,class:`m-1 ${a}`,click:()=>B({size:c,type:u}).open()}),w=()=>[new h({icon:o.ellipsis.vertical,groups:[[{icon:o.mapPin,label:"Track Item",value:"track-item"},{icon:o.trash,label:"Delete Item",value:"delete-item"}]],onSelect:t=>{console.log("Selected item from header:",t)}})],I=()=>new d({title:"Detail Example",description:"This is a detailed view of an item.",icon:o.information,size:"md",headerOptions:w,hidePrimaryButton:!0},[M([p({title:"Overview"},[i("Label","Value"),i("Date","2024-11-02"),s({class:"my-2 border-t"}),i("Status","Pending")]),p({title:"Details"},[v("Label text","Value")]),p({title:"More Info"},[i("Description","This is a multi-line snippet."),i("Comments","No comments available.")])])]),z=()=>r({text:"Detail Modal",variant:"outline",click:()=>I().open()}),E=()=>S({title:"Modals",description:"Displays modals or modal-like components with various sizes, forms, and header options."},[e({title:"Detail Modal Atoms",description:"Demonstrates usage of DetailBody, DetailSection, and SplitRow within a modal.",preview:[z()],code:`
