...
})`})]),co=[{label:"checkbox",key:""},{label:"Status",key:"status"},{label:"Email",key:"email"},{label:"Amount",key:"amount",align:"justify-end"}],uo=[{id:1,status:"Success",email:"ken99@yahoo.com",amount:316,selected:!1},{id:2,status:"Success",email:"abe45@gmail.com",amount:242,selected:!1},{id:3,status:"Processing",email:"monserrat44@gmail.com",amount:837,selected:!1},{id:4,status:"Success",email:"silas22@gmail.com",amount:874,selected:!1},{id:5,status:"Failed",email:"carmella@hotmail.com",amount:721,selected:!1}],mo=(e,t)=>Qe({class:"items-center px-4 py-2 hover:bg-muted"},[O({class:"p-4 "},[new le({checked:e.selected,class:"mr-2",onChange:()=>t(e)})]),O({class:"p-4 "},[i({class:"text-muted-foreground"},e.status)]),O({class:"p-4 "},e.email),O({class:"p-4 text-right"},`$${e.amount.toFixed(2)}`)]),po=()=>p({title:"Data Tables",description:"Data tables are used to display data in a structured format. They can be used to display a list of items, a grid of items, or a table of items."},[a({title:"Usage",description:"The data table component is used to display data in a structured format. It can be used to display a list of items, a grid of items, or a table of items.",preview:[new ft({headers:co,rows:uo,rowItem:mo,key:"id"})],code:`import { DataTable } from "@components/organisms/lists/data-table.js";
