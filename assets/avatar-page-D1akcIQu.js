...
Div({
    ...
    StatusIndicator()
])`}),a({title:"Static Status Indicator",description:"A small status indicator for online, offline, busy, or away statuses.",preview:[e({class:"relative"},[o("online")])],code:`import { Div, H4, P, Span } from "@base-framework/atoms";
