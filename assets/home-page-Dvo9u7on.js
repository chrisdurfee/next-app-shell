import{r as a,S as p,Y as s,J as o,G as n,u as c,M as m,N as u,o as h,l as r,d as x,s as f}from"./index-DG-BSwAy.js";const b=a(()=>s({class:"mt-10 flex items-center justify-start gap-x-4 px-6 pb-6 border-b"},[o({href:"/docs",class:"bttn primary"},"Get started"),o({href:"https://github.com/chrisdurfee/base",target:"_blank",class:"bttn ghost gap-2"},"Github")])),g=a(({title:e,description:t})=>r({class:"flex flex-col px-6"},[x({class:"text-3xl font-bold leading-tight tracking-tighter md:text-4xl lg:leading-[1.1]"},e),t&&n({class:"max-w-2xl text-lg font-light text-foreground mt-2"},t)])),w=a(({title:e,description:t})=>r({class:"flex flex-col"},[f({class:"scroll-m-20 text-2xl font-bold tracking-tight"},e),t&&n({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),i=a(({title:e,description:t},d)=>c({class:"flex flex-col w-full px-6 py-8 border-b"},[w({title:e,description:t}),d])),k=a((e,t)=>s({class:"flex flex-auto flex-col"},[s({class:"flex flex-auto flex-col w-full max-w-[1400px] m-auto sm:pt-8 lg:border-r lg:border-l"},[g({title:"Build faster with Base and Tailwind CSS",description:"Beautifully designed components inpired by the genius at Shadcn and tailored to work with Base. Base is easy to use and open source."}),b(),...t])])),l=a((e,t)=>m({...e,class:`flex p-4 max-h-[650px] max-w-[1024px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces break-all cursor-pointer mt-4 ${e.class}`},[u({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(t[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:h.clipboard.checked})}},t)])),y=()=>new p([k([i({title:"Why Base?",description:"Base is a small framework that does things like global and local states, routing, events, dates, data tracking, data binding, data watching, and rending of components using Atoms. It is designed to be simple and fast to build. It's open source and in npm."},[l("npm install @base-framework/base"),s({class:"mt-10 flex items-center justify-start gap-x-4 pb-6"},[o({href:"https://github.com/chrisdurfee/base/wiki",target:"_blank",class:"bttn ghost gap-2"},"Base Docs")])]),i({title:"Example App",description:"This is an example Todo app built with base."},[l(`import { Button, Div, Form, H1, Input, Li, Ul } from "@base-framework/atoms";
