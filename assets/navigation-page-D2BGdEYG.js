import{_ as e,z as n,s as o}from"./index-BOO5Pnj0.js";import{T as s}from"./signature-panel-BWHC9V2v-CAplkTPP.js";import{b as i}from"./sidebar-menu-BHHp2hXa-BfYRJzQL.js";import{D as a}from"./doc-section-BYWZkHEJ.js";import{D as t}from"./doc-page-DSSU-fnG.js";import"./sidebar-menu-page-D12NEBpp-CYabCRqd.js";const d=()=>t({title:"Navigations",description:"Navigations are components that help users move around the website or application."},[a({title:"Navigation Menu",description:"The navigation menu component is a simple navigation component that will create a horizontal menu.",preview:[e({class:"flex flex-auto flex-col w-full"},[new s({options:[{label:"Examples",href:"docs/components/navigations/examples"},{label:"Mail",href:"docs/components/navigations/mail"},{label:"Dashboard",href:"docs/components/navigations/dashboard"},{label:"Tasks",href:"docs/components/navigations/tasks"},{label:"Playground",href:"docs/components/navigations/playground"},{label:"Forms",href:"docs/components/navigations/forms"},{label:"Music",href:"docs/components/navigations/music"},{label:"Authentication",href:"docs/components/navigations/authentication"}]})])],code:`import {  Button  } from "@base-framework/ui/organisms";
...
`})]);export{d as NavigationPage,d as default};
