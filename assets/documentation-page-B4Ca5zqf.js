import{Q as b,M as je,N as Le,o as s,Y as o,q as pe,u as p,l as R,s as ae,G as i,w as Fe,e as fe,y as L,m as k,A as c,z as r,B as $e,C as Ee,H as w,I as Re,K as Ne,r as l,a as he,O as He,P as ze,R as Ue,U as qe,W as Oe,X as We,Z as C,$ as x,a0 as P,f as m,a1 as Z,a2 as W,a3 as se,_ as ge,a4 as Ge,c as D,a5 as T,a6 as E,a7 as be,a8 as _e,h as we,a9 as Ye,i as X,aa as Je,ab as J,j as B,k as G,ac as xe,ad as ie,ae as ve,E as $,af as Ve,ag as Ke,L as N,ah as ee,ai as te,aj as ye,ak as Qe,al as Ze,am as V,an as Xe,ao as et,ap as tt,aq as ot,ar as at,as as st,at as it,au as rt,av as lt,aw as nt,ax as ct,T as mt,n as dt,ay as ut,az as pt,x as _,aA as ft,aB as re,aC as F,aD as ht,aE as gt,F as bt,aF as j,aG as wt,aH as xt,V as I,aI as vt,t as yt,p as kt,D as A,J as S,aJ as Tt,aK as oe,v as St,aL as It,aM as Dt,aN as Ct}from"./index-CPLyRTYu.js";const v=b((e,a)=>je({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces break-all cursor-pointer"},[Le({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(a[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:s.clipboard.checked})}},a)])),At=b((e,a)=>o({class:"flex flex-auto p-4 min-h-[350px] max-h-[650px] overflow-x-auto max-w-[90vw] rounded-lg border bg-card"},[o({class:"preview flex flex-auto justify-center items-center"},a)])),le=b((e,a)=>o({class:"py-4"},a)),Bt=e=>new pe({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:le([At(e.preview)])},{label:"Code",value:"code",layout:le([v(e.code)])}]}),Pt=b(({title:e,description:a})=>R({class:"flex flex-col"},[ae({class:"scroll-m-20 text-2xl font-bold tracking-tight"},e),a&&i({class:"text-base text-muted-foreground py-2 max-w-[700px]"},a)])),t=b((e,a)=>p({class:"grid py-4"},[Pt({title:e.title,description:e.description}),Bt({preview:e.preview,code:e.code})])),Mt=b(({title:e,description:a})=>R({class:"flex flex-col"},[fe({class:"scroll-m-20 text-3xl font-bold tracking-tight"},e),i({class:"text-base text-muted-foreground py-2 max-w-[700px]"},a)])),jt=b((e,a)=>o({class:"contained py-8"},[Mt(e),p({class:"pb-12 pt-8"},a)])),f=b((e,a)=>new Fe([jt(e,a)])),Lt=()=>f({title:"Alerts",description:"Alerts are used to provide feedback to the user about the outcome of an action or to inform them of important information."},[t({title:"Default Alert",description:"This is a standard alert without any specific type.",preview:[L({title:"Notice",description:"This is a default alert without a specific type.",icon:s.information})],code:`import {  Alert  } from "@base-framework/ui/molecules";
...
CookieSettingsCard()`})]),so=[{value:"next.js",label:"Next.js",icon:s.home},{value:"sveltekit",label:"SvelteKit"},{value:"nuxt.js",label:"Nuxt.js"},{value:"remix",label:"Remix"},{value:"astro",label:"Astro"}],io=()=>f({title:"Comboboxes",description:"Comboboxes are used to allow users to select an option from a dropdown list or enter a custom value."},[t({title:"Usage",description:"To use the Combobox component, import it from the components library and use it in your application.",preview:[o({class:"w-full max-w-[300px]"},[new be({items:so,onSelect:e=>console.log(e)})])],code:`@base-framework/ui/molecules;
import {  Icons  } from "@base-framework/ui/icons";
...
`)])]),uo=b((e,a)=>l({text:"Open",class:"m-1",click:()=>new xe(e,a).open()})),po=e=>l({text:"Open",class:"m-1",click:()=>new ie(e).open()}),fo=b((e,a)=>l({text:"Open",class:"m-1",click:()=>new ie({icon:s.signOut,type:"destructive",title:"Are you absoultely sure?",description:"This will sign you out of the application.",confirmTextLabel:"Sign Out",confirmed:()=>console.log("Confirmed!")}).open()})),ho=({link:e})=>o({class:"flex items-center gap-4 py-2"},[D({type:"text",value:e,readOnly:!0,class:"border p-2 rounded-md w-full bg-background text-foreground"}),l({variant:"secondary",class:"px-4 py-2",click:()=>{navigator.clipboard.writeText(e),app.notify({title:"Link copied",description:"The link has been copied to your clipboard.",icon:s.clipboard.checked})}},"Copy Link")]),go=e=>l({text:"Open",class:"m-1",click:()=>new xe(e,[ho({link:"https://example.com"})]).open()}),bo=()=>f({title:"Dialogs",description:"Displays a dialog or a component that looks like a dialog. Dialogs can be opened and closed. They will be closed if the user clicks outside of the dialog or if the user clicks the close button."},[t({title:"Usage",description:"Import the dialog atom and use it in your components.",preview:[uo({title:"Title",description:"this is the description.",hideFooter:!1},[])],code:`import {  Dialog  } from "@base-framework/ui/molecules";
...
])`})]),z=b((e,a)=>o({...e,class:"flex flex-auto items-center justify-center w-full py-4 space-y-8 max-w-[450px]"},a)),xo=[{value:"next.js",label:"Next.js"},{value:"sveltekit",label:"SvelteKit"},{value:"nuxt.js",label:"Nuxt.js"},{value:"remix",label:"Remix"},{value:"astro",label:"Astro"}],vo=()=>P({submit:e=>{console.log("Profile Form submitted")}},[N({legend:"Profile"},[new m({name:"username",label:"Username",description:"This is your public display name."},[D({placeholder:"e.g. username",required:!0})]),new m({name:"email",label:"Email Address",description:"We'll use this to contact you."},[ee({placeholder:"e.g. email@address.com",required:!0})]),l({type:"submit"},"Submit")])]),yo=()=>P({submit:e=>{console.log("Preferences Form submitted")}},[N({legend:"Preferences"},[new m({name:"framework",label:"Favorite Framework",description:"Select your preferred framework."},[T({options:xo,required:!0})]),new m({name:"newsletter",label:"Subscribe to Newsletter",description:"Stay updated with our latest news."},[new G({label:"Yes, sign me up!",required:!0,onChange:e=>console.log("Newsletter checked:",e)})]),l({type:"submit"},"Save Preferences")])]),ko=()=>P({submit:e=>{console.log("Contact Form submitted")}},[N({legend:"Contact Us"},[new m({name:"phone",label:"Phone Number",description:"We may contact you at this number."},[te({placeholder:"e.g. +1234567890",required:!0})]),new m({name:"message",label:"Your Message",description:"Let us know how we can help you."},[E({placeholder:"Type your message here...",required:!0})]),new m({name:"message",label:"Select Framework",description:"Select your preferred framework."},[new be({required:!0,items:[{value:"next.js",label:"Next.js"},{value:"sveltekit",label:"SvelteKit"},{value:"nuxt.js",label:"Nuxt.js"},{value:"remix",label:"Remix"},{value:"astro",label:"Astro"}]})]),l({type:"submit"},"Send Message")])]),To=()=>P({submit:e=>{console.log("Settings Form submitted")}},[N({legend:"Settings"},[new m({name:"notifications",label:"Enable Notifications",description:"Toggle to enable or disable notifications."},[new W({active:!0,required:!0})]),new m({name:"volume",label:"Volume Level",description:"Set your preferred volume level."},[new ye({min:0,max:100,value:50})]),l({type:"submit"},"Save Settings")])]),So=()=>f({title:"Forms",description:"Forms are used to collect user data and submit it to the server."},[t({title:"Profile Form",description:"A simple profile form with username and email fields.",preview:[z([vo()])],code:`import {  Button, Input, EmailInput  } from "@base-framework/ui/atoms";
...
])`}),t({title:"Preferences Form",description:"A preferences form with a select input and a checkbox.",preview:[z([yo()])],code:`import {  Button, Checkbox, Select  } from "@base-framework/ui/atoms";
import {  Form, FormField  } from "@base-framework/ui/molecules";
import { Div } from "@base-framework/atoms";
import { Atom } from "@base-framework/base";
import {  Fieldset  } from "@base-framework/ui/atoms";
...
])`}),t({title:"Contact Form",description:"A contact form with a phone input and a textarea for messages.",preview:[z([ko()])],code:`import {  Button, TelInput, Textarea  } from "@base-framework/ui/atoms";
import {  Form, FormField  } from "@base-framework/ui/molecules";
import { Div } from "@base-framework/atoms";
import { Atom } from "@base-framework/base";
import {  Fieldset  } from "@base-framework/ui/atoms";
...
])`}),t({title:"Settings Form",description:"A settings form with a toggle and a range slider.",preview:[z([To()])],code:`import {  Button, Toggle, RangeSlider  } from "@base-framework/ui/atoms";
import {  Form, FormField  } from "@base-framework/ui/molecules";
import { Div } from "@base-framework/atoms";
import { Atom } from "@base-framework/base";
import {  Fieldset  } from "@base-framework/ui/atoms";
...
])`}),t({title:"Text Input",description:"This is a text input.",preview:[h([D({type:"text",placeholder:"Enter your text here..."})])],code:`
...
`)])]),U=[{label:"Large",buttonStyle:"primary",size:"lg"},{label:"Small",buttonStyle:"secondary",size:"sm"},{label:"Medium",buttonStyle:"destructive",size:"md"},{label:"XL",buttonStyle:"primary",size:"xl"},{label:"Right",buttonStyle:"ghost",type:"right"},{label:"Left",buttonStyle:"link",type:"left"}],q=({label:e,buttonStyle:a,size:n,type:d})=>l({text:e,class:`m-1 ${a}`,click:()=>new _({title:"Are you absolutely sure?",size:n,type:d},[o({class:"flex flex-col max-w-lg lg:p-4 space-y-8"},[new m({name:"popover-test",label:"Popover Test"},[new se]),new m({name:"dialog-test",label:"Dialog Test"},[l({click:()=>{new ie({title:"Are you absolutely sure?",description:"This action cannot be undone.",confirmTextLabel:"Save",confirmed:()=>{app.notify({icon:s.trash,title:"Action complete",description:"You confirmed your selection.",type:"destructive"})}}).open()}},"Confirm")])])]).open()}),Bo=({size:e="md",type:a="center"})=>new _({title:"Report an Issue",icon:s.warning,description:"What area are you having problems with?",size:e,type:a,onSubmit:()=>console.log("Form submitted")},[o({class:"flex flex-col lg:p-4 space-y-8"},[N({legend:"Issue Details"},[o({class:"flex flex-auto w-full gap-4"},[new m({name:"area",label:"Area"},[T({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"billing",label:"Billing"},{value:"technical",label:"Technical"},{value:"account",label:"Account"},{value:"other",label:"Other"}],defaultValue:"billing"})]),new m({name:"security_level",label:"Security Level"},[T({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"severity_1",label:"Severity 1"},{value:"severity_2",label:"Severity 2"},{value:"severity_3",label:"Severity 3"}],defaultValue:"severity_2"})])]),new m({name:"subject",label:"Subject"},[D({type:"text",placeholder:"I need help with...",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),new m({name:"description",label:"Description"},[E({placeholder:"Please include all information relevant to your issue.",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})])])])]),me=({label:e,buttonStyle:a,size:n,type:d})=>l({text:e,class:`m-1 ${a}`,click:()=>Bo({size:n,type:d}).open()}),Be=()=>[new ve({icon:s.ellipsis.vertical,groups:[[{icon:s.mapPin,label:"Track Item",value:"track-item"},{icon:s.trash,label:"Delete Item",value:"delete-item"}]],onSelect:e=>{console.log("Selected item from header:",e)}})],Po=()=>new _({title:"Detail Example",description:"This is a detailed view of an item.",icon:s.information,size:"md",headerOptions:Be,hidePrimaryButton:!0},[ft([re({title:"Overview"},[F("Label","Value"),F("Date","2024-11-02"),o({class:"my-2 border-t"}),F("Status","Pending")]),re({title:"More Info"},[F("Description","This is a multi-line snippet."),F("Comments","No comments available.")])])]),Mo=()=>l({text:"Detail Modal",variant:"outline",click:()=>Po().open()}),jo=()=>f({title:"Modals",description:"Displays modals or modal-like components with various sizes, forms, and header options."},[t({title:"Detail Modal Atoms",description:"Demonstrates usage of DetailBody, DetailSection, and SplitRow within a modal.",preview:[Mo()],code:`
...
`}),t({title:"Extra Large Modal",description:"An extra large modal example.",preview:[q(U[3])],code:`
import {  Modal  } from "@base-framework/ui/molecules";
import {  Button  } from "@base-framework/ui/atoms";
...
});`}),t({title:"Large Modal",preview:[q(U[0])],code:`
import {  Modal  } from "@base-framework/ui/molecules";
import {  Button  } from "@base-framework/ui/atoms";
...
});`}),t({title:"Medium Modal",preview:[q(U[2])],code:`
import {  Modal  } from "@base-framework/ui/molecules";
import {  Button  } from "@base-framework/ui/atoms";
...
});`}),t({title:"Right Modal",preview:[q(U[4])],code:`
import {  Modal  } from "@base-framework/ui/molecules";
import {  Button  } from "@base-framework/ui/atoms";
...
LoadingAvatar();`})]),de=b((e,a)=>o({class:"py-4"},a)),No=()=>f({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[t({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new pe({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:de([])},{label:"Code",value:"code",layout:de([])}]})],code:`
