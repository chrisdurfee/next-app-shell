...
TelInput({
})`}),s({title:"Email Input",description:"This is a email input.",preview:[g([ne({})])],code:`
import { EmailInput, FileInput, Input, TelInput, Textarea } from "@components/atoms/form/input.js";
...
})`}),s({title:"Select",description:"This is a select input.",preview:[g([C({options:ua,change:e=>console.log(e.target.value)})])],code:`import { Select } from "@components/atoms/form/select.js";
...
Textarea({
    placeholder: 'Enter your text here...'
})`}),s({title:"Date Picker",description:"This is a date picker input.",preview:[g([new ce({selectedDate:"2022-01-01"})])],code:`
