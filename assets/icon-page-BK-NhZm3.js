...
Icon({ class: 'text-yellow-500' }, Icons.phone.outbound)`}),e({class:"my-20"},[f({class:"text-2xl font-bold"},"Available Heroicons"),t({class:"text-muted-foreground"},"Below is a curated collection of Heroicons available in the Icons object. Click any icon to copy its path to your clipboard.")]),H(o)]);export{V as IconPage,V as default};
