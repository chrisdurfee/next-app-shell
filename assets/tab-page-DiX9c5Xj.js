import{ax as l,s as n,aA as p,ag as a,a2 as i,am as m,Y as r}from"./index-DDW7XYOj.js";import{D as e}from"./doc-section-Cixoiu-a.js";import{D as c}from"./doc-page-Dos4Al3q.js";import"./sidebar-menu-page-nCAVFk3R-CfzmPBT3.js";import"./mobile-nav-wrapper-BE_hr65B-BwlYgnmR.js";const t=n((o,s)=>r({class:"py-4"},s)),w=()=>c({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[e({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new l({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:t([])},{label:"Code",value:"code",layout:t([])}]})],code:`
...
})`})]);export{w as TabPage,w as default};
