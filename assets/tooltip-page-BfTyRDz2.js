import{G as p,Y as t,a0 as o,w as e}from"./index-CM1IEHgP.js";import{D as i}from"./doc-section-1HDPv0lU.js";import{D as l}from"./doc-page-Cjx708Nb.js";import"./sidebar-menu-page-nCAVFk3R-Di2_rNMK.js";const h=()=>l({title:"Tooltips",description:"Tooltips are small popups that appear when a user hovers over an element."},[i({title:"Usage",description:"Import the tooltip atom and use it in your components.",preview:[t({class:"flex gap-2 flex-wrap"},[o({content:"This is a tooltip."},[e("Hover me")])])],code:`import {  Button  } from "@base-framework/ui/atoms";
...
Tooltip({ content: 'This is a tooltip.' }, [
    ...
    Button('Hover me')
])`}),p({class:"text-muted-foreground text-sm mt-4"},"The tooltip position can be set to: top, top-right, top-left, bottom, bottom-right, bottom-left, left, right.")]);export{h as TooltipPage,h as default};
