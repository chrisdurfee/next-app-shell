import{Y as t,X as o,w as e,G as p}from"./index-DCpU6b2K.js";import{D as i}from"./doc-section-C3wHpgQC.js";import{D as l}from"./doc-page-D7FKkNfr.js";const a=()=>l({title:"Tooltips",description:"Tooltips are small popups that appear when a user hovers over an element."},[i({title:"Usage",description:"Import the tooltip atom and use it in your components.",preview:[t({class:"flex gap-2 flex-wrap"},[o({content:"This is a tooltip."},[e("Hover me")])])],code:`import {  Button  } from "@base-framework/ui/atoms";
