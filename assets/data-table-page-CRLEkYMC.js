import{a as p,U as f,Z as c,ak as e,V as T,B as s,r as a,a8 as o,e as x}from"./index-wYN7iTVl.js";import{a as g,V as d}from"./tooltip-Cok_NM7z-BbePt1H1.js";import{j as m,b as S,y as u,r as D}from"./signature-panel-BEO99NlI-DPHTrVYi.js";import{D as n,C as l}from"./doc-section-CSNHVfYO.js";import{D as v}from"./doc-page-B-agd6yJ.js";import"./sidebar-menu-page-BtUJdw-T-Ce7Yaah_.js";import"./mobile-nav-wrapper-C7RyGC5a-ltnr2Q1O.js";const I=()=>{const t=[{id:1,status:"Active",email:"user1@example.com",amount:500.5},{id:2,status:"Inactive",email:"user2@example.com",amount:250.75},{id:3,status:"Active",email:"user3@example.com",amount:300}],r=()=>T([c({class:"text-muted-foreground border-b"},[S({}),u({key:"status",label:"Custom Status"}),u({key:"email",label:"User Email"}),u({key:"amount",label:"Amount (USD)",align:"justify-end"})])]),y=(i,k)=>c({class:"items-center px-4 py-2 hover:bg-muted/50"},[e({class:"p-4"},[new g({checked:i.selected,class:"mr-2",click:()=>k(i)})]),e({class:"p-4 justify-center"},i.status),e({class:"p-4"},i.email),e({class:"p-4 text-right"},`$${i.amount.toFixed(2)}`)]);return p({class:"w-full mt-4"},[p({class:"w-full rounded-md border overflow-x-auto"},[f({class:"w-full"},[new m({key:"id",customHeader:r(),rows:t,rowItem:y})])])])},h=[{label:"checkbox",key:""},{label:"Status",key:"status"},{label:"Email",key:"email"},{label:"Amount",key:"amount",align:"justify-end"}],w=[{id:1,status:"Success",email:"ken99@yahoo.com",amount:316,selected:!1},{id:2,status:"Success",email:"abe45@gmail.com",amount:242,selected:!1},{id:3,status:"Processing",email:"monserrat44@gmail.com",amount:837,selected:!1},{id:4,status:"Success",email:"silas22@gmail.com",amount:874,selected:!1},{id:5,status:"Failed",email:"carmella@hotmail.com",amount:721,selected:!1}],b=(t,r)=>c({class:"items-center px-4 py-2 hover:bg-muted/50"},[e({class:"p-4"},[new g({checked:t.selected,class:"mr-2",onChange:()=>r(t)})]),e({class:"p-4 "},[x({class:"text-muted-foreground"},t.status)]),e({class:"p-4 "},t.email),e({class:"p-4 text-right"},`$${t.amount.toFixed(2)}`)]),C=(t,r)=>c({class:"border-b hover:bg-muted/50"},[e({class:"p-4"},[d({shape:"circle",width:"w-4",height:"h-4"})]),e({class:"p-4"},[d({width:"w-20",height:"h-4"})]),e({class:"p-4"},[d({width:"w-32",height:"h-4"})]),e({class:"p-4"},[d({width:"w-16",height:"h-4"})])]),j=()=>v({title:"Data Tables",description:"Data tables are used to display or manipulate lists of items in tabular form."},[n({title:"Usage",description:"The DataTable component displays items in a structured format, supporting selection, custom row items, and more.",preview:[new m({headers:h,rows:w,rowItem:b,key:"id"})],code:`import { DataTable } from "@base-framework/ui/organisms";
...
});`}),s({class:"space-y-4 mt-8"},[o({class:"text-lg font-bold"},"Dynamic Data Table Features"),a({class:"text-muted-foreground"},"DynamicDataTable provides automatic data management with built-in loading states, error handling, and model integration."),l(`// Key features of DynamicDataTable:
...
new DataTable({
	...
	rowItem: userRowItem,
	key: 'id'
});`}),s({class:"space-y-4 mt-8"},[o({class:"text-lg font-bold"},"Skeleton API and Control"),a({class:"text-muted-foreground"},"The skeleton system provides automatic and manual control methods for managing loading states."),l(`// Skeleton configuration options
...
`)]),s({class:"space-y-4 mt-8"},[o({class:"text-lg font-bold"},"Selecting and Resetting Rows"),a({class:"text-muted-foreground"},"DataTable supports toggling all rows, clearing selections, and retrieving selected rows."),l(`// Suppose 'dt' is your DataTable instance
...
`)]),s({class:"space-y-4 mt-8"},[o({class:"text-lg font-bold"},"Removing Items"),a({class:"text-muted-foreground"},"Use remove() to delete rows by passing an array of items (or a single item)."),l(`// dt is your DataTable instance
...
`)]),s({class:"space-y-4 mt-8"},[o({class:"text-lg font-bold"},"Appending Items"),a({class:"text-muted-foreground"},"Use append() to add rows at the end of the list. Accepts an array or single object."),l(`// dt is your DataTable instance
...
`)]),s({class:"space-y-4 mt-8"},[o({class:"text-lg font-bold"},"Mingling Items"),a({class:"text-muted-foreground"},"Mingle merges new items with existing items by matching keys. If withDelete = true, items not in newItems are removed."),l(`// dt is your DataTable instance
const newItems = [
...
`)]),s({class:"space-y-4 mt-8"},[o({class:"text-lg font-bold"},"Prepending Items"),a({class:"text-muted-foreground"},"Use prepend() to add new rows at the beginning of the list, shifting existing rows down."),l(`// dt is your DataTable instance
...
`)])]);export{j as DataTablePage,j as default};
