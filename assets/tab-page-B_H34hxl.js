import{w as n,H as l}from"./index-CV4GSeLQ.js";import{N as i,z as r,P as e,j as p,h as c,A as b,I as m,U as d}from"./signature-panel-C0enb6BJ-CIx1wzMo.js";import{D as o}from"./doc-section-zCj_deO5.js";import{D as u}from"./doc-page-WcS71eV4.js";import"./sidebar-menu-page-CPoNqLGD-CLruaz4N.js";import"./sidebar-menu-Qw5a8TeQ-CWvaRbSr.js";const a=n((t,s)=>l({class:"py-4"},s)),g=()=>u({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[o({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new i({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:a([])},{label:"Code",value:"code",layout:a([])}]})],code:`
...
);`})]);export{g as TabPage,g as default};
