import{I as h,P as s,f as I,o,s as t,H as r,aa as b,M as u,az as g,as as w}from"./index-DKyDmH4w.js";import"./tooltip-PupzYM1r-ChIvTG2T.js";import{D as m}from"./doc-section-DMmtfojS.js";import{D as y}from"./doc-page-Cx4YteUm.js";import"./signature-panel-C73NYC3W-SV0rAT-P.js";import"./sidebar-menu-page-D4WMgz5U-LUrzZsPE.js";import"./mobile-nav-wrapper-Dm9DinRD-CFDvrTv7.js";const x=(c,n,e=null)=>(e="Icons"+(e?"."+e:""),s({class:"flex flex-auto flex-col items-center gap-2 w-full max-w-[150px] h-34 cursor-pointer"},[s({class:"flex flex-auto w-full h-full justify-center items-center flex-wrap rounded-lg border bg-card text-base shadow-sm hover:bg-muted/50",click:()=>{navigator.clipboard.writeText(`${e}.${n}`),app.notify({title:"Icon copied",description:`The icon '${e}.${n}' has been copied to your clipboard.`,icon:o.clipboard.checked})}},[t(c)]),s({class:"text-muted-foreground"},n)])),d=(c,n,e)=>{const l=typeof c=="object";l&&n.push(u({class:"text-muted-foreground"},"path: "+e+".{icon}"));const i=[];if(n.push(s({class:"flex flex-auto flex-wrap gap-2 my-8"},i)),l===!1)i.push(x(c,e));else for(var a in c){if(c.hasOwnProperty(a)===!1)continue;const f=c[a];if(typeof f!="object"){i.push(x(f,a,e));continue}const p=`${e}.${a}`;d(f,n,p)}},z=c=>{if(!c||typeof c!="object")return;const n=[];for(let[e,l]of Object.entries(c)){if(e==="parse")continue;n.push(g({id:e.toLowerCase(),class:"text-2xl font-bold"},w.titleCase(e))),d(l,n,e)}return n},H=()=>y({title:"Icons",description:"The icons are from the Hericon library. They are SVG icons that can be used in your project. This icon set uses the outline style."},[h({href:"https://heroicons.com/",target:"_blank",class:"bttn link"},"link: Hericons"),m({title:"Icons",description:"This is an icon.",preview:[I({html:o.home})],code:`
