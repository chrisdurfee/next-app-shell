import{z as o,N as s,U as u,a$ as c,aE as p,b0 as h,b1 as f,b2 as w,b3 as v,b4 as I,b5 as x,b6 as k,b7 as T,ad as l,H as i,aj as y,b8 as S,s as C,b9 as F,ba as D,bb as r,bc as E,bd as P,be as R,bf as U,bg as N,bh as X,bi as j,bj as L,aG as A,av as H,a3 as M,aF as W,bk as q,M as G,ao as B,bl as K,a0 as z,al as d,b as V,aD as J,k as Q}from"./index-B0D4AD-V.js";import{U as Y}from"./signature-panel-BOh8VNYa-B-4as7Ja.js";import{D as a}from"./doc-section-cHBzosZX.js";import{D as Z}from"./doc-page-DLSmyI_M.js";import"./sidebar-menu-page-C6gtJ-5U-CBkJEhyp.js";import"./sidebar-menu-D5VxMCLC-D1hY0PWw.js";const _=[{value:"next.js",label:"Next.js"},{value:"sveltekit",label:"SvelteKit"},{value:"nuxt.js",label:"Nuxt.js"},{value:"remix",label:"Remix"},{value:"astro",label:"Astro"}],$=[{value:"us",label:"United States"},{value:"ca",label:"Canada"},{value:"uk",label:"United Kingdom"},{value:"au",label:"Australia"},{value:"de",label:"Germany"}],t=Q((e,n)=>o({...e,class:"flex flex-auto items-center justify-center w-full max-w-[350px]"},n)),m=({label:e,description:n,active:g,onChange:b})=>o({class:"flex items-center justify-between p-4 border rounded-md bg-muted/10 border-muted-foreground/20 mb-4"},[o({class:"flex flex-col pr-8"},[l({class:"font-semibold"},e),i({class:"text-sm text-muted-foreground"},n)]),new d({active:g,change:b})]),O=[{label:"Apple",value:"apple"},{label:"Banana",value:"banana"},{label:"Cherry",value:"cherry"},{label:"Date",value:"date"},{label:"Elderberry",value:"elderberry"},{label:"Fig",value:"fig"},{label:"Grape",value:"grape"},{label:"Honeydew",value:"honeydew"}],ne=()=>Z({title:"Inputs",description:"Inputs are essential for gathering user data in forms."},[a({title:"Usage",description:"Import the input atom and use it in your components. The input can be of various types: text, password, email, etc.",preview:[o({class:"grid gap-2 w-full max-w-[350px]"},[s({type:"text",placeholder:"Enter your text here...",change:e=>console.log(e.target.value)}),u({}),c({}),p({placeholder:"Enter your text here..."})])],code:`import {  Input, EmailInput, TelInput, Textarea  } from "@base-framework/ui/atoms";
...
})`}),a({title:"Select",description:"This is a select input.",preview:[t([W({options:_,change:e=>console.log(e.target.value)})])],code:`import {  Select  } from "@base-framework/ui/atoms";
...
})`}),a({title:"Counter",description:"This is a counter input.",preview:[t([new z({class:"max-w-[300px]",initialCount:5,min:0,max:1e5,readonly:!1,bind:"count",change:e=>console.log(e)})])],code:`
...
]);`}),a({title:"Logo Uploader",description:"This is a logo uploader.",preview:[t([new J({src:"",onChange:(e,n)=>console.log(e,n)})])],code:`
