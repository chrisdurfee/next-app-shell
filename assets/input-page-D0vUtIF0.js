import{H as o,d as s,Y as u,a$ as c,aE as p,b0 as h,b1 as f,b2 as w,b3 as v,b4 as I,b5 as x,b6 as k,b7 as T,ad as l,U as i,aj as y,b8 as S,s as C,b9 as F,ba as D,bb as r,bc as E,bd as P,be as R,bf as U,bg as N,bh as X,bi as j,bj as L,aG as A,av as H,a3 as M,aF as W,bk as q,B,ao as G,bl as K,a0 as O,al as d,x as Y,aD as V,T as Z}from"./index-C7IgtdX5.js";import{O as z}from"./signature-panel-C70NY5pI-Cb_gXbDy.js";import{D as a}from"./doc-section-Dp-TE_n0.js";import{D as J}from"./doc-page-B1G_e0cm.js";import"./sidebar-menu-page-CyjzBKBh-D_nFJVhZ.js";import"./sidebar-menu-BOz-Ju8B-CAeo820-.js";const Q=[{value:"next.js",label:"Next.js"},{value:"sveltekit",label:"SvelteKit"},{value:"nuxt.js",label:"Nuxt.js"},{value:"remix",label:"Remix"},{value:"astro",label:"Astro"}],_=[{value:"us",label:"United States"},{value:"ca",label:"Canada"},{value:"uk",label:"United Kingdom"},{value:"au",label:"Australia"},{value:"de",label:"Germany"}],t=Z((e,n)=>o({...e,class:"flex flex-auto items-center justify-center w-full max-w-[350px]"},n)),m=({label:e,description:n,active:g,onChange:b})=>o({class:"flex items-center justify-between p-4 border rounded-md bg-muted/10 border-muted-foreground/20 mb-4"},[o({class:"flex flex-col pr-8"},[l({class:"font-semibold"},e),i({class:"text-sm text-muted-foreground"},n)]),new d({active:g,change:b})]),$=[{label:"Apple",value:"apple"},{label:"Banana",value:"banana"},{label:"Cherry",value:"cherry"},{label:"Date",value:"date"},{label:"Elderberry",value:"elderberry"},{label:"Fig",value:"fig"},{label:"Grape",value:"grape"},{label:"Honeydew",value:"honeydew"}],ne=()=>J({title:"Inputs",description:"Inputs are essential for gathering user data in forms."},[a({title:"Usage",description:"Import the input atom and use it in your components. The input can be of various types: text, password, email, etc.",preview:[o({class:"grid gap-2 w-full max-w-[350px]"},[s({type:"text",placeholder:"Enter your text here...",change:e=>console.log(e.target.value)}),u({}),c({}),p({placeholder:"Enter your text here..."})])],code:`import {  Input, EmailInput, TelInput, Textarea  } from "@base-framework/ui/atoms";
...
FloatingSelect       // Select dropdown with floating label + custom chevron arrow`}),a({title:"Search Dropdown",description:"This is a search dropdown.",preview:[o({class:"relative w-full max-w-md"},[new y({options:$,onSelect:e=>console.log(e)})])],code:`import {  SearchDropdown  } from "@base-framework/ui/organisms";
...
`}),a({title:"Search Input",description:"This is a search input.",preview:[o({class:"relative w-full max-w-md"},[S({placeholder:"Search...",bind:"",keyup:(e,n)=>{},icon:C.magnifyingGlass.default})])],code:`import {  SearchInput  } from "@base-framework/ui/organisms";
...
NumberInput({
    ...
    change: (e) => console.log(e.target.value),
});`}),a({title:"Hidden Input",description:"This is a hidden input field.",preview:[t([H({value:"hidden-value"})])],code:`import {  HiddenInput  } from "@base-framework/ui/atoms";

HiddenInput({
    value: 'hidden-value',
});`}),a({title:"Checkbox",description:"This is a checkbox input.",preview:[new M({label:"Check me",onChange:e=>console.log(e)})],code:`
import {  Checkbox  } from "@base-framework/ui/atoms";

new Checkbox({
    label: 'Check me',
    onChange: (checked) => console.log(checked)
})`}),a({title:"Select",description:"This is a select input.",preview:[t([W({options:Q,change:e=>console.log(e.target.value)})])],code:`import {  Select  } from "@base-framework/ui/atoms";
...
Textarea({
    placeholder: 'Enter your text here...'
})`}),a({title:"Time Picker",description:"This is a time picker input.",preview:[t([new q({selectedTime:"12:00 am",change:e=>console.log(e)})])],code:`
...
})`}),a({title:"Date Picker",description:"This is a date picker input.",preview:[t([new B({blockPriorDates:!1,selectedDate:"2022-01-01",onChange:e=>console.log(e)})])],code:`
...
})`}),a({title:"Date Range Picker",description:"This is a date range picker input.",preview:[t([new G({blockPriorDates:!1,start:"2022-01-01",end:"2022-01-31",onChange:e=>console.log(e)})])],code:`
...
})`}),a({title:"Counter",description:"This is a counter input.",preview:[t([new O({class:"max-w-[300px]",initialCount:5,min:0,max:1e5,readonly:!1,bind:"count",change:e=>console.log(e)})])],code:`
...
})`}),a({title:"Signature Pad",description:"This is a signature pad input.",preview:[t([new z({lineWidth:1,lineColor:"#CCCCCC",baseLineWidth:1,baseStrokeColor:"#333333"})])],code:`
