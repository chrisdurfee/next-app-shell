import{A as _e}from"./aside-page-Cpph0EZJ.js";import{w as J,m as o,R as T,l as ye,D as Y,H as z,d as F,Q as u,p as Ge,n as Ve,I as i,U as B,a as ce,b as c,o as Qe,e as Je,C as ke,A as E,q as v,y as l,_ as L,P as q,T as k,B as r,F as K,L as Ye,r as Ke,s as me,f as ne,t as Te,u as H,v as Ze,x as j,z as b,E as N,J as Se,K as de,M as Xe,N as S,W as R,X as y,Y as P,Z as ue,$ as et,a0 as tt,a1 as Ce,a2 as pe,a3 as ot,a4 as U,a5 as Ie,a6 as je,a7 as at,a8 as ie,a9 as le,aa as st,ab as te,ac as nt,ad as it,ae as lt,af as rt,ag as ct,ah as dt,ai as ut,aj as mt,ak as pt,al as ft,am as ht,an as gt,ao as bt,ap as xt,aq as $,S as I,ar as Ae,h as Q,as as re,at as wt,O as vt,G as yt}from"./index-Cwbzy0lu.js";import{S as kt,T as Tt}from"./sidebar-menu-B1lndwhv.js";import{T as A}from"./tooltip-zpp1jSks.js";const St=e=>z({class:"inline-flex flex-auto items-center justify-center whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm",dataSet:["selected",["state",e.value,"active"]]},[F({class:"flex flex-auto justify-center items-center px-3 py-1.5",onSet:["selected",{selected:e.value}],click:t=>e.callBack(e.value)},e.label)]),Ct=(e,t)=>(e.callBack=t,St(e)),It=e=>ye({class:`tab items-center justify-center rounded-md bg-muted p-1 text-muted-foreground ${e.class}`},[Y({class:"flex flex-auto flex-row",map:[e.options,t=>Ct(t,e.callBack)]})]);class De extends J{render(){const t=this.select.bind(this);return o({class:""},[It({class:this.class,options:this.options,callBack:t}),T({class:"tab-content",onState:["selected",this.updateContent.bind(this)]})])}getFirstValue(){var t;return(t=this.options[0])==null?void 0:t.value}update(){const t=this.state.get("selected");this.select(null),this.select(t)}select(t){this.state.selected=t}updateContent(t){const a=this.options;if(!a||a.length<1)return;const n=a[0];for(const d of a)if(d.value===t)return d.layout;return n.layout}setupStates(){const t=this.callBack,a=typeof t;return{selected:{state:this.getFirstValue(),callBack(n){a==="function"&&t(n)}}}}}const Be=u((e,t)=>Ge({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces break-all cursor-pointer"},[Ve({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(t[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:i.clipboard.checked})}},t)])),jt=u((e,t)=>o({class:"flex flex-auto p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-card"},[o({class:"preview flex flex-auto justify-center items-center"},t)])),fe=u((e,t)=>o({class:"py-4"},t)),At=e=>new De({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:fe([jt(e.preview)])},{label:"Code",value:"code",layout:fe([Be(e.code)])}]}),Dt=u(({title:e,description:t})=>B({class:"flex flex-col"},[ce({class:"scroll-m-20 text-2xl font-bold tracking-tight"},e),t&&c({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),s=u((e,t)=>T({class:"grid py-4"},[Dt({title:e.title,description:e.description}),At({preview:e.preview,code:e.code})]));class Bt extends Qe{render(){return Je([o({class:"contained px-4 flex flex-auto flex-col"},this.children)])}}const Lt=u(({title:e,description:t})=>B({class:"flex flex-col"},[ke({class:"scroll-m-20 text-3xl font-bold tracking-tight"},e),c({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),Mt=u((e,t)=>o({class:"contained py-8"},[Lt(e),T({class:"pb-12 pt-8"},t)])),f=u((e,t)=>new Bt([Mt(e,t)])),Ft=()=>f({title:"Alerts",description:"Alerts are used to provide feedback to the user about the outcome of an action or to inform them of important information."},[s({title:"Default Alert",description:"This is a standard alert without any specific type.",preview:[E({title:"Notice",description:"This is a default alert without a specific type.",icon:i.information})],code:`import { Alert } from "@components/molecules/alert.js";
...
})`})]),$o=({title:e})=>B({class:"flex flex-auto items-center"},[K({class:"text-lg font-semibold"},e)]),No=u((e,t)=>Ie({class:`fixed pullUpIn z-30 w-[98%] md:w-full max-w-lg gap-4 border bg-background text-foreground p-6 pb-12 md:pb-6 shadow-lg duration-200
                rounded-lg flex flex-auto flex-col
                bottom-4 top-auto md:m-auto md:bottom-auto md:top-1/2 md:left-0 md:right-0 md:-translate-y-1/2`,click:e.click,aria:{expanded:["open"]}},[o({class:"flex flex-auto flex-col space-y-2"},[$o(e),e.description&&c({class:"flex flex-auto flex-col text-sm text-muted-foreground"},e.description),o({class:"flex flex-auto flex-col text-sm text-muted-foreground"},t)]),je({class:"flex flex-col-reverse sm:flex-row sm:justify-end mt-6 gap-2 sm:gap-0 sm:space-x-2"},e.buttons)])),Ro=e=>at.render(e,app.appShell.panel);class ee extends J{render(){const t=d=>{d.target===this.panel&&this.close()},a=this.getMainClass(),n=this.title||"Dialog Title";return No({class:a,title:n,click:t,description:this.description,buttons:this.getButtons()},this.children)}getButtons(){return[r({variant:"outline",click:()=>this.close()},"Close")]}setupStates(){return{open:!1}}getMainClass(){return""}open(){Ro(this),this.panel.showModal(),this.state.open=!0}close(){this.state.open=!1,this.panel.close(),this.destroy()}}class qe extends ee{getButtons(){const t=this.confirmTextLabel||"Confirm";return[r({variant:"outline",click:()=>this.close()},"Cancel"),r({variant:"primary",click:()=>this.confirm()},t)]}confirm(){this.confirmed&&this.confirmed(),this.close()}}const zo=u((e,t)=>r({text:"Open",class:"m-1",click:()=>new ee(e,t).open()})),qo=e=>r({text:"Open",class:"m-1",click:()=>new qe(e).open()}),Ho=({link:e})=>o({class:"flex items-center gap-4 py-2"},[S({type:"text",value:e,readOnly:!0,class:"border p-2 rounded-md w-full bg-background text-foreground"}),r({variant:"secondary",class:"px-4 py-2",click:()=>{navigator.clipboard.writeText(e),app.notify({title:"Link copied",description:"The link has been copied to your clipboard.",icon:i.clipboard.checked})}},"Copy Link")]),Oo=e=>r({text:"Open",class:"m-1",click:()=>new ee(e,[Ho({link:"https://example.com"})]).open()}),Uo=()=>f({title:"Dialogs",description:"Displays a dialog or a component that looks like a dialog. Dialogs can be opened and closed. They will be closed if the user clicks outside of the dialog or if the user clicks the close button."},[s({title:"Usage",description:"Import the dialog atom and use it in your components.",preview:[zo({title:"Title",description:"this is the description."},[])],code:`import { Dialog } from '@components/molecules/dialogue.js';
...
Textarea({
    placeholder: 'Enter your text here...'
})`}),s({title:"Date Picker",description:"This is a date picker input.",preview:[g([new de({selectedDate:"2022-01-01"})])],code:`
