import{P as Q,A as Ue}from"./panel-fMQEvpYc.js";import{w as E,m as a,R as k,l as le,D as z,H as W,d as L,K as u,p as Ve,n as _e,I as i,U as M,a as J,b as c,f as Ge,e as Qe,C as ve,A as V,k as Je,y as r,_ as w,P as U,T as y,B as l,F as K,L as Ye,o as ye,q as de,h as Y,r as ke,t as Ke,s as I,u as R,v as P,x as Ze,z as T,E as q,J as v,M as Xe,N as et,Z as tt,Q as Te,W as ue,X as ot,Y as _,$ as at,a0 as Se,a1 as Ce,a2 as ne,a3 as re,a4 as st,a5 as te,a6 as nt,a7 as rt,c as it,a8 as N,S as j,a9 as me,aa as lt,ab as ie,ac as ct,O as dt,G as ut}from"./index-Cxpq0009.js";import{T as mt}from"./tab-group-B5vOYGfA.js";import{T as A}from"./tooltip-jwhVcEVK.js";const pt=e=>W({class:"inline-flex flex-auto items-center justify-center whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm",dataSet:["selected",["state",e.value,"active"]]},[L({class:"flex flex-auto justify-center items-center px-3 py-1.5",onSet:["selected",{selected:e.value}],click:t=>e.callBack(e.value)},e.label)]),ft=(e,t)=>(e.callBack=t,pt(e)),ht=e=>le({class:`tab items-center justify-center rounded-md bg-muted p-1 text-muted-foreground ${e.class}`},[z({class:"flex flex-auto flex-row",map:[e.options,t=>ft(t,e.callBack)]})]);class je extends E{render(){const t=this.select.bind(this);return a({class:""},[ht({class:this.class,options:this.options,callBack:t}),k({class:"tab-content",onState:["selected",this.updateContent.bind(this)]})])}getFirstValue(){var t;return(t=this.options[0])==null?void 0:t.value}update(){const t=this.state.get("selected");this.select(null),this.select(t)}select(t){this.state.selected=t}updateContent(t){const o=this.options;if(!o||o.length<1)return;const n=o[0];for(const d of o)if(d.value===t)return d.layout;return n.layout}setupStates(){const t=this.callBack,o=typeof t;return{selected:{state:this.getFirstValue(),callBack(n){o==="function"&&t(n)}}}}}const Ie=u((e,t)=>Ve({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces break-all cursor-pointer"},[_e({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(t[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:i.clipboard.checked})}},t)])),gt=u((e,t)=>a({class:"flex flex-auto p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-card"},[a({class:"preview flex flex-auto justify-center items-center"},t)])),pe=u((e,t)=>a({class:"py-4"},t)),bt=e=>new je({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:pe([gt(e.preview)])},{label:"Code",value:"code",layout:pe([Ie(e.code)])}]}),xt=u(({title:e,description:t})=>M({class:"flex flex-col"},[J({class:"scroll-m-20 text-2xl font-bold tracking-tight"},e),t&&c({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),s=u((e,t)=>k({class:"grid py-4"},[xt({title:e.title,description:e.description}),bt({preview:e.preview,code:e.code})]));class wt extends Ge{render(){return Qe([a({class:"contained px-4 flex flex-auto flex-col"},this.children)])}}const vt=u(({title:e,description:t})=>M({class:"flex flex-col"},[ve({class:"scroll-m-20 text-3xl font-bold tracking-tight"},e),c({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),yt=u((e,t)=>a({class:"contained py-8"},[vt(e),k({class:"pb-12 pt-8"},t)])),f=u((e,t)=>new wt([yt(e,t)])),kt=()=>f({title:"Alerts",description:"Alerts are used to provide feedback to the user about the outcome of an action or to inform them of important information."},[s({title:"Default Alert",description:"This is a standard alert without any specific type.",preview:[V({title:"Notice",description:"This is a default alert without a specific type.",icon:i.information})],code:`import { Alert } from "@components/molecules/alert.js";
...
LoadingButton('With Icon')`})]),Nt=()=>Y.formatTime("",24),Ot=()=>f({title:"Calendars",description:"This is the calendar component documentation."},[s({title:"Usage",description:"This is how you can use the calendar component.",preview:[new ye],code:`@components/organisms/calendar/calendar.js';

new Calendar()`}),s({title:"Dynamic Time",description:"This is how you can use the calendar component.",preview:[new de({filter:()=>{let e="Morning";const t=Nt();return t>="18:00:00"?e="Evening":t>="12:00:00"&&(e="Afternoon"),`Good ${e}`}})],code:`import { DateTime } from "@base-framework/base";
...
})`}),s({title:"Date Select Card",preview:[Le({startDate:"2023-01-23"})],code:`import AccountCard from "./examples/date-select-card.js";
...
Textarea({
    placeholder: 'Enter your text here...'
})`}),s({title:"Date Picker",description:"This is a date picker input.",preview:[C([new Fe({selectedDate:"2022-01-01"})])],code:`
...
LoadingAvatar();`})]),Ca=(e,t)=>t.indexOf(e)!==-1,ja=(e,t)=>{const o=e.getLinkPath()??"";return Ca(o,t)};class Ia extends E{onCreated(){this.links=[]}render(){return le({class:`tab items-center justify-center rounded-md bg-muted p-1 text-muted-foreground ${this.class}`},[z({class:"flex flex-auto flex-row",map:[this.options,t=>this.addLink(t)],watch:{value:["[[path]]",me.data],callBack:this.updateLinks.bind(this)}})])}afterSetup(){const t=me.data.path;this.updateLinks(t)}updateLinks(t){let o=!1,n=this.links[0];for(const d of this.links)if(d.rendered!==!1&&(o=ja(d,t),o===!0))break;o!==!0&&n&&this.updateLink(n,!0)}updateLink(t,o){t.update(o)}addLink({label:t,href:o}){const n=new lt({text:t,href:o,dataSet:["selected",["state",!0,"active"]],class:"inline-flex flex-auto items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm"});return this.links.push(n),n}}class Da extends E{render(){return a({class:"tab-panel"},[new Ia({class:this.class,options:this.options}),k({class:"tab-content",switch:this.addGroup()})])}addGroup(){let t;const o=[],n=this.options;for(let d=0,h=n.length;d<h;d++)t=n[d],o.push({uri:t.uri||t.href,component:t.component,title:t.title||null,persist:!0});return o}}const be=u((e,t)=>a({class:"py-4"},t)),Aa=()=>f({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[s({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new je({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:be([])},{label:"Code",value:"code",layout:be([])}]})],code:`
