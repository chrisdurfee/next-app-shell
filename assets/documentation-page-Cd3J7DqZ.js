import{G as Ye,S as Je}from"./molecules-CuQ3Ur-G.js";import{o as J,Y as o,u as T,p as Se,Z as de,q as me,w as W,Q as b,x as Qe,N as Ke,a as r,l as z,s as ue,G as d,y as Ze,E as Xe,r as Ce,H as $,A as k,K as y,z as i,L as et,_ as Q,R as q,J as S,B as c,b as Ie,U as tt,V as ot,W as De,X as at,$ as st,a0 as nt,a1 as A,I as w,a2 as M,c as m,a3 as H,a4 as K,a5 as pe,d as j,a6 as C,a7 as R,a8 as Z,a9 as je,aa as Ae,ab as rt,D as Be,ac as it,j as re,ad as lt,ae as oe,k as P,C as X,af as Fe,ag as fe,P as E,ah as Pe,F as O,ai as ie,aj as le,ak as ct,al as dt,am as ae,an as mt,ao as ut,ap as pt,aq as ft,ar as gt,as as ht,at as bt,au as xt,av as wt,aw as vt,M as Me,ax as yt,ay as kt,h as Tt,az as N,S as D,m as Le,T as St,e as F,aA as ce,v as Ct,aB as It,O as Dt}from"./index-j6qNbAPz.js";import{C as jt}from"./counter-BT7Swykh.js";import{U as At}from"./user-list-D10PtORF.js";const Bt=e=>me({class:"inline-flex flex-auto items-center justify-center whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm",dataSet:["selected",["state",e.value,"active"]]},[W({class:"flex flex-auto justify-center items-center px-3 py-1.5",onSet:["selected",{selected:e.value}],click:t=>e.callBack(e.value)},e.label)]),Ft=(e,t)=>(e.callBack=t,Bt(e)),Pt=e=>Se({class:`tab items-center justify-center rounded-md bg-muted p-1 text-muted-foreground ${e.class}`},[de({class:"flex flex-auto flex-row",map:[e.options,t=>Ft(t,e.callBack)]})]);class Ne extends J{render(){const t=this.select.bind(this);return o({class:""},[Pt({class:this.class,options:this.options,callBack:t}),T({class:"tab-content",onState:["selected",this.updateContent.bind(this)]})])}getFirstValue(){var t;return(t=this.options[0])==null?void 0:t.value}update(){const t=this.state.get("selected");this.select(null),this.select(t)}select(t){this.state.selected=t}updateContent(t){const a=this.options;if(!a||a.length<1)return;const n=a[0];for(const l of a)if(l.value===t)return l.layout;return n.layout}setupStates(){const t=this.callBack,a=typeof t;return{selected:{state:this.getFirstValue(),callBack(n){a==="function"&&t(n)}}}}}const $e=b((e,t)=>Qe({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces break-all cursor-pointer"},[Ke({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(t[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:r.clipboard.checked})}},t)])),Mt=b((e,t)=>o({class:"flex flex-auto p-4 min-h-[350px] max-h-[650px] overflow-x-auto max-w-[90vw] rounded-lg border bg-card"},[o({class:"preview flex flex-auto justify-center items-center"},t)])),ge=b((e,t)=>o({class:"py-4"},t)),Lt=e=>new Ne({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:ge([Mt(e.preview)])},{label:"Code",value:"code",layout:ge([$e(e.code)])}]}),Nt=b(({title:e,description:t})=>z({class:"flex flex-col"},[ue({class:"scroll-m-20 text-2xl font-bold tracking-tight"},e),t&&d({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),s=b((e,t)=>T({class:"grid py-4"},[Nt({title:e.title,description:e.description}),Lt({preview:e.preview,code:e.code})]));class $t extends Ze{render(){return Xe([o({class:"contained px-4 flex flex-auto flex-col"},this.children)])}}const Et=b(({title:e,description:t})=>z({class:"flex flex-col"},[Ce({class:"scroll-m-20 text-3xl font-bold tracking-tight"},e),d({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),Ht=b((e,t)=>o({class:"contained py-8"},[Et(e),T({class:"pb-12 pt-8"},t)])),p=b((e,t)=>new $t([Ht(e,t)])),Rt=()=>p({title:"Alerts",description:"Alerts are used to provide feedback to the user about the outcome of an action or to inform them of important information."},[s({title:"Default Alert",description:"This is a standard alert without any specific type.",preview:[$({title:"Notice",description:"This is a default alert without a specific type.",icon:r.information})],code:`import { Alert } from "@components/molecules/alert.js";
...
Button({ ...props, variant: 'secondary' }, primary)`}),z({class:"flex flex-col py-8"},[Ie({class:"text-3xl font-bold tracking-tight border-b pb-2"},"Variants")]),s({title:"Primary Button",description:"This is a primary button.",preview:[c({variant:"primary"},"Click Me")],code:`
...
LoadingButton('With Icon')`})]),Kt=e=>{const t=new Date(e.valueOf()),a=(e.getDay()+6)%7;t.setDate(t.getDate()-a+3);const n=t.valueOf();return t.setMonth(0,1),t.getDay()!==4&&t.setMonth(0,1+(4-t.getDay()+7)%7),1+Math.ceil((n-t)/6048e5)},be=(e,t)=>{const a=new Date(t,0,1+(e-1)*7),n=a.getDay(),l=a;return n<=4?l.setDate(a.getDate()-a.getDay()+1):l.setDate(a.getDate()+8-a.getDay()),l},Zt=(e,t,a)=>{const n=new Date;return n.getDate()===e&&n.getMonth()===t&&n.getFullYear()===a},Xt=({day:e,week:t,month:a,year:n,currentWeek:l,currentDate:g,selectWeek:h})=>{const B=Zt(e,a,n),ee=t.some(I=>(I==null?void 0:I.getDate())===g);return W({text:e||"",disabled:!e,class:`
            px-2 py-1 text-center rounded-md
            ${B?"bg-accent text-accent-foreground":""}
            ${ee&&!B?"border border-accent":""}
            hover:bg-primary hover:text-primary-foreground
        `,click:()=>h(e)})},eo=(e,t)=>{const a=new Date(e,t,1).getDay(),n=new Date(e,t+1,0).getDate(),l=[];let g=[];for(let h=1-a;h<=n;h++){const B=new Date(e,t,h);g.push(h>0?B:null),(g.length===7||h===n)&&(l.push([...g]),g=[])}return l},to=({selectWeek:e})=>ot("month",(t,a,{data:n})=>{const{year:l,month:g,currentWeek:h,currentDate:B}=n,ee=eo(l,g);return o({class:"grid grid-cols-8 gap-1 text-sm px-4 py-2"},[o({class:"text-xs text-center col-span-1 text-muted-foreground flex items-center"},"Week"),o({class:"grid grid-cols-7 col-span-7 text-center text-muted-foreground items-center"},["Su","Mo","Tu","We","Th","Fr","Sa"].map(I=>i({class:"px-1 py-1",text:I}))),...ee.map((I,Fa)=>{const te=Kt(I.find(U=>U)||new Date(l,g,1));return o({class:"grid grid-cols-8 col-span-8 items-center"},[o({class:`font-medium text-center col-span-1 rounded-sm cursor-pointer ${h===te?"bg-primary text-primary-foreground":""}`,click:()=>e(te),text:`${te}`}),o({class:"grid grid-cols-7 col-span-7 text-center"},I.map(U=>Xt({year:l,month:g,day:U?U.getDate():null,week:I,currentWeek:h,currentDate:B,selectWeek:e})))])})])}),xe=({label:e,click:t})=>c({class:`
            inline-flex items-center justify-center h-7 w-7 bg-transparent p-0
            opacity-50 hover:opacity-100 text-muted-foreground absolute
            ${e==="Previous"?"left-1":"right-1"}
            focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2
          `,click:t,"aria-label":`${e} month`,variant:"icon",icon:e==="Previous"?r.chevron.single.left:r.chevron.single.right}),oo=({next:e,previous:t})=>o({class:"flex flex-auto min-h-12 text-sm font-medium relative justify-center items-center"},[i("[[monthName]] [[year]]"),xe({label:"Previous",click:t}),xe({label:"Next",click:e})]);class ao extends J{setData(){const t=new Date,a=this.selectedWeek||this.calculateCurrentWeek(t),n=be(a,t.getFullYear());return new q({monthName:this.getMonthName(n.getMonth()),year:n.getFullYear(),month:n.getMonth(),currentDate:n.getDate(),currentWeek:a})}getSelectedDate(t){const a=this.selectedDate?new Date(this.selectedDate):t;return new Date(a.getFullYear(),a.getMonth(),a.getDate())}calculateCurrentWeek(t){const a=new Date(t.valueOf()),n=(t.getDay()+6)%7;a.setDate(a.getDate()-n+3);const l=a.valueOf();return a.setMonth(0,1),a.getDay()!==4&&a.setMonth(0,1+(4-a.getDay()+7)%7),1+Math.ceil((l-a)/6048e5)}getMonthName(t){return De.monthNames[t]}goToPreviousMonth(){const t=this.data;let{year:a,month:n}=t;n===0?(n=11,a--):n--,this.setDate(n,a)}goToNextMonth(){const t=this.data;let{year:a,month:n}=t;n===11?(n=0,a++):n++,this.setDate(n,a)}setDate(t,a,n){this.data.set({year:a,month:t,monthName:this.getMonthName(t)}),n&&(this.data.currentDate=n)}selectWeek(t){this.currentWeek=t;const a=be(t,today.getFullYear());this.setDate(a.getMonth(),a.getFullYear(),a.getDate()),typeof this.selectedCallBack=="function"&&this.selectedCallBack(t)}render(){return o({class:"week-calendar-container border rounded-md bg-background p-3"},[oo({next:()=>this.goToNextMonth(),previous:()=>this.goToPreviousMonth()}),to({selectWeek:t=>this.selectWeek(t)})])}}const so=()=>De.formatTime("",24),no=()=>p({title:"Calendars",description:"This is the calendar component documentation."},[s({title:"Usage",description:"This is how you can use the calendar component.",preview:[new at],code:`@components/organisms/calendar/calendar.js';
...
})`})]),Bo=()=>{const e=[{id:1,status:"Active",email:"user1@example.com",amount:500.5},{id:2,status:"Inactive",email:"user2@example.com",amount:250.75},{id:3,status:"Active",email:"user3@example.com",amount:300}],t=()=>it([re({class:"text-muted-foreground border-b"},[lt({}),oe({key:"status",label:"Custom Status"}),oe({key:"email",label:"User Email"}),oe({key:"amount",label:"Amount (USD)",align:"justify-end"})])]),a=(n,l)=>re({class:"items-center px-4 py-2 hover:bg-muted/50"},[P({class:"p-4"},[new X({checked:n.selected,class:"mr-2",click:()=>l(n)})]),P({class:"p-4 justify-center"},n.status),P({class:"p-4"},n.email),P({class:"p-4 text-right"},`$${n.amount.toFixed(2)}`)]);return o({class:"w-full mt-4"},[o({class:"w-full rounded-md border overflow-x-auto"},[rt({class:"w-full"},[new Be({key:"id",customHeader:t(),rows:e,rowItem:a})])])])},Fo=[{label:"checkbox",key:""},{label:"Status",key:"status"},{label:"Email",key:"email"},{label:"Amount",key:"amount",align:"justify-end"}],Po=[{id:1,status:"Success",email:"ken99@yahoo.com",amount:316,selected:!1},{id:2,status:"Success",email:"abe45@gmail.com",amount:242,selected:!1},{id:3,status:"Processing",email:"monserrat44@gmail.com",amount:837,selected:!1},{id:4,status:"Success",email:"silas22@gmail.com",amount:874,selected:!1},{id:5,status:"Failed",email:"carmella@hotmail.com",amount:721,selected:!1}],Mo=(e,t)=>re({class:"items-center px-4 py-2 hover:bg-muted/50"},[P({class:"p-4 "},[new X({checked:e.selected,class:"mr-2",onChange:()=>t(e)})]),P({class:"p-4 "},[i({class:"text-muted-foreground"},e.status)]),P({class:"p-4 "},e.email),P({class:"p-4 text-right"},`$${e.amount.toFixed(2)}`)]),Lo=()=>p({title:"Data Tables",description:"Data tables are used to display data in a structured format. They can be used to display a list of items, a grid of items, or a table of items."},[s({title:"Usage",description:"The data table component is used to display data in a structured format. It can be used to display a list of items, a grid of items, or a table of items.",preview:[new Be({headers:Fo,rows:Po,rowItem:Mo,key:"id"})],code:`import { DataTable } from "@components/organisms/lists/data-table.js";
...
])`})]),Ge=Pe({state(){return{value:this.value??0,min:this.min??0,max:this.max??100,filledPercentage:this.getFillPercentage(this.value)}},getFillPercentage(e){return(e-this.min)/(this.max-this.min)*100},render(){return o({class:"relative w-full h-4 flex items-center"},[o({class:"absolute h-2 w-full rounded-full bg-muted"}),o({class:"absolute h-2 bg-primary rounded-full",style:"width: [[filledPercentage]]%"}),o({class:"absolute block h-5 w-5 rounded-full border-2 border-primary bg-background ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 transform -translate-x-1/2",style:"left: [[filledPercentage]]%"}),H({type:"range",min:"[[min]]",max:"[[max]]",value:"[[value]]",class:"absolute w-full h-full opacity-0 cursor-pointer",bind:this.bind,input:e=>{const t=Number(e.target.value);this.state.value=t,this.state.filledPercentage=this.getFillPercentage(t),typeof this.change=="function"&&this.change(t)}})])}}),_=b((e,t)=>o({...e,class:"flex flex-auto items-center justify-center w-full py-4 space-y-8 max-w-[450px]"},t)),Qo=[{value:"next.js",label:"Next.js"},{value:"sveltekit",label:"SvelteKit"},{value:"nuxt.js",label:"Nuxt.js"},{value:"remix",label:"Remix"},{value:"astro",label:"Astro"}],Ko=()=>M({submit:e=>{console.log("Profile Form submitted")}},[O({legend:"Profile"},[new m({name:"username",label:"Username",description:"This is your public display name."},[j({placeholder:"e.g. username",required:!0})]),new m({name:"email",label:"Email Address",description:"We'll use this to contact you."},[ie({placeholder:"e.g. email@address.com",required:!0})]),c({type:"submit"},"Submit")])]),Zo=()=>M({submit:e=>{console.log("Preferences Form submitted")}},[O({legend:"Preferences"},[new m({name:"framework",label:"Favorite Framework",description:"Select your preferred framework."},[C({options:Qo,required:!0})]),new m({name:"newsletter",label:"Subscribe to Newsletter",description:"Stay updated with our latest news."},[new X({label:"Yes, sign me up!",required:!0,onChange:e=>console.log("Newsletter checked:",e)})]),c({type:"submit"},"Save Preferences")])]),Xo=()=>M({submit:e=>{console.log("Contact Form submitted")}},[O({legend:"Contact Us"},[new m({name:"phone",label:"Phone Number",description:"We may contact you at this number."},[le({placeholder:"e.g. +1234567890",required:!0})]),new m({name:"message",label:"Your Message",description:"Let us know how we can help you."},[R({placeholder:"Type your message here...",required:!0})]),new m({name:"message",label:"Select Framework",description:"Select your preferred framework."},[new Ue({required:!0,items:[{value:"next.js",label:"Next.js"},{value:"sveltekit",label:"SvelteKit"},{value:"nuxt.js",label:"Nuxt.js"},{value:"remix",label:"Remix"},{value:"astro",label:"Astro"}]})]),c({type:"submit"},"Send Message")])]),ea=()=>M({submit:e=>{console.log("Settings Form submitted")}},[O({legend:"Settings"},[new m({name:"notifications",label:"Enable Notifications",description:"Toggle to enable or disable notifications."},[new K({active:!0,required:!0})]),new m({name:"volume",label:"Volume Level",description:"Set your preferred volume level."},[new Ge({min:0,max:100,value:50})]),c({type:"submit"},"Save Settings")])]),ta=()=>p({title:"Forms",description:"Forms are used to collect user data and submit it to the server."},[s({title:"Profile Form",description:"A simple profile form with username and email fields.",preview:[_([Ko()])],code:`import { Button, Input, EmailInput } from "@components/atoms/form/input.js";
...
])`}),s({title:"Preferences Form",description:"A preferences form with a select input and a checkbox.",preview:[_([Zo()])],code:`import { Button, Checkbox, Select } from "@components/atoms/form/input.js";
import { Form, FormField } from "@components/molecules/form/form.js";
import { Div } from "@base-framework/atoms";
import { Atom } from "@base-framework/base";
import { Fieldset } from "@components/atoms/form/fieldset.js";
...
])`}),s({title:"Contact Form",description:"A contact form with a phone input and a textarea for messages.",preview:[_([Xo()])],code:`import { Button, TelInput, Textarea } from "@components/atoms/form/input.js";
import { Form, FormField } from "@components/molecules/form/form.js";
import { Div } from "@base-framework/atoms";
import { Atom } from "@base-framework/base";
import { Fieldset } from "@components/atoms/form/fieldset.js";
...
])`}),s({title:"Settings Form",description:"A settings form with a toggle and a range slider.",preview:[_([ea()])],code:`import { Button, Toggle, RangeSlider } from "@components/atoms/form/input.js";
import { Form, FormField } from "@components/molecules/form/form.js";
import { Div } from "@base-framework/atoms";
import { Atom } from "@base-framework/base";
import { Fieldset } from "@components/atoms/form/fieldset.js";
...
])`}),s({title:"Text Input",description:"This is a text input.",preview:[f([j({type:"text",placeholder:"Enter your text here..."})])],code:`
import { EmailInput, FileInput, Input, TelInput, Textarea } from "@components/atoms/form/input.js";

Input({
    type: 'text',
    placeholder: 'Enter your text here...'
})`}),s({title:"Tel Input",description:"This is a phone input.",preview:[f([le({})])],code:`
import { EmailInput, FileInput, Input, TelInput, Textarea } from "@components/atoms/form/input.js";

TelInput({
})`}),s({title:"Email Input",description:"This is a email input.",preview:[f([ie({})])],code:`
import { EmailInput, FileInput, Input, TelInput, Textarea } from "@components/atoms/form/input.js";
...
})`}),s({title:"Select",description:"This is a select input.",preview:[f([C({options:oa,change:e=>console.log(e.target.value)})])],code:`import { Select } from "@components/atoms/form/select.js";
...
Textarea({
    placeholder: 'Enter your text here...'
})`}),s({title:"Date Picker",description:"This is a date picker input.",preview:[f([new pe({selectedDate:"2022-01-01"})])],code:`
import DatePicker from "@components/molecules/date-time/date-picker.js";

new DatePicker()`}),s({title:"Range Slider",description:"This is a range slider input.",preview:[f([new Ge({min:0,max:100,value:50,change:e=>console.log(e)})])],code:`
import { RangeSlider } from '@components/atoms/form/range-slider.js';
...
})`}),s({title:"Counter",description:"This is a counter input.",preview:[f([new jt({class:"max-w-[300px]",initialCount:5,min:0,max:1e5,readonly:!1,bind:"count",change:e=>console.log(e)})])],code:`
...
})`})]),ma=e=>!e||isNaN(e)?null:e,ye=(e,t)=>{const a=e,n=16,l=2*Math.PI*n,g=a/100*l,h=`
...
new ProgressBar({ cache: 'progress', progress: 20 })`})]),ha=Q({state:{loaded:!1},render(){return o({class:"flex flex-auto flex-col max-w-[350px]"},[o({class:"my-8"},[c({variant:"outline",click:()=>this.state.toggle("loaded")},"Toggle Loaded")]),o({class:"flex items-center bg-card rounded-md border shadow-md w-full max-w-md"},[o({class:"flex flex-auto gap-4 p-4",onState:["loaded",e=>e?[k({src:"https://github.com/shadcn.png",alt:"@shadcn",fallbackText:"CN",size:"md"}),o({class:"flex flex-auto flex-col"},[i({class:"text-lg font-semibold text-foreground"},"Leslie Alexander"),d({class:"text-sm text-muted-foreground m-0"},"leslie.alexander@example.com")])]:[D({shape:"circle",width:"w-12",height:"h-12"}),o({class:"flex flex-auto flex-col gap-2"},[D({width:"w-3/4",height:"h-6"}),D({width:"w-1/2",height:"h-4"})])]]})])])}}),ba=()=>p({title:"Skeletons",description:"Skeletons are components that are used to show a placeholder for content that is loading."},[s({title:"Usage",description:"The skeleton component is used to show a placeholder for content that is loading.",preview:[o({class:"flex flex-auto space-x-4 w-full max-w-64"},[D({shape:"circle",width:"w-10",height:"h-10"}),o({class:"flex flex-auto flex-col space-y-2"},[D({width:"w-3/4",height:"h-4"}),D({width:"w-1/2",height:"h-4"})])])],code:`import { Skeleton } from "@components/atoms/skeleton.js";
import { Div } from '@base-framework/atoms';
...
])`}),s({title:"Skeleton Post",description:"This is a skeleton post.",preview:[o({class:"space-y-4 flex flex-auto flex-col w-full max-w-64"},[D({width:"w-full",height:"h-32",shape:"rectangle"}),o({class:"space-y-2"},[D({width:"w-3/4",height:"h-4"}),D({width:"w-1/2",height:"h-4"})])])],code:`import { Skeleton } from "@components/atoms/skeleton.js";
import { Div } from '@base-framework/atoms';
...
LoadingAvatar();`})]);class xa extends J{render(){return o({class:"tab-panel"},[new Le({class:this.class,options:this.options}),T({class:"tab-content",switch:this.addGroup()})])}addGroup(){let t;const a=[],n=this.options;for(let l=0,g=n.length;l<g;l++)t=n[l],a.push({uri:t.uri||t.href,component:t.component,title:t.title||null,persist:!0});return a}}const ke=b((e,t)=>o({class:"py-4"},t)),wa=()=>p({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[s({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new Ne({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:ke([])},{label:"Code",value:"code",layout:ke([])}]})],code:`
