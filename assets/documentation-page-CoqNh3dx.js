...
LoadingButton('With Icon')`})]),Nt=()=>Y.formatTime("",24),Ot=()=>f({title:"Calendars",description:"This is the calendar component documentation."},[s({title:"Usage",description:"This is how you can use the calendar component.",preview:[new ke],code:`@components/organisms/calendar/calendar.js';
...
])`})]),Yo=u(e=>T({cache:"input",placeholder:e.placeholder??"Search...",bind:[e.state,"searchQuery"],keyup:(t,{state:o})=>{o.isOpen=!0,typeof e.filterOptions=="function"&&e.filterOptions()},focus:(t,{state:o})=>o.isOpen=!0,blur:(t,{state:o})=>setTimeout(()=>o.isOpen=!1,100),keydown:t=>typeof e.handleKeyDown=="function"&&e.handleKeyDown(t)})),Ko=u(({index:e,click:t},o)=>W({class:"p-2 cursor-pointer hover:bg-accent hover:text-accent-foreground",onState:[["selectedIndex",{"bg-accent":e,"text-white":e}]],pointerdown:()=>t(e)},o)),Zo=u(({selectOption:e})=>z({class:"list-none m-0 p-0",for:["filteredOptions",(t,o)=>Ko({index:o,click:e},t)]})),Xo=e=>a({class:"relative flex fle-auto flex-col",onState:["isOpen",(t,o,n)=>{if(t)return e.setSelected(),new de({cache:"dropdown",parent:n,button:n.input},[Zo(e)])}]}),ea=w({setData(){const e=this.options||[];return new U({options:e,filteredOptions:e,position:{y:0,x:0}})},state(){return{searchQuery:"",selectedIndex:-1,isOpen:!1}},setSelectedIndexByQuery(){const e=this.data.filteredOptions,{searchQuery:t}=this.state,o=e.findIndex(n=>n===t);o>=0&&(this.state.selectedIndex=o)},filterOptions(){const e=this.state.searchQuery.toLowerCase();if(e===""||e.length===0){this.data.filteredOptions=this.data.options;return}const t=this.data.get("options");this.data.filteredOptions=t.filter(o=>o.toLowerCase().includes(e))},selectOption(e){this.state.searchQuery=this.data.filteredOptions[e],this.state.isOpen=!1,typeof this.onSelect=="function"&&this.onSelect(this.state.searchQuery)},updatePosition(){const e=this.button,t=this.dropdown.panel,o=ce(e,t);this.data.position=o},handleKeyDown(e){const t=this.data.filteredOptions,{selectedIndex:o}=this.state;e.key==="ArrowDown"?(e.preventDefault(),this.state.selectedIndex=Math.min(o+1,t.length-1)):e.key==="ArrowUp"?(e.preventDefault(),this.state.selectedIndex=Math.max(o-1,0)):e.key==="Enter"&&o>=0&&(e.preventDefault(),this.selectOption(o))},render(){return a({class:"relative w-full max-w-md"},[Yo({state:this.state,placeholder:this.placeholder,filterOptions:this.filterOptions.bind(this),handleKeyDown:this.handleKeyDown.bind(this)}),Xo({updatePosition:this.updatePosition.bind(this),setSelected:this.setSelectedIndexByQuery.bind(this),selectOption:this.selectOption.bind(this)})])}}),ta=[{value:"next.js",label:"Next.js"},{value:"sveltekit",label:"SvelteKit"},{value:"nuxt.js",label:"Nuxt.js"},{value:"remix",label:"Remix"},{value:"astro",label:"Astro"}],C=u((e,t)=>a({...e,class:"flex flex-auto items-center justify-center w-full max-w-[350px]"},t)),ge=({label:e,description:t,active:o,onChange:n})=>a({class:"flex items-center justify-between p-4 border rounded-md bg-muted/10 border-muted-foreground/20 mb-4"},[a({class:"flex flex-col pr-8"},[v({class:"font-semibold"},e),c({class:"text-sm text-muted-foreground"},t)]),new Z({active:o,change:n})]),oa=["Apple","Banana","Cherry","Date","Elderberry","Fig","Grape","Honeydew"],aa=()=>f({title:"Inputs",description:"Inputs are essential for gathering user data in forms."},[s({title:"Usage",description:"Import the input atom and use it in your components. The input can be of various types: text, password, email, etc.",preview:[a({class:"grid gap-2 w-full max-w-[350px]"},[T({type:"text",placeholder:"Enter your text here...",change:e=>console.log(e.target.value)}),ne({}),re({}),q({placeholder:"Enter your text here..."})])],code:`import { Input, EmailInput, TelInput, Textarea } from '@components/atoms/form/input.js';
...
Textarea({
    placeholder: 'Enter your text here...'
})`}),s({title:"Search Dropdown",description:"This is a search dropdown.",preview:[a({class:"relative w-full max-w-md"},[new ea({options:oa,onSelect:e=>console.log(e)})])],code:`import { SearchDropdown } from "@components/organisms/search/search-dropdown.js";
...
})`}),s({title:"Select",description:"This is a select input.",preview:[C([S({options:ta,change:e=>console.log(e.target.value)})])],code:`import { Select } from "@components/atoms/form/select.js";
...
Textarea({
    placeholder: 'Enter your text here...'
})`}),s({title:"Date Picker",description:"This is a date picker input.",preview:[C([new Le({selectedDate:"2022-01-01"})])],code:`
...
LoadingAvatar();`})]),Ca=(e,t)=>t.indexOf(e)!==-1,ja=(e,t)=>{const o=e.getLinkPath()??"";return Ca(o,t)};class Ia extends E{onCreated(){this.links=[]}render(){return le({class:`tab items-center justify-center rounded-md bg-muted p-1 text-muted-foreground ${this.class}`},[z({class:"flex flex-auto flex-row",map:[this.options,t=>this.addLink(t)],watch:{value:["[[path]]",pe.data],callBack:this.updateLinks.bind(this)}})])}afterSetup(){const t=pe.data.path;this.updateLinks(t)}updateLinks(t){let o=!1,n=this.links[0];for(const d of this.links)if(d.rendered!==!1&&(o=ja(d,t),o===!0))break;o!==!0&&n&&this.updateLink(n,!0)}updateLink(t,o){t.update(o)}addLink({label:t,href:o}){const n=new lt({text:t,href:o,dataSet:["selected",["state",!0,"active"]],class:"inline-flex flex-auto items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm"});return this.links.push(n),n}}class Da extends E{render(){return a({class:"tab-panel"},[new Ia({class:this.class,options:this.options}),k({class:"tab-content",switch:this.addGroup()})])}addGroup(){let t;const o=[],n=this.options;for(let d=0,h=n.length;d<h;d++)t=n[d],o.push({uri:t.uri||t.href,component:t.component,title:t.title||null,persist:!0});return o}}const xe=u((e,t)=>a({class:"py-4"},t)),Aa=()=>f({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[s({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new Ie({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:xe([])},{label:"Code",value:"code",layout:xe([])}]})],code:`
