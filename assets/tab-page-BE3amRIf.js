import{av as l,r as n,ay as p,a6 as a,H as i,af as r,Y as m}from"./index-Dvug2xuf.js";import{D as e}from"./doc-section-JkKftWVX.js";import{D as c}from"./doc-page-CcQE00IT.js";const t=n((o,s)=>m({class:"py-4"},s)),T=()=>c({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[e({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new l({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:t([])},{label:"Code",value:"code",layout:t([])}]})],code:`
