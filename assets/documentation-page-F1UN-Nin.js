import{G as Ye,S as Je}from"./molecules-BFZTlg02.js";import{o as Q,Y as o,u as S,p as Se,Z as ce,q as de,w as q,Q as x,x as Qe,N as Ke,a as r,l as O,s as me,G as d,y as Ze,E as Xe,r as Ce,H,A as T,K as k,z as i,L as et,_ as K,R as U,J as I,B as c,b as De,U as tt,V as ot,W as Ie,X as at,$ as st,a0 as nt,a1 as P,I as v,a2 as L,c as m,a3 as W,a4 as Z,a5 as ue,d as B,a6 as j,a7 as z,a8 as X,a9 as je,aa as Ae,ab as rt,D as Be,ac as it,j as ne,ad as lt,ae as te,k as M,C as ee,af as Pe,ag as pe,P as R,ah as Fe,F as _,ai as re,aj as ie,ak as ct,al as dt,am as oe,an as mt,ao as ut,ap as pt,aq as ft,ar as gt,as as ht,at as bt,au as xt,av as wt,aw as vt,M as Me,ax as yt,ay as kt,h as Tt,az as N,S as A,m as Le,T as St,e as F,aA as le,v as Ct,aB as Dt,O as It}from"./index-Bcg81o_g.js";import{C as jt}from"./counter-CpuzE-tq.js";import{U as At}from"./user-list-CXduOBUM.js";const Bt=e=>de({class:"inline-flex flex-auto items-center justify-center whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm",dataSet:["selected",["state",e.value,"active"]]},[q({class:"flex flex-auto justify-center items-center px-3 py-1.5",onSet:["selected",{selected:e.value}],click:t=>e.callBack(e.value)},e.label)]),Pt=(e,t)=>(e.callBack=t,Bt(e)),Ft=e=>Se({class:`tab items-center justify-center rounded-md bg-muted p-1 text-muted-foreground ${e.class}`},[ce({class:"flex flex-auto flex-row",map:[e.options,t=>Pt(t,e.callBack)]})]);class $e extends Q{render(){const t=this.select.bind(this);return o({class:""},[Ft({class:this.class,options:this.options,callBack:t}),S({class:"tab-content",onState:["selected",this.updateContent.bind(this)]})])}getFirstValue(){var t;return(t=this.options[0])==null?void 0:t.value}update(){const t=this.state.get("selected");this.select(null),this.select(t)}select(t){this.state.selected=t}updateContent(t){const a=this.options;if(!a||a.length<1)return;const n=a[0];for(const l of a)if(l.value===t)return l.layout;return n.layout}setupStates(){const t=this.callBack,a=typeof t;return{selected:{state:this.getFirstValue(),callBack(n){a==="function"&&t(n)}}}}}const Ne=x((e,t)=>Qe({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces break-all cursor-pointer"},[Ke({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(t[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:r.clipboard.checked})}},t)])),Mt=x((e,t)=>o({class:"flex flex-auto p-4 min-h-[350px] max-h-[650px] overflow-x-auto max-w-[90vw] rounded-lg border bg-card"},[o({class:"preview flex flex-auto justify-center items-center"},t)])),ge=x((e,t)=>o({class:"py-4"},t)),Lt=e=>new $e({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:ge([Mt(e.preview)])},{label:"Code",value:"code",layout:ge([Ne(e.code)])}]}),$t=x(({title:e,description:t})=>O({class:"flex flex-col"},[me({class:"scroll-m-20 text-2xl font-bold tracking-tight"},e),t&&d({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),s=x((e,t)=>S({class:"grid py-4"},[$t({title:e.title,description:e.description}),Lt({preview:e.preview,code:e.code})]));class Nt extends Ze{render(){return Xe([o({class:"contained px-4 flex flex-auto flex-col"},this.children)])}}const Et=x(({title:e,description:t})=>O({class:"flex flex-col"},[Ce({class:"scroll-m-20 text-3xl font-bold tracking-tight"},e),d({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),Ht=x((e,t)=>o({class:"contained py-8"},[Et(e),S({class:"pb-12 pt-8"},t)])),p=x((e,t)=>new Nt([Ht(e,t)])),Rt=()=>p({title:"Alerts",description:"Alerts are used to provide feedback to the user about the outcome of an action or to inform them of important information."},[s({title:"Default Alert",description:"This is a standard alert without any specific type.",preview:[H({title:"Notice",description:"This is a default alert without a specific type.",icon:r.information})],code:`import { Alert } from "@components/molecules/alert.js";
...
LoadingButton('With Icon')`})]),Kt=e=>{const t=new Date(e.valueOf()),a=(e.getDay()+6)%7;t.setDate(t.getDate()-a+3);const n=t.valueOf();return t.setMonth(0,1),t.getDay()!==4&&t.setMonth(0,1+(4-t.getDay()+7)%7),1+Math.ceil((n-t)/6048e5)},be=(e,t)=>{const a=new Date(t,0,4),n=a.getDay(),l=new Date(a);l.setDate(a.getDate()-(n+6)%7);const f=new Date(l);return f.setDate(l.getDate()+(e-1)*7),f},Zt=(e,t,a)=>{const n=new Date;return n.getDate()===e&&n.getMonth()===t&&n.getFullYear()===a},Xt=({day:e,week:t,month:a,year:n,weekNumber:l,currentDate:f,selectWeek:h})=>{const C=Zt(e,a,n),D=t.some(b=>(b==null?void 0:b.getDate())===f);return q({text:e||"",disabled:!e,class:`
            px-2 py-1 text-center rounded-md
            ${C?"bg-accent text-accent-foreground":""}
            ${D&&!C?"border border-accent":""}
            hover:bg-primary hover:text-primary-foreground
        `,click:()=>h(l)})},eo=(e,t)=>{const n=new Date(e,t,1).getDay(),l=new Date(e,t+1,0).getDate(),f=[];let h=[],C=null;for(let D=1-n;D<=l;D++){const b=D>0&&D<=l?new Date(e,t,D):null;if(b){const E=Kt(b);C!==E&&h.length>0&&(f.push({weekNumber:C,days:[...h]}),h=[]),C=E}h.push(b),(h.length===7||D===l)&&(f.push({weekNumber:C,days:[...h]}),h=[])}return f},to=({selectWeek:e})=>ot("month",(t,a,{data:n})=>{const{year:l,month:f,currentDate:h,currentWeek:C}=n,D=eo(l,f);return o({class:"grid grid-cols-8 gap-1 text-sm px-4 py-2"},[o({class:"text-xs text-center col-span-1 text-muted-foreground flex items-center"},"Week"),o({class:"grid grid-cols-7 col-span-7 text-center text-muted-foreground items-center"},["Su","Mo","Tu","We","Th","Fr","Sa"].map(b=>i({class:"px-1 py-1",text:b}))),...D.map(({weekNumber:b,days:E})=>o({class:"grid grid-cols-8 col-span-8 items-center"},[o({class:"font-medium text-center col-span-1 rounded-sm cursor-pointer",click:()=>e(b),onSet:["currentWeek",{"text-primary-foreground":b,"bg-primary":b}],text:b?`W${b}`:""}),o({class:"grid grid-cols-7 col-span-7 text-center"},E.map(fe=>Xt({year:l,month:f,day:fe?fe.getDate():null,week:E,weekNumber:b,currentDate:h,selectWeek:e})))]))])}),xe=({label:e,click:t})=>c({class:`
...
})`})]),$=({title:e,description:t})=>O({class:"text-left"},[De({class:"font-semibold tracking-tight text-2xl"},e),d({class:"text-sm text-muted-foreground"},t)]),ro=()=>o({class:"flex items-center justify-center gap-4"},[c({variant:"outline",class:"gap-2 w-full",click:()=>console.log("Sign in with Github"),"aria-label":"Sign in with Github"},[v(r.companies.gitHub),i("Github")]),c({variant:"outline",class:"gap-2 w-full",click:()=>console.log("Sign in with Google"),"aria-label":"Sign in with Google"},[v(r.companies.google),i("Google")])]),io=()=>L({submit:e=>{e.preventDefault(),console.log("Account created")}},[new m({name:"email",label:"Email"},[W({type:"email",placeholder:"m@example.com",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),new m({name:"password",label:"Password"},[W({type:"password",placeholder:"Your password",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),c({type:"submit",class:"w-full mt-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition"},"Create account")]),Ee=()=>P({class:"w-full max-w-md mx-auto p-8 bg-card space-y-6"},[$({title:"Create an account",description:"Enter your email below to create your account"}),ro(),o({class:"relative"},[o({class:"absolute inset-0 flex items-center"},[i({class:"flex-grow border-t"})]),o({class:"relative flex justify-center text-xs uppercase"},[i({class:"bg-background px-2 text-muted-foreground"},"or continue with")])]),io()]),ae=({title:e,description:t,defaultState:a,onChange:n})=>o({class:"flex items-start justify-between gap-2"},[o({class:"text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex flex-col space-y-1"},[i({class:"font-medium text-foreground"},e),i({class:"font-normal leading-snug text-muted-foreground"},t)]),new Z({active:a,change:n})]),He=()=>P({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[$({title:"Cookie Settings",description:"Manage your cookie settings here."}),o({class:"pt-0 grid gap-6"},[ae({title:"Strictly Necessary",description:"These cookies are essential in order to use the website and use its features.",defaultState:!0,onChange:e=>console.log("Strictly Necessary:",e)}),ae({title:"Functional Cookies",description:"These cookies allow the website to provide personalized functionality.",defaultState:!1,onChange:e=>console.log("Functional Cookies:",e)}),ae({title:"Performance Cookies",description:"These cookies help to improve the performance of the website.",defaultState:!1,onChange:e=>console.log("Performance Cookies:",e)})]),c({variant:"outline",class:"w-full",click:()=>console.log("Preferences saved")},"Save preferences")]),Re=({startDate:e})=>P({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[$({title:"Pick a Date",description:"When is the event?"}),o({class:"font-medium text-foreground"},[new ue({selectedDate:e,selectedCallBack:t=>console.log(t)})])]),se=x(({value:e,label:t,icon:a})=>q({class:'text-sm gap-1 font-medium leading-none disabled:cursor-not-allowed disabled:opacity-70 flex flex-col items-center justify-between rounded-md border-2 border-muted bg-popover p-4 hover:bg-muted data-[state="active"]:border-primary [&:has([data-state="active"])]:border-primary',onState:["method",{active:e}],dataSet:["method",["state",e,"active"]],click:(n,{state:l})=>l.method=e},[v(a),i(t)])),lo=K({render(){return o({class:"flex flex-auto flex-col"},[o({class:"grid grid-cols-3 gap-4"},[se({label:"Card",value:"card",icon:r.creditCard}),se({label:"Paypal",value:"paypal",icon:r.companies.paypal}),se({label:"Apple",value:"apple",icon:r.companies.apple})])])},state(){return{method:null}}}),co=()=>o({class:"flex items-center justify-center gap-4"},[new lo]),mo=()=>L({submit:e=>{e.preventDefault(),console.log("Payment method added")}},[new m({name:"name",label:"Name"},[B({type:"text",placeholder:"First Last",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),new m({name:"card_number",label:"Card number"},[B({type:"text",placeholder:"1234 5678 9012 3456",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),o({class:"flex gap-4 mt-4"},[new m({name:"month",label:"Expires"},[j({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"",label:"Month",disabled:!0},...Array.from({length:12},(e,t)=>({value:`${t+1}`,label:`${t+1}`.padStart(2,"0")}))]})]),new m({name:"year",label:"Year"},[j({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"",label:"Year",disabled:!0},...Array.from({length:10},(e,t)=>({value:`${new Date().getFullYear()+t}`,label:`${new Date().getFullYear()+t}`}))]})]),new m({name:"cvc",label:"CVC"},[B({type:"text",placeholder:"CVC",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})])]),c({type:"submit",class:"w-full mt-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition"},"Continue")]),We=()=>P({class:"w-full max-w-md mx-auto p-8 bg-card space-y-6"},[$({title:"Payment Method",description:"Add a new payment method to your account."}),co(),o({class:"space-y-4"},[mo()])]),uo=({name:e,description:t,stars:a,language:n,lastUpdated:l})=>o({class:"flex items-start justify-between py-4 border-b border-muted last:border-b-0"},[o({class:"flex flex-col"},[i({class:"font-semibold text-foreground"},e),i({class:"text-sm text-muted-foreground"},t),o({class:"flex space-x-4 text-sm text-muted-foreground mt-3"},[o({class:"flex items-center gap-2"},[v({class:" text-blue-500"},r.document.text),i(` ${n}`)]),o({class:"flex items-center"},[v(r.star),i(` ${a}`)]),o(`Updated ${l}`)])]),c({variant:"secondary",class:"px-3 py-1 gap-1 flex items-center rounded-md",click:()=>console.log(`Starred ${e}`)},[v(r.star),i("Star")])]),po=({projects:e})=>o({class:"space-y-3"},e.map(t=>uo(t))),fo=[{name:"shadcn/ui",description:"Beautifully designed components that you can copy and paste into your apps. Accessible. Customizable. Open Source.",stars:"20k",language:"TypeScript",lastUpdated:"April 2023"},{name:"base-framework",description:"A robust framework for building and structuring large-scale applications with ease.",stars:"2",language:"JavaScript",lastUpdated:"June 2024"}],go=()=>P({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[o({class:"font-semibold text-lg text-foreground"},"Projects"),po({projects:fo})]),ho=()=>L({submit:e=>{e.preventDefault(),console.log("Issue reported")}},[o({class:"flex flex-auto w-full gap-4"},[new m({name:"area",label:"Area"},[j({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"billing",label:"Billing"},{value:"technical",label:"Technical"},{value:"account",label:"Account"},{value:"other",label:"Other"}],defaultValue:"billing",change:e=>console.log(`Area selected: ${e.target.value}`)})]),new m({name:"security_level",label:"Security Level"},[j({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"severity_1",label:"Severity 1"},{value:"severity_2",label:"Severity 2"},{value:"severity_3",label:"Severity 3"}],defaultValue:"severity_2",change:e=>console.log(`Security Level selected: ${e.target.value}`)})])]),new m({name:"subject",label:"Subject"},[B({type:"text",placeholder:"I need help with...",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),new m({name:"description",label:"Description"},[z({placeholder:"Please include all information relevant to your issue.",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),o({class:"flex justify-end gap-4 mt-4"},[c({variant:"outline",class:"px-4 py-2",click:()=>console.log("Cancel clicked")},"Cancel"),c({type:"submit",class:"px-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition"},"Submit")])]),ze=()=>P({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[$({title:"Report an issue",description:"What area are you having problems with?"}),ho()]),bo=({link:e})=>o({class:"flex items-center gap-4 py-2"},[W({type:"text",value:e,readOnly:!0,class:"border p-2 rounded-md w-full bg-background text-foreground"}),c({variant:"secondary",class:"px-4 py-2",click:()=>{navigator.clipboard.writeText(e),app.notify({title:"Link copied",description:"The link has been copied to your clipboard.",icon:r.clipboard.checked})}},"Copy Link")]),xo=({name:e,email:t,access:a,image:n})=>o({class:"flex items-center justify-between gap-4 py-2"},[o({class:"flex items-center gap-3"},[T({src:n,alt:e,fallbackText:e.split(" ").map(l=>l[0]).join("")}),o({},[i({class:"font-medium text-foreground"},e),i({class:"block text-sm text-muted-foreground"},t)])]),j({class:"border rounded-md bg-background text-foreground px-3 py-1",options:[{value:"edit",label:"Can edit"},{value:"view",label:"Can view"},{value:"comment",label:"Can comment"}],defaultValue:a,change:l=>console.log(`Access level changed for ${e}: ${l.target.value}`)})]),wo=({people:e})=>o({class:"space-y-3"},e.map(t=>xo(t))),qe=({link:e,people:t})=>P({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[$({title:"Share this document",description:"Anyone with the link can view this document."}),bo({link:e}),o({class:"border-t my-4"}),o({class:"font-medium text-foreground"},"People with access"),wo({people:t})]),vo=e=>e.split(" ").map(a=>a[0]).join(""),yo=({name:e,email:t,role:a,image:n})=>o({class:"flex items-center justify-between gap-4 py-2"},[o({class:"flex items-center gap-3"},[T({src:n,alt:e,fallbackText:vo(e)}),o({},[i({class:"font-medium text-foreground"},e),i({class:"block text-sm text-muted-foreground"},t)])]),j({class:"border rounded-md bg-background text-foreground px-3 py-1",options:[{value:"owner",label:"Owner"},{value:"member",label:"Member"}],defaultValue:a,change:l=>console.log(`Role changed for ${e}: ${l.target.value}`)})]),ko=({members:e})=>o({class:"space-y-3"},e.map(t=>yo(t))),Oe=({members:e})=>P({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[$({title:"Team Member",description:"Invite your team members to collaborate."}),ko({members:e})]),To=()=>p({title:"Cards",description:"Cards are a great way to display content in a concise and organized manner."},[s({title:"Usage",description:"Import the card atom and use it in your components.",preview:[P()],code:`import { Button } from '@components/atoms/cards/card.js';
...
})`})]),Bo=()=>{const e=[{id:1,status:"Active",email:"user1@example.com",amount:500.5},{id:2,status:"Inactive",email:"user2@example.com",amount:250.75},{id:3,status:"Active",email:"user3@example.com",amount:300}],t=()=>it([ne({class:"text-muted-foreground border-b"},[lt({}),te({key:"status",label:"Custom Status"}),te({key:"email",label:"User Email"}),te({key:"amount",label:"Amount (USD)",align:"justify-end"})])]),a=(n,l)=>ne({class:"items-center px-4 py-2 hover:bg-muted/50"},[M({class:"p-4"},[new ee({checked:n.selected,class:"mr-2",click:()=>l(n)})]),M({class:"p-4 justify-center"},n.status),M({class:"p-4"},n.email),M({class:"p-4 text-right"},`$${n.amount.toFixed(2)}`)]);return o({class:"w-full mt-4"},[o({class:"w-full rounded-md border overflow-x-auto"},[rt({class:"w-full"},[new Be({key:"id",customHeader:t(),rows:e,rowItem:a})])])])},Po=[{label:"checkbox",key:""},{label:"Status",key:"status"},{label:"Email",key:"email"},{label:"Amount",key:"amount",align:"justify-end"}],Fo=[{id:1,status:"Success",email:"ken99@yahoo.com",amount:316,selected:!1},{id:2,status:"Success",email:"abe45@gmail.com",amount:242,selected:!1},{id:3,status:"Processing",email:"monserrat44@gmail.com",amount:837,selected:!1},{id:4,status:"Success",email:"silas22@gmail.com",amount:874,selected:!1},{id:5,status:"Failed",email:"carmella@hotmail.com",amount:721,selected:!1}],Mo=(e,t)=>ne({class:"items-center px-4 py-2 hover:bg-muted/50"},[M({class:"p-4 "},[new ee({checked:e.selected,class:"mr-2",onChange:()=>t(e)})]),M({class:"p-4 "},[i({class:"text-muted-foreground"},e.status)]),M({class:"p-4 "},e.email),M({class:"p-4 text-right"},`$${e.amount.toFixed(2)}`)]),Lo=()=>p({title:"Data Tables",description:"Data tables are used to display data in a structured format. They can be used to display a list of items, a grid of items, or a table of items."},[s({title:"Usage",description:"The data table component is used to display data in a structured format. It can be used to display a list of items, a grid of items, or a table of items.",preview:[new Be({headers:Po,rows:Fo,rowItem:Mo,key:"id"})],code:`import { DataTable } from "@components/organisms/lists/data-table.js";
...
})`}),s({title:"Select",description:"This is a select input.",preview:[g([j({options:oa,change:e=>console.log(e.target.value)})])],code:`import { Select } from "@components/atoms/form/select.js";
...
})`})]),ma=e=>!e||isNaN(e)?null:e,ye=(e,t)=>{const a=e,n=16,l=2*Math.PI*n,f=a/100*l,h=`
...
LoadingAvatar();`})]);class xa extends Q{render(){return o({class:"tab-panel"},[new Le({class:this.class,options:this.options}),S({class:"tab-content",switch:this.addGroup()})])}addGroup(){let t;const a=[],n=this.options;for(let l=0,f=n.length;l<f;l++)t=n[l],a.push({uri:t.uri||t.href,component:t.component,title:t.title||null,persist:!0});return a}}const ke=x((e,t)=>o({class:"py-4"},t)),wa=()=>p({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[s({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new $e({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:ke([])},{label:"Code",value:"code",layout:ke([])}]})],code:`
