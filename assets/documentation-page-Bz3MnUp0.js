import{O as le,A as ce}from"./overlay-CR0bVDQk.js";import{w as A,m as s,R as P,a as Q,D as N,H as R,b as I,X as u,p as me,c as ue,U as k,I as D,S as d,B as de,d as pe,C as X,A as fe,e as i,f as he,y as p,g as x,h as M,T as z,i as m,j as H,L as be,k as Z,l as G,u as $,q as w,O as ge,n as ee,z as xe,Z as we,o as te,J as W,r as ve,s as B,t as ye,v as oe,V as se,x as ke,E,K as Te,M as Ce,N as Ie,Q as L,W as Be,Y as Se,$ as je,a0 as De,a1 as F,a2 as $e,a3 as Ae,a4 as Pe,P as j,a5 as ne,a6 as Me,G as Le}from"./index-CmeAQbJZ.js";const Ee=e=>R({class:"inline-flex flex-auto items-center justify-center whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm",dataSet:["selected",["state",e.value,"active"]]},[I({class:"flex flex-auto justify-center items-center px-3 py-1.5",onSet:["selected",{selected:e.value}],click:t=>e.callBack(e.value)},e.label)]),Fe=(e,t)=>(e.callBack=t,Ee(e)),Ne=e=>Q({class:`tab items-center justify-center rounded-md bg-muted p-1 text-muted-foreground ${e.class}`},[N({class:"flex flex-auto flex-row",map:[e.options,t=>Fe(t,e.callBack)]})]);class ae extends A{render(){const t=this.select.bind(this);return s({class:""},[Ne({class:this.class,options:this.options,callBack:t}),P({class:"tab-content",onState:["selected",this.updateContent.bind(this)]})])}getFirstValue(){var t;return(t=this.options[0])==null?void 0:t.value}update(){const t=this.state.get("selected");this.select(null),this.select(t)}select(t){this.state.selected=t}updateContent(t){const o=this.options;if(!o||o.length<1)return;const a=o[0];for(const r of o)if(r.value===t)return r.layout;return a.layout}setupStates(){const t=this.callBack,o=typeof t;return{selected:{state:this.getFirstValue(),callBack(a){o==="function"&&t(a)}}}}}const Re=u((e,t)=>me({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces cursor-pointer"},[ue({class:"font-mono text-sm",click:()=>navigator.clipboard.writeText(t[0].textContent)},t)])),ze=u((e,t)=>s({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-card"},[s({class:"preview flex w-full justify-center items-center"},t)])),V=u((e,t)=>s({class:"py-4"},t)),He=e=>new ae({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:V([ze(e.preview)])},{label:"Code",value:"code",layout:V([Re(e.code)])}]}),Oe=u(({title:e,description:t})=>k({class:"flex flex-col"},[D({class:"scroll-m-20 text-2xl font-bold tracking-tight"},e),t&&d({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),n=u((e,t)=>P({class:"py-4"},[Oe({title:e.title,description:e.description}),He({preview:e.preview,code:e.code})]));class Ue extends de{render(){return pe([s({class:"contained px-4 flex flex-auto flex-col"},this.children)])}}const Ge=u(({title:e,description:t})=>k({class:"flex flex-col"},[X({class:"scroll-m-20 text-3xl font-bold tracking-tight"},e),d({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),We=u((e,t)=>s({class:"contained py-8"},[Ge(e),P({class:"pb-12 pt-8"},t)])),c=u((e,t)=>new Ue([We(e,t)])),Ve=()=>c({title:"Alerts",description:"Alerts are used to provide feedback to the user about the outcome of an action or to inform them of important information."},[n({title:"Usage",description:"To use the Alert component, import it from the components library and use it in your application.",preview:[fe({title:"Heads up!",description:"You can add components to your app using the cli.",icon:i.information})],code:`import { Alert } from "@components/molecules/alert.js";
...
Button({ ...props, variant: 'secondary' }, primary)`}),k({class:"flex flex-col py-8"},[H({class:"text-3xl font-bold tracking-tight border-b pb-2"},"Variants")]),n({title:"Primary Button",description:"This is a primary button.",preview:[m({variant:"primary"},"Click Me")],code:`
...
})`})]),yt=e=>ye.render(e,document.body),kt=({title:e})=>k({class:"flex flex-auto items-center"},[H({class:"text-lg font-semibold"},e)]),Tt=u((e,t)=>oe({class:"flex flex-auto flex-col fixed z-30 w-full max-w-lg gap-4 border bg-background text-foreground p-6 shadow-lg duration-200 sm:rounded-lg",click:e.click,aria:{expanded:["open"]}},[s({class:"flex flex-auto flex-col space-y-2"},[kt(e),e.description&&d({class:"flex flex-auto flex-col text-sm text-muted-foreground"},e.description),s({class:"flex flex-auto flex-col text-sm text-muted-foreground"},t)]),se({class:"flex flex-col-reverse sm:flex-row sm:justify-end mt-6 gap-2 sm:gap-0 sm:space-x-2"},e.buttons)]));class U extends A{render(){const t=r=>{r.target===this.panel&&this.close()},o=this.getMainClass(),a=this.title||"Dialog Title";return Tt({class:o,title:a,click:t,description:this.description,buttons:this.getButtons()},this.children)}getButtons(){return[m({variant:"outline",click:()=>this.close()},"Close")]}setupStates(){return{open:!1}}getMainClass(){return""}open(){yt(this),this.panel.showModal(),this.state.open=!0}close(){this.state.open=!1,this.panel.close(),this.destroy()}}class Ct extends U{getButtons(){const t=this.confirmTextLabel||"Confirm";return[m({variant:"outline",click:()=>this.close()},"Cancel"),m({variant:"primary",click:()=>this.confirm()},t)]}confirm(){this.confirmed&&this.confirmed(),this.close()}}const It=u((e,t)=>m({text:"Open",class:"m-1",click:()=>new U(e,t).open()})),Bt=e=>m({text:"Open",class:"m-1",click:()=>new Ct(e).open()}),St=()=>c({title:"Dialogs",description:"Displays a dialog or a component that looks like a dialog. Dialogs can be opened and closed. They will be closed if the user clicks outside of the dialog or if the user clicks the close button."},[n({title:"Usage",description:"Import the dialog atom and use it in your components.",preview:[It({title:"Title",description:"this is the description."},[])],code:`import { Dialog } from '@components/molecules/dialogue.js';
...
})`})]),zt=u((e,t)=>ke({...e,class:"space-y-8 w-full max-w-lg"},t)),Ht=x({state(){return{error:null,value:this.defaultValue??""}},render(){const e=this.name,t=this.getId(`${e}`),{label:o,description:a,onValidate:r}=this,g=f=>{const v=r?r(f):null;this.state.error=v,this.state.value=f};return s({class:"space-y-4"},[Ot([Ut({htmlFor:t},o),Gt({id:t,name:e,value:this.state.value,input:f=>g(f.target.value)},this.children),a&&Wt({id:`${t}-description`},a),s({onState:["error",f=>f&&Vt(f)]})])])}}),Ot=u((e,t)=>s({...e,class:"space-y-2"},t)),Ut=u((e,t)=>ee({...e,class:"text-sm font-medium"},t)),Gt=u((e,t)=>s({...e},t)),Wt=u((e,t)=>d({...e,class:"text-sm text-muted-foreground"},t)),Vt=({children:e})=>d({class:"text-sm text-destructive"},e),Kt=e=>e.length<2?"Username must be at least 2 characters.":null,_t=()=>zt([new Ht({name:"username",label:"Username",description:"This is your public display name.",onValidate:Kt},[E({placeholder:"e.g. email@address.com",required:!0})]),m({type:"submit",submit:e=>{e.preventDefault(),console.log("Form submitted")}},"Submit")]),Yt=()=>c({title:"Forms",description:"Forms are used to collect user data and submit it to the server."},[n({title:"Usage",description:"To use the form component, import it from the components library and use it in your application.",preview:[_t()],code:`@components/molecules/combobox/combobox.js';
import { Icons } from "@components/icons/icons.js";
...
new InlineNavigation({
...
})`})]),co=()=>c({title:"Notifications",description:"Displays a notification message to the user."},[n({title:"In App Notifications",description:"Notifications can be displayed in the app to inform users about important events or updates. They are a global notification container that can be called from anywhere in the app.",preview:[new Ae({title:"Notification Title",description:"This is a notification.",icon:i.warning,duration:"infinite"})],code:`app.notify({
    ...
    type: 'warning', // 'success', 'destructive', 'info', 'warning'
    duration: 5000 // in milliseconds, leave it blank for 4 seconds, infinite is also a value to prevent it from going away
})`})]),mo=()=>s({class:"absolute h-full rounded-full bg-primary transition-all duration-300",style:"width: [[progress]]%;"}),uo=x({render(){return s({class:"relative w-full h-4 rounded-full bg-muted"},[mo()])},state(){return{progress:this.progress??0}},set(e){e<0&&(e=0),e>100&&(e=100),this.state.progress=e}}),po=()=>c({title:"Progress Bars",description:"Progress bars are a great way to show the progress of a task or process."},[n({title:"Usage",description:"Import the progress bar atom and use it in your components. The progress bar can be used to show the progress of a task or process.",preview:[new uo({cache:"progress",progress:20})],code:`import { ProgressBar } from "@components/atoms/progress-bar.js";

new ProgressBar({ cache: 'progress', progress: 20 })`})]),y=({className:e,shape:t="rectangle",width:o="w-full",height:a="h-4"})=>s({class:`bg-muted animate-pulse ${o} ${a} ${t==="circle"?"rounded-full":"rounded-md"} ${e||""}`}),fo=()=>c({title:"Skeletons",description:"Skeletons are components that are used to show a placeholder for content that is loading."},[n({title:"Usage",description:"The skeleton component is used to show a placeholder for content that is loading.",preview:[s({class:"flex flex-auto space-x-4 w-full max-w-64"},[y({shape:"circle",width:"w-10",height:"h-10"}),s({class:"flex flex-auto flex-col space-y-2"},[y({width:"w-3/4",height:"h-4"}),y({width:"w-1/2",height:"h-4"})])])],code:`import { Skeleton } from "@components/atoms/skeleton.js";
import { Div } from '@base-framework/atoms';
...
])`})]),_=u((e,t)=>s({class:"py-4"},t)),ho=()=>c({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[n({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new ae({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:_([])},{label:"Code",value:"code",layout:_([])}]})],code:`
...
export const ExampleTab = () => (
	new Tab({
        ...
        options: [
            ...
            `},t)])}),go=()=>c({title:"Tooltips",description:"This is a tooltip."},[n({title:"Usage",description:"Import the card atom and use it in your components.",preview:[s({class:"flex gap-2 flex-wrap"},[q({content:"This is a tooltip."},[m("Hover me")])])],code:`import { Button } from "@components/atoms/buttons/buttons.js";
import { Tooltip } from "@components/atoms/tooltip.js";

Tooltip({ content: 'This is a tooltip.' }, [
    Button('Hover me')
])`}),n({title:"Bottom Tooltip",description:"This will show the tooltip at the bottom of the target element.",preview:[s({class:"flex gap-2 flex-wrap"},[q({content:"This is a tooltip.",position:"bottom"},[m("Hover me")])])],code:`import { Button } from "@components/atoms/buttons/buttons.js";
import { Tooltip } from "@components/atoms/tooltip.js";

Tooltip({ content: 'This is a tooltip.', position: 'bottom' }, [
    Button('Hover me')
])`}),d({class:"text-muted-foreground text-sm mt-4"},"The tooltip position can be set to: top, top-right, top-left, bottom, bottom-right, bottom-left, left, right.")]),re=u((e,t)=>{var o;return w({...e,html:(o=t[0])==null?void 0:o.textContent})}),J=(e,t,o)=>(o="Icons"+(o?"."+o:""),s({class:"flex flex-auto flex-col items-center gap-2 max-w-[150px] h-[8.5rem] cursor-pointer"},[s({class:"flex flex-auto w-full h-full justify-center items-center flex-wrap rounded-lg border bg-card text-base shadow-sm hover:bg-accent hover:text-accent-foreground",click:()=>{navigator.clipboard.writeText(`${o}.${t}`)}},[re(e)]),s({class:"text-muted-foreground"},t)])),ie=(e,t,o)=>{const a=typeof e=="object";a&&t.push(d({class:"text-muted-foreground"},"path: "+o+".{icon}"));const r=[];if(t.push(s({class:"flex flex-auto flex-wrap gap-2 my-8"},r)),a===!1)r.push(J(e,o));else for(var g in e){if(e.hasOwnProperty(g)===!1)continue;const f=e[g];if(typeof f!="object"){r.push(J(f,g,o));continue}const v=`${o}.${g}`;ie(f,t,v)}},xo=e=>{if(!e||typeof e!="object")return;const t=[];for(let[o,a]of Object.entries(e)){if(o==="parse")continue;t.push(ne({id:o.toLowerCase(),class:"text-2xl font-bold"},Me.titleCase(o))),ie(a,t,o)}return t},wo=()=>c({title:"Icons",description:"The icons are from the Hericon library. They are SVG icons that can be used in your project. This icon set uses the outline style."},[z({href:"https://heroicons.com/",target:"_blank",class:"bttn link"},"link: Hericons"),n({title:"Icons",description:"This is an icon.",preview:[w({html:i.home})],code:`
import { Icons } from '@components/icons/icons.js';
...
Icon(Icons.home);`}),s({class:"my-20"},[D({class:"text-2xl font-bold"},"Default Icons"),d({class:"text-muted-foreground"},'A few of the icons have been saved to the "Icons" object. You can use these icons in your project. Click to copy the Icon path. Here is a list of the icons that are available:')]),xo(i)]),vo=()=>c({title:"Introduction",description:"This app shell was created to showcase Base framework and its components and atoms. It is a simple app shell that can be used as a starting point for your project. It is built with Tailwind CSS and uses Shadcn as the inspiration for the theme and many of it's components. "}),yo=e=>s({class:"flex flex-auto flex-col items-center gap-2 max-w-[150px] h-[8.5rem] cursor-pointer"},[s({class:`flex flex-auto w-full h-full min-h-[136px] justify-center items-center flex-wrap rounded-lg border text-base shadow-sm ${e.class}`,click:()=>{navigator.clipboard.writeText(`${e.class}`)}}),s({class:"text-sm text-muted-foreground"},e.var)]),b=(e,t)=>P({class:"flex flex-auto flex-col gap-2"},[d({class:"text-base text-muted-foreground"},e),s({class:"flex flex-auto flex-wrap gap-2 my-2",map:[t,yo]})]),ko=e=>s({class:"flex flex-auto flex-col gap-12"},[ne({class:"text-2xl font-bold"},"Color Guide"),b("Default background color of <body />...etc",[{var:"--backround",class:"bg-backround"},{var:"--foreground",class:"bg-foreground"}]),b("Muted backgrounds such as <TabsList />, <Skeleton /> and <Switch />",[{var:"--muted",class:"bg-muted"},{var:"--muted-foreground",class:"bg-muted-forground"}]),b("Background color for <Card />",[{var:"--card",class:"bg-card"},{var:"--card-foreground",class:"bg-card-foreground"}]),b("Background color for popovers such as <DropdownMenu />, <HoverCard />, <Popover />",[{var:"--popover",class:"bg-popover"},{var:"--popover-foreground",class:"bg-popover-foreground"}]),b("Default border color",[{var:"--border",class:"bg-border"}]),b("Border color for inputs such as <Input />, <Select />, <Textarea />",[{var:"--input",class:"bg-input"}]),b("Primary colors for <Button />",[{var:"--primary",class:"bg-primary"},{var:"--primary-foreground",class:"bg-primary-foreground"}]),b("Secondary colors for <Button />",[{var:"--secondary",class:"bg-secondary"},{var:"--secondary-foreground",class:"bg-secondary-foreground"}]),b("Used for accents such as hover effects on <DropdownMenuItem>, <SelectItem>...etc",[{var:"--accent",class:"bg-accent"},{var:"--accent-foreground",class:"bg-accent-foreground"}]),b('Used for destructive actions such as <Button variant="destructive">',[{var:"--destructive",class:"bg-destructive"},{var:"--destructive-foreground",class:"bg-destructive-foreground"}]),b('Used for warning actions such as <Button variant="warning">',[{var:"--warning",class:"bg-warning"},{var:"--warning-foreground",class:"bg-warning-foreground"}]),b("Used for focus ring",[{var:"--ring",class:"bg-ring"}]),b("Border radius for card, input and buttons",[{var:"--radius",class:"bg-radius"}])]),To=()=>c({title:"Theme",description:"The theme is using Tailwind CSS and is based on Shadcn UI. The theme is customizable and can be extended. It comes with light and dark theme support."},[z({href:"https://ui.shadcn.com/docs/theming",target:"_blank",class:"bttn link"},"link: Shadcn"),s({class:"my-20"},[D({class:"text-2xl font-bold"},"Default Styles"),d({class:"text-muted-foreground"},"The default styles are defined in the Tailwind CSS configuration file and in the base CSS file. Here's the list of variables available for customization:")]),ko(),s({class:"flex flex-auto flex-col gap-2 mt-20"},[F({class:"text-2xl font-bold"},"Text Sizes"),d({class:"text-muted-foreground text-3xl"},"Text-3xl A test sentence."),d({class:"text-muted-foreground text-2xl"},"Text-2xl A test sentence."),d({class:"text-muted-foreground text-xl"},"Text-xl A test sentence."),d({class:"text-muted-foreground text-lg"},"Text-lg A test sentence."),d({class:"text-muted-foreground text-base"},"Text-base A test sentence."),d({class:"text-muted-foreground text-sm"},"Text-sm A test sentence."),d({class:"text-muted-foreground text-xs"},"Text-xs A test sentence.")])]),l=(e,t,o)=>({uri:e,title:t,component:o()}),Co=e=>[l(`${e}`,"Introduction",vo),l(`${e}/theme`,"Theme",To),l(`${e}/icons`,"Icons",wo),l(`${e}/components/buttons*`,"Buttons",ot),l(`${e}/components/badges*`,"Badges",qe),l(`${e}/components/tabs*`,"Tabs",ho),l(`${e}/components/modals*`,"Modals",io),l(`${e}/components/notifications*`,"Notifications",co),l(`${e}/components/dialogs*`,"Modals",St),l(`${e}/components/cards*`,"Cards",rt),l(`${e}/components/calendars*`,"Calendars",nt),l(`${e}/components/avatars*`,"Avatars",Ke),l(`${e}/components/inputs*`,"Inputs",to),l(`${e}/components/forms*`,"Forms",Yt),l(`${e}/components/alerts*`,"Alerts",Ve),l(`${e}/components/comboboxes*`,"Comboboxes",dt),l(`${e}/components/lists*`,"Lists",so),l(`${e}/components/data-tables*`,"Data Tables",vt),l(`${e}/components/breadcrumbs*`,"Breadcrumbs",tt),l(`${e}/components/navigations*`,"Navigations",lo),l(`${e}/components/progress-bars*`,"Progress Bars",po),l(`${e}/components/skeletons*`,"Skeletons",fo),l(`${e}/components/tooltips*`,"Tooltips",go),l(`${e}/components/dropdown-menus*`,"Dropdown Menus",Rt)],Io=e=>[{href:`${e}`,label:"Introduction",exact:!0},{href:`${e}/theme`,label:"Theme",exact:!0},{href:`${e}/icons`,label:"Icons"},{group:"Components",options:[{label:"Buttons",href:`${e}/components/buttons`},{label:"Badges",href:`${e}/components/badges`},{label:"Tabs",href:`${e}/components/tabs`},{label:"Modals",href:`${e}/components/modals`},{label:"Notifications",href:`${e}/components/notifications`},{label:"Dialogs",href:`${e}/components/dialogs`},{label:"Cards",href:`${e}/components/cards`},{label:"Calendars",href:`${e}/components/calendars`},{label:"Avatars",href:`${e}/components/avatars`},{label:"Inputs",href:`${e}/components/inputs`},{label:"Forms",href:`${e}/components/forms`},{label:"Alerts",href:`${e}/components/alerts`},{label:"Comboboxes",href:`${e}/components/comboboxes`},{label:"Lists",href:`${e}/components/lists`},{label:"Data Tables",href:`${e}/components/data-tables`},{label:"Breadcrumbs",href:`${e}/components/breadcrumbs`},{label:"Navigations",href:`${e}/components/navigations`},{label:"Progress Bars",href:`${e}/components/progress-bars`},{label:"Skeletons",href:`${e}/components/skeletons`},{label:"Tooltips",href:`${e}/components/tooltips`},{label:"Dropdown Menus",href:`${e}/components/dropdown-menus`}]}],Bo=()=>new le({backHref:"aside/"},[new j([s([k([X("Overlay")]),s({class:"contained"},[Le()])])])]),So=e=>[{uri:`${e}/overlay-test`,component:Bo()}],S="docs",$o=()=>new ce({title:"Documentation",basePath:S,routes:So(S),switch:Co(S),links:Io(S)});export{$o as DocumentationPage,$o as default};
