import{o as s,u as o,H as e,_ as a,v as r,A as l,E as d,s as c}from"./index-CJnrX494.js";import{D as u}from"./doc-page-L49zK9-d.js";import"./sidebar-menu-page-BImgFKeY-Cx7z5SsA.js";import"./full-page-CgVI1G7F-CdDt1lPX.js";import"./mobile-nav-wrapper-C7cKTxaV-C6uLGK7P.js";import"./sidebar-menu-Dz2oh95a-BJu2S9D5.js";const t=r((i,n)=>l({...i,class:`flex p-4 max-h-[650px] max-w-[1024px] overflow-x-auto
					 rounded-lg border bg-muted whitespace-break-spaces
					 break-all cursor-pointer mt-4 ${i.class}`},[d({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(n[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:c.clipboard.checked})}},n)])),x=()=>u({title:"Get Started",description:"Learn how to install, configure, and begin working with the App Shell project."},[s({class:"flex flex-col gap-y-4"},[o({class:"text-lg font-bold"},"About the Project"),e({class:"text-muted-foreground"},`This project is a Progressive Web App (PWA) framework designed to serve as a
					...
					meet your specific requirements.`)]),s({class:"flex flex-col gap-y-4 mt-12"},[o({class:"text-lg font-bold"},"Prerequisites & Installation"),e({class:"text-muted-foreground"},`Before you begin, make sure you have Node.js (version 16+) and npm or yarn
...
yarn install`),e({class:"text-muted-foreground"},`This will download and install all the packages defined in the "dependencies"
					and "devDependencies" fields of your package.json file.`)]),s({class:"flex flex-col gap-y-4 mt-12"},[o({class:"text-lg font-bold"},"Project Structure & Package Setup"),e({class:"text-muted-foreground"},{html:`
...
}`)]),s({class:"flex flex-col gap-y-4 mt-12"},[o({class:"text-lg font-bold"},"Running the App"),e({class:"text-muted-foreground"},`Use the following commands to start the development server or build
...
npm run preview`),e({class:"text-muted-foreground"},`The development server by default is accessible at http://localhost:5173
					(or whichever port Vite dynamically chooses).`)]),s({class:"flex flex-col gap-y-4 mt-12"},[o({class:"text-lg font-bold"},"Vite Configuration"),e({class:"text-muted-foreground"},{html:`
 ...
 */
import { Div } from "@components/atoms/inputs.js";`)]),s({class:"flex flex-col gap-y-4 mt-12"},[o({class:"text-lg font-bold"},"Theme Setup"),e({class:"text-muted-foreground"},{html:`
...
<meta name="msapplication-TileColor" content="#09090b">`),o({class:"text-lg font-bold"},"Manifest Colors and Settings"),e({class:"text-muted-foreground"},{html:`
  ...
  "background_color": "#09090b"
						...
						A favicon.ico file should be added to the <code>public</code> folder.`})]),s({class:"flex flex-col gap-y-4 mt-12"},[o({class:"text-lg font-bold mt-12"},"Authentication"),e({class:"text-muted-foreground"},`The shell supports authentication flows with "signed in" and "signed out"
					...
					and properties.`)]),s({class:"flex flex-col gap-y-4 mt-12"},[o({class:"text-lg font-bold"},"Development Guidelines"),e({class:"text-muted-foreground"},[a(`Modules are central to the App Shell's extensibility. You can add new
  ...
  links: [
	{
	  ...
	  options: [
		{ label: 'Docs', href: 'docs', icon: Icons.document.text, mobileOrder: 5 }
							...
							point for understanding module creation and registration.`)])]),s({class:"flex flex-col gap-y-4 mt-12"},[o({class:"text-lg font-bold"},"Global Configs"),e({class:"text-muted-foreground"},`The App Shell provides a global “Configs” object for handling application-level
...
- **userStatusApi**: An endpoint for checking user status or other server-side calls.`)]),e({class:"text-muted-foreground"},`You can extend or modify this object to add more application-wide configurations.
					...
					production environments, you can do so here and reference them throughout your code.`)]),s({class:"flex flex-col gap-y-4 mt-12"},[o({class:"text-lg font-bold"},"Service Worker & Push Notifications"),e({class:"text-muted-foreground"},`The App Shell provides a service worker setup for caching assets and handling
...
[
	'./',
	'./index.html'
];`)])]);export{x as GetStartedPage,x as default};
