import{P as Q,A as We}from"./panel-CVJVgSiX.js";import{w as E,m as a,R as k,l as le,D as q,H as W,d as F,Q as u,p as Ue,n as Ve,I as i,U as M,a as J,b as c,h as _e,e as Ge,C as ve,A as V,k as Qe,y as r,_ as w,P as U,T as y,B as l,F as K,L as Je,o as ye,q as de,f as Y,r as ke,t as Ye,s as I,u as z,v as P,x as Ke,z as T,E as R,J as v,K as Ze,M as Xe,Z as et,N as Te,W as ue,X as tt,Y as _,$ as ot,a0 as Se,a1 as Ce,a2 as ne,a3 as re,a4 as at,a5 as te,a6 as st,a7 as nt,c as rt,a8 as N,S as j,a9 as me,aa as it,ab as ie,ac as lt,O as ct,G as dt}from"./index-HO7zAEPi.js";import{T as ut}from"./tab-group-DoY4-rsh.js";import{T as A}from"./tooltip-TUPDceud.js";const mt=e=>W({class:"inline-flex flex-auto items-center justify-center whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm",dataSet:["selected",["state",e.value,"active"]]},[F({class:"flex flex-auto justify-center items-center px-3 py-1.5",onSet:["selected",{selected:e.value}],click:t=>e.callBack(e.value)},e.label)]),pt=(e,t)=>(e.callBack=t,mt(e)),ft=e=>le({class:`tab items-center justify-center rounded-md bg-muted p-1 text-muted-foreground ${e.class}`},[q({class:"flex flex-auto flex-row",map:[e.options,t=>pt(t,e.callBack)]})]);class je extends E{render(){const t=this.select.bind(this);return a({class:""},[ft({class:this.class,options:this.options,callBack:t}),k({class:"tab-content",onState:["selected",this.updateContent.bind(this)]})])}getFirstValue(){var t;return(t=this.options[0])==null?void 0:t.value}update(){const t=this.state.get("selected");this.select(null),this.select(t)}select(t){this.state.selected=t}updateContent(t){const o=this.options;if(!o||o.length<1)return;const s=o[0];for(const d of o)if(d.value===t)return d.layout;return s.layout}setupStates(){const t=this.callBack,o=typeof t;return{selected:{state:this.getFirstValue(),callBack(s){o==="function"&&t(s)}}}}}const Ie=u((e,t)=>Ue({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces break-all cursor-pointer"},[Ve({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(t[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:i.clipboard.checked})}},t)])),ht=u((e,t)=>a({class:"flex flex-auto p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-card"},[a({class:"preview flex flex-auto justify-center items-center"},t)])),pe=u((e,t)=>a({class:"py-4"},t)),gt=e=>new je({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:pe([ht(e.preview)])},{label:"Code",value:"code",layout:pe([Ie(e.code)])}]}),bt=u(({title:e,description:t})=>M({class:"flex flex-col"},[J({class:"scroll-m-20 text-2xl font-bold tracking-tight"},e),t&&c({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),n=u((e,t)=>k({class:"grid py-4"},[bt({title:e.title,description:e.description}),gt({preview:e.preview,code:e.code})]));class xt extends _e{render(){return Ge([a({class:"contained px-4 flex flex-auto flex-col"},this.children)])}}const wt=u(({title:e,description:t})=>M({class:"flex flex-col"},[ve({class:"scroll-m-20 text-3xl font-bold tracking-tight"},e),c({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),vt=u((e,t)=>a({class:"contained py-8"},[wt(e),k({class:"pb-12 pt-8"},t)])),f=u((e,t)=>new xt([vt(e,t)])),yt=()=>f({title:"Alerts",description:"Alerts are used to provide feedback to the user about the outcome of an action or to inform them of important information."},[n({title:"Default Alert",description:"This is a standard alert without any specific type.",preview:[V({title:"Notice",description:"This is a default alert without a specific type.",icon:i.information})],code:`import { Alert } from "@components/molecules/alert.js";
...
Button({ ...props, variant: 'secondary' }, primary)`}),M({class:"flex flex-col py-8"},[K({class:"text-3xl font-bold tracking-tight border-b pb-2"},"Variants")]),n({title:"Primary Button",description:"This is a primary button.",preview:[l({variant:"primary"},"Click Me")],code:`
...
LoadingButton('With Icon')`})]),Et=()=>Y.formatTime("",24),Nt=()=>f({title:"Calendars",description:"This is the calendar component documentation."},[n({title:"Usage",description:"This is how you can use the calendar component.",preview:[new ye],code:`@components/organisms/calendar/calendar.js';

new Calendar()`}),n({title:"Dynamic Time",description:"This is how you can use the calendar component.",preview:[new de({filter:()=>{let e="Morning";const t=Et();return t>="18:00:00"?e="Evening":t>="12:00:00"&&(e="Afternoon"),`Good ${e}`}})],code:`import { DateTime } from "@base-framework/base";
...
})`}),n({title:"Date Select Card",preview:[Fe({startDate:"2023-01-23"})],code:`import AccountCard from "./examples/date-select-card.js";

DateSelectCard({
    startDate: '2023-01-23'
})`}),n({title:"Report Issue Card",preview:[Pe()],code:`import AccountCard from "./examples/report-issue-card.js";

ReportIssueCard()`}),n({title:"Project Card",preview:[eo()],code:`import AccountCard from "./examples/project-card.js";

ProjectCard()`}),n({title:"Cookie Settings Card",preview:[Be()],code:`import AccountCard from "./examples/cookie-settings-card.js";

CookieSettingsCard()`})]),co=(e,t)=>{const o=e?e.getBoundingClientRect():{top:0,bottom:0,left:0},s=t.getBoundingClientRect();let d=o.left+window.scrollX,h=o.bottom+window.scrollY;const L=10;return d+s.width>window.innerWidth&&(d=window.innerWidth-s.width-L),h+s.height>window.innerHeight&&(h=o.top+window.scrollY-s.height-L),{x:d,y:h}};class ce extends E{setData(){return this.parent.data}getSize(){switch(this.size||"lg"){case"sm":return"w-48";case"md":return"w-64";case"lg":return"w-[250px]";case"xl":return"w-96";case"2xl":return"w-[400px]";case"full":return"w-full"}}render(){const t=this.getSize();return a({class:`absolute mt-2 border rounded-md shadow-lg bg-popover min-h-12 r z-30 ${t}`,style:"top: [[position.y]]px; left: [[position.x]]px"},this.children)}setupStates(){return{open:{id:this.parent.getId(),callBack:s=>{this.state.open===!1&&this.destroy()}}}}updatePosition(){const t=this.button??null,o=this.panel,s=co(t,o);this.data.position=s}afterSetup(){this.updatePosition()}isOutsideClick(t){return!this.panel.contains(t)&&this.button&&!this.button.contains(t)}setupEvents(){return[["click",document,t=>{this.isOutsideClick(t.target)&&(this.state.open=!1)}]]}setup(t){this.container=app.appShell.panel,this.initialize()}}const uo=({toggleDropdown:e})=>F({cache:"button",class:"relative z-[2] inline-flex items-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2 justify-between",click:e,addEvent:["click",document,(t,{state:o,panel:s})=>{ho(t.target,s)&&(o.open=!1)}]},[r({onState:["selectedLabel",t=>t||"Select item..."]}),P({html:i.chevron.upDown})]),mo=(e,t)=>W({class:"flex flex-auto items-center cursor-pointer p-2 hover:bg-secondary rounded-sm",click:()=>t(e),onState:["selectedValue",{"bg-secondary":e.value}]},[e.icon&&r({class:"mr-2 flex items-baseline"},[P({class:"flex w-4 h-4",html:e.icon})]),r(e.label)]),po=e=>a({class:"w-full"},[q({class:"max-h-60 overflow-y-auto p-2 grid gap-1",for:["items",t=>mo(t,e)]})]),fo=({onSelect:e})=>a({class:"flex flex-auto flex-col",onState:["open",(t,o,s)=>{if(t)return new ce({cache:"dropdown",parent:s,button:s.button},[po(e)])}]}),ho=(e,t)=>!t.contains(e),Ne=w({setData(){return new U({items:this.items||[],position:{y:0,x:0}})},state:{open:!1,selectedLabel:"",selectedValue:""},handleSelect(e){const t=this.state;t.selectedValue=e.value,t.selectedLabel=e.label,t.open=!1,typeof this.onSelect=="function"&&this.onSelect(e)},toggleDropdown(){this.state.toggle("open")},render(){const e=t=>{const o=this.state;o.selectedValue=t.value,o.selectedLabel=t.label,o.open=!1};return a({class:"relative w-full flex flex-auto flex-col max-w-[250px]"},[uo({toggleDropdown:this.toggleDropdown.bind(this)}),fo({onSelect:e}),this.required&&z({class:"opacity-0 absolute top-0 left-0 z-[1]",type:"text",name:this.name,required:!0,value:["[[selectedValue]]",this.state]})])}}),go=[{value:"next.js",label:"Next.js",icon:i.home},{value:"sveltekit",label:"SvelteKit"},{value:"nuxt.js",label:"Nuxt.js"},{value:"remix",label:"Remix"},{value:"astro",label:"Astro"}],bo=()=>f({title:"Comboboxes",description:"Comboboxes are used to allow users to select an option from a dropdown list or enter a custom value."},[n({title:"Usage",description:"To use the Combobox component, import it from the components library and use it in your application.",preview:[a({class:"w-full max-w-[300px]"},[new Ne({items:go,onSelect:e=>console.log(e)})])],code:`@components/molecules/combobox/combobox.js';
import { Icons } from "@components/icons/icons.js";
...
`}),n({title:"File Input",description:"This is a file input.",preview:[C([at({multiple:!0,change:e=>console.log(e.target.files)})])],code:`import { EmailInput, FileInput, Input, TelInput, Textarea } from "@components/atoms/form/input.js";
...
Textarea({
    placeholder: 'Enter your text here...'
})`}),n({title:"Date Picker",description:"This is a date picker input.",preview:[C([new Le({selectedDate:"2022-01-01"})])],code:`
import DatePicker from "@components/molecules/date-time/date-picker.js";

new DatePicker()`}),n({title:"Range Slider",description:"This is a range slider input.",preview:[C([new He({min:0,max:100,value:50,change:e=>console.log(e)})])],code:`
...
});`}),v({class:"text-lg font-bold"},"Description"),c({class:"text-muted-foreground"},"The List component can be used to display a list of items in a structured format. Each item can be customized to show different information. The List component supports appending, prepending, mingling, and deleting or items. "),v({class:"text-lg font-bold"},"Performance"),c({class:"text-muted-foreground"},"The list will only update or re-render the items that have changed, improving performance. It uses a key to know when to update an item.")]),ha=({title:e,description:t})=>M({class:"modal-header flex items-center"},[l({variant:"icon",icon:i.arrows.left,class:"mr-2 p-0 flex sm:hidden",click:(o,s)=>s.close()}),a({class:"flex flex-auto flex-col ml-2"},[K({class:"text-lg font-semibold m-0"},e),t&&a({class:"text-sm text-muted-foreground"},t)])]),ga=u((e,t)=>Se({class:`modal m-auto fixed z-20 grid w-full h-full gap-4 lg:border bg-background text-foreground shadow-xl break-words overflow-hidden ${e.class}`,click:e.click},[B({class:"modal-content flex flex-auto flex-col",submit:o=>e.onSubmit&&e.onSubmit()},[ha(e),a({class:"modal-body flex flex-auto flex-col overflow-y-auto"},t),Ce({class:"modal-footer flex justify-between"},e.buttons)])]));class ze extends ee{render(){const t=h=>{h.target===this.panel&&this.close()},o=this.getMainClass(),s=this.title||"",d=this.description||null;return ga({class:o,click:t,title:s,description:d,buttons:this.getButtons(),onSubmit:this.submit,aria:{expanded:["open"]}},this.children)}getButtons(){return[l({variant:"outline",click:()=>this.close()},"Cancel"),l({variant:"primary",type:"submit"},"Save")]}getSizeClass(){switch(this.size){case"sm":return"sm max-w-[646px]";case"lg":return"lg max-w-[900px]";case"xl":return"xl max-w-[1400px]";default:return"md max-w-[760px]"}}getTypeClass(){switch(this.type){case"right":return"right right-0";case"left":return"left left-0";default:return""}}getMainClass(){return this.getSizeClass()+" "+this.getTypeClass()}}const O=[{label:"Large",buttonStyle:"primary",size:"lg"},{label:"Small",buttonStyle:"secondary",size:"sm"},{label:"Medium",buttonStyle:"destructive",size:"md"},{label:"XL",buttonStyle:"primary",size:"xl"},{label:"Right",buttonStyle:"ghost",type:"right"},{label:"Left",buttonStyle:"link",type:"left"}],H=({label:e,buttonStyle:t,size:o,type:s})=>l({text:e,class:`m-1 ${t}`,click:()=>new ze({title:"Are you absolutely sure?",size:o,type:s},[a({class:"flex flex-auto flex-col items-center justify-center p-4"},[l({click:()=>{new Oe({title:"Are you absoultely sure?",description:"This action cannot be undone. This will permanently delete your account and remove your data from our servers.",confirmTextLabel:"Save",confirmed:()=>{app.notify({icon:i.trash,title:"Account deleted",description:"Your account has been successfully deleted.",type:"destructive"})}}).open()}},"Confirm")])]).open()}),ba=({size:e="lg",type:t="center"})=>new ze({title:"Report an Issue",description:"What area are you having problems with?",size:e,type:t,onSubmit:()=>console.log("Form submitted")},[a({class:"flex flex-col max-w-lg p-4 space-y-8"},[a({class:"flex flex-auto w-full gap-4"},[new p({name:"area",label:"Area"},[S({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"billing",label:"Billing"},{value:"technical",label:"Technical"},{value:"account",label:"Account"},{value:"other",label:"Other"}],defaultValue:"billing",change:o=>console.log(`Area selected: ${o.target.value}`)})]),new p({name:"security_level",label:"Security Level"},[S({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"severity_1",label:"Severity 1"},{value:"severity_2",label:"Severity 2"},{value:"severity_3",label:"Severity 3"}],defaultValue:"severity_2",change:o=>console.log(`Security Level selected: ${o.target.value}`)})])]),new p({name:"subject",label:"Subject"},[T({type:"text",placeholder:"I need help with...",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),new p({name:"description",label:"Description"},[R({placeholder:"Please include all information relevant to your issue.",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})])])]),ge=({label:e,buttonStyle:t,size:o,type:s})=>l({text:e,class:`m-1 ${t}`,click:()=>ba({size:o,type:s}).open()}),xa=()=>f({title:"Modals",description:"Displays a modal or a component that looks like a modal."},[n({title:"Extra Large Modal",description:"This is an extra large modal.",preview:[H(O[3])],code:`
...
});`}),n({title:"Form Modal",preview:[ge({label:"Form Modal",buttonStyle:"primary"})],code:`
import { Modal } from "@components/molecules/modal.js";
import { Button } from "@components/atoms/atoms.js";
...
);`}),n({title:"Right Form Modal",preview:[ge({label:"Form Modal",buttonStyle:"primary",size:"md",type:"right"})],code:`
import { Modal } from "@components/molecules/modal.js";
import { Button } from "@components/atoms/atoms.js";
...
);`})]),wa=()=>f({title:"Navigations",description:"Navigations are components that help users move around the website or application."},[n({title:"Inline Navigation",description:"The inline navigation component is a simple navigation component that can be used in a sidebar or app shell.",preview:[a({class:"flex flex-auto flex-col w-full border rounded-md max-w-[300px]"},[new rt({options:[{label:"Home",href:"/",icon:i.home},{label:"About",href:"/about"},{label:"Contact",href:"/contact"},{label:"Services",options:[{label:"Web Development",href:"/web-development"}]},{group:"Frameworks",options:[{label:"Next.js",href:"/next"},{label:"SvelteKit",href:"/sveltekit"},{label:"Nuxt.js",href:"/nuxt"},{label:"Remix",href:"/remix"},{label:"Astro",href:"/astro"}]}]})])],code:`import { Button } from '@components/organisms/navigation/inline-navigation.js';
import { Icons } from "@components/icons/icons.js";
...
LoadingAvatar();`})]),ja=(e,t)=>t.indexOf(e)!==-1,Ia=(e,t)=>{const o=e.getLinkPath()??"";return ja(o,t)};class Da extends E{onCreated(){this.links=[]}render(){return le({class:`tab items-center justify-center rounded-md bg-muted p-1 text-muted-foreground ${this.class}`},[q({class:"flex flex-auto flex-row",map:[this.options,t=>this.addLink(t)],watch:{value:["[[path]]",me.data],callBack:this.updateLinks.bind(this)}})])}afterSetup(){const t=me.data.path;this.updateLinks(t)}updateLinks(t){let o=!1,s=this.links[0];for(const d of this.links)if(d.rendered!==!1&&(o=Ia(d,t),o===!0))break;o!==!0&&s&&this.updateLink(s,!0)}updateLink(t,o){t.update(o)}addLink({label:t,href:o}){const s=new it({text:t,href:o,dataSet:["selected",["state",!0,"active"]],class:"inline-flex flex-auto items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm"});return this.links.push(s),s}}class Aa extends E{render(){return a({class:"tab-panel"},[new Da({class:this.class,options:this.options}),k({class:"tab-content",switch:this.addGroup()})])}addGroup(){let t;const o=[],s=this.options;for(let d=0,h=s.length;d<h;d++)t=s[d],o.push({uri:t.uri||t.href,component:t.component,title:t.title||null,persist:!0});return o}}const be=u((e,t)=>a({class:"py-4"},t)),Ba=()=>f({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[n({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new je({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:be([])},{label:"Code",value:"code",layout:be([])}]})],code:`
...
);`}),n({title:"Tab Group",description:"This is a tab group. The buttons update the state.",preview:[new ut({options:[{label:"Music",value:"music"},{label:"Podcasts",value:"podcasts"},{label:"Live",value:"live"}]})],code:`import { TabGroup } from "@components/organisms/tabs/tab-group.js";
...
Tooltip({ content: 'This is a tooltip.' }, [
    ...
    Button('Hover me')
])`}),c({class:"text-muted-foreground text-sm mt-4"},"The tooltip position can be set to: top, top-right, top-left, bottom, bottom-right, bottom-left, left, right.")]),xe=(e,t,o)=>(o="Icons"+(o?"."+o:""),a({class:"flex flex-auto flex-col items-center gap-2 max-w-[150px] h-[8.5rem] cursor-pointer"},[a({class:"flex flex-auto w-full h-full justify-center items-center flex-wrap rounded-lg border bg-card text-base shadow-sm hover:bg-accent hover:text-accent-foreground",click:()=>{navigator.clipboard.writeText(`${o}.${t}`),app.notify({title:"Icon copied",description:`The icon '${o}.${t}' has been copied to your clipboard.`,icon:i.clipboard.checked})}},[I(e)]),a({class:"text-muted-foreground"},t)])),Re=(e,t,o)=>{const s=typeof e=="object";s&&t.push(c({class:"text-muted-foreground"},"path: "+o+".{icon}"));const d=[];if(t.push(a({class:"flex flex-auto flex-wrap gap-2 my-8"},d)),s===!1)d.push(xe(e,o));else for(var h in e){if(e.hasOwnProperty(h)===!1)continue;const L=e[h];if(typeof L!="object"){d.push(xe(L,h,o));continue}const qe=`${o}.${h}`;Re(L,t,qe)}},Fa=e=>{if(!e||typeof e!="object")return;const t=[];for(let[o,s]of Object.entries(e)){if(o==="parse")continue;t.push(ie({id:o.toLowerCase(),class:"text-2xl font-bold"},lt.titleCase(o))),Re(s,t,o)}return t},Ma=()=>f({title:"Icons",description:"The icons are from the Hericon library. They are SVG icons that can be used in your project. This icon set uses the outline style."},[y({href:"https://heroicons.com/",target:"_blank",class:"bttn link"},"link: Hericons"),n({title:"Icons",description:"This is an icon.",preview:[P({html:i.home})],code:`
import { Icons } from '@components/icons/icons.js';
