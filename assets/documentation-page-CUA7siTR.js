import{B as r,O as U,A as R}from"./overlay-CLrBcawM.js";import{X as i,y as V,w as I,m as s,R as w,a as N,D as W,H as X,b as _,p as q,c as F,U as m,I as B,S as b,B as Y,d as J,C as A,e as T,g as K,h as D,V as $,f as k,i as Q,P as y,T as P,q as z,M as L,j as Z,G as ee}from"./index-CUeT0K46.js";const C={gray:{backgroundColor:"bg-gray-50",textColor:"text-gray-600",ringColor:"ring-gray-500/10"},red:{backgroundColor:"bg-red-50",textColor:"text-red-700",ringColor:"ring-red-600/10"},yellow:{backgroundColor:"bg-yellow-50",textColor:"text-yellow-800",ringColor:"ring-yellow-600/20"},green:{backgroundColor:"bg-green-50",textColor:"text-green-700",ringColor:"ring-green-600/20"},blue:{backgroundColor:"bg-blue-50",textColor:"text-blue-700",ringColor:"ring-blue-700/10"},indigo:{backgroundColor:"bg-indigo-50",textColor:"text-indigo-700",ringColor:"ring-indigo-700/10"},purple:{backgroundColor:"bg-purple-50",textColor:"text-purple-700",ringColor:"ring-purple-700/10"},pink:{backgroundColor:"bg-pink-50",textColor:"text-pink-700",ringColor:"ring-pink-700/10"}},te=e=>C[e]||C.gray,oe=e=>{const{backgroundColor:t,textColor:o,ringColor:n}=te(e);return`inline-flex items-center rounded-md px-2 py-1 text-xs font-medium ring-1 ring-inset ${t} ${o} ${n}`},u=i((e,t)=>{const o=oe(e==null?void 0:e.type);return V({...e,class:o},t)}),se=e=>X({class:"inline-flex flex-auto items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm",dataSet:["selected",["state",e.value,"active"]]},[_({class:"flex flex-auto justify-center items-center",onSet:["selected",{selected:e.value}],click:t=>e.callBack(e.value)},e.label)]),ae=(e,t)=>(e.callBack=t,se(e)),ne=e=>N({class:`tab items-center justify-center rounded-md bg-muted p-1 text-muted-foreground ${e.class}`},[W({class:"flex flex-auto flex-row",map:[e.options,t=>ae(t,e.callBack)]})]);class O extends I{render(){const t=this.select.bind(this);return s({class:""},[ne({class:this.class,options:this.options,callBack:t}),w({class:"tab-content",onState:["selected",this.updateContent.bind(this)]})])}afterSetup(){const t=this.options[0].value;this.select(t)}update(){const t=this.state.get("selected");this.select(null),this.select(t)}select(t){this.state.selected=t}updateContent(t){const o=this.options;if(!o||o.length<1)return;const n=o[0];for(const c of o)if(c.value===t)return c.layout;return n.layout}setupStates(){const t=this.callBack,o=typeof t;return{selected:{state:null,callBack(n){o==="function"&&t(n)}}}}}const re=i((e,t)=>q({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces cursor-pointer"},[F({class:"font-mono text-sm",click:()=>navigator.clipboard.writeText(t[0].textContent)},t)])),le=i((e,t)=>s({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-card"},[s({class:"preview flex w-full justify-center items-center"},t)])),j=i((e,t)=>s({class:"py-4"},t)),ie=e=>new O({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:j([le(e.preview)])},{label:"Code",value:"code",layout:j([re(e.code)])}]}),ce=i(({title:e,description:t})=>m({class:"flex flex-col"},[B({class:"scroll-m-20 text-2xl font-bold tracking-tight"},e),t&&b({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),a=i((e,t)=>w({class:"py-4"},[ce({title:e.title,description:e.description}),ie({preview:e.preview,code:e.code})]));class ue extends Y{render(){return J([s({class:"contained px-4 flex flex-auto flex-col"},this.children)])}}const de=i(({title:e,description:t})=>m({class:"flex flex-col"},[A({class:"scroll-m-20 text-3xl font-bold tracking-tight"},e),b({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),pe=i((e,t)=>s({class:"contained py-8"},[de(e),w({class:"pb-12 pt-8"},t)])),p=i((e,t)=>new ue([pe(e,t)])),me=()=>p({title:"Badges",description:"Badges can be used to display a status or a count."},[a({title:"Badge",description:"This is a badge.",preview:[s({class:"flex gap-2"},[u({type:"gray"},"Text"),u({type:"red"},"Text"),u({type:"yellow"},"Text"),u({type:"green"},"Text"),u({type:"blue"},"Text"),u({type:"indigo"},"Text"),u({type:"purple"},"Text"),u({type:"pink"},"Text")])],code:`
