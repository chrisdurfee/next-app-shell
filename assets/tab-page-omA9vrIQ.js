import{as as l,s as n,av as p,a3 as a,D as i,ab as r,Y as m}from"./index-CM1IEHgP.js";import{D as e}from"./doc-section-1HDPv0lU.js";import{D as c}from"./doc-page-Cjx708Nb.js";import"./sidebar-menu-page-nCAVFk3R-Di2_rNMK.js";const t=n((o,s)=>m({class:"py-4"},s)),d=()=>c({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[e({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new l({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:t([])},{label:"Code",value:"code",layout:t([])}]})],code:`
...
})`})]);export{d as TabPage,d as default};
