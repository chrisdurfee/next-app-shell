import{as as l,av as n,a0 as a,A as p,aa as i,e as r,Y as m}from"./index-BDcHE6-I.js";import{D as e}from"./doc-section-DtSxH-ZC.js";import{D as c}from"./doc-page-Jelupsg9.js";const t=r((o,s)=>m({class:"py-4"},s)),T=()=>c({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[e({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new l({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:t([])},{label:"Code",value:"code",layout:t([])}]})],code:`
