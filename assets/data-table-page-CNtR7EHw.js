import{Y as c,L as b,T as i,ah as e,M as f,u as a,a6 as o,G as l,z as h}from"./index-DA2FGZN4.js";import{q as u}from"./tooltip-Cy5agtG6-BcJKSIuZ.js";import{k as p,p as y,w as n}from"./signature-panel-CrKk8upb-CHkLyiLv.js";import{D as d,C as m}from"./doc-section-Ct-IP-C9.js";import{D as x}from"./doc-page-C8Ew1AmG.js";import"./sidebar-menu-page-nCAVFk3R-BtKr2xIG.js";import"./mobile-nav-wrapper-BE_hr65B-B97p8BEy.js";const k=()=>{const t=[{id:1,status:"Active",email:"user1@example.com",amount:500.5},{id:2,status:"Inactive",email:"user2@example.com",amount:250.75},{id:3,status:"Active",email:"user3@example.com",amount:300}],r=()=>f([i({class:"text-muted-foreground border-b"},[y({}),n({key:"status",label:"Custom Status"}),n({key:"email",label:"User Email"}),n({key:"amount",label:"Amount (USD)",align:"justify-end"})])]),g=(s,w)=>i({class:"items-center px-4 py-2 hover:bg-muted/50"},[e({class:"p-4"},[new u({checked:s.selected,class:"mr-2",click:()=>w(s)})]),e({class:"p-4 justify-center"},s.status),e({class:"p-4"},s.email),e({class:"p-4 text-right"},`$${s.amount.toFixed(2)}`)]);return c({class:"w-full mt-4"},[c({class:"w-full rounded-md border overflow-x-auto"},[b({class:"w-full"},[new p({key:"id",customHeader:r(),rows:t,rowItem:g})])])])},T=[{label:"checkbox",key:""},{label:"Status",key:"status"},{label:"Email",key:"email"},{label:"Amount",key:"amount",align:"justify-end"}],D=[{id:1,status:"Success",email:"ken99@yahoo.com",amount:316,selected:!1},{id:2,status:"Success",email:"abe45@gmail.com",amount:242,selected:!1},{id:3,status:"Processing",email:"monserrat44@gmail.com",amount:837,selected:!1},{id:4,status:"Success",email:"silas22@gmail.com",amount:874,selected:!1},{id:5,status:"Failed",email:"carmella@hotmail.com",amount:721,selected:!1}],I=(t,r)=>i({class:"items-center px-4 py-2 hover:bg-muted/50"},[e({class:"p-4"},[new u({checked:t.selected,class:"mr-2",onChange:()=>r(t)})]),e({class:"p-4 "},[h({class:"text-muted-foreground"},t.status)]),e({class:"p-4 "},t.email),e({class:"p-4 text-right"},`$${t.amount.toFixed(2)}`)]),U=()=>x({title:"Data Tables",description:"Data tables are used to display or manipulate lists of items in tabular form."},[d({title:"Usage",description:"The DataTable component displays items in a structured format, supporting selection, custom row items, and more.",preview:[new p({headers:T,rows:D,rowItem:I,key:"id"})],code:`import {  DataTable  } from "@base-framework/ui/organisms";
