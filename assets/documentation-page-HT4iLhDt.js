import{Z as x,M as fe,N as he,o as s,Y as o,w as ge,u as m,l as O,s as se,G as i,y as Fe,e as $e,A as F,m as k,B as c,z as r,C as Ee,E as Re,H as b,I as Ne,O as He,r as n,a as be,P as ze,Q as Ue,R as qe,U as Oe,W as We,X as Ge,a0 as D,$ as w,a1 as j,f as d,a2 as X,a3 as W,a4 as ie,_ as we,a5 as _e,c as C,a6 as S,a7 as E,a8 as xe,a9 as Ye,h as ve,aa as Je,i as ee,ab as Ve,ac as J,j as B,k as G,ad as ye,ae as re,af as ke,K as q,ag as Ke,ah as Qe,L as R,ai as te,aj as oe,ak as Te,al as Ze,am as Xe,an as V,ao as et,ap as tt,aq as ot,ar as at,as as st,at as it,au as rt,av as nt,aw as lt,ax as ct,ay as mt,T as dt,az as ut,p as pt,aA as ft,aB as ht,x as _,aC as gt,aD as ne,aE as $,aF as bt,aG as wt,F as xt,aH as M,aI as vt,aJ as yt,V as I,aK as kt,b as Tt,q as St,D as A,J as T,aL as It,aM as ae,v as Ct,aN as Dt,aO as At}from"./index-BuvJI13o.js";const v=x((e,a)=>fe({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces break-all cursor-pointer"},[he({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(a[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:s.clipboard.checked})}},a)])),Bt=x((e,a)=>o({class:"flex flex-auto p-4 min-h-[350px] max-h-[650px] overflow-x-auto max-w-[90vw] rounded-lg border bg-card"},[o({class:"preview flex flex-auto justify-center items-center"},a)])),le=x((e,a)=>o({class:"py-4"},a)),jt=e=>new ge({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:le([Bt(e.preview)])},{label:"Code",value:"code",layout:le([v(e.code)])}]}),Pt=x(({title:e,description:a})=>O({class:"flex flex-col"},[se({class:"scroll-m-20 text-2xl font-bold tracking-tight"},e),a&&i({class:"text-base text-muted-foreground py-2 max-w-[700px]"},a)])),t=x((e,a)=>m({class:"grid py-4"},[Pt({title:e.title,description:e.description}),jt({preview:e.preview,code:e.code})])),Mt=x(({title:e,description:a})=>O({class:"flex flex-col"},[$e({class:"scroll-m-20 text-3xl font-bold tracking-tight"},e),i({class:"text-base text-muted-foreground py-2 max-w-[700px]"},a)])),Lt=x((e,a)=>o({class:"contained py-8"},[Mt(e),m({class:"pb-12 pt-8"},a)])),f=x((e,a)=>new Fe([Lt(e,a)])),Ft=()=>f({title:"Alerts",description:"Alerts are used to provide feedback to the user about the outcome of an action or to inform them of important information."},[t({title:"Default Alert",description:"This is a standard alert without any specific type.",preview:[F({title:"Notice",description:"This is a default alert without a specific type.",icon:s.information})],code:`import {  Alert  } from "@base-framework/ui/molecules";
...
Button({ ...props, variant: 'secondary' }, primary)`}),O({class:"flex flex-col py-8"},[be({class:"text-3xl font-bold tracking-tight border-b pb-2"},"Variants")]),t({title:"Primary Button",description:"This is a primary button.",preview:[n({variant:"primary"},"Click Me")],code:`
import {  Button  } from "@base-framework/ui/atoms";
import { Atom } from '@base-framework/base';
...
})`})]),P=({title:e,description:a})=>O({class:"text-left"},[be({class:"font-semibold tracking-tight text-2xl"},e),i({class:"text-sm text-muted-foreground"},a)]),qt=()=>o({class:"flex items-center justify-center gap-4"},[n({variant:"outline",class:"gap-2 w-full",click:()=>console.log("Sign in with Github"),"aria-label":"Sign in with Github"},[w(s.companies.gitHub),r("Github")]),n({variant:"outline",class:"gap-2 w-full",click:()=>console.log("Sign in with Google"),"aria-label":"Sign in with Google"},[w(s.companies.google),r("Google")])]),Ot=()=>j({class:"space-y-4",submit:e=>{e.preventDefault(),console.log("Account created")}},[new d({name:"email",label:"Email"},[X({type:"email",placeholder:"m@example.com",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),new d({name:"password",label:"Password"},[X({type:"password",placeholder:"Your password",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),n({type:"submit",class:"w-full mt-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition"},"Create account")]),Se=()=>D({class:"w-full max-w-md mx-auto p-8 bg-card space-y-6"},[P({title:"Create an account",description:"Enter your email below to create your account"}),qt(),o({class:"relative"},[o({class:"absolute inset-0 flex items-center"},[r({class:"flex-grow border-t"})]),o({class:"relative flex justify-center text-xs uppercase"},[r({class:"bg-background px-2 text-muted-foreground"},"or continue with")])]),Ot()]),K=({title:e,description:a,defaultState:l,onChange:u})=>o({class:"flex items-start justify-between gap-2"},[o({class:"text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex flex-col space-y-1"},[r({class:"font-medium text-foreground"},e),r({class:"font-normal leading-snug text-muted-foreground"},a)]),new W({active:l,change:u})]),Ie=()=>D({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[P({title:"Cookie Settings",description:"Manage your cookie settings here."}),o({class:"pt-0 grid gap-6"},[K({title:"Strictly Necessary",description:"These cookies are essential in order to use the website and use its features.",defaultState:!0,onChange:e=>console.log("Strictly Necessary:",e)}),K({title:"Functional Cookies",description:"These cookies allow the website to provide personalized functionality.",defaultState:!1,onChange:e=>console.log("Functional Cookies:",e)}),K({title:"Performance Cookies",description:"These cookies help to improve the performance of the website.",defaultState:!1,onChange:e=>console.log("Performance Cookies:",e)})]),n({variant:"outline",class:"w-full",click:()=>console.log("Preferences saved")},"Save preferences")]),Ce=({startDate:e})=>D({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[P({title:"Pick a Date",description:"When is the event?"}),o({class:"font-medium text-foreground"},[new ie({selectedDate:e,selectedCallBack:a=>console.log(a)})])]),Q=x(({value:e,label:a,icon:l})=>_e({class:'text-sm gap-1 font-medium leading-none disabled:cursor-not-allowed disabled:opacity-70 flex flex-col items-center justify-between rounded-md border-2 border-muted bg-popover p-4 hover:bg-muted data-[state="active"]:border-primary [&:has([data-state="active"])]:border-primary',onState:["method",{active:e}],dataSet:["method",["state",e,"active"]],click:(u,{state:g})=>g.method=e},[w(l),r(a)])),Wt=we({render(){return o({class:"flex flex-auto flex-col"},[o({class:"grid grid-cols-3 gap-4"},[Q({label:"Card",value:"card",icon:s.creditCard}),Q({label:"Paypal",value:"paypal",icon:s.companies.paypal}),Q({label:"Apple",value:"apple",icon:s.companies.apple})])])},state(){return{method:null}}}),Gt=()=>o({class:"flex items-center justify-center gap-4"},[new Wt]),_t=()=>j({class:"space-y-4",submit:e=>{e.preventDefault(),console.log("Payment method added")}},[new d({name:"name",label:"Name"},[C({type:"text",placeholder:"First Last",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),new d({name:"card_number",label:"Card number"},[C({type:"text",placeholder:"1234 5678 9012 3456",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),o({class:"flex gap-4 mt-4"},[new d({name:"month",label:"Expires"},[S({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"",label:"Month",disabled:!0},...Array.from({length:12},(e,a)=>({value:`${a+1}`,label:`${a+1}`.padStart(2,"0")}))]})]),new d({name:"year",label:"Year"},[S({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"",label:"Year",disabled:!0},...Array.from({length:10},(e,a)=>({value:`${new Date().getFullYear()+a}`,label:`${new Date().getFullYear()+a}`}))]})]),new d({name:"cvc",label:"CVC"},[C({type:"text",placeholder:"CVC",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})])]),n({type:"submit",class:"w-full mt-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition"},"Continue")]),De=()=>D({class:"w-full max-w-md mx-auto p-8 bg-card space-y-6"},[P({title:"Payment Method",description:"Add a new payment method to your account."}),Gt(),o({class:"space-y-4"},[_t()])]),Yt=({name:e,description:a,stars:l,language:u,lastUpdated:g})=>o({class:"flex items-start justify-between py-4 border-b border-muted last:border-b-0"},[o({class:"flex flex-col"},[r({class:"font-semibold text-foreground"},e),r({class:"text-sm text-muted-foreground"},a),o({class:"flex space-x-4 text-sm text-muted-foreground mt-3"},[o({class:"flex items-center gap-2"},[w({class:" text-blue-500"},s.document.text),r(` ${u}`)]),o({class:"flex items-center"},[w(s.star),r(` ${l}`)]),o(`Updated ${g}`)])]),n({variant:"secondary",class:"px-3 py-1 gap-1 flex items-center rounded-md",click:()=>console.log(`Starred ${e}`)},[w(s.star),r("Star")])]),Jt=({projects:e})=>o({class:"space-y-3"},e.map(a=>Yt(a))),Vt=[{name:"shadcn/ui",description:"Beautifully designed components that you can copy and paste into your apps. Accessible. Customizable. Open Source.",stars:"20k",language:"TypeScript",lastUpdated:"April 2023"},{name:"base-framework",description:"A robust framework for building and structuring large-scale applications with ease.",stars:"2",language:"JavaScript",lastUpdated:"June 2024"}],Kt=()=>D({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[o({class:"font-semibold text-lg text-foreground"},"Projects"),Jt({projects:Vt})]),Qt=()=>j({class:"space-y-4",submit:e=>{e.preventDefault(),console.log("Issue reported")}},[o({class:"flex flex-auto w-full gap-4"},[new d({name:"area",label:"Area"},[S({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"billing",label:"Billing"},{value:"technical",label:"Technical"},{value:"account",label:"Account"},{value:"other",label:"Other"}],defaultValue:"billing",change:e=>console.log(`Area selected: ${e.target.value}`)})]),new d({name:"security_level",label:"Security Level"},[S({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"severity_1",label:"Severity 1"},{value:"severity_2",label:"Severity 2"},{value:"severity_3",label:"Severity 3"}],defaultValue:"severity_2",change:e=>console.log(`Security Level selected: ${e.target.value}`)})])]),new d({name:"subject",label:"Subject"},[C({type:"text",placeholder:"I need help with...",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),new d({name:"description",label:"Description"},[E({placeholder:"Please include all information relevant to your issue.",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),o({class:"flex justify-end gap-4 mt-4"},[n({variant:"outline",class:"px-4 py-2",click:()=>console.log("Cancel clicked")},"Cancel"),n({type:"submit",class:"px-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition"},"Submit")])]),Ae=()=>D({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[P({title:"Report an issue",description:"What area are you having problems with?"}),Qt()]),Zt=({link:e})=>o({class:"flex items-center gap-4 py-2"},[X({type:"text",value:e,readOnly:!0,class:"border p-2 rounded-md w-full bg-background text-foreground"}),n({variant:"secondary",class:"px-4 py-2",click:()=>{navigator.clipboard.writeText(e),app.notify({title:"Link copied",description:"The link has been copied to your clipboard.",icon:s.clipboard.checked})}},"Copy Link")]),Xt=({name:e,email:a,access:l,image:u})=>o({class:"flex items-center justify-between gap-4 py-2"},[o({class:"flex items-center gap-3"},[k({src:u,alt:e,fallbackText:e.split(" ").map(g=>g[0]).join("")}),o({},[r({class:"font-medium text-foreground"},e),r({class:"block text-sm text-muted-foreground"},a)])]),S({class:"border rounded-md bg-background text-foreground px-3 py-1",options:[{value:"edit",label:"Can edit"},{value:"view",label:"Can view"},{value:"comment",label:"Can comment"}],defaultValue:l,change:g=>console.log(`Access level changed for ${e}: ${g.target.value}`)})]),eo=({people:e})=>o({class:"space-y-3"},e.map(a=>Xt(a))),Be=({link:e,people:a})=>D({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[P({title:"Share this document",description:"Anyone with the link can view this document."}),Zt({link:e}),o({class:"border-t my-4"}),o({class:"font-medium text-foreground"},"People with access"),eo({people:a})]),to=e=>e.split(" ").map(l=>l[0]).join(""),oo=({name:e,email:a,role:l,image:u})=>o({class:"flex items-center justify-between gap-4 py-2"},[o({class:"flex items-center gap-3"},[k({src:u,alt:e,fallbackText:to(e)}),o({},[r({class:"font-medium text-foreground"},e),r({class:"block text-sm text-muted-foreground"},a)])]),S({class:"border rounded-md bg-background text-foreground px-3 py-1",options:[{value:"owner",label:"Owner"},{value:"member",label:"Member"}],defaultValue:l,change:g=>console.log(`Role changed for ${e}: ${g.target.value}`)})]),ao=({members:e})=>o({class:"space-y-3"},e.map(a=>oo(a))),je=({members:e})=>D({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[P({title:"Team Member",description:"Invite your team members to collaborate."}),ao({members:e})]),so=()=>f({title:"Cards",description:"Cards are a great way to display content in a concise and organized manner."},[t({title:"Usage",description:"Import the card atom and use it in your components.",preview:[D()],code:`import {  Button  } from "@base-framework/ui/atoms";

Card()`}),c({class:"text-lg font-bold"},"Examples"),i({class:"text-muted-foreground"},"This is a list of examples of how to use the card component in your application."),t({title:"Account Card",preview:[Se()],code:`import AccountCard from "./examples/account-card.js";
...
})`})]),no=()=>{const e=[{id:1,status:"Active",email:"user1@example.com",amount:500.5},{id:2,status:"Inactive",email:"user2@example.com",amount:250.75},{id:3,status:"Active",email:"user3@example.com",amount:300}],a=()=>Je([ee({class:"text-muted-foreground border-b"},[Ve({}),J({key:"status",label:"Custom Status"}),J({key:"email",label:"User Email"}),J({key:"amount",label:"Amount (USD)",align:"justify-end"})])]),l=(u,g)=>ee({class:"items-center px-4 py-2 hover:bg-muted/50"},[B({class:"p-4"},[new G({checked:u.selected,class:"mr-2",click:()=>g(u)})]),B({class:"p-4 justify-center"},u.status),B({class:"p-4"},u.email),B({class:"p-4 text-right"},`$${u.amount.toFixed(2)}`)]);return o({class:"w-full mt-4"},[o({class:"w-full rounded-md border overflow-x-auto"},[Ye({class:"w-full"},[new ve({key:"id",customHeader:a(),rows:e,rowItem:l})])])])},lo=[{label:"checkbox",key:""},{label:"Status",key:"status"},{label:"Email",key:"email"},{label:"Amount",key:"amount",align:"justify-end"}],co=[{id:1,status:"Success",email:"ken99@yahoo.com",amount:316,selected:!1},{id:2,status:"Success",email:"abe45@gmail.com",amount:242,selected:!1},{id:3,status:"Processing",email:"monserrat44@gmail.com",amount:837,selected:!1},{id:4,status:"Success",email:"silas22@gmail.com",amount:874,selected:!1},{id:5,status:"Failed",email:"carmella@hotmail.com",amount:721,selected:!1}],mo=(e,a)=>ee({class:"items-center px-4 py-2 hover:bg-muted/50"},[B({class:"p-4"},[new G({checked:e.selected,class:"mr-2",onChange:()=>a(e)})]),B({class:"p-4 "},[r({class:"text-muted-foreground"},e.status)]),B({class:"p-4 "},e.email),B({class:"p-4 text-right"},`$${e.amount.toFixed(2)}`)]),uo=()=>f({title:"Data Tables",description:"Data tables are used to display or manipulate lists of items in tabular form."},[t({title:"Usage",description:"The DataTable component displays items in a structured format, supporting selection, custom row items, and more.",preview:[new ve({headers:lo,rows:co,rowItem:mo,key:"id"})],code:`import {  DataTable  } from "@base-framework/ui/organisms";
...
};`}),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Selecting and Resetting Rows"),i({class:"text-muted-foreground"},"DataTable supports toggling all rows, clearing selections, and retrieving selected rows."),v(`// Suppose 'dt' is your DataTable instance
...
`)]),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Removing Items"),i({class:"text-muted-foreground"},"Use remove() to delete rows by passing an array of items (or a single item)."),v(`// dt is your DataTable instance
...
`)]),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Appending Items"),i({class:"text-muted-foreground"},"Use append() to add rows at the end of the list. Accepts an array or single object."),v(`// dt is your DataTable instance
...
`)]),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Mingling Items"),i({class:"text-muted-foreground"},"Mingle merges new items with existing items by matching keys. If withDelete = true, items not in newItems are removed."),v(`// dt is your DataTable instance
const newItems = [
...
`)]),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Prepending Items"),i({class:"text-muted-foreground"},"Use prepend() to add new rows at the beginning of the list, shifting existing rows down."),v(`// dt is your DataTable instance
...
});`}),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Removing Items"),i({class:"text-muted-foreground"},"Use remove() to delete items by their key. You can pass an array of items."),v(`// Suppose 'list' is an instance of the List component.

// Removing a single item:
list.remove([ item ]);

// Removing multiple items:
list.remove([ item1, item2 ]);`)]),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Setting Rows"),i({class:"text-muted-foreground"},"Use setRows() to directly replace the entire items array in the list."),v(`const newData = [
    { name: 'Alice', email: 'alice@example.com' },
    { name: 'Bob', email: 'bob@example.com' }
];
list.setRows(newData); // Replaces entire list with newData
`)]),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Getting Rows"),i({class:"text-muted-foreground"},"Use getRows() to retrieve the current items array in the list."),v(`const currentItems = list.getRows();
console.log('Current list items:', currentItems);
`)]),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Resetting the List"),i({class:"text-muted-foreground"},"Use reset() to clear all items, returning it to an empty list. Dividers are also reset, if any."),v(`list.reset(); // Empties the list's items array
`)]),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Appending Items"),i({class:"text-muted-foreground"},"Use append() to add new items to the end of the list. Accepts an array or single object."),v(`// Single item
...
`)]),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Mingling Items"),i({class:"text-muted-foreground"},"Use mingle(newItems, withDelete) to merge new items into existing ones, removing old ones if not present when withDelete = true. Compares based on the key property."),v(`const newItems = [
...
`)]),m({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Prepending Items"),i({class:"text-muted-foreground"},"Use prepend() to add new items at the beginning of the list, shifting existing items down."),v(`// Single item
...
`)])]),z=[{label:"Large",buttonStyle:"primary",size:"lg"},{label:"Small",buttonStyle:"secondary",size:"sm"},{label:"Medium",buttonStyle:"destructive",size:"md"},{label:"XL",buttonStyle:"primary",size:"xl"},{label:"Right",buttonStyle:"ghost",type:"right"},{label:"Left",buttonStyle:"link",type:"left"}],U=({label:e,buttonStyle:a,size:l,type:u})=>n({text:e,class:`m-1 ${a}`,click:()=>new _({title:"Are you absolutely sure?",size:l,type:u},[o({class:"flex flex-col max-w-lg lg:p-4 space-y-8"},[new d({name:"popover-test",label:"Popover Test"},[new ie]),new d({name:"dialog-test",label:"Dialog Test"},[n({click:()=>{new re({title:"Are you absolutely sure?",description:"This action cannot be undone.",confirmTextLabel:"Save",confirmed:()=>{app.notify({icon:s.trash,title:"Action complete",description:"You confirmed your selection.",type:"destructive"})}}).open()}},"Confirm")])])]).open()}),jo=({size:e="md",type:a="center"})=>new _({title:"Report an Issue",icon:s.warning,description:"What area are you having problems with?",size:e,type:a,onSubmit:()=>console.log("Form submitted")},[o({class:"flex flex-col lg:p-4 space-y-8"},[R({legend:"Issue Details"},[o({class:"flex flex-auto w-full gap-4"},[new d({name:"area",label:"Area"},[S({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"billing",label:"Billing"},{value:"technical",label:"Technical"},{value:"account",label:"Account"},{value:"other",label:"Other"}],defaultValue:"billing"})]),new d({name:"security_level",label:"Security Level"},[S({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"severity_1",label:"Severity 1"},{value:"severity_2",label:"Severity 2"},{value:"severity_3",label:"Severity 3"}],defaultValue:"severity_2"})])]),new d({name:"subject",label:"Subject"},[C({type:"text",placeholder:"I need help with...",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),new d({name:"description",label:"Description"},[E({placeholder:"Please include all information relevant to your issue.",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})])])])]),de=({label:e,buttonStyle:a,size:l,type:u})=>n({text:e,class:`m-1 ${a}`,click:()=>jo({size:l,type:u}).open()}),Pe=()=>[new ke({icon:s.ellipsis.vertical,groups:[[{icon:s.mapPin,label:"Track Item",value:"track-item"},{icon:s.trash,label:"Delete Item",value:"delete-item"}]],onSelect:e=>{console.log("Selected item from header:",e)}})],Po=()=>new _({title:"Detail Example",description:"This is a detailed view of an item.",icon:s.information,size:"md",headerOptions:Pe,hidePrimaryButton:!0},[gt([ne({title:"Overview"},[$("Label","Value"),$("Date","2024-11-02"),o({class:"my-2 border-t"}),$("Status","Pending")]),ne({title:"More Info"},[$("Description","This is a multi-line snippet."),$("Comments","No comments available.")])])]),Mo=()=>n({text:"Detail Modal",variant:"outline",click:()=>Po().open()}),Lo=()=>f({title:"Modals",description:"Displays modals or modal-like components with various sizes, forms, and header options."},[t({title:"Detail Modal Atoms",description:"Demonstrates usage of DetailBody, DetailSection, and SplitRow within a modal.",preview:[Mo()],code:`
...
`})]),$o=()=>f({title:"Notifications",description:"Displays a notification message to the user."},[t({title:"Default Notification",description:"This is a standard notification without any specific type.",preview:[new M({title:"Default Notification",description:"This is a default notification.",icon:s.information,duration:"infinite"})],code:`app.notify({
    title: 'Default Notification',
    description: 'This is a default notification.',
    icon: Icons.info,
    duration: 'infinite'
})`}),i({class:"text-muted-foreground"},'The notification can either be a link with an "href" attribute or a button with an "onClick" event.'),t({title:"Info Notification",description:"An informational notification to inform users about general information.",preview:[new M({title:"Heads up!",description:"You can add components to your app using the CLI.",icon:s.information,type:"info",duration:"infinite"})],code:`app.notify({
    title: 'Heads up!',
    description: 'You can add components to your app using the CLI.',
    icon: Icons.information,
    type: 'info',
    duration: 'infinite'
})`}),t({title:"Warning Notification",description:"A warning notification to caution the user about potential issues.",preview:[new M({title:"Warning!",description:"Please check your input before proceeding.",icon:s.warning,type:"warning",duration:"infinite"})],code:`app.notify({
    title: 'Warning!',
    description: 'Please check your input before proceeding.',
    icon: Icons.warning,
    type: 'warning',
    duration: 5000
})`}),t({title:"Destructive Notification",description:"A destructive notification to alert the user of a serious issue or error.",preview:[new M({title:"Error!",description:"Something went wrong. Please try again later.",icon:s.shield,type:"destructive",duration:"infinite"})],code:`app.notify({
    title: 'Error!',
    description: 'Something went wrong. Please try again later.',
    icon: Icons.error,
    type: 'destructive',
    duration: 'infinite'
})`}),t({title:"Success Notification",description:"A success notification to confirm a successful action or process.",preview:[new M({title:"Success!",description:"The action was successful.",icon:s.check,type:"success",duration:"infinite"})],code:`app.notify({
    title: 'Success!',
    description: 'The action was successful.',
    icon: Icons.check,
    type: 'success',
    duration: 'infinite'
})`}),t({title:"Notification with Actions",description:"This notification includes primary and secondary buttons for user actions.",preview:[new M({title:"Action Required",description:"Would you like to proceed with this action?",icon:s.information,type:"info",primary:"Proceed",primaryAction:()=>console.log(1),secondary:"Cancel",secondaryAction:()=>console.log(1),duration:"infinite"})],code:`app.notify({
...
LoadingAvatar();`})]),ue=x((e,a)=>o({class:"py-4"},a)),Ho=()=>f({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[t({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new ge({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:ue([])},{label:"Code",value:"code",layout:ue([])}]})],code:`
...
})`})]),zo=()=>f({title:"Tooltips",description:"Tooltips are small popups that appear when a user hovers over an element."},[t({title:"Usage",description:"Import the tooltip atom and use it in your components.",preview:[o({class:"flex gap-2 flex-wrap"},[A({content:"This is a tooltip."},[n("Hover me")])])],code:`import {  Button  } from "@base-framework/ui/atoms";
import {  Tooltip  } from "@base-framework/ui/atoms";

Tooltip({ content: 'This is a tooltip.' }, [
    Button('Hover me')
])`}),t({title:"Bottom Tooltip",description:"This will show the tooltip at the bottom of the target element.",preview:[o({class:"flex gap-2 flex-wrap"},[A({content:"This is a tooltip.",position:"bottom"},[n("Hover me")])])],code:`Tooltip({ content: 'This is a tooltip.', position: 'bottom' }, [
    Button('Hover me')
])`}),t({title:"Top-Right Tooltip",description:"This will show the tooltip at the top-right of the target element.",preview:[o({class:"flex gap-2 flex-wrap"},[A({content:"This is a tooltip.",position:"top-right"},[n("Hover me")])])],code:`Tooltip({ content: 'This is a tooltip.', position: 'top-right' }, [
    Button('Hover me')
])`}),t({title:"Top-Left Tooltip",description:"This will show the tooltip at the top-left of the target element.",preview:[o({class:"flex gap-2 flex-wrap"},[A({content:"This is a tooltip.",position:"top-left"},[n("Hover me")])])],code:`Tooltip({ content: 'This is a tooltip.', position: 'top-left' }, [
    Button('Hover me')
])`}),t({title:"Bottom-Right Tooltip",description:"This will show the tooltip at the bottom-right of the target element.",preview:[o({class:"flex gap-2 flex-wrap"},[A({content:"This is a tooltip.",position:"bottom-right"},[n("Hover me")])])],code:`Tooltip({ content: 'This is a tooltip.', position: 'bottom-right' }, [
    Button('Hover me')
])`}),t({title:"Bottom-Left Tooltip",description:"This will show the tooltip at the bottom-left of the target element.",preview:[o({class:"flex gap-2 flex-wrap"},[A({content:"This is a tooltip.",position:"bottom-left"},[n("Hover me")])])],code:`Tooltip({ content: 'This is a tooltip.', position: 'bottom-left' }, [
    Button('Hover me')
])`}),t({title:"Left Tooltip",description:"This will show the tooltip to the left of the target element.",preview:[o({class:"flex gap-2 flex-wrap"},[A({content:"This is a tooltip.",position:"left"},[n("Hover me")])])],code:`Tooltip({ content: 'This is a tooltip.', position: 'left' }, [
    Button('Hover me')
])`}),t({title:"Right Tooltip",description:"This will show the tooltip to the right of the target element.",preview:[o({class:"flex gap-2 flex-wrap"},[A({content:"This is a tooltip.",position:"right"},[n("Hover me")])])],code:`Tooltip({ content: 'This is a tooltip.', position: 'right' }, [
    Button('Hover me')
])`}),i({class:"text-muted-foreground text-sm mt-4"},"The tooltip position can be set to: top, top-right, top-left, bottom, bottom-right, bottom-left, left, right.")]),L=x((e,a)=>fe({...e,class:`flex p-4 max-h-[650px] max-w-[1024px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces break-all cursor-pointer mt-4 ${e.class}`},[he({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(a[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:Icons.clipboard.checked})}},a)])),Uo=()=>f({title:"Get Started",description:"This page will help you get started with the App Shell project."},[m({class:"space-y-4"},[c({class:"text-lg font-bold"},"About the Project"),i({class:"text-muted-foreground"},"This project is a PWA (Progressive Web App) that serves as a foundational framework for building web applications. It is designed to be modular, scalable, and easy to use, making it an ideal starting point for new projects.")]),m({class:"space-y-4 mt-12"},[c({class:"text-lg font-bold"},"Theme Setup"),i({class:"text-muted-foreground"},{html:'This project uses Tailwind and supported light and dark themes. The theme can be modified to fit the application style by changing a few fils in the project with the desired light and dark theme colors. The <a href="/docs/theme" class="underline">"Theme"</a> page outlines the types of properties that are themeable and how they are applied. '}),L(`
/**
 * /src/css/base.css
 */
@layer base {
	...
	@media (prefers-color-scheme: dark) {
		:root:not(.light) {
            ...
            ...
                ...
                `),c({class:"text-lg font-bold"},"Index Meta Tags"),i({class:"text-muted-foreground"},{html:"The theme colors should also be added to the index.html meta tags. The other meta tags like description and title can also be edited. "}),L(`
<meta name="theme-color" content="#09090b">
<meta name="msapplication-TileColor" content="#09090b">
                `),c({class:"text-lg font-bold"},"Manifest Colors and Settings"),i({class:"text-muted-foreground"},{html:`All PWA's need to have a manifiest that outlines the app settings. Edit the app theme and settings in the "public/manifest.json" file. `}),L(`
{
	...
	"background_color": "#09090b"
                ...
                `),c({class:"text-lg font-bold"},"Images and Icons"),i({class:"text-muted-foreground"},{html:'The app will need to have at least two homescreen icons (192px and 512px) and one "badge" (Mobile status bar icon for push notifications) in the "/public/images/icons" folder. '}),L(`
{
	"short_name": "Base Example",
	"name": "Base Example",
	"icons": [
	...
	"background_color": "#09090b"
                ...
                `)]),m({class:"space-y-4 mt-12"},[c({class:"text-lg font-bold mt-12"},"Authentication"),i({class:"text-muted-foreground"},'The shell supports auth flows and has a "signed in" and signed out" mode. The "src/shell" folder has a login page that can be edited to fit the application needs. The "src/shell" also has a "models" folder with a "UserData" that can be updated to add specific methods and properties for the application needs.')]),m({class:"space-y-4 mt-12"},[c({class:"text-lg font-bold"},"Development Guidelines"),i({class:"text-muted-foreground"},[r(`Modules are an essential part of the App Shell's extensibility. You can add new features by creating modules in the modules folder and registering them in the "src/modules/imported-modules.js" file. `),r("This structure supports modularity, making it easier to maintain and scale projects.")]),L(`/**
...
});`)]),m({class:"space-y-4 mt-12"},[c({class:"text-lg font-bold"},"Contributors and Community"),i({class:"text-muted-foreground"},[r("The App Shell is an open-source project, and contributions from the community are welcome. The project is maintained by a dedicated developer who aims to continuously enhance its functionality.")]),i({class:"text-muted-foreground"},[r("For information on contributing, check the "),T({href:"https://github.com/chrisdurfee/next-app-shell",class:"underline",target:"_blank"},"GitHub repository"),r(" and join the community discussions to collaborate and innovate.")])])]),pe=(e,a,l)=>(l="Icons"+(l?"."+l:""),o({class:"flex flex-auto flex-col items-center gap-2 w-full max-w-[150px] h-[8.5rem] cursor-pointer"},[o({class:"flex flex-auto w-full h-full justify-center items-center flex-wrap rounded-lg border bg-card text-base shadow-sm hover:bg-muted/50",click:()=>{navigator.clipboard.writeText(`${l}.${a}`),app.notify({title:"Icon copied",description:`The icon '${l}.${a}' has been copied to your clipboard.`,icon:s.clipboard.checked})}},[w(e)]),o({class:"text-muted-foreground"},a)])),Me=(e,a,l)=>{const u=typeof e=="object";u&&a.push(i({class:"text-muted-foreground"},"path: "+l+".{icon}"));const g=[];if(a.push(o({class:"flex flex-auto flex-wrap gap-2 my-8"},g)),u===!1)g.push(pe(e,l));else for(var N in e){if(e.hasOwnProperty(N)===!1)continue;const Y=e[N];if(typeof Y!="object"){g.push(pe(Y,N,l));continue}const Le=`${l}.${N}`;Me(Y,a,Le)}},qo=e=>{if(!e||typeof e!="object")return;const a=[];for(let[l,u]of Object.entries(e)){if(l==="parse")continue;a.push(ae({id:l.toLowerCase(),class:"text-2xl font-bold"},Ct.titleCase(l))),Me(u,a,l)}return a},Oo=()=>f({title:"Icons",description:"The icons are from the Hericon library. They are SVG icons that can be used in your project. This icon set uses the outline style."},[T({href:"https://heroicons.com/",target:"_blank",class:"bttn link"},"link: Hericons"),t({title:"Icons",description:"This is an icon.",preview:[It({html:s.home})],code:`
import {  Icons  } from "@base-framework/ui/icons";
...
Span('3X Large (16x16)')`}),o({class:"my-20"},[se({class:"text-2xl font-bold"},"Default Icons"),i({class:"text-muted-foreground"},'A few of the icons have been saved to the "Icons" object. You can use these icons in your project. Click to copy the Icon path. Here is a list of the icons that are available:')]),qo(s)]),Wo=()=>f({title:"Introduction",description:"The App Shell project is an open-source versatile and modular platform, designed to speed up front-end application development using Tailwind CSS and Shadcn-inspired themes. It provides a comprehensive set of components and atoms created with the Base framework."},[m({class:"space-y-4"},[c({class:"text-lg font-bold"},"The App Shell"),i({class:"text-muted-foreground"},'The App Shell is the core that sets up the Configs, router, Service Worker, ENV, global "app" variable, and renders the "shell" that is used to add the additional pages.'),i({class:"text-muted-foreground"},"As a modular and scalable PWA (Progressive Web App), it offers easy installation across devices, making it suitable as a foundational framework for new projects. The project comes with PWA installation prompts for all devices."),i({class:"text-muted-foreground"},"Designed with accessibility, customization, and ease of use in mind, the App Shell accelerates setup, allowing developers to focus on creating functionality without reinventing the wheel.")]),m({class:"space-y-4 mt-12"},[c({class:"text-lg font-bold"},"Base UI"),i({class:"text-muted-foreground"},{html:'The <a class="underline" href="https://github.com/chrisdurfee/ui" target="_blank">@base-framework/ui</a> npm package is a collection of atoms and components that are designed to be used by the app shell. This package has atoms, molecules, organisms, icons, templates, and pages. This package is open source and can be used by any project.'})]),m({class:"space-y-4 mt-12"},[c({class:"text-lg font-bold mt-12"},"Authentication"),i('The shell supports auth flows and has a "signed in" and signed out" mode. It has a few default page types including a login page. The implentation of the auth flow is up to the developer.')]),m({class:"space-y-4 mt-12"},[c({class:"text-lg font-bold mt-12"},"Examples"),i({class:"text-muted-foreground"},"The following examples demonstrate the use of various components and atoms within the App Shell framework that are designs from Shadcn.")]),o({class:"items-start justify-center gap-6 rounded-lg pt-0 md:p-8 md:mt-6 md:grid lg:grid-cols-2 xl:grid-cols-2"},[o({class:"col-span-2 grid items-start gap-6 lg:col-span-1"},[Se(),De(),Ie()]),o({class:"col-span-2 grid items-start gap-6 lg:col-span-1"},[je({members:[{name:"Leslie Alexander",email:"leslie.alexander@example.com",image:"https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80",role:"owner",lastSeen:"2023-01-23T13:23Z",status:"offline"},{name:"Michael Foster",email:"michael.foster@example.com",image:"https://images.unsplash.com/photo-1519244703995-f4e0f30006d5?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80",role:"member",lastSeen:"2023-01-23T13:23Z",status:"offline"},{name:"Dries Vincent",email:"dries.vincent@example.com",image:"https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80",role:"owner",status:"online"}]}),Be({link:"http://example.com/link/to/document",people:[{name:"Leslie Alexander",email:"leslie.alexander@example.com",image:"https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80",role:"owner",lastSeen:"2023-01-23T13:23Z",status:"offline"},{name:"Michael Foster",email:"michael.foster@example.com",image:"https://images.unsplash.com/photo-1519244703995-f4e0f30006d5?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80",role:"member",lastSeen:"2023-01-23T13:23Z",status:"offline"},{name:"Dries Vincent",email:"dries.vincent@example.com",image:"https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80",role:"owner",status:"online"}]}),Ce({startDate:"2023-01-23"}),Ae()])]),m({class:"space-y-4 mt-12"},[c({class:"text-lg font-bold"},"Theme and Styling"),i({class:"text-muted-foreground"},[r("This project is powered by Tailwind CSS, providing a highly customizable, utility-first approach to styling. Additionally, the theme draws inspiration from "),T({href:"https://github.com/shadcn",class:"underline",target:"_blank"},"Shadcn’s UI component library"),r(", combining best practices for consistency and flexibility.")])]),m({class:"space-y-4 mt-12"},[c({class:"text-lg font-bold"},"Icons"),i({class:"text-muted-foreground"},[r("This project utilizes Heroicons, a comprehensive icon set provided by the Tailwind Labs team. These icons are fully customizable and designed to fit seamlessly within Tailwind-based applications.")]),i({class:"text-muted-foreground"},[r("For more details on available icons, visit the "),T({href:"https://heroicons.com",class:"underline",target:"_blank"},"Heroicons website"),r(".")])]),m({class:"space-y-4 mt-12"},[c({class:"text-lg font-bold"},"Components and Atoms"),i({class:"text-muted-foreground"},[r("Leveraging the Base framework, this project provides a comprehensive set of reusable components and atoms. Inspired by projects like "),T({href:"https://github.com/shadcn/ui",class:"underline",target:"_blank"},"shadcn/ui"),r(", the components are crafted to balance flexibility and simplicity, allowing developers to integrate pre-designed elements or customize them as needed.")]),i({class:"text-muted-foreground"},[r("You can explore components like "),T({href:"/docs/components/buttons",class:"underline"},"Buttons"),r(", "),T({href:"/docs/components/tabs",class:"underline"},"Tabs"),r(", and "),T({href:"/docs/components/forms",class:"underline"},"Forms"),r(" to quickly build complex UIs without starting from scratch.")])]),m({class:"space-y-4 mt-12"},[c({class:"text-lg font-bold"},"Development Guidelines"),i({class:"text-muted-foreground"},[r("Modules are an essential part of the App Shell's extensibility. You can add new features by creating modules in the modules folder and registering them in the "),T({href:"/docs/imported-modules",class:"underline"},"imported-modules.js"),r(" file. This structure supports modularity, making it easier to maintain and scale projects.")]),i({class:"text-muted-foreground"},[r("Each module includes its own routes, links, and options, as demonstrated in the example provided. This architecture ensures that modules are self-contained and can be easily integrated into any project using the App Shell framework.")]),v(`import {  Icons  } from "@base-framework/ui/icons";
import { Module } from '../module/module.js';
...
});`)]),m({class:"space-y-4 mt-12"},[c({class:"text-lg font-bold"},"Contributors and Community"),i({class:"text-muted-foreground"},[r("The App Shell is an open-source project, and contributions from the community are welcome. The project is maintained by a dedicated developer who aims to continuously enhance its functionality.")]),i({class:"text-muted-foreground"},[r("For information on contributing, check the "),T({href:"https://github.com/chrisdurfee/next-app-shell",class:"underline",target:"_blank"},"GitHub repository"),r(" and join the community discussions to collaborate and innovate.")])])]),Go=e=>o({class:"flex flex-auto flex-col items-center gap-2 max-w-[150px] h-[8.5rem] cursor-pointer"},[o({class:`flex flex-auto w-full h-full min-h-[136px] justify-center items-center flex-wrap rounded-lg border text-base shadow-sm ${e.class}`,click:()=>{navigator.clipboard.writeText(`${e.class}`),app.notify({title:"Color copied",description:`The color '${e.class}' has been copied to your clipboard.`,icon:s.clipboard.checked})}}),o({class:"text-sm text-muted-foreground"},e.var)]),y=(e,a)=>m({class:"flex flex-auto flex-col gap-2"},[i({class:"text-base text-muted-foreground"},e),o({class:"flex flex-auto flex-wrap gap-2 my-2",map:[a,Go]})]),_o=e=>o({class:"flex flex-auto flex-col gap-12"},[ae({class:"text-2xl font-bold"},"Theme Toggle"),new Dt,ae({class:"text-2xl font-bold"},"Color Guide"),y("Default background color of <body />...etc",[{var:"--backround",class:"bg-backround"},{var:"--foreground",class:"bg-foreground"}]),y("Muted backgrounds such as <TabsList />, <Skeleton /> and <Switch />",[{var:"--muted",class:"bg-muted"},{var:"--muted-foreground",class:"bg-muted-forground"}]),y("Background color for <Card />",[{var:"--card",class:"bg-card"},{var:"--card-foreground",class:"bg-card-foreground"}]),y("Background color for popovers such as <DropdownMenu />, <HoverCard />, <Popover />",[{var:"--popover",class:"bg-popover"},{var:"--popover-foreground",class:"bg-popover-foreground"}]),y("Default border color",[{var:"--border",class:"bg-border"}]),y("Border color for inputs such as <Input />, <Select />, <Textarea />",[{var:"--input",class:"bg-input"}]),y("Primary colors for <Button />",[{var:"--primary",class:"bg-primary"},{var:"--primary-foreground",class:"bg-primary-foreground"}]),y("Secondary colors for <Button />",[{var:"--secondary",class:"bg-secondary"},{var:"--secondary-foreground",class:"bg-secondary-foreground"}]),y("Used for accents such as hover effects on <DropdownMenuItem>, <SelectItem>...etc",[{var:"--accent",class:"bg-accent"},{var:"--accent-foreground",class:"bg-accent-foreground"}]),y('Used for destructive actions such as <Button variant="destructive">',[{var:"--destructive",class:"bg-destructive"},{var:"--destructive-foreground",class:"bg-destructive-foreground"}]),y('Used for warning actions such as <Button variant="warning">',[{var:"--warning",class:"bg-warning"},{var:"--warning-foreground",class:"bg-warning-foreground"}]),y("Used for focus ring",[{var:"--ring",class:"bg-ring"}]),y("Border radius for card, input and buttons",[{var:"--radius",class:"bg-radius"}])]),Yo=()=>f({title:"Theme",description:"The theme is using Tailwind CSS and is based on Shadcn UI. The theme is customizable and can be extended. It comes with light and dark theme support."},[i({class:"text-muted-foreground"},{html:'To learn about Shandcn UI, visit the official documentation: <a href="https://ui.shadcn.com/docs/theming" class="underline" target="_blank">Shadcn Documentation'}),o({class:"my-20"},[se({class:"text-2xl font-bold"},"Default Styles"),i({class:"text-muted-foreground"},"The default styles are defined in the Tailwind CSS configuration file and in the base CSS file. Here's the list of variables available for customization:")]),_o(),o({class:"flex flex-auto flex-col gap-2 mt-20"},[o({class:"flex flex-auto flex-col gap-2"},[c({class:"text-2xl font-bold"},"Text Sizes"),i({class:"text-muted-foreground text-3xl"},"Text-3xl A test sentence."),i({class:"text-muted-foreground text-2xl"},"Text-2xl A test sentence."),i({class:"text-muted-foreground text-xl"},"Text-xl A test sentence."),i({class:"text-muted-foreground text-lg"},"Text-lg A test sentence."),i({class:"text-muted-foreground text-base"},"Text-base A test sentence."),i({class:"text-muted-foreground text-sm"},"Text-sm A test sentence."),i({class:"text-muted-foreground text-xs"},"Text-xs A test sentence.")])])]),p=(e,a,l)=>({uri:e,title:a,component:l}),Jo=e=>[p(`${e}`,"Introduction",Wo),p(`${e}/get-started`,"Get Started",Uo),p(`${e}/theme`,"Theme",Yo),p(`${e}/icons`,"Icons",Oo),p(`${e}/components/buttons*`,"Buttons",Ht),p(`${e}/components/badges*`,"Badges",Et),p(`${e}/components/tabs*`,"Tabs",Ho),p(`${e}/components/modals*`,"Modals",Lo),p(`${e}/components/notifications*`,"Notifications",$o),p(`${e}/components/dialogs*`,"Modals",wo),p(`${e}/components/cards*`,"Cards",so),p(`${e}/components/calendars*`,"Calendars",Ut),p(`${e}/components/avatars*`,"Avatars",$t),p(`${e}/components/inputs*`,"Inputs",Ao),p(`${e}/components/forms*`,"Forms",Io),p(`${e}/components/alerts*`,"Alerts",Ft),p(`${e}/components/comboboxes*`,"Comboboxes",ro),p(`${e}/components/lists*`,"Lists",Bo),p(`${e}/components/data-tables*`,"Data Tables",uo),p(`${e}/components/breadcrumbs*`,"Breadcrumbs",Nt),p(`${e}/components/navigations*`,"Navigations",Fo),p(`${e}/components/progress-bars*`,"Progress Bars",Eo),p(`${e}/components/skeletons*`,"Skeletons",No),p(`${e}/components/tooltips*`,"Tooltips",zo),p(`${e}/components/dropdown-menus*`,"Dropdown Menus",xo)],Vo=e=>[{href:`${e}`,label:"Introduction",exact:!0},{href:`${e}/get-started`,label:"Get Started"},{href:`${e}/theme`,label:"Theme",exact:!0},{href:`${e}/icons`,label:"Icons"},{group:"Components",options:[{label:"Buttons",href:`${e}/components/buttons`},{label:"Badges",href:`${e}/components/badges`},{label:"Tabs",href:`${e}/components/tabs`},{label:"Modals",href:`${e}/components/modals`},{label:"Notifications",href:`${e}/components/notifications`},{label:"Dialogs",href:`${e}/components/dialogs`},{label:"Cards",href:`${e}/components/cards`},{label:"Calendars",href:`${e}/components/calendars`},{label:"Avatars",href:`${e}/components/avatars`},{label:"Inputs",href:`${e}/components/inputs`},{label:"Forms",href:`${e}/components/forms`},{label:"Alerts",href:`${e}/components/alerts`},{label:"Comboboxes",href:`${e}/components/comboboxes`},{label:"Lists",href:`${e}/components/lists`},{label:"Data Tables",href:`${e}/components/data-tables`},{label:"Breadcrumbs",href:`${e}/components/breadcrumbs`},{label:"Navigations",href:`${e}/components/navigations`},{label:"Progress Bars",href:`${e}/components/progress-bars`},{label:"Skeletons",href:`${e}/components/skeletons`},{label:"Tooltips",href:`${e}/components/tooltips`},{label:"Dropdown Menus",href:`${e}/components/dropdown-menus`}]}],Z="docs",Qo=()=>new At({title:"Documentation",basePath:Z,switch:Jo(Z),links:Vo(Z)});export{Qo as DocumentationPage,Qo as default};
