import{A as Re}from"./aside-page-CunaKvFn.js";import{w as N,m as o,R as k,q as we,D as _,H as G,e as z,Q as f,r as qe,s as He,a as n,U as B,c as ie,S as c,t as We,i as Ue,C as ve,A as M,u as w,y as i,_ as P,f as V,T as y,B as r,F as Q,v as _e,x as Ge,z as me,h as oe,E as I,I as h,J as E,K as le,l as T,M as $,L as v,N as J,W as re,G as Ve,X as O,Y as Qe,Z as ye,$ as ke,a0 as Te,a1 as ae,a2 as se,a3 as Je,a4 as Z,a5 as Ye,a6 as Ke,a7 as Ze,a8 as Xe,a9 as et,aa as tt,ab as ot,ac as at,ad as st,ae as nt,af as it,ag as lt,ah as F,b as C,j as Se,P as U,ai as ne,aj as rt,O as ct,o as dt}from"./index-Df_NBokq.js";import{F as D,a as u,T as Y,S}from"./toggle-GZW_dkAt.js";import{C as ce}from"./checkbox-C4m5L8lr.js";import{D as mt,U as ut}from"./data-table-Dde_35FA.js";import{S as pt}from"./sidebar-menu-Dj-qK2Rv.js";import{T as ft}from"./tab-group-CsVUR89b.js";import{T as A}from"./tooltip-Cn4A3xxH.js";const gt=e=>G({class:"inline-flex flex-auto items-center justify-center whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm",dataSet:["selected",["state",e.value,"active"]]},[z({class:"flex flex-auto justify-center items-center px-3 py-1.5",onSet:["selected",{selected:e.value}],click:t=>e.callBack(e.value)},e.label)]),ht=(e,t)=>(e.callBack=t,gt(e)),bt=e=>we({class:`tab items-center justify-center rounded-md bg-muted p-1 text-muted-foreground ${e.class}`},[_({class:"flex flex-auto flex-row",map:[e.options,t=>ht(t,e.callBack)]})]);class Ce extends N{render(){const t=this.select.bind(this);return o({class:""},[bt({class:this.class,options:this.options,callBack:t}),k({class:"tab-content",onState:["selected",this.updateContent.bind(this)]})])}getFirstValue(){var t;return(t=this.options[0])==null?void 0:t.value}update(){const t=this.state.get("selected");this.select(null),this.select(t)}select(t){this.state.selected=t}updateContent(t){const s=this.options;if(!s||s.length<1)return;const l=s[0];for(const d of s)if(d.value===t)return d.layout;return l.layout}setupStates(){const t=this.callBack,s=typeof t;return{selected:{state:this.getFirstValue(),callBack(l){s==="function"&&t(l)}}}}}const Ie=f((e,t)=>qe({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces break-all cursor-pointer"},[He({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(t[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:n.clipboard.checked})}},t)])),xt=f((e,t)=>o({class:"flex flex-auto p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-card"},[o({class:"preview flex flex-auto justify-center items-center"},t)])),ue=f((e,t)=>o({class:"py-4"},t)),wt=e=>new Ce({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:ue([xt(e.preview)])},{label:"Code",value:"code",layout:ue([Ie(e.code)])}]}),vt=f(({title:e,description:t})=>B({class:"flex flex-col"},[ie({class:"scroll-m-20 text-2xl font-bold tracking-tight"},e),t&&c({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),a=f((e,t)=>k({class:"grid py-4"},[vt({title:e.title,description:e.description}),wt({preview:e.preview,code:e.code})]));class yt extends We{render(){return Ue([o({class:"contained px-4 flex flex-auto flex-col"},this.children)])}}const kt=f(({title:e,description:t})=>B({class:"flex flex-col"},[ve({class:"scroll-m-20 text-3xl font-bold tracking-tight"},e),c({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),Tt=f((e,t)=>o({class:"contained py-8"},[kt(e),k({class:"pb-12 pt-8"},t)])),p=f((e,t)=>new yt([Tt(e,t)])),St=()=>p({title:"Alerts",description:"Alerts are used to provide feedback to the user about the outcome of an action or to inform them of important information."},[a({title:"Default Alert",description:"This is a standard alert without any specific type.",preview:[M({title:"Notice",description:"This is a default alert without a specific type.",icon:n.information})],code:`import { Alert } from "@components/molecules/alert.js";
...
])`})]),pe={gray:{backgroundColor:"bg-gray-50",textColor:"text-gray-600",ringColor:"ring-gray-500/10"},red:{backgroundColor:"bg-red-50",textColor:"text-red-700",ringColor:"ring-red-600/10"},yellow:{backgroundColor:"bg-yellow-50",textColor:"text-yellow-800",ringColor:"ring-yellow-600/20"},green:{backgroundColor:"bg-green-50",textColor:"text-green-700",ringColor:"ring-green-600/20"},blue:{backgroundColor:"bg-blue-50",textColor:"text-blue-700",ringColor:"ring-blue-700/10"},indigo:{backgroundColor:"bg-indigo-50",textColor:"text-indigo-700",ringColor:"ring-indigo-700/10"},purple:{backgroundColor:"bg-purple-50",textColor:"text-purple-700",ringColor:"ring-purple-700/10"},pink:{backgroundColor:"bg-pink-50",textColor:"text-pink-700",ringColor:"ring-pink-700/10"},primary:{backgroundColor:"bg-primary",textColor:"text-primary-foreground",ringColor:"ring-primary/10"},secondary:{backgroundColor:"bg-secondary",textColor:"text-secondary-foreground",ringColor:"ring-secondary/10"},destructive:{backgroundColor:"bg-destructive",textColor:"text-destructive-foreground",ringColor:"ring-destructive/10"},warning:{backgroundColor:"bg-warning",textColor:"text-warning-foreground",ringColor:"ring-warning/10"},outline:{backgroundColor:"bg-background",textColor:"text-primary",ringColor:"ring-input"},ghost:{backgroundColor:"bg-background",textColor:"text-primary",ringColor:"ring-background"},link:{backgroundColor:"bg-background",textColor:"text-primary",ringColor:"ring-background"}},It=e=>pe[e]||pe.gray,jt=e=>{const{backgroundColor:t,textColor:s,ringColor:l}=It(e);return`inline-flex items-center rounded-full border px-2.5 py-0.5 text-xs font-semibold transition-colors ${t} ${s} ${l}`},b=f((e,t)=>{const s=jt(e==null?void 0:e.type);return i({...e,class:s},t)}),At=()=>p({title:"Badges",description:"Badges can be used to display a status or a count."},[a({title:"Badge",description:"This is a badge.",preview:[o({class:"flex gap-2 flex-wrap"},[b({type:"gray"},"Text"),b({type:"red"},"Text"),b({type:"yellow"},"Text"),b({type:"green"},"Text"),b({type:"blue"},"Text"),b({type:"indigo"},"Text"),b({type:"purple"},"Text"),b({type:"pink"},"Text"),b({type:"primary"},"Text"),b({type:"secondary"},"Text"),b({type:"destructive"},"Text"),b({type:"warning"},"Text"),b({type:"outline"},"Text"),b({type:"ghost"},"Text"),b({type:"link"},"Text")])],code:`
import { Button } from '@components/atoms/badges/badges.js';
import { Atom } from '@base-framework/base';

export const PrimaryBadge = Atom((props, children)) => (
    Badge({ ...props, type: 'gray' }, children)
);`})]),Dt=(e,t)=>y({href:e,"aria-current":t==="Breadcrumb"?"page":null,class:"text-muted-foreground hover:text-foreground"},[i(t)]),Bt=()=>i({class:"mx-2 text-muted-foreground","aria-hidden":!0,html:">"}),Lt=e=>o({class:"flex items-center"},[e.href?Dt(e.href,e.label):i(e.label),e.separator&&Bt()]),Pt=P({setData(){return new V({items:this.items||[]})},render(){return we({"aria-label":"Breadcrumb",class:"flex items-center space-x-1 text-sm"},[o({role:"list",class:"flex items-center",for:["items",(e,t)=>Lt({href:e.href,label:e.label,separator:t<this.data.items.length-1})]})])}}),Mt=[{href:"/",label:"Home"},{href:"/components",label:"Components"},{label:"Breadcrumb"}],Ft=()=>p({title:"Breadcrumbs",description:"Breadcrumbs are a navigation aid that helps users understand their location within a website or application."},[a({title:"Usage",description:"To use the Breadcrumb component, import it and provide an array of items. Each item can have a label and an optional href.",preview:[new Pt({items:Mt})],code:`import { Breadcrumb } from "@components/molecules/breadcrumb/breadcrumb.js";
...
LoadingButton('With Icon')`})]),$t=()=>oe.formatTime("",24),Nt=()=>p({title:"Calendars",description:"This is the calendar component documentation."},[a({title:"Usage",description:"This is how you can use the calendar component.",preview:[new Ge],code:`@components/organisms/calendar/calendar.js';

new Calendar()`}),a({title:"Dynamic Time",description:"This is how you can use the calendar component.",preview:[new me({filter:()=>{let e="Morning";const t=$t();return t>="18:00:00"?e="Evening":t>="12:00:00"&&(e="Afternoon"),`Good ${e}`}})],code:`import { DateTime } from "@base-framework/base";
...
})`})]),L=({title:e,description:t})=>B({class:"text-left"},[Q({class:"font-semibold tracking-tight text-2xl"},e),c({class:"text-sm text-muted-foreground"},t)]),zt=()=>o({class:"flex items-center justify-center gap-4"},[r({variant:"outline",class:"gap-2 w-full",click:()=>console.log("Sign in with Github"),"aria-label":"Sign in with Github"},[h(n.companies.gitHub),i("Github")]),r({variant:"outline",class:"gap-2 w-full",click:()=>console.log("Sign in with Google"),"aria-label":"Sign in with Google"},[h(n.companies.google),i("Google")])]),Ot=()=>D({submit:e=>{e.preventDefault(),console.log("Account created")}},[new u({name:"email",label:"Email"},[E({type:"email",placeholder:"m@example.com",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),new u({name:"password",label:"Password"},[E({type:"password",placeholder:"Your password",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),r({type:"submit",class:"w-full mt-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition"},"Create account")]),je=()=>I({class:"w-full max-w-md mx-auto p-8 bg-card space-y-6"},[L({title:"Create an account",description:"Enter your email below to create your account"}),zt(),o({class:"relative"},[o({class:"absolute inset-0 flex items-center"},[i({class:"flex-grow border-t"})]),o({class:"relative flex justify-center text-xs uppercase"},[i({class:"bg-background px-2 text-muted-foreground"},"or continue with")])]),Ot()]),X=({title:e,description:t,defaultState:s,onChange:l})=>o({class:"flex items-start justify-between gap-2"},[o({class:"text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex flex-col space-y-1"},[i({class:"font-medium text-foreground"},e),i({class:"font-normal leading-snug text-muted-foreground"},t)]),new Y({active:s,change:l})]),Ae=()=>I({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[L({title:"Cookie Settings",description:"Manage your cookie settings here."}),o({class:"pt-0 grid gap-6"},[X({title:"Strictly Necessary",description:"These cookies are essential in order to use the website and use its features.",defaultState:!0,onChange:e=>console.log("Strictly Necessary:",e)}),X({title:"Functional Cookies",description:"These cookies allow the website to provide personalized functionality.",defaultState:!1,onChange:e=>console.log("Functional Cookies:",e)}),X({title:"Performance Cookies",description:"These cookies help to improve the performance of the website.",defaultState:!1,onChange:e=>console.log("Performance Cookies:",e)})]),r({variant:"outline",class:"w-full",click:()=>console.log("Preferences saved")},"Save preferences")]),De=({startDate:e})=>I({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[L({title:"Pick a Date",description:"When is the event?"}),o({class:"font-medium text-foreground"},[new le({selectedDate:e,selectedCallBack:t=>console.log(t)})])]),ee=f(({value:e,label:t,icon:s})=>z({class:'text-sm gap-1 font-medium leading-none disabled:cursor-not-allowed disabled:opacity-70 flex flex-col items-center justify-between rounded-md border-2 border-muted bg-popover p-4 hover:bg-accent hover:text-accent-foreground data-[state="active"]:border-primary [&:has([data-state="active"])]:border-primary',onState:["method",{active:e}],dataSet:["method",["state",e,"active"]],click:(l,{state:d})=>d.method=e},[h(s),i(t)])),Rt=P({render(){return o({class:"flex flex-auto flex-col"},[o({class:"grid grid-cols-3 gap-4"},[ee({label:"Card",value:"card",icon:n.creditCard}),ee({label:"Paypal",value:"paypal",icon:n.companies.paypal}),ee({label:"Apple",value:"apple",icon:n.companies.apple})])])},state(){return{method:null}}}),qt=()=>o({class:"flex items-center justify-center gap-4"},[new Rt]),Ht=()=>D({submit:e=>{e.preventDefault(),console.log("Payment method added")}},[new u({name:"name",label:"Name"},[T({type:"text",placeholder:"First Last",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),new u({name:"card_number",label:"Card number"},[T({type:"text",placeholder:"1234 5678 9012 3456",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),o({class:"flex gap-4 mt-4"},[new u({name:"month",label:"Expires"},[S({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"",label:"Month",disabled:!0},...Array.from({length:12},(e,t)=>({value:`${t+1}`,label:`${t+1}`.padStart(2,"0")}))]})]),new u({name:"year",label:"Year"},[S({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"",label:"Year",disabled:!0},...Array.from({length:10},(e,t)=>({value:`${new Date().getFullYear()+t}`,label:`${new Date().getFullYear()+t}`}))]})]),new u({name:"cvc",label:"CVC"},[T({type:"text",placeholder:"CVC",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})])]),r({type:"submit",class:"w-full mt-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition"},"Continue")]),Be=()=>I({class:"w-full max-w-md mx-auto p-8 bg-card space-y-6"},[L({title:"Payment Method",description:"Add a new payment method to your account."}),qt(),o({class:"space-y-4"},[Ht()])]),Wt=({name:e,description:t,stars:s,language:l,lastUpdated:d})=>o({class:"flex items-start justify-between py-4 border-b border-muted last:border-b-0"},[o({class:"flex flex-col"},[i({class:"font-semibold text-foreground"},e),i({class:"text-sm text-muted-foreground"},t),o({class:"flex space-x-4 text-sm text-muted-foreground mt-3"},[o({class:"flex items-center gap-2"},[h({class:" text-blue-500"},n.document.text),i(` ${l}`)]),o({class:"flex items-center"},[h(n.star),i(` ${s}`)]),o(`Updated ${d}`)])]),r({variant:"secondary",class:"px-3 py-1 gap-1 flex items-center rounded-md",click:()=>console.log(`Starred ${e}`)},[h(n.star),i("Star")])]),Ut=({projects:e})=>o({class:"space-y-3"},e.map(t=>Wt(t))),_t=[{name:"shadcn/ui",description:"Beautifully designed components that you can copy and paste into your apps. Accessible. Customizable. Open Source.",stars:"20k",language:"TypeScript",lastUpdated:"April 2023"},{name:"base-framework",description:"A robust framework for building and structuring large-scale applications with ease.",stars:"2",language:"JavaScript",lastUpdated:"June 2024"}],Gt=()=>I({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[o({class:"font-semibold text-lg text-foreground"},"Projects"),Ut({projects:_t})]),Vt=()=>D({submit:e=>{e.preventDefault(),console.log("Issue reported")}},[o({class:"flex flex-auto w-full gap-4"},[new u({name:"area",label:"Area"},[S({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"billing",label:"Billing"},{value:"technical",label:"Technical"},{value:"account",label:"Account"},{value:"other",label:"Other"}],defaultValue:"billing",change:e=>console.log(`Area selected: ${e.target.value}`)})]),new u({name:"security_level",label:"Security Level"},[S({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"severity_1",label:"Severity 1"},{value:"severity_2",label:"Severity 2"},{value:"severity_3",label:"Severity 3"}],defaultValue:"severity_2",change:e=>console.log(`Security Level selected: ${e.target.value}`)})])]),new u({name:"subject",label:"Subject"},[T({type:"text",placeholder:"I need help with...",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),new u({name:"description",label:"Description"},[$({placeholder:"Please include all information relevant to your issue.",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),o({class:"flex justify-end gap-4 mt-4"},[r({variant:"outline",class:"px-4 py-2",click:()=>console.log("Cancel clicked")},"Cancel"),r({type:"submit",class:"px-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition"},"Submit")])]),Le=()=>I({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[L({title:"Report an issue",description:"What area are you having problems with?"}),Vt()]),Qt=({link:e})=>o({class:"flex items-center gap-4 py-2"},[E({type:"text",value:e,readOnly:!0,class:"border p-2 rounded-md w-full bg-background text-foreground"}),r({variant:"secondary",class:"px-4 py-2",click:()=>{navigator.clipboard.writeText(e),app.notify({title:"Link copied",description:"The link has been copied to your clipboard.",icon:n.clipboard.checked})}},"Copy Link")]),Jt=({name:e,email:t,access:s,image:l})=>o({class:"flex items-center justify-between gap-4 py-2"},[o({class:"flex items-center gap-3"},[w({src:l,alt:e,fallbackText:e.split(" ").map(d=>d[0]).join("")}),o({},[i({class:"font-medium text-foreground"},e),i({class:"block text-sm text-muted-foreground"},t)])]),S({class:"border rounded-md bg-background text-foreground px-3 py-1",options:[{value:"edit",label:"Can edit"},{value:"view",label:"Can view"},{value:"comment",label:"Can comment"}],defaultValue:s,change:d=>console.log(`Access level changed for ${e}: ${d.target.value}`)})]),Yt=({people:e})=>o({class:"space-y-3"},e.map(t=>Jt(t))),Pe=({link:e,people:t})=>I({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[L({title:"Share this document",description:"Anyone with the link can view this document."}),Qt({link:e}),o({class:"border-t my-4"}),o({class:"font-medium text-foreground"},"People with access"),Yt({people:t})]),Kt=e=>e.split(" ").map(s=>s[0]).join(""),Zt=({name:e,email:t,role:s,image:l})=>o({class:"flex items-center justify-between gap-4 py-2"},[o({class:"flex items-center gap-3"},[w({src:l,alt:e,fallbackText:Kt(e)}),o({},[i({class:"font-medium text-foreground"},e),i({class:"block text-sm text-muted-foreground"},t)])]),S({class:"border rounded-md bg-background text-foreground px-3 py-1",options:[{value:"owner",label:"Owner"},{value:"member",label:"Member"}],defaultValue:s,change:d=>console.log(`Role changed for ${e}: ${d.target.value}`)})]),Xt=({members:e})=>o({class:"space-y-3"},e.map(t=>Zt(t))),Me=({members:e})=>I({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[L({title:"Team Member",description:"Invite your team members to collaborate."}),Xt({members:e})]),eo=()=>p({title:"Cards",description:"Cards are a great way to display content in a concise and organized manner."},[a({title:"Usage",description:"Import the card atom and use it in your components.",preview:[I()],code:`import { Button } from '@components/atoms/cards/card.js';
...
CookieSettingsCard()`})]),to=({toggleDropdown:e})=>z({cache:"button",class:"relative z-[2] inline-flex items-center gap-2 whitespace-nowrap rounded-md text-sm font-medium ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 border border-input bg-background hover:bg-accent hover:text-accent-foreground h-10 px-4 py-2 justify-between",click:e},[i({onState:["selectedLabel",t=>t||"Select item..."]}),J({html:n.chevron.upDown})]),oo=(e,t)=>G({class:"flex flex-auto items-center cursor-pointer p-2 hover:bg-secondary rounded-sm",click:()=>t(e),onState:["selectedValue",{"bg-secondary":e.value}]},[e.icon&&i({class:"mr-2 flex items-baseline"},[J({class:"flex w-4 h-4",html:e.icon})]),i(e.label)]),ao=e=>o({class:"w-full border rounded-md"},[_({class:"max-h-60 overflow-y-auto p-2 grid gap-1",for:["items",t=>oo(t,e)]})]),so=({onSelect:e})=>o({class:"flex flex-auto flex-col",onState:["open",(t,s,l)=>{if(t)return new re({cache:"dropdown",parent:l,button:l.button},[ao(e)])}]}),Fe=P({setData(){return new V({items:this.items||[]})},state:{open:!1,selectedLabel:"",selectedValue:""},handleSelect(e){const t=this.state;t.selectedValue=e.value,t.selectedLabel=e.label,t.open=!1,typeof this.onSelect=="function"&&this.onSelect(e)},toggleDropdown(){this.state.toggle("open")},render(){const e=t=>{const s=this.state;s.selectedValue=t.value,s.selectedLabel=t.label,s.open=!1};return o({class:"relative w-full flex flex-auto flex-col max-w-[250px]"},[to({toggleDropdown:this.toggleDropdown.bind(this)}),so({onSelect:e}),this.required&&E({class:"opacity-0 absolute top-0 left-0 z-[1]",type:"text",name:this.name,required:!0,value:["[[selectedValue]]",this.state]})])}}),no=[{value:"next.js",label:"Next.js",icon:n.home},{value:"sveltekit",label:"SvelteKit"},{value:"nuxt.js",label:"Nuxt.js"},{value:"remix",label:"Remix"},{value:"astro",label:"Astro"}],io=()=>p({title:"Comboboxes",description:"Comboboxes are used to allow users to select an option from a dropdown list or enter a custom value."},[a({title:"Usage",description:"To use the Combobox component, import it from the components library and use it in your application.",preview:[o({class:"w-full max-w-[300px]"},[new Fe({items:no,onSelect:e=>console.log(e)})])],code:`@components/molecules/combobox/combobox.js';
import { Icons } from "@components/icons/icons.js";
...
})`})]),lo=[{label:"checkbox",key:""},{label:"Status",key:"status"},{label:"Email",key:"email"},{label:"Amount",key:"amount",align:"justify-end"}],ro=[{id:1,status:"Success",email:"ken99@yahoo.com",amount:316,selected:!1},{id:2,status:"Success",email:"abe45@gmail.com",amount:242,selected:!1},{id:3,status:"Processing",email:"monserrat44@gmail.com",amount:837,selected:!1},{id:4,status:"Success",email:"silas22@gmail.com",amount:874,selected:!1},{id:5,status:"Failed",email:"carmella@hotmail.com",amount:721,selected:!1}],co=(e,t)=>Ve({class:"items-center px-4 py-2 hover:bg-muted"},[O({class:"p-4 "},[new ce({checked:e.selected,class:"mr-2",onChange:()=>t(e)})]),O({class:"p-4 "},[i({class:"text-muted-foreground"},e.status)]),O({class:"p-4 "},e.email),O({class:"p-4 text-right"},`$${e.amount.toFixed(2)}`)]),mo=()=>p({title:"Data Tables",description:"Data tables are used to display data in a structured format. They can be used to display a list of items, a grid of items, or a table of items."},[a({title:"Usage",description:"The data table component is used to display data in a structured format. It can be used to display a list of items, a grid of items, or a table of items.",preview:[new mt({headers:lo,rows:ro,rowItem:co,key:"id"})],code:`import { DataTable } from "@components/organisms/lists/data-table.js";
...
})`})]),uo=({title:e})=>B({class:"flex flex-auto items-center"},[Q({class:"text-lg font-semibold"},e)]),po=f((e,t)=>Qe({class:`fixed pullUpIn z-30 w-[98%] md:w-full max-w-lg border bg-popover text-foreground shadow-lg duration-200
                rounded-lg flex flex-auto flex-col
                bottom-4 top-auto md:m-auto md:bottom-auto md:top-1/2 md:left-0 md:right-0 md:-translate-y-1/2`,click:e.click,aria:{expanded:["open"]}},[o({class:"flex flex-auto flex-col gap-4 p-6 pb-12 md:pb-6"},[o({class:"flex flex-auto flex-col space-y-2"},[uo(e),e.description&&c({class:"flex flex-auto flex-col text-sm text-muted-foreground"},e.description),o({class:"flex flex-auto flex-col text-sm text-muted-foreground"},t)]),ye({class:"flex flex-col-reverse sm:flex-row sm:justify-end mt-6 gap-2 sm:gap-0 sm:space-x-2"},e.buttons)])])),fo=e=>ke.render(e,app.appShell.panel);class de extends N{render(){const t=d=>{d.target===this.panel&&this.close()},s=this.getMainClass(),l=this.title||"Dialog Title";return po({class:s,title:l,click:t,description:this.description,buttons:this.getButtons()},this.children)}getButtons(){return[r({variant:"outline",click:()=>this.close()},"Close")]}setupStates(){return{open:!1}}getMainClass(){return""}open(){fo(this),this.panel.showModal(),this.state.open=!0}close(){this.state.open=!1,this.panel.close(),this.destroy()}}class Ee extends de{getButtons(){const t=this.confirmTextLabel||"Confirm";return[r({variant:"outline",click:()=>this.close()},"Cancel"),r({variant:"primary",click:()=>this.confirm()},t)]}confirm(){this.confirmed&&this.confirmed(),this.close()}}const go=f((e,t)=>r({text:"Open",class:"m-1",click:()=>new de(e,t).open()})),ho=e=>r({text:"Open",class:"m-1",click:()=>new Ee(e).open()}),bo=({link:e})=>o({class:"flex items-center gap-4 py-2"},[T({type:"text",value:e,readOnly:!0,class:"border p-2 rounded-md w-full bg-background text-foreground"}),r({variant:"secondary",class:"px-4 py-2",click:()=>{navigator.clipboard.writeText(e),app.notify({title:"Link copied",description:"The link has been copied to your clipboard.",icon:n.clipboard.checked})}},"Copy Link")]),xo=e=>r({text:"Open",class:"m-1",click:()=>new de(e,[bo({link:"https://example.com"})]).open()}),wo=()=>p({title:"Dialogs",description:"Displays a dialog or a component that looks like a dialog. Dialogs can be opened and closed. They will be closed if the user clicks outside of the dialog or if the user clicks the close button."},[a({title:"Usage",description:"Import the dialog atom and use it in your components.",preview:[go({title:"Title",description:"this is the description."},[])],code:`import { Dialog } from '@components/molecules/dialogue.js';
...
})`})]),$e=Te({state(){return{value:this.value??0,min:this.min??0,max:this.max??100,filledPercentage:this.getFillPercentage(this.value)}},getFillPercentage(e){return(e-this.min)/(this.max-this.min)*100},render(){return o({class:"relative w-full h-4 flex items-center"},[o({class:"absolute h-2 w-full rounded-full bg-muted"}),o({class:"absolute h-2 bg-primary rounded-full",style:"width: [[filledPercentage]]%"}),o({class:"absolute block h-5 w-5 rounded-full border-2 border-primary bg-background ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 transform -translate-x-1/2",style:"left: [[filledPercentage]]%"}),E({type:"range",min:"[[min]]",max:"[[max]]",value:"[[value]]",class:"absolute w-full h-full opacity-0 cursor-pointer",bind:this.bind,input:e=>{const t=Number(e.target.value);this.state.value=t,this.state.filledPercentage=this.getFillPercentage(t),typeof this.change=="function"&&this.change(t)}})])}}),R=f((e,t)=>o({...e,class:"flex flex-auto items-center justify-center w-full py-4 space-y-8 max-w-[350px]"},t)),Bo=[{value:"next.js",label:"Next.js"},{value:"sveltekit",label:"SvelteKit"},{value:"nuxt.js",label:"Nuxt.js"},{value:"remix",label:"Remix"},{value:"astro",label:"Astro"}],Lo=()=>D({submit:e=>{console.log("Profile Form submitted")}},[new u({name:"username",label:"Username",description:"This is your public display name."},[T({placeholder:"e.g. username",required:!0})]),new u({name:"email",label:"Email Address",description:"We'll use this to contact you."},[ae({placeholder:"e.g. email@address.com",required:!0})]),r({type:"submit"},"Submit")]),Po=()=>D({submit:e=>{console.log("Preferences Form submitted")}},[new u({name:"framework",label:"Favorite Framework",description:"Select your preferred framework."},[S({options:Bo,required:!0})]),new u({name:"newsletter",label:"Subscribe to Newsletter",description:"Stay updated with our latest news."},[new ce({label:"Yes, sign me up!",required:!0,onChange:e=>console.log("Newsletter checked:",e)})]),r({type:"submit"},"Save Preferences")]),Mo=()=>D({submit:e=>{console.log("Contact Form submitted")}},[new u({name:"phone",label:"Phone Number",description:"We may contact you at this number."},[se({placeholder:"e.g. +1234567890",required:!0})]),new u({name:"message",label:"Your Message",description:"Let us know how we can help you."},[$({placeholder:"Type your message here...",required:!0})]),new u({name:"message",label:"Select Framework",description:"Select your preferred framework."},[new Fe({required:!0,items:[{value:"next.js",label:"Next.js"},{value:"sveltekit",label:"SvelteKit"},{value:"nuxt.js",label:"Nuxt.js"},{value:"remix",label:"Remix"},{value:"astro",label:"Astro"}]})]),r({type:"submit"},"Send Message")]),Fo=()=>D({submit:e=>{console.log("Settings Form submitted")}},[new u({name:"notifications",label:"Enable Notifications",description:"Toggle to enable or disable notifications."},[new Y({active:!0,required:!0})]),new u({name:"volume",label:"Volume Level",description:"Set your preferred volume level."},[new $e({min:0,max:100,value:50})]),r({type:"submit"},"Save Settings")]),Eo=()=>p({title:"Forms",description:"Forms are used to collect user data and submit it to the server."},[a({title:"Profile Form",description:"A simple profile form with username and email fields.",preview:[R([Lo()])],code:`import { Button, Input, EmailInput } from "@components/atoms/form/input.js";
...
`}),a({title:"File Input",description:"This is a file input.",preview:[g([Je({multiple:!0,change:e=>console.log(e.target.files)})])],code:`import { EmailInput, FileInput, Input, TelInput, Textarea } from "@components/atoms/form/input.js";
...
})`}),a({title:"URL Input",description:"This is a URL input field.",preview:[g([Ye({placeholder:"Enter a valid URL...",change:e=>console.log(e.target.value)})])],code:`import { UrlInput } from '@components/atoms/form/input.js';

UrlInput({
    placeholder: 'Enter a valid URL...',
    change: (e) => console.log(e.target.value),
});`}),a({title:"Color Input",description:"This is a color input field.",preview:[g([Ke({change:e=>console.log(e.target.value)})])],code:`import { ColorInput } from '@components/atoms/form/input.js';

ColorInput({
    change: (e) => console.log(e.target.value),
});`}),a({title:"Date Input",description:"This is a date input field.",preview:[g([Ze({change:e=>console.log(e.target.value)})])],code:`import { DateInput } from '@components/atoms/form/input.js';

DateInput({
    change: (e) => console.log(e.target.value),
});`}),a({title:"Time Input",description:"This is a time input field.",preview:[g([Xe({change:e=>console.log(e.target.value)})])],code:`import { TimeInput } from '@components/atoms/form/input.js';

TimeInput({
    change: (e) => console.log(e.target.value),
});`}),a({title:"DateTime Input",description:"This is a datetime input field.",preview:[g([et({change:e=>console.log(e.target.value)})])],code:`import { DateTimeInput } from '@components/atoms/form/input.js';

DateTimeInput({
    change: (e) => console.log(e.target.value),
});`}),a({title:"Week Input",description:"This is a week input field.",preview:[g([tt({change:e=>console.log(e.target.value)})])],code:`import { WeekInput } from '@components/atoms/form/input.js';

WeekInput({
    change: (e) => console.log(e.target.value),
});`}),a({title:"Month Input",description:"This is a month input field.",preview:[g([ot({change:e=>console.log(e.target.value)})])],code:`import { MonthInput } from '@components/atoms/form/input.js';

MonthInput({
    change: (e) => console.log(e.target.value),
});`}),a({title:"Password Input",description:"This is a password input field.",preview:[g([at({class:"w-12 h-12"})])],code:`import { PasswordInput } from '@components/atoms/form/input.js';

PasswordInput({
    class: 'w-12 h-12'
});`}),a({title:"Number Input",description:"This is a number input field.",preview:[g([st({placeholder:"Enter a number...",change:e=>console.log(e.target.value)})])],code:`import { NumberInput } from '@components/atoms/form/input.js';

NumberInput({
    placeholder: 'Enter a number...',
    change: (e) => console.log(e.target.value),
});`}),a({title:"Hidden Input",description:"This is a hidden input field.",preview:[g([nt({value:"hidden-value"})])],code:`import { HiddenInput } from '@components/atoms/form/input.js';
...
})`}),a({title:"Select",description:"This is a select input.",preview:[g([S({options:Ho,change:e=>console.log(e.target.value)})])],code:`import { Select } from "@components/atoms/form/select.js";
...
Select({
    ...
    change: (e) => console.log(e.target.value)
})`}),a({title:"Textarea",description:"This is a textarea input.",preview:[g([$({placeholder:"Enter your text here..."})])],code:`
import { EmailInput, FileInput, Input, TelInput, Textarea } from "@components/atoms/form/input.js";
...
});`}),v({class:"text-lg font-bold"},"Description"),c({class:"text-muted-foreground"},"The List component can be used to display a list of items in a structured format. Each item can be customized to show different information. The List component supports appending, prepending, mingling, and deleting or items. "),v({class:"text-lg font-bold"},"Performance"),c({class:"text-muted-foreground"},"The list will only update or re-render the items that have changed, improving performance. It uses a key to know when to update an item.")]),Vo=({title:e,description:t,back:s,icon:l})=>B({class:"modal-header flex items-center pt-4 px-6"},[s&&r({variant:"icon",icon:n.arrows.left,class:"mr-2 p-0 flex sm:hidden",click:(d,j)=>j.close()}),l&&o({class:"mr-2 w-12 h-12 rounded-full bg-muted flex items-center justify-center"},[h(l)]),o({class:"flex flex-auto flex-col ml-2"},[Q({class:"text-lg font-semibold m-0"},e),t&&o({class:"text-sm text-muted-foreground"},t)])]),Qo=f((e,t)=>o({popover:"manual",class:`modal m-auto top-0 right-0 bottom-0 left-0 fixed z-20 grid w-full h-full gap-4 lg:border bg-background text-foreground shadow-xl break-words overflow-hidden p-0 ${e.class}`,pointerdown:(s,l)=>{s.target===l.panel&&(s.preventDefault(),s.stopPropagation(),l.state.open=!1)}},[D({class:"modal-content flex flex-auto flex-col",submit:s=>e.onSubmit&&e.onSubmit()},[Vo(e),o({class:"modal-body flex flex-auto flex-col overflow-y-auto py-0 px-6"},t),ye({class:"modal-footer flex justify-between pb-4 px-6"},e.buttons)])])),Jo=e=>ke.render(e,app.appShell.panel);class Ne extends N{render(){const t=this.getMainClass(),s=this.title||"",l=this.description||null;return Qo({class:t,title:s,description:l,buttons:this.getButtons(),onSubmit:this.submit,icon:this.icon,back:this.back??!1,aria:{expanded:["open"]}},this.children)}setupStates(){return{open:{state:!1,callBack:t=>{t||this.close()}}}}getButtons(){return[r({variant:"outline",click:()=>this.close()},"Cancel"),r({variant:"primary",type:"submit"},"Save")]}isOutsideClick(t){return!this.panel.contains(t)}getSizeClass(){switch(this.size){case"lg":return"lg max-w-[900px]";case"xl":return"xl max-w-[1400px]";default:return"md max-w-[760px]"}}getTypeClass(){switch(this.type){case"right":return"right right-0";case"left":return"left left-0";default:return""}}getMainClass(){return this.getSizeClass()+" "+this.getTypeClass()}open(){Jo(this),this.panel.showPopover(),this.state.open=!0}close(){this.state.open=!1,this.panel.hidePopover(),this.destroy()}}const q=[{label:"Large",buttonStyle:"primary",size:"lg"},{label:"Small",buttonStyle:"secondary",size:"sm"},{label:"Medium",buttonStyle:"destructive",size:"md"},{label:"XL",buttonStyle:"primary",size:"xl"},{label:"Right",buttonStyle:"ghost",type:"right"},{label:"Left",buttonStyle:"link",type:"left"}],H=({label:e,buttonStyle:t,size:s,type:l})=>r({text:e,class:`m-1 ${t}`,click:()=>new Ne({title:"Are you absolutely sure?",size:s,type:l},[o({class:"flex flex-auto flex-col items-center justify-center p-4"},[new le,r({click:()=>{new Ee({title:"Are you absoultely sure?",description:"This action cannot be undone. This will permanently delete your account and remove your data from our servers.",confirmTextLabel:"Save",confirmed:()=>{app.notify({icon:n.trash,title:"Account deleted",description:"Your account has been successfully deleted.",type:"destructive"})}}).open()}},"Confirm")])]).open()}),Yo=({size:e="md",type:t="center"})=>new Ne({title:"Report an Issue",icon:n.warning,description:"What area are you having problems with?",size:e,type:t,onSubmit:()=>console.log("Form submitted")},[o({class:"flex flex-col max-w-lg lg:p-4 space-y-8"},[o({class:"flex flex-auto w-full gap-4"},[new u({name:"area",label:"Area"},[S({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"billing",label:"Billing"},{value:"technical",label:"Technical"},{value:"account",label:"Account"},{value:"other",label:"Other"}],defaultValue:"billing",change:s=>console.log(`Area selected: ${s.target.value}`)})]),new u({name:"security_level",label:"Security Level"},[S({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"severity_1",label:"Severity 1"},{value:"severity_2",label:"Severity 2"},{value:"severity_3",label:"Severity 3"}],defaultValue:"severity_2",change:s=>console.log(`Security Level selected: ${s.target.value}`)})])]),new u({name:"subject",label:"Subject"},[T({type:"text",placeholder:"I need help with...",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),new u({name:"description",label:"Description"},[$({placeholder:"Please include all information relevant to your issue.",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})])])]),ge=({label:e,buttonStyle:t,size:s,type:l})=>r({text:e,class:`m-1 ${t}`,click:()=>Yo({size:s,type:l}).open()}),Ko=()=>p({title:"Modals",description:"Displays a modal or a component that looks like a modal."},[a({title:"Extra Large Modal",description:"This is an extra large modal.",preview:[H(q[3])],code:`
...
])`}),a({title:"Skeleton with Avatar Loading",description:"This example demonstrates a skeleton loading animation that transitions to an avatar and user info after 3 seconds.",preview:[new aa],code:`import { Skeleton } from "@components/atoms/skeleton.js";
...
LoadingAvatar();`})]);class na extends N{render(){return o({class:"tab-panel"},[new Se({class:this.class,options:this.options}),k({class:"tab-content",switch:this.addGroup()})])}addGroup(){let t;const s=[],l=this.options;for(let d=0,j=l.length;d<j;d++)t=l[d],s.push({uri:t.uri||t.href,component:t.component,title:t.title||null,persist:!0});return s}}const he=f((e,t)=>o({class:"py-4"},t)),ia=()=>p({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[a({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new Ce({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:he([])},{label:"Code",value:"code",layout:he([])}]})],code:`
...
);`}),a({title:"Tab Group",description:"This is a tab group. The buttons update the state.",preview:[new ft({options:[{label:"Music",value:"music"},{label:"Podcasts",value:"podcasts"},{label:"Live",value:"live"}],onSelect:e=>console.log(e)})],code:`import { TabGroup } from "@components/organisms/tabs/tab-group.js";
