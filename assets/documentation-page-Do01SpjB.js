import{O as te,A as oe}from"./overlay-BnYDteDH.js";import{w as U,m as a,R as j,a as F,D as W,H as G,b as A,X as d,p as se,c as ae,U as h,I as B,S as c,B as ne,d as re,C as V,A as ie,e as u,f as le,y as b,g as v,h as D,T as $,i as r,j as M,k as q,q as g,O as ce,l as de,z as me,Z as ue,n as Y,J as P,o as pe,r as k,s as fe,t as K,V as J,v as be,u as ge,x as E,E as he,K as xe,L as we,M as ve,N as S,Q as ye,W as ke,Y as Te,P as C,$ as Q,a0 as Ce,G as Be}from"./index-CI0rZIbZ.js";const je=e=>G({class:"inline-flex flex-auto items-center justify-center whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm",dataSet:["selected",["state",e.value,"active"]]},[A({class:"flex flex-auto justify-center items-center px-3 py-1.5",onSet:["selected",{selected:e.value}],click:t=>e.callBack(e.value)},e.label)]),Ie=(e,t)=>(e.callBack=t,je(e)),Se=e=>F({class:`tab items-center justify-center rounded-md bg-muted p-1 text-muted-foreground ${e.class}`},[W({class:"flex flex-auto flex-row",map:[e.options,t=>Ie(t,e.callBack)]})]);class X extends U{render(){const t=this.select.bind(this);return a({class:""},[Se({class:this.class,options:this.options,callBack:t}),j({class:"tab-content",onState:["selected",this.updateContent.bind(this)]})])}afterSetup(){const t=this.options[0].value;this.select(t)}update(){const t=this.state.get("selected");this.select(null),this.select(t)}select(t){this.state.selected=t}updateContent(t){const o=this.options;if(!o||o.length<1)return;const n=o[0];for(const f of o)if(f.value===t)return f.layout;return n.layout}setupStates(){const t=this.callBack,o=typeof t;return{selected:{state:null,callBack(n){o==="function"&&t(n)}}}}}const Ae=d((e,t)=>se({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces cursor-pointer"},[ae({class:"font-mono text-sm",click:()=>navigator.clipboard.writeText(t[0].textContent)},t)])),De=d((e,t)=>a({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-card"},[a({class:"preview flex w-full justify-center items-center"},t)])),z=d((e,t)=>a({class:"py-4"},t)),$e=e=>new X({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:z([De(e.preview)])},{label:"Code",value:"code",layout:z([Ae(e.code)])}]}),Me=d(({title:e,description:t})=>h({class:"flex flex-col"},[B({class:"scroll-m-20 text-2xl font-bold tracking-tight"},e),t&&c({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),s=d((e,t)=>j({class:"py-4"},[Me({title:e.title,description:e.description}),$e({preview:e.preview,code:e.code})]));class Le extends ne{render(){return re([a({class:"contained px-4 flex flex-auto flex-col"},this.children)])}}const Ne=d(({title:e,description:t})=>h({class:"flex flex-col"},[V({class:"scroll-m-20 text-3xl font-bold tracking-tight"},e),c({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),Pe=d((e,t)=>a({class:"contained py-8"},[Ne(e),j({class:"pb-12 pt-8"},t)])),l=d((e,t)=>new Le([Pe(e,t)])),Ee=()=>l({title:"Alerts",description:"Alerts are used to provide feedback to the user about the outcome of an action or to inform them of important information."},[s({title:"Usage",description:"To use the Alert component, import it from the components library and use it in your application.",preview:[ie({title:"Heads up!",description:"You can add components to your app using the cli.",icon:u.information})],code:`import { Alert } from "@components/molecules/alert.js";
...
})`})]),dt=e=>fe.render(e,document.body),mt=({title:e})=>h({class:"flex flex-auto items-center"},[M({class:"text-lg font-semibold"},e)]),ut=d((e,t)=>K({class:"flex flex-auto flex-col fixed z-30 w-full max-w-lg gap-4 border bg-background text-foreground p-6 shadow-lg duration-200 sm:rounded-lg",click:e.click,aria:{expanded:["open"]}},[a({class:"flex flex-auto flex-col space-y-2"},[mt(e),e.description&&c({class:"flex flex-auto flex-col text-sm text-muted-foreground"},e.description),a({class:"flex flex-auto flex-col text-sm text-muted-foreground"},t)]),J({class:"flex flex-col-reverse sm:flex-row sm:justify-end mt-6 gap-2 sm:gap-0 sm:space-x-2"},e.buttons)]));class N extends U{render(){const t=f=>{f.target===this.panel&&this.close()},o=this.getMainClass(),n=this.title||"Dialog Title";return ut({class:o,title:n,click:t,description:this.description,buttons:this.getButtons()},this.children)}getButtons(){return[r({variant:"outline",click:()=>this.close()},"Close")]}setupStates(){return{open:!1}}getMainClass(){return""}open(){dt(this),this.panel.showModal(),this.state.open=!0}close(){this.state.open=!1,this.panel.close(),this.destroy()}}class pt extends N{getButtons(){const t=this.confirmTextLabel||"Confirm";return[r({variant:"outline",click:()=>this.close()},"Cancel"),r({variant:"primary",click:()=>this.confirm()},t)]}confirm(){this.confirmed&&this.confirmed(),this.close()}}const ft=d((e,t)=>r({text:"Open",class:"m-1",click:()=>new N(e,t).open()})),bt=e=>r({text:"Open",class:"m-1",click:()=>new pt(e).open()}),gt=()=>l({title:"Dialogs",description:"Displays a dialog or a component that looks like a dialog. Dialogs can be opened and closed. They will be closed if the user clicks outside of the dialog or if the user clicks the close button."},[s({title:"Usage",description:"Import the dialog atom and use it in your components.",preview:[ft({title:"Title",description:"this is the description."},[])],code:`import { Dialog } from '@components/molecules/dialogue.js';
...
Input({
    type: 'text',
    placeholder: 'Enter your text here...'
})`}),s({title:"Tel Input",description:"This is a phone input.",preview:[he({})],code:`
import { Button } from '@components/atoms/form/input.js';
...
})`}),s({title:"Select",description:"This is a select input.",preview:[ht({options:wt,change:e=>console.log(e.target.value)})],code:`
import { Button } from '@components/atoms/form/input.js';
