...
})`}),t({title:"Date Picker",description:"This is a date picker input.",preview:[a([new j({selectedDate:"2022-01-01"})])],code:`
import DatePicker from "@base-framework/ui/molecules/date-time/date-picker.js";

new DatePicker()`}),t({title:"Range Slider",description:"This is a range slider input.",preview:[a([new N({min:0,max:100,value:50,change:e=>console.log(e)})])],code:`
