import{G as p,Y as t,W as o,w as e}from"./index-RbYAKzBL.js";import{D as i}from"./doc-section-BJYsMUS2.js";import{D as l}from"./doc-page-BaQxlDjw.js";const a=()=>l({title:"Tooltips",description:"Tooltips are small popups that appear when a user hovers over an element."},[i({title:"Usage",description:"Import the tooltip atom and use it in your components.",preview:[t({class:"flex gap-2 flex-wrap"},[o({content:"This is a tooltip."},[e("Hover me")])])],code:`import {  Button  } from "@base-framework/ui/atoms";
