...
])`}),a({title:"Skeleton Post",description:"This is a skeleton post.",preview:[e({class:"gap-y-4 flex flex-auto flex-col w-full max-w-64"},[t({width:"w-full",height:"h-32",shape:"rectangle"}),e({class:"flex flex-col gap-y-2"},[t({width:"w-3/4",height:"h-4"}),t({width:"w-1/2",height:"h-4"})])])],code:`import {  Skeleton  } from "@base-framework/ui/atoms";
import { Div } from '@base-framework/atoms';
