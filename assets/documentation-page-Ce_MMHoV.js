import{Z as v,M as Me,N as je,o as s,Y as o,w as pe,u as p,l as q,s as ae,G as i,y as Le,e as Fe,A as L,m as k,B as c,z as r,C as $e,E as Ee,H as b,I as Re,O as Ne,r as l,a as fe,P as He,Q as ze,R as Ue,U as qe,W as Oe,X as We,a0 as D,$ as w,a1 as P,f as m,a2 as Z,a3 as O,a4 as se,_ as he,a5 as Ge,c as C,a6 as T,a7 as $,a8 as ge,a9 as _e,h as be,aa as Ye,i as X,ab as Je,ac as Y,j as B,k as W,ad as we,ae as ie,af as xe,K as U,ag as Ve,ah as Ke,L as E,ai as ee,aj as te,ak as ve,al as Qe,am as Ze,an as J,ao as Xe,ap as et,aq as tt,ar as ot,as as at,at as st,au as it,av as rt,aw as lt,ax as nt,ay as ct,T as mt,az as dt,p as ut,aA as pt,aB as ft,x as G,aC as ht,aD as re,aE as F,aF as gt,aG as bt,F as wt,aH as j,aI as xt,aJ as vt,V as I,aK as yt,b as kt,q as Tt,D as A,J as S,aL as St,aM as oe,v as It,aN as Ct,aO as Dt}from"./index-fToDur54.js";const x=v((e,a)=>Me({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces break-all cursor-pointer"},[je({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(a[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:s.clipboard.checked})}},a)])),At=v((e,a)=>o({class:"flex flex-auto p-4 min-h-[350px] max-h-[650px] overflow-x-auto max-w-[90vw] rounded-lg border bg-card"},[o({class:"preview flex flex-auto justify-center items-center"},a)])),le=v((e,a)=>o({class:"py-4"},a)),Bt=e=>new pe({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:le([At(e.preview)])},{label:"Code",value:"code",layout:le([x(e.code)])}]}),Pt=v(({title:e,description:a})=>q({class:"flex flex-col"},[ae({class:"scroll-m-20 text-2xl font-bold tracking-tight"},e),a&&i({class:"text-base text-muted-foreground py-2 max-w-[700px]"},a)])),t=v((e,a)=>p({class:"grid py-4"},[Pt({title:e.title,description:e.description}),Bt({preview:e.preview,code:e.code})])),Mt=v(({title:e,description:a})=>q({class:"flex flex-col"},[Fe({class:"scroll-m-20 text-3xl font-bold tracking-tight"},e),i({class:"text-base text-muted-foreground py-2 max-w-[700px]"},a)])),jt=v((e,a)=>o({class:"contained py-8"},[Mt(e),p({class:"pb-12 pt-8"},a)])),f=v((e,a)=>new Le([jt(e,a)])),Lt=()=>f({title:"Alerts",description:"Alerts are used to provide feedback to the user about the outcome of an action or to inform them of important information."},[t({title:"Default Alert",description:"This is a standard alert without any specific type.",preview:[L({title:"Notice",description:"This is a default alert without a specific type.",icon:s.information})],code:`import {  Alert  } from "@base-framework/ui/molecules";
...
);`})]),Et=[{href:"/",label:"Home"},{href:"/components",label:"Components"},{label:"Breadcrumb"}],Rt=()=>f({title:"Breadcrumbs",description:"Breadcrumbs are a navigation aid that helps users understand their location within a website or application."},[t({title:"Usage",description:"To use the Breadcrumb component, import it and provide an array of items. Each item can have a label and an optional href.",preview:[new Re({items:Et})],code:`import {  Breadcrumb  } from "@base-framework/ui/molecules";
...
})`})]),Nt=()=>f({title:"Button",description:"Displays a button or a component that looks like a button."},[t({title:"Usage",description:"Import the button atom and use it in your components. This platform has variants for different use cases. The variant can be set using the `variant` prop.",preview:[l({variant:"primary"},"Click Me")],code:`import {  Button  } from "@base-framework/ui/atoms";

Button({ ...props, variant: 'secondary' }, primary)`}),q({class:"flex flex-col py-8"},[fe({class:"text-3xl font-bold tracking-tight border-b pb-2"},"Variants")]),t({title:"Primary Button",description:"This is a primary button.",preview:[l({variant:"primary"},"Click Me")],code:`
import {  Button  } from "@base-framework/ui/atoms";
import { Atom } from '@base-framework/base';
...
LoadingButton('With Icon')`})]),Ht=()=>We.formatTime("",24),zt=()=>f({title:"Calendars",description:"This is the calendar component documentation."},[t({title:"Usage",description:"This is how you can use the calendar component.",preview:[new ze],code:`@base-framework/ui/organisms;
...
new Calendar()`}),t({title:"Dynamic Time",description:"The Dynamic Time class will allow you to create a dynamic time that will update every minute.",preview:[new qe({filter:()=>{let e="Morning";const a=Ht();return a>="18:00:00"?e="Evening":a>="12:00:00"&&(e="Afternoon"),`Good ${e}`}})],code:`import { DateTime } from "@base-framework/base";
...
})`})]),M=({title:e,description:a})=>q({class:"text-left"},[fe({class:"font-semibold tracking-tight text-2xl"},e),i({class:"text-sm text-muted-foreground"},a)]),Ut=()=>o({class:"flex items-center justify-center gap-4"},[l({variant:"outline",class:"gap-2 w-full",click:()=>console.log("Sign in with Github"),"aria-label":"Sign in with Github"},[w(s.companies.gitHub),r("Github")]),l({variant:"outline",class:"gap-2 w-full",click:()=>console.log("Sign in with Google"),"aria-label":"Sign in with Google"},[w(s.companies.google),r("Google")])]),qt=()=>P({class:"space-y-4",submit:e=>{e.preventDefault(),console.log("Account created")}},[new m({name:"email",label:"Email"},[Z({type:"email",placeholder:"m@example.com",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),new m({name:"password",label:"Password"},[Z({type:"password",placeholder:"Your password",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),l({type:"submit",class:"w-full mt-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition"},"Create account")]),ye=()=>D({class:"w-full max-w-md mx-auto p-8 bg-card space-y-6"},[M({title:"Create an account",description:"Enter your email below to create your account"}),Ut(),o({class:"relative"},[o({class:"absolute inset-0 flex items-center"},[r({class:"flex-grow border-t"})]),o({class:"relative flex justify-center text-xs uppercase"},[r({class:"bg-background px-2 text-muted-foreground"},"or continue with")])]),qt()]),V=({title:e,description:a,defaultState:n,onChange:d})=>o({class:"flex items-start justify-between gap-2"},[o({class:"text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex flex-col space-y-1"},[r({class:"font-medium text-foreground"},e),r({class:"font-normal leading-snug text-muted-foreground"},a)]),new O({active:n,change:d})]),ke=()=>D({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[M({title:"Cookie Settings",description:"Manage your cookie settings here."}),o({class:"pt-0 grid gap-6"},[V({title:"Strictly Necessary",description:"These cookies are essential in order to use the website and use its features.",defaultState:!0,onChange:e=>console.log("Strictly Necessary:",e)}),V({title:"Functional Cookies",description:"These cookies allow the website to provide personalized functionality.",defaultState:!1,onChange:e=>console.log("Functional Cookies:",e)}),V({title:"Performance Cookies",description:"These cookies help to improve the performance of the website.",defaultState:!1,onChange:e=>console.log("Performance Cookies:",e)})]),l({variant:"outline",class:"w-full",click:()=>console.log("Preferences saved")},"Save preferences")]),Te=({startDate:e})=>D({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[M({title:"Pick a Date",description:"When is the event?"}),o({class:"font-medium text-foreground"},[new se({selectedDate:e,selectedCallBack:a=>console.log(a)})])]),K=v(({value:e,label:a,icon:n})=>Ge({class:'text-sm gap-1 font-medium leading-none disabled:cursor-not-allowed disabled:opacity-70 flex flex-col items-center justify-between rounded-md border-2 border-muted bg-popover p-4 hover:bg-muted data-[state="active"]:border-primary [&:has([data-state="active"])]:border-primary',onState:["method",{active:e}],dataSet:["method",["state",e,"active"]],click:(d,{state:g})=>g.method=e},[w(n),r(a)])),Ot=he({render(){return o({class:"flex flex-auto flex-col"},[o({class:"grid grid-cols-3 gap-4"},[K({label:"Card",value:"card",icon:s.creditCard}),K({label:"Paypal",value:"paypal",icon:s.companies.paypal}),K({label:"Apple",value:"apple",icon:s.companies.apple})])])},state(){return{method:null}}}),Wt=()=>o({class:"flex items-center justify-center gap-4"},[new Ot]),Gt=()=>P({class:"space-y-4",submit:e=>{e.preventDefault(),console.log("Payment method added")}},[new m({name:"name",label:"Name"},[C({type:"text",placeholder:"First Last",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),new m({name:"card_number",label:"Card number"},[C({type:"text",placeholder:"1234 5678 9012 3456",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),o({class:"flex gap-4 mt-4"},[new m({name:"month",label:"Expires"},[T({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"",label:"Month",disabled:!0},...Array.from({length:12},(e,a)=>({value:`${a+1}`,label:`${a+1}`.padStart(2,"0")}))]})]),new m({name:"year",label:"Year"},[T({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"",label:"Year",disabled:!0},...Array.from({length:10},(e,a)=>({value:`${new Date().getFullYear()+a}`,label:`${new Date().getFullYear()+a}`}))]})]),new m({name:"cvc",label:"CVC"},[C({type:"text",placeholder:"CVC",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})])]),l({type:"submit",class:"w-full mt-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition"},"Continue")]),Se=()=>D({class:"w-full max-w-md mx-auto p-8 bg-card space-y-6"},[M({title:"Payment Method",description:"Add a new payment method to your account."}),Wt(),o({class:"space-y-4"},[Gt()])]),_t=({name:e,description:a,stars:n,language:d,lastUpdated:g})=>o({class:"flex items-start justify-between py-4 border-b border-muted last:border-b-0"},[o({class:"flex flex-col"},[r({class:"font-semibold text-foreground"},e),r({class:"text-sm text-muted-foreground"},a),o({class:"flex space-x-4 text-sm text-muted-foreground mt-3"},[o({class:"flex items-center gap-2"},[w({class:" text-blue-500"},s.document.text),r(` ${d}`)]),o({class:"flex items-center"},[w(s.star),r(` ${n}`)]),o(`Updated ${g}`)])]),l({variant:"secondary",class:"px-3 py-1 gap-1 flex items-center rounded-md",click:()=>console.log(`Starred ${e}`)},[w(s.star),r("Star")])]),Yt=({projects:e})=>o({class:"space-y-3"},e.map(a=>_t(a))),Jt=[{name:"shadcn/ui",description:"Beautifully designed components that you can copy and paste into your apps. Accessible. Customizable. Open Source.",stars:"20k",language:"TypeScript",lastUpdated:"April 2023"},{name:"base-framework",description:"A robust framework for building and structuring large-scale applications with ease.",stars:"2",language:"JavaScript",lastUpdated:"June 2024"}],Vt=()=>D({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[o({class:"font-semibold text-lg text-foreground"},"Projects"),Yt({projects:Jt})]),Kt=()=>P({class:"space-y-4",submit:e=>{e.preventDefault(),console.log("Issue reported")}},[o({class:"flex flex-auto w-full gap-4"},[new m({name:"area",label:"Area"},[T({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"billing",label:"Billing"},{value:"technical",label:"Technical"},{value:"account",label:"Account"},{value:"other",label:"Other"}],defaultValue:"billing",change:e=>console.log(`Area selected: ${e.target.value}`)})]),new m({name:"security_level",label:"Security Level"},[T({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"severity_1",label:"Severity 1"},{value:"severity_2",label:"Severity 2"},{value:"severity_3",label:"Severity 3"}],defaultValue:"severity_2",change:e=>console.log(`Security Level selected: ${e.target.value}`)})])]),new m({name:"subject",label:"Subject"},[C({type:"text",placeholder:"I need help with...",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),new m({name:"description",label:"Description"},[$({placeholder:"Please include all information relevant to your issue.",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),o({class:"flex justify-end gap-4 mt-4"},[l({variant:"outline",class:"px-4 py-2",click:()=>console.log("Cancel clicked")},"Cancel"),l({type:"submit",class:"px-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition"},"Submit")])]),Ie=()=>D({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[M({title:"Report an issue",description:"What area are you having problems with?"}),Kt()]),Qt=({link:e})=>o({class:"flex items-center gap-4 py-2"},[Z({type:"text",value:e,readOnly:!0,class:"border p-2 rounded-md w-full bg-background text-foreground"}),l({variant:"secondary",class:"px-4 py-2",click:()=>{navigator.clipboard.writeText(e),app.notify({title:"Link copied",description:"The link has been copied to your clipboard.",icon:s.clipboard.checked})}},"Copy Link")]),Zt=({name:e,email:a,access:n,image:d})=>o({class:"flex items-center justify-between gap-4 py-2"},[o({class:"flex items-center gap-3"},[k({src:d,alt:e,fallbackText:e.split(" ").map(g=>g[0]).join("")}),o({},[r({class:"font-medium text-foreground"},e),r({class:"block text-sm text-muted-foreground"},a)])]),T({class:"border rounded-md bg-background text-foreground px-3 py-1",options:[{value:"edit",label:"Can edit"},{value:"view",label:"Can view"},{value:"comment",label:"Can comment"}],defaultValue:n,change:g=>console.log(`Access level changed for ${e}: ${g.target.value}`)})]),Xt=({people:e})=>o({class:"space-y-3"},e.map(a=>Zt(a))),Ce=({link:e,people:a})=>D({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[M({title:"Share this document",description:"Anyone with the link can view this document."}),Qt({link:e}),o({class:"border-t my-4"}),o({class:"font-medium text-foreground"},"People with access"),Xt({people:a})]),eo=e=>e.split(" ").map(n=>n[0]).join(""),to=({name:e,email:a,role:n,image:d})=>o({class:"flex items-center justify-between gap-4 py-2"},[o({class:"flex items-center gap-3"},[k({src:d,alt:e,fallbackText:eo(e)}),o({},[r({class:"font-medium text-foreground"},e),r({class:"block text-sm text-muted-foreground"},a)])]),T({class:"border rounded-md bg-background text-foreground px-3 py-1",options:[{value:"owner",label:"Owner"},{value:"member",label:"Member"}],defaultValue:n,change:g=>console.log(`Role changed for ${e}: ${g.target.value}`)})]),oo=({members:e})=>o({class:"space-y-3"},e.map(a=>to(a))),De=({members:e})=>D({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[M({title:"Team Member",description:"Invite your team members to collaborate."}),oo({members:e})]),ao=()=>f({title:"Cards",description:"Cards are a great way to display content in a concise and organized manner."},[t({title:"Usage",description:"Import the card atom and use it in your components.",preview:[D()],code:`import {  Button  } from "@base-framework/ui/atoms";

Card()`}),c({class:"text-lg font-bold"},"Examples"),i({class:"text-muted-foreground"},"This is a list of examples of how to use the card component in your application."),t({title:"Account Card",preview:[ye()],code:`import AccountCard from "./examples/account-card.js";

AccountCard()`}),t({title:"Paymnet Card",preview:[Se()],code:`import AccountCard from "./examples/payment-card.js";

PaymentCard()`}),t({title:"Team Mmeber Card",preview:[De({members:[{name:"Leslie Alexander",email:"leslie.alexander@example.com",image:"https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80",role:"owner",lastSeen:"2023-01-23T13:23Z",status:"offline"},{name:"Michael Foster",email:"michael.foster@example.com",image:"https://images.unsplash.com/photo-1519244703995-f4e0f30006d5?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80",role:"member",lastSeen:"2023-01-23T13:23Z",status:"offline"},{name:"Dries Vincent",email:"dries.vincent@example.com",image:"https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80",role:"owner",status:"online"}]})],code:`import AccountCard from "./examples/team-member-card.js";

TeamMemberCard()`}),t({title:"Share Document Card",preview:[Ce({link:"http://example.com/link/to/document",people:[{name:"Leslie Alexander",email:"leslie.alexander@example.com",image:"https://images.unsplash.com/photo-1494790108377-be9c29b29330?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80",role:"owner",lastSeen:"2023-01-23T13:23Z",status:"offline"},{name:"Michael Foster",email:"michael.foster@example.com",image:"https://images.unsplash.com/photo-1519244703995-f4e0f30006d5?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80",role:"member",lastSeen:"2023-01-23T13:23Z",status:"offline"},{name:"Dries Vincent",email:"dries.vincent@example.com",image:"https://images.unsplash.com/photo-1506794778202-cad84cf45f1d?ixlib=rb-1.2.1&ixid=eyJhcHBfaWQiOjEyMDd9&auto=format&fit=facearea&facepad=2&w=256&h=256&q=80",role:"owner",status:"online"}]})],code:`import AccountCard from "./examples/share-document-card.js";
...
})`}),t({title:"Date Select Card",preview:[Te({startDate:"2023-01-23"})],code:`import AccountCard from "./examples/date-select-card.js";

DateSelectCard({
    startDate: '2023-01-23'
})`}),t({title:"Report Issue Card",preview:[Ie()],code:`import AccountCard from "./examples/report-issue-card.js";

ReportIssueCard()`}),t({title:"Project Card",preview:[Vt()],code:`import AccountCard from "./examples/project-card.js";

ProjectCard()`}),t({title:"Cookie Settings Card",preview:[ke()],code:`import AccountCard from "./examples/cookie-settings-card.js";

CookieSettingsCard()`})]),so=[{value:"next.js",label:"Next.js",icon:s.home},{value:"sveltekit",label:"SvelteKit"},{value:"nuxt.js",label:"Nuxt.js"},{value:"remix",label:"Remix"},{value:"astro",label:"Astro"}],io=()=>f({title:"Comboboxes",description:"Comboboxes are used to allow users to select an option from a dropdown list or enter a custom value."},[t({title:"Usage",description:"To use the Combobox component, import it from the components library and use it in your application.",preview:[o({class:"w-full max-w-[300px]"},[new ge({items:so,onSelect:e=>console.log(e)})])],code:`@base-framework/ui/molecules;
import {  Icons  } from "@base-framework/ui/icons";
...
})`})]),ro=()=>{const e=[{id:1,status:"Active",email:"user1@example.com",amount:500.5},{id:2,status:"Inactive",email:"user2@example.com",amount:250.75},{id:3,status:"Active",email:"user3@example.com",amount:300}],a=()=>Ye([X({class:"text-muted-foreground border-b"},[Je({}),Y({key:"status",label:"Custom Status"}),Y({key:"email",label:"User Email"}),Y({key:"amount",label:"Amount (USD)",align:"justify-end"})])]),n=(d,g)=>X({class:"items-center px-4 py-2 hover:bg-muted/50"},[B({class:"p-4"},[new W({checked:d.selected,class:"mr-2",click:()=>g(d)})]),B({class:"p-4 justify-center"},d.status),B({class:"p-4"},d.email),B({class:"p-4 text-right"},`$${d.amount.toFixed(2)}`)]);return o({class:"w-full mt-4"},[o({class:"w-full rounded-md border overflow-x-auto"},[_e({class:"w-full"},[new be({key:"id",customHeader:a(),rows:e,rowItem:n})])])])},lo=[{label:"checkbox",key:""},{label:"Status",key:"status"},{label:"Email",key:"email"},{label:"Amount",key:"amount",align:"justify-end"}],no=[{id:1,status:"Success",email:"ken99@yahoo.com",amount:316,selected:!1},{id:2,status:"Success",email:"abe45@gmail.com",amount:242,selected:!1},{id:3,status:"Processing",email:"monserrat44@gmail.com",amount:837,selected:!1},{id:4,status:"Success",email:"silas22@gmail.com",amount:874,selected:!1},{id:5,status:"Failed",email:"carmella@hotmail.com",amount:721,selected:!1}],co=(e,a)=>X({class:"items-center px-4 py-2 hover:bg-muted/50"},[B({class:"p-4"},[new W({checked:e.selected,class:"mr-2",onChange:()=>a(e)})]),B({class:"p-4 "},[r({class:"text-muted-foreground"},e.status)]),B({class:"p-4 "},e.email),B({class:"p-4 text-right"},`$${e.amount.toFixed(2)}`)]),mo=()=>f({title:"Data Tables",description:"Data tables are used to display or manipulate lists of items in tabular form."},[t({title:"Usage",description:"The DataTable component displays items in a structured format, supporting selection, custom row items, and more.",preview:[new be({headers:lo,rows:no,rowItem:co,key:"id"})],code:`import {  DataTable  } from "@base-framework/ui/organisms";
...
new DataTable({
    ...
    rows,
    rowItem
});`}),t({title:"Custom Header Data Table",description:"Demonstrates a data table with custom headers and row rendering using the DataTable component.",preview:[ro()],code:`// custom-header-table.js
...
};`}),p({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Selecting and Resetting Rows"),i({class:"text-muted-foreground"},"DataTable supports toggling all rows, clearing selections, and retrieving selected rows."),x(`// Suppose 'dt' is your DataTable instance
...
`)]),p({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Removing Items"),i({class:"text-muted-foreground"},"Use remove() to delete rows by passing an array of items (or a single item)."),x(`// dt is your DataTable instance
...
`)]),p({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Appending Items"),i({class:"text-muted-foreground"},"Use append() to add rows at the end of the list. Accepts an array or single object."),x(`// dt is your DataTable instance
...
`)]),p({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Mingling Items"),i({class:"text-muted-foreground"},"Mingle merges new items with existing items by matching keys. If withDelete = true, items not in newItems are removed."),x(`// dt is your DataTable instance
const newItems = [
...
`)]),p({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Prepending Items"),i({class:"text-muted-foreground"},"Use prepend() to add new rows at the beginning of the list, shifting existing rows down."),x(`// dt is your DataTable instance
...
`)])]),uo=v((e,a)=>l({text:"Open",class:"m-1",click:()=>new we(e,a).open()})),po=e=>l({text:"Open",class:"m-1",click:()=>new ie(e).open()}),fo=v((e,a)=>l({text:"Open",class:"m-1",click:()=>new ie({icon:s.signOut,type:"destructive",title:"Are you absoultely sure?",description:"This will sign you out of the application.",confirmTextLabel:"Sign Out",confirmed:()=>console.log("Confirmed!")}).open()})),ho=({link:e})=>o({class:"flex items-center gap-4 py-2"},[C({type:"text",value:e,readOnly:!0,class:"border p-2 rounded-md w-full bg-background text-foreground"}),l({variant:"secondary",class:"px-4 py-2",click:()=>{navigator.clipboard.writeText(e),app.notify({title:"Link copied",description:"The link has been copied to your clipboard.",icon:s.clipboard.checked})}},"Copy Link")]),go=e=>l({text:"Open",class:"m-1",click:()=>new we(e,[ho({link:"https://example.com"})]).open()}),bo=()=>f({title:"Dialogs",description:"Displays a dialog or a component that looks like a dialog. Dialogs can be opened and closed. They will be closed if the user clicks outside of the dialog or if the user clicks the close button."},[t({title:"Usage",description:"Import the dialog atom and use it in your components.",preview:[uo({title:"Title",description:"this is the description.",hideFooter:!1},[])],code:`import {  Dialog  } from "@base-framework/ui/molecules";
...
]).open()`}),t({title:"Confirmation",description:"Displays a confirmation dialog.",preview:[po({title:"Are you absoultely sure?",description:"This action cannot be undone. This will permanently delete your account and remove your data from our servers.",confirmTextLabel:"Save",confirmed:()=>console.log("Confirmed!")})],code:`import {  Confirmation  } from "@base-framework/ui/molecules";
...
}).open()`}),t({title:"Share Link",description:"Displays a dialog with a shareable link.",preview:[go({title:"Share Link",description:"Share this link with others."})],code:`import {  Confirmation  } from "@base-framework/ui/molecules";
...
new Confirmation({
    ...
    confirmTextLabel: 'Save',
    confirmed: () => console.log('Confirmed!')
}).open()`}),t({title:"Types",description:"There are different types of dialogs.",preview:[fo()],code:`import {  Dialog  } from "@base-framework/ui/molecules";
...
`}),i("The types are `destructive`, `warning`, `info`, `success`, and `default`. Dialogs can also have an icon in the header. The icon can be any icon from the icon library.")]),wo=()=>f({title:"Dropdown Menus",description:"Dropdown menus are used to display a list of options when a user clicks on a button or input field."},[t({title:"Usage",description:"To use the DropdownMenu component, import it from the components library and use it in your application.",preview:[new xe({icon:s.ellipsis.vertical,groups:[[{icon:s.user.default,label:"Profile",shortcut:"⌘P",value:"profile"},{icon:s.creditCard,label:"Billing",shortcut:"⌘B",value:"billing"},{icon:s.cog.six,label:"Settings",shortcut:"⌘S",value:"settings"},{icon:s.computerDesktop,label:"Keyboard shortcuts",shortcut:"⌘K",value:"shortcuts"}],[{icon:s.user.multiple,label:"Team",value:"team"},{icon:s.user.plus,label:"Invite users",value:"invite"},{icon:s.plus,label:"New Team",shortcut:"⌘T",value:"new_team"}],[{icon:s.github,label:"GitHub",value:"github"},{icon:s.helpCircle,label:"Support",value:"support"},{icon:s.api,label:"API",value:"api"}]],onSelect:e=>{console.log("Selected item:",e)}})],code:`import {  Icons  } from "@base-framework/ui/icons";
...
})`}),t({title:"Dropdown",description:'The Dropdown component is used to render a list of items within the dropdown menu. This uses the parent data "groups" to render the items.',preview:[new U({setData(){return new Ve({groups:[[{icon:s.user.default,label:"Profile",shortcut:"⌘P",value:"profile"},{icon:s.creditCard,label:"Billing",shortcut:"⌘B",value:"billing"},{icon:s.cog.six,label:"Settings",shortcut:"⌘S",value:"settings"},{icon:s.computerDesktop,label:"Keyboard shortcuts",shortcut:"⌘K",value:"shortcuts"}],[{icon:s.user.multiple,label:"Team",value:"team"},{icon:s.user.plus,label:"Invite users",value:"invite"},{icon:s.plus,label:"New Team",shortcut:"⌘T",value:"new_team"}],[{icon:s.github,label:"GitHub",value:"github"},{icon:s.helpCircle,label:"Support",value:"support"},{icon:s.api,label:"API",value:"api"}]]})}},[Ke({onSelect:e=>{console.log("Selected item:",e)}})])],code:`import {  Icons  } from "@base-framework/ui/icons";
...
])`})]),N=v((e,a)=>o({...e,class:"flex flex-auto items-center justify-center w-full py-4 space-y-8 max-w-[450px]"},a)),xo=[{value:"next.js",label:"Next.js"},{value:"sveltekit",label:"SvelteKit"},{value:"nuxt.js",label:"Nuxt.js"},{value:"remix",label:"Remix"},{value:"astro",label:"Astro"}],vo=()=>P({submit:e=>{console.log("Profile Form submitted")}},[E({legend:"Profile"},[new m({name:"username",label:"Username",description:"This is your public display name."},[C({placeholder:"e.g. username",required:!0})]),new m({name:"email",label:"Email Address",description:"We'll use this to contact you."},[ee({placeholder:"e.g. email@address.com",required:!0})]),l({type:"submit"},"Submit")])]),yo=()=>P({submit:e=>{console.log("Preferences Form submitted")}},[E({legend:"Preferences"},[new m({name:"framework",label:"Favorite Framework",description:"Select your preferred framework."},[T({options:xo,required:!0})]),new m({name:"newsletter",label:"Subscribe to Newsletter",description:"Stay updated with our latest news."},[new W({label:"Yes, sign me up!",required:!0,onChange:e=>console.log("Newsletter checked:",e)})]),l({type:"submit"},"Save Preferences")])]),ko=()=>P({submit:e=>{console.log("Contact Form submitted")}},[E({legend:"Contact Us"},[new m({name:"phone",label:"Phone Number",description:"We may contact you at this number."},[te({placeholder:"e.g. +1234567890",required:!0})]),new m({name:"message",label:"Your Message",description:"Let us know how we can help you."},[$({placeholder:"Type your message here...",required:!0})]),new m({name:"message",label:"Select Framework",description:"Select your preferred framework."},[new ge({required:!0,items:[{value:"next.js",label:"Next.js"},{value:"sveltekit",label:"SvelteKit"},{value:"nuxt.js",label:"Nuxt.js"},{value:"remix",label:"Remix"},{value:"astro",label:"Astro"}]})]),l({type:"submit"},"Send Message")])]),To=()=>P({submit:e=>{console.log("Settings Form submitted")}},[E({legend:"Settings"},[new m({name:"notifications",label:"Enable Notifications",description:"Toggle to enable or disable notifications."},[new O({active:!0,required:!0})]),new m({name:"volume",label:"Volume Level",description:"Set your preferred volume level."},[new ve({min:0,max:100,value:50})]),l({type:"submit"},"Save Settings")])]),So=()=>f({title:"Forms",description:"Forms are used to collect user data and submit it to the server."},[t({title:"Profile Form",description:"A simple profile form with username and email fields.",preview:[N([vo()])],code:`import {  Button, Input, EmailInput  } from "@base-framework/ui/atoms";
...
])`}),t({title:"Preferences Form",description:"A preferences form with a select input and a checkbox.",preview:[N([yo()])],code:`import {  Button, Checkbox, Select  } from "@base-framework/ui/atoms";
import {  Form, FormField  } from "@base-framework/ui/molecules";
import { Div } from "@base-framework/atoms";
import { Atom } from "@base-framework/base";
import {  Fieldset  } from "@base-framework/ui/atoms";
...
])`}),t({title:"Contact Form",description:"A contact form with a phone input and a textarea for messages.",preview:[N([ko()])],code:`import {  Button, TelInput, Textarea  } from "@base-framework/ui/atoms";
import {  Form, FormField  } from "@base-framework/ui/molecules";
import { Div } from "@base-framework/atoms";
import { Atom } from "@base-framework/base";
import {  Fieldset  } from "@base-framework/ui/atoms";
...
])`}),t({title:"Settings Form",description:"A settings form with a toggle and a range slider.",preview:[N([To()])],code:`import {  Button, Toggle, RangeSlider  } from "@base-framework/ui/atoms";
import {  Form, FormField  } from "@base-framework/ui/molecules";
import { Div } from "@base-framework/atoms";
import { Atom } from "@base-framework/base";
import {  Fieldset  } from "@base-framework/ui/atoms";
...
Textarea({
    placeholder: 'Enter your text here...'
})`}),t({title:"Search Dropdown",description:"This is a search dropdown.",preview:[o({class:"relative w-full max-w-md"},[new Qe({options:Co,onSelect:e=>console.log(e)})])],code:`import {  SearchDropdown  } from "@base-framework/ui/organisms";
...
HiddenInput({
    value: 'hidden-value',
});`}),t({title:"Checkbox",description:"This is a checkbox input.",preview:[new W({label:"Check me",onChange:e=>console.log(e)})],code:`
import {  Checkbox  } from "@base-framework/ui/atoms";

new Checkbox({
    label: 'Check me',
    check: (checked) => console.log(checked)
})`}),t({title:"Select",description:"This is a select input.",preview:[h([T({options:Io,change:e=>console.log(e.target.value)})])],code:`import {  Select  } from "@base-framework/ui/atoms";
...
new DatePicker()`}),t({title:"Range Slider",description:"This is a range slider input.",preview:[h([new ve({min:0,max:100,value:50,change:e=>console.log(e)})])],code:`
import {  RangeSlider  } from "@base-framework/ui/atoms";
...
});`}),p({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Removing Items"),i({class:"text-muted-foreground"},"Use remove() to delete items by their key. You can pass an array of items."),x(`// Suppose 'list' is an instance of the List component.

// Removing a single item:
list.remove([ item ]);

// Removing multiple items:
list.remove([ item1, item2 ]);`)]),p({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Setting Rows"),i({class:"text-muted-foreground"},"Use setRows() to directly replace the entire items array in the list."),x(`const newData = [
    { name: 'Alice', email: 'alice@example.com' },
    { name: 'Bob', email: 'bob@example.com' }
];
list.setRows(newData); // Replaces entire list with newData
`)]),p({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Getting Rows"),i({class:"text-muted-foreground"},"Use getRows() to retrieve the current items array in the list."),x(`const currentItems = list.getRows();
console.log('Current list items:', currentItems);
`)]),p({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Resetting the List"),i({class:"text-muted-foreground"},"Use reset() to clear all items, returning it to an empty list. Dividers are also reset, if any."),x(`list.reset(); // Empties the list's items array
`)]),p({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Appending Items"),i({class:"text-muted-foreground"},"Use append() to add new items to the end of the list. Accepts an array or single object."),x(`// Single item
...
`)]),p({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Mingling Items"),i({class:"text-muted-foreground"},"Use mingle(newItems, withDelete) to merge new items into existing ones, removing old ones if not present when withDelete = true. Compares based on the key property."),x(`const newItems = [
...
`)]),p({class:"space-y-4 mt-8"},[c({class:"text-lg font-bold"},"Prepending Items"),i({class:"text-muted-foreground"},"Use prepend() to add new items at the beginning of the list, shifting existing items down."),x(`// Single item
...
`)])]),H=[{label:"Large",buttonStyle:"primary",size:"lg"},{label:"Small",buttonStyle:"secondary",size:"sm"},{label:"Medium",buttonStyle:"destructive",size:"md"},{label:"XL",buttonStyle:"primary",size:"xl"},{label:"Right",buttonStyle:"ghost",type:"right"},{label:"Left",buttonStyle:"link",type:"left"}],z=({label:e,buttonStyle:a,size:n,type:d})=>l({text:e,class:`m-1 ${a}`,click:()=>new G({title:"Are you absolutely sure?",size:n,type:d},[o({class:"flex flex-col max-w-lg lg:p-4 space-y-8"},[new m({name:"popover-test",label:"Popover Test"},[new se]),new m({name:"dialog-test",label:"Dialog Test"},[l({click:()=>{new ie({title:"Are you absolutely sure?",description:"This action cannot be undone.",confirmTextLabel:"Save",confirmed:()=>{app.notify({icon:s.trash,title:"Action complete",description:"You confirmed your selection.",type:"destructive"})}}).open()}},"Confirm")])])]).open()}),Bo=({size:e="md",type:a="center"})=>new G({title:"Report an Issue",icon:s.warning,description:"What area are you having problems with?",size:e,type:a,onSubmit:()=>console.log("Form submitted")},[o({class:"flex flex-col lg:p-4 space-y-8"},[E({legend:"Issue Details"},[o({class:"flex flex-auto w-full gap-4"},[new m({name:"area",label:"Area"},[T({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"billing",label:"Billing"},{value:"technical",label:"Technical"},{value:"account",label:"Account"},{value:"other",label:"Other"}],defaultValue:"billing"})]),new m({name:"security_level",label:"Security Level"},[T({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"severity_1",label:"Severity 1"},{value:"severity_2",label:"Severity 2"},{value:"severity_3",label:"Severity 3"}],defaultValue:"severity_2"})])]),new m({name:"subject",label:"Subject"},[C({type:"text",placeholder:"I need help with...",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),new m({name:"description",label:"Description"},[$({placeholder:"Please include all information relevant to your issue.",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})])])])]),me=({label:e,buttonStyle:a,size:n,type:d})=>l({text:e,class:`m-1 ${a}`,click:()=>Bo({size:n,type:d}).open()}),Ae=()=>[new xe({icon:s.ellipsis.vertical,groups:[[{icon:s.mapPin,label:"Track Item",value:"track-item"},{icon:s.trash,label:"Delete Item",value:"delete-item"}]],onSelect:e=>{console.log("Selected item from header:",e)}})],Po=()=>new G({title:"Detail Example",description:"This is a detailed view of an item.",icon:s.information,size:"md",headerOptions:Ae,hidePrimaryButton:!0},[ht([re({title:"Overview"},[F("Label","Value"),F("Date","2024-11-02"),o({class:"my-2 border-t"}),F("Status","Pending")]),re({title:"More Info"},[F("Description","This is a multi-line snippet."),F("Comments","No comments available.")])])]),Mo=()=>l({text:"Detail Modal",variant:"outline",click:()=>Po().open()}),jo=()=>f({title:"Modals",description:"Displays modals or modal-like components with various sizes, forms, and header options."},[t({title:"Detail Modal Atoms",description:"Demonstrates usage of DetailBody, DetailSection, and SplitRow within a modal.",preview:[Mo()],code:`
...
`}),t({title:"Header Options",description:"You can pass `headerOptions` as an array of atoms for the modal’s top-right actions. Below is an example with a DropdownMenu in the modal header.",preview:[l({text:"Open Modal with Header Options",variant:"secondary",click:()=>new G({title:"Modal with Header Options",icon:s.settings,headerOptions:Ae,hidePrimaryButton:!0},[o({class:"p-4"},"This modal has an ellipsis menu in the header.")]).open()})],code:`
...
`}),t({title:"Extra Large Modal",description:"An extra large modal example.",preview:[z(H[3])],code:`
import {  Modal  } from "@base-framework/ui/molecules";
import {  Button  } from "@base-framework/ui/atoms";
...
});`}),t({title:"Large Modal",preview:[z(H[0])],code:`
import {  Modal  } from "@base-framework/ui/molecules";
import {  Button  } from "@base-framework/ui/atoms";
...
});`}),t({title:"Medium Modal",preview:[z(H[2])],code:`
import {  Modal  } from "@base-framework/ui/molecules";
import {  Button  } from "@base-framework/ui/atoms";
...
});`}),t({title:"Right Modal",preview:[z(H[4])],code:`
import {  Modal  } from "@base-framework/ui/molecules";
import {  Button  } from "@base-framework/ui/atoms";
...
])`}),t({title:"Skeleton with Avatar Loading",description:"This example demonstrates a skeleton loading animation that transitions to an avatar and user info after 3 seconds.",preview:[new Eo],code:`import {  Skeleton  } from "@base-framework/ui/atoms";
...
LoadingAvatar();`})]),de=v((e,a)=>o({class:"py-4"},a)),No=()=>f({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[t({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new pe({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:de([])},{label:"Code",value:"code",layout:de([])}]})],code:`
...
Tooltip({ content: 'This is a tooltip.' }, [
    ...
    Button('Hover me')
])`}),i({class:"text-muted-foreground text-sm mt-4"},"The tooltip position can be set to: top, top-right, top-left, bottom, bottom-right, bottom-left, left, right.")]),ue=(e,a,n)=>(n="Icons"+(n?"."+n:""),o({class:"flex flex-auto flex-col items-center gap-2 w-full max-w-[150px] h-[8.5rem] cursor-pointer"},[o({class:"flex flex-auto w-full h-full justify-center items-center flex-wrap rounded-lg border bg-card text-base shadow-sm hover:bg-muted/50",click:()=>{navigator.clipboard.writeText(`${n}.${a}`),app.notify({title:"Icon copied",description:`The icon '${n}.${a}' has been copied to your clipboard.`,icon:s.clipboard.checked})}},[w(e)]),o({class:"text-muted-foreground"},a)])),Be=(e,a,n)=>{const d=typeof e=="object";d&&a.push(i({class:"text-muted-foreground"},"path: "+n+".{icon}"));const g=[];if(a.push(o({class:"flex flex-auto flex-wrap gap-2 my-8"},g)),d===!1)g.push(ue(e,n));else for(var R in e){if(e.hasOwnProperty(R)===!1)continue;const _=e[R];if(typeof _!="object"){g.push(ue(_,R,n));continue}const Pe=`${n}.${R}`;Be(_,a,Pe)}},zo=e=>{if(!e||typeof e!="object")return;const a=[];for(let[n,d]of Object.entries(e)){if(n==="parse")continue;a.push(oe({id:n.toLowerCase(),class:"text-2xl font-bold"},It.titleCase(n))),Be(d,a,n)}return a},Uo=()=>f({title:"Icons",description:"The icons are from the Hericon library. They are SVG icons that can be used in your project. This icon set uses the outline style."},[S({href:"https://heroicons.com/",target:"_blank",class:"bttn link"},"link: Hericons"),t({title:"Icons",description:"This is an icon.",preview:[St({html:s.home})],code:`
import {  Icons  } from "@base-framework/ui/icons";
...
});`)]),p({class:"space-y-4 mt-12"},[c({class:"text-lg font-bold"},"Contributors and Community"),i({class:"text-muted-foreground"},[r("The App Shell is an open-source project, and contributions from the community are welcome. The project is maintained by a dedicated developer who aims to continuously enhance its functionality.")]),i({class:"text-muted-foreground"},[r("For information on contributing, check the "),S({href:"https://github.com/chrisdurfee/next-app-shell",class:"underline",target:"_blank"},"GitHub repository"),r(" and join the community discussions to collaborate and innovate.")])])]),Oo=e=>o({class:"flex flex-auto flex-col items-center gap-2 max-w-[150px] h-[8.5rem] cursor-pointer"},[o({class:`flex flex-auto w-full h-full min-h-[136px] justify-center items-center flex-wrap rounded-lg border text-base shadow-sm ${e.class}`,click:()=>{navigator.clipboard.writeText(`${e.class}`),app.notify({title:"Color copied",description:`The color '${e.class}' has been copied to your clipboard.`,icon:s.clipboard.checked})}}),o({class:"text-sm text-muted-foreground"},e.var)]),y=(e,a)=>p({class:"flex flex-auto flex-col gap-2"},[i({class:"text-base text-muted-foreground"},e),o({class:"flex flex-auto flex-wrap gap-2 my-2",map:[a,Oo]})]),Wo=e=>o({class:"flex flex-auto flex-col gap-12"},[oe({class:"text-2xl font-bold"},"Theme Toggle"),new Ct,oe({class:"text-2xl font-bold"},"Color Guide"),y("Default background color of <body />...etc",[{var:"--backround",class:"bg-backround"},{var:"--foreground",class:"bg-foreground"}]),y("Muted backgrounds such as <TabsList />, <Skeleton /> and <Switch />",[{var:"--muted",class:"bg-muted"},{var:"--muted-foreground",class:"bg-muted-forground"}]),y("Background color for <Card />",[{var:"--card",class:"bg-card"},{var:"--card-foreground",class:"bg-card-foreground"}]),y("Background color for popovers such as <DropdownMenu />, <HoverCard />, <Popover />",[{var:"--popover",class:"bg-popover"},{var:"--popover-foreground",class:"bg-popover-foreground"}]),y("Default border color",[{var:"--border",class:"bg-border"}]),y("Border color for inputs such as <Input />, <Select />, <Textarea />",[{var:"--input",class:"bg-input"}]),y("Primary colors for <Button />",[{var:"--primary",class:"bg-primary"},{var:"--primary-foreground",class:"bg-primary-foreground"}]),y("Secondary colors for <Button />",[{var:"--secondary",class:"bg-secondary"},{var:"--secondary-foreground",class:"bg-secondary-foreground"}]),y("Used for accents such as hover effects on <DropdownMenuItem>, <SelectItem>...etc",[{var:"--accent",class:"bg-accent"},{var:"--accent-foreground",class:"bg-accent-foreground"}]),y('Used for destructive actions such as <Button variant="destructive">',[{var:"--destructive",class:"bg-destructive"},{var:"--destructive-foreground",class:"bg-destructive-foreground"}]),y('Used for warning actions such as <Button variant="warning">',[{var:"--warning",class:"bg-warning"},{var:"--warning-foreground",class:"bg-warning-foreground"}]),y("Used for focus ring",[{var:"--ring",class:"bg-ring"}]),y("Border radius for card, input and buttons",[{var:"--radius",class:"bg-radius"}])]),Go=()=>f({title:"Theme",description:"The theme is using Tailwind CSS and is based on Shadcn UI. The theme is customizable and can be extended. It comes with light and dark theme support."},[i({class:"text-muted-foreground"},{html:'To learn about Shandcn UI, visit the official documentation: <a href="https://ui.shadcn.com/docs/theming" class="underline" target="_blank">Shadcn Documentation'}),o({class:"my-20"},[ae({class:"text-2xl font-bold"},"Default Styles"),i({class:"text-muted-foreground"},"The default styles are defined in the Tailwind CSS configuration file and in the base CSS file. Here's the list of variables available for customization:")]),Wo(),o({class:"flex flex-auto flex-col gap-2 mt-20"},[o({class:"flex flex-auto flex-col gap-2"},[c({class:"text-2xl font-bold"},"Text Sizes"),i({class:"text-muted-foreground text-3xl"},"Text-3xl A test sentence."),i({class:"text-muted-foreground text-2xl"},"Text-2xl A test sentence."),i({class:"text-muted-foreground text-xl"},"Text-xl A test sentence."),i({class:"text-muted-foreground text-lg"},"Text-lg A test sentence."),i({class:"text-muted-foreground text-base"},"Text-base A test sentence."),i({class:"text-muted-foreground text-sm"},"Text-sm A test sentence."),i({class:"text-muted-foreground text-xs"},"Text-xs A test sentence.")])])]),u=(e,a,n)=>({uri:e,title:a,component:n}),_o=e=>[u(`${e}`,"Introduction",qo),u(`${e}/theme`,"Theme",Go),u(`${e}/icons`,"Icons",Uo),u(`${e}/components/buttons*`,"Buttons",Nt),u(`${e}/components/badges*`,"Badges",$t),u(`${e}/components/tabs*`,"Tabs",No),u(`${e}/components/modals*`,"Modals",jo),u(`${e}/components/notifications*`,"Notifications",Fo),u(`${e}/components/dialogs*`,"Modals",bo),u(`${e}/components/cards*`,"Cards",ao),u(`${e}/components/calendars*`,"Calendars",zt),u(`${e}/components/avatars*`,"Avatars",Ft),u(`${e}/components/inputs*`,"Inputs",Do),u(`${e}/components/forms*`,"Forms",So),u(`${e}/components/alerts*`,"Alerts",Lt),u(`${e}/components/comboboxes*`,"Comboboxes",io),u(`${e}/components/lists*`,"Lists",Ao),u(`${e}/components/data-tables*`,"Data Tables",mo),u(`${e}/components/breadcrumbs*`,"Breadcrumbs",Rt),u(`${e}/components/navigations*`,"Navigations",Lo),u(`${e}/components/progress-bars*`,"Progress Bars",$o),u(`${e}/components/skeletons*`,"Skeletons",Ro),u(`${e}/components/tooltips*`,"Tooltips",Ho),u(`${e}/components/dropdown-menus*`,"Dropdown Menus",wo)],Yo=e=>[{href:`${e}`,label:"Introduction",exact:!0},{href:`${e}/theme`,label:"Theme",exact:!0},{href:`${e}/icons`,label:"Icons"},{group:"Components",options:[{label:"Buttons",href:`${e}/components/buttons`},{label:"Badges",href:`${e}/components/badges`},{label:"Tabs",href:`${e}/components/tabs`},{label:"Modals",href:`${e}/components/modals`},{label:"Notifications",href:`${e}/components/notifications`},{label:"Dialogs",href:`${e}/components/dialogs`},{label:"Cards",href:`${e}/components/cards`},{label:"Calendars",href:`${e}/components/calendars`},{label:"Avatars",href:`${e}/components/avatars`},{label:"Inputs",href:`${e}/components/inputs`},{label:"Forms",href:`${e}/components/forms`},{label:"Alerts",href:`${e}/components/alerts`},{label:"Comboboxes",href:`${e}/components/comboboxes`},{label:"Lists",href:`${e}/components/lists`},{label:"Data Tables",href:`${e}/components/data-tables`},{label:"Breadcrumbs",href:`${e}/components/breadcrumbs`},{label:"Navigations",href:`${e}/components/navigations`},{label:"Progress Bars",href:`${e}/components/progress-bars`},{label:"Skeletons",href:`${e}/components/skeletons`},{label:"Tooltips",href:`${e}/components/tooltips`},{label:"Dropdown Menus",href:`${e}/components/dropdown-menus`}]}],Q="docs",Vo=()=>new Dt({title:"Documentation",basePath:Q,switch:_o(Q),links:Yo(Q)});export{Vo as DocumentationPage,Vo as default};
