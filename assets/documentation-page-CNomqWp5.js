import{S as ze}from"./sidebar-menu-page-BUxq38ru.js";import{o as ae,Y as o,u as y,p as be,Z as se,q as ne,w as M,Q as b,x as qe,N as Ue,a as s,l as R,s as re,G as c,y as We,E as Oe,r as xe,H as E,A as v,K as w,z as r,L as _e,_ as O,R as _,J as T,B as l,b as we,U as Ge,V as Ve,W as Je,X as Ye,$ as Qe,a0 as I,I as g,a1 as B,F as u,a2 as L,a3 as G,a4 as ie,c as C,a5 as k,a6 as H,a7 as V,a8 as le,a9 as ve,aa as Ke,D as ye,ab as Ze,i as X,ac as Xe,ad as Y,j as D,C as J,ae as Te,af as ke,P as N,ag as ce,ah as ee,ai as te,aj as et,ak as tt,al as Q,am as ot,an as at,ao as st,ap as nt,aq as rt,ar as it,as as lt,at as ct,au as dt,av as ut,M as Se,aw as mt,ax as pt,f as ft,ay as F,S,k as Ce,T as gt,d as A,az as oe,v as ht,aA as bt,O as xt,m as wt}from"./index-Co6i5WPL.js";import{U as vt}from"./user-list-Cjw9jW5N.js";const yt=e=>ne({class:"inline-flex flex-auto items-center justify-center whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm",dataSet:["selected",["state",e.value,"active"]]},[M({class:"flex flex-auto justify-center items-center px-3 py-1.5",onSet:["selected",{selected:e.value}],click:t=>e.callBack(e.value)},e.label)]),Tt=(e,t)=>(e.callBack=t,yt(e)),kt=e=>be({class:`tab items-center justify-center rounded-md bg-muted p-1 text-muted-foreground ${e.class}`},[se({class:"flex flex-auto flex-row",map:[e.options,t=>Tt(t,e.callBack)]})]);class Ie extends ae{render(){const t=this.select.bind(this);return o({class:""},[kt({class:this.class,options:this.options,callBack:t}),y({class:"tab-content",onState:["selected",this.updateContent.bind(this)]})])}getFirstValue(){var t;return(t=this.options[0])==null?void 0:t.value}update(){const t=this.state.get("selected");this.select(null),this.select(t)}select(t){this.state.selected=t}updateContent(t){const n=this.options;if(!n||n.length<1)return;const i=n[0];for(const d of n)if(d.value===t)return d.layout;return i.layout}setupStates(){const t=this.callBack,n=typeof t;return{selected:{state:this.getFirstValue(),callBack(i){n==="function"&&t(i)}}}}}const je=b((e,t)=>qe({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces break-all cursor-pointer"},[Ue({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(t[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:s.clipboard.checked})}},t)])),St=b((e,t)=>o({class:"flex flex-auto p-4 min-h-[350px] max-h-[650px] overflow-x-auto max-w-[90vw] rounded-lg border bg-card"},[o({class:"preview flex flex-auto justify-center items-center"},t)])),de=b((e,t)=>o({class:"py-4"},t)),Ct=e=>new Ie({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:de([St(e.preview)])},{label:"Code",value:"code",layout:de([je(e.code)])}]}),It=b(({title:e,description:t})=>R({class:"flex flex-col"},[re({class:"scroll-m-20 text-2xl font-bold tracking-tight"},e),t&&c({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),a=b((e,t)=>y({class:"grid py-4"},[It({title:e.title,description:e.description}),Ct({preview:e.preview,code:e.code})]));class jt extends We{render(){return Oe([o({class:"contained px-4 flex flex-auto flex-col"},this.children)])}}const At=b(({title:e,description:t})=>R({class:"flex flex-col"},[xe({class:"scroll-m-20 text-3xl font-bold tracking-tight"},e),c({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),Dt=b((e,t)=>o({class:"contained py-8"},[At(e),y({class:"pb-12 pt-8"},t)])),p=b((e,t)=>new jt([Dt(e,t)])),Bt=()=>p({title:"Alerts",description:"Alerts are used to provide feedback to the user about the outcome of an action or to inform them of important information."},[a({title:"Default Alert",description:"This is a standard alert without any specific type.",preview:[E({title:"Notice",description:"This is a default alert without a specific type.",icon:s.information})],code:`import { Alert } from "@components/molecules/alert.js";
...
})`}),a({title:"Info Alert",description:"An info alert that provides general information to the user.",preview:[E({title:"Heads up!",description:"You can add components to your app using the CLI.",icon:s.information,type:"info"})],code:`Alert({
    title: 'Heads up!',
    description: 'You can add components to your app using the CLI.',
    icon: Icons.information,
    type: 'info'
})`}),a({title:"Success Alert",description:"A success alert to inform the user of a successful action.",preview:[E({title:"Success!",description:"Your changes have been saved successfully.",icon:s.check,type:"success"})],code:`Alert({
    title: 'Success!',
    description: 'Your changes have been saved successfully.',
    icon: Icons.check,
    type: 'success'
})`}),a({title:"Warning Alert",description:"A warning alert to caution the user about something important.",preview:[E({title:"Warning!",description:"Please check your input before proceeding.",icon:s.warning,type:"warning"})],code:`Alert({
    title: 'Warning!',
    description: 'Please check your input before proceeding.',
    icon: Icons.warning,
    type: 'warning'
})`}),a({title:"Destructive Alert",description:"A destructive alert to inform the user of an error or serious issue.",preview:[E({title:"Error!",description:"Something went wrong. Please try again later.",icon:s.shield,type:"destructive"})],code:`Alert({
    title: 'Error!',
...
Button({ ...props, variant: 'secondary' }, primary)`}),R({class:"flex flex-col py-8"},[we({class:"text-3xl font-bold tracking-tight border-b pb-2"},"Variants")]),a({title:"Primary Button",description:"This is a primary button.",preview:[l({variant:"primary"},"Click Me")],code:`
...
})`})]),P=({title:e,description:t})=>R({class:"text-left"},[we({class:"font-semibold tracking-tight text-2xl"},e),c({class:"text-sm text-muted-foreground"},t)]),Ot=()=>o({class:"flex items-center justify-center gap-4"},[l({variant:"outline",class:"gap-2 w-full",click:()=>console.log("Sign in with Github"),"aria-label":"Sign in with Github"},[g(s.companies.gitHub),r("Github")]),l({variant:"outline",class:"gap-2 w-full",click:()=>console.log("Sign in with Google"),"aria-label":"Sign in with Google"},[g(s.companies.google),r("Google")])]),_t=()=>B({submit:e=>{e.preventDefault(),console.log("Account created")}},[new u({name:"email",label:"Email"},[L({type:"email",placeholder:"m@example.com",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),new u({name:"password",label:"Password"},[L({type:"password",placeholder:"Your password",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),l({type:"submit",class:"w-full mt-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition"},"Create account")]),Ae=()=>I({class:"w-full max-w-md mx-auto p-8 bg-card space-y-6"},[P({title:"Create an account",description:"Enter your email below to create your account"}),Ot(),o({class:"relative"},[o({class:"absolute inset-0 flex items-center"},[r({class:"flex-grow border-t"})]),o({class:"relative flex justify-center text-xs uppercase"},[r({class:"bg-background px-2 text-muted-foreground"},"or continue with")])]),_t()]),K=({title:e,description:t,defaultState:n,onChange:i})=>o({class:"flex items-start justify-between gap-2"},[o({class:"text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex flex-col space-y-1"},[r({class:"font-medium text-foreground"},e),r({class:"font-normal leading-snug text-muted-foreground"},t)]),new G({active:n,change:i})]),De=()=>I({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[P({title:"Cookie Settings",description:"Manage your cookie settings here."}),o({class:"pt-0 grid gap-6"},[K({title:"Strictly Necessary",description:"These cookies are essential in order to use the website and use its features.",defaultState:!0,onChange:e=>console.log("Strictly Necessary:",e)}),K({title:"Functional Cookies",description:"These cookies allow the website to provide personalized functionality.",defaultState:!1,onChange:e=>console.log("Functional Cookies:",e)}),K({title:"Performance Cookies",description:"These cookies help to improve the performance of the website.",defaultState:!1,onChange:e=>console.log("Performance Cookies:",e)})]),l({variant:"outline",class:"w-full",click:()=>console.log("Preferences saved")},"Save preferences")]),Be=({startDate:e})=>I({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[P({title:"Pick a Date",description:"When is the event?"}),o({class:"font-medium text-foreground"},[new ie({selectedDate:e,selectedCallBack:t=>console.log(t)})])]),Z=b(({value:e,label:t,icon:n})=>M({class:'text-sm gap-1 font-medium leading-none disabled:cursor-not-allowed disabled:opacity-70 flex flex-col items-center justify-between rounded-md border-2 border-muted bg-popover p-4 hover:bg-accent hover:text-accent-foreground data-[state="active"]:border-primary [&:has([data-state="active"])]:border-primary',onState:["method",{active:e}],dataSet:["method",["state",e,"active"]],click:(i,{state:d})=>d.method=e},[g(n),r(t)])),Gt=O({render(){return o({class:"flex flex-auto flex-col"},[o({class:"grid grid-cols-3 gap-4"},[Z({label:"Card",value:"card",icon:s.creditCard}),Z({label:"Paypal",value:"paypal",icon:s.companies.paypal}),Z({label:"Apple",value:"apple",icon:s.companies.apple})])])},state(){return{method:null}}}),Vt=()=>o({class:"flex items-center justify-center gap-4"},[new Gt]),Jt=()=>B({submit:e=>{e.preventDefault(),console.log("Payment method added")}},[new u({name:"name",label:"Name"},[C({type:"text",placeholder:"First Last",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),new u({name:"card_number",label:"Card number"},[C({type:"text",placeholder:"1234 5678 9012 3456",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),o({class:"flex gap-4 mt-4"},[new u({name:"month",label:"Expires"},[k({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"",label:"Month",disabled:!0},...Array.from({length:12},(e,t)=>({value:`${t+1}`,label:`${t+1}`.padStart(2,"0")}))]})]),new u({name:"year",label:"Year"},[k({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"",label:"Year",disabled:!0},...Array.from({length:10},(e,t)=>({value:`${new Date().getFullYear()+t}`,label:`${new Date().getFullYear()+t}`}))]})]),new u({name:"cvc",label:"CVC"},[C({type:"text",placeholder:"CVC",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})])]),l({type:"submit",class:"w-full mt-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition"},"Continue")]),Pe=()=>I({class:"w-full max-w-md mx-auto p-8 bg-card space-y-6"},[P({title:"Payment Method",description:"Add a new payment method to your account."}),Vt(),o({class:"space-y-4"},[Jt()])]),Yt=({name:e,description:t,stars:n,language:i,lastUpdated:d})=>o({class:"flex items-start justify-between py-4 border-b border-muted last:border-b-0"},[o({class:"flex flex-col"},[r({class:"font-semibold text-foreground"},e),r({class:"text-sm text-muted-foreground"},t),o({class:"flex space-x-4 text-sm text-muted-foreground mt-3"},[o({class:"flex items-center gap-2"},[g({class:" text-blue-500"},s.document.text),r(` ${i}`)]),o({class:"flex items-center"},[g(s.star),r(` ${n}`)]),o(`Updated ${d}`)])]),l({variant:"secondary",class:"px-3 py-1 gap-1 flex items-center rounded-md",click:()=>console.log(`Starred ${e}`)},[g(s.star),r("Star")])]),Qt=({projects:e})=>o({class:"space-y-3"},e.map(t=>Yt(t))),Kt=[{name:"shadcn/ui",description:"Beautifully designed components that you can copy and paste into your apps. Accessible. Customizable. Open Source.",stars:"20k",language:"TypeScript",lastUpdated:"April 2023"},{name:"base-framework",description:"A robust framework for building and structuring large-scale applications with ease.",stars:"2",language:"JavaScript",lastUpdated:"June 2024"}],Zt=()=>I({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[o({class:"font-semibold text-lg text-foreground"},"Projects"),Qt({projects:Kt})]),Xt=()=>B({submit:e=>{e.preventDefault(),console.log("Issue reported")}},[o({class:"flex flex-auto w-full gap-4"},[new u({name:"area",label:"Area"},[k({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"billing",label:"Billing"},{value:"technical",label:"Technical"},{value:"account",label:"Account"},{value:"other",label:"Other"}],defaultValue:"billing",change:e=>console.log(`Area selected: ${e.target.value}`)})]),new u({name:"security_level",label:"Security Level"},[k({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"severity_1",label:"Severity 1"},{value:"severity_2",label:"Severity 2"},{value:"severity_3",label:"Severity 3"}],defaultValue:"severity_2",change:e=>console.log(`Security Level selected: ${e.target.value}`)})])]),new u({name:"subject",label:"Subject"},[C({type:"text",placeholder:"I need help with...",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),new u({name:"description",label:"Description"},[H({placeholder:"Please include all information relevant to your issue.",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),o({class:"flex justify-end gap-4 mt-4"},[l({variant:"outline",class:"px-4 py-2",click:()=>console.log("Cancel clicked")},"Cancel"),l({type:"submit",class:"px-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition"},"Submit")])]),Fe=()=>I({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[P({title:"Report an issue",description:"What area are you having problems with?"}),Xt()]),eo=({link:e})=>o({class:"flex items-center gap-4 py-2"},[L({type:"text",value:e,readOnly:!0,class:"border p-2 rounded-md w-full bg-background text-foreground"}),l({variant:"secondary",class:"px-4 py-2",click:()=>{navigator.clipboard.writeText(e),app.notify({title:"Link copied",description:"The link has been copied to your clipboard.",icon:s.clipboard.checked})}},"Copy Link")]),to=({name:e,email:t,access:n,image:i})=>o({class:"flex items-center justify-between gap-4 py-2"},[o({class:"flex items-center gap-3"},[v({src:i,alt:e,fallbackText:e.split(" ").map(d=>d[0]).join("")}),o({},[r({class:"font-medium text-foreground"},e),r({class:"block text-sm text-muted-foreground"},t)])]),k({class:"border rounded-md bg-background text-foreground px-3 py-1",options:[{value:"edit",label:"Can edit"},{value:"view",label:"Can view"},{value:"comment",label:"Can comment"}],defaultValue:n,change:d=>console.log(`Access level changed for ${e}: ${d.target.value}`)})]),oo=({people:e})=>o({class:"space-y-3"},e.map(t=>to(t))),Le=({link:e,people:t})=>I({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[P({title:"Share this document",description:"Anyone with the link can view this document."}),eo({link:e}),o({class:"border-t my-4"}),o({class:"font-medium text-foreground"},"People with access"),oo({people:t})]),ao=e=>e.split(" ").map(n=>n[0]).join(""),so=({name:e,email:t,role:n,image:i})=>o({class:"flex items-center justify-between gap-4 py-2"},[o({class:"flex items-center gap-3"},[v({src:i,alt:e,fallbackText:ao(e)}),o({},[r({class:"font-medium text-foreground"},e),r({class:"block text-sm text-muted-foreground"},t)])]),k({class:"border rounded-md bg-background text-foreground px-3 py-1",options:[{value:"owner",label:"Owner"},{value:"member",label:"Member"}],defaultValue:n,change:d=>console.log(`Role changed for ${e}: ${d.target.value}`)})]),no=({members:e})=>o({class:"space-y-3"},e.map(t=>so(t))),Me=({members:e})=>I({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[P({title:"Team Member",description:"Invite your team members to collaborate."}),no({members:e})]),ro=()=>p({title:"Cards",description:"Cards are a great way to display content in a concise and organized manner."},[a({title:"Usage",description:"Import the card atom and use it in your components.",preview:[I()],code:`import { Button } from '@components/atoms/cards/card.js';
...
})`})]),fo=()=>{const e=[{id:1,status:"Active",email:"user1@example.com",amount:500.5},{id:2,status:"Inactive",email:"user2@example.com",amount:250.75},{id:3,status:"Active",email:"user3@example.com",amount:300}],t=()=>Ze([X({class:"text-muted-foreground border-b"},[Xe({}),Y({key:"status",label:"Custom Status"}),Y({key:"email",label:"User Email"}),Y({key:"amount",label:"Amount (USD)",align:"justify-end"})])]),n=(i,d)=>X({class:"items-center px-4 py-2 hover:bg-accent"},[D({class:"p-4"},[new J({checked:i.selected,class:"mr-2",click:()=>d(i)})]),D({class:"p-4 justify-center"},i.status),D({class:"p-4"},i.email),D({class:"p-4 text-right"},`$${i.amount.toFixed(2)}`)]);return o({class:"w-full mt-4"},[o({class:"w-full rounded-md border overflow-x-auto"},[Ke({class:"w-full"},[new ye({key:"id",customHeader:t(),rows:e,rowItem:n})])])])},go=[{label:"checkbox",key:""},{label:"Status",key:"status"},{label:"Email",key:"email"},{label:"Amount",key:"amount",align:"justify-end"}],ho=[{id:1,status:"Success",email:"ken99@yahoo.com",amount:316,selected:!1},{id:2,status:"Success",email:"abe45@gmail.com",amount:242,selected:!1},{id:3,status:"Processing",email:"monserrat44@gmail.com",amount:837,selected:!1},{id:4,status:"Success",email:"silas22@gmail.com",amount:874,selected:!1},{id:5,status:"Failed",email:"carmella@hotmail.com",amount:721,selected:!1}],bo=(e,t)=>X({class:"items-center px-4 py-2 hover:bg-accent"},[D({class:"p-4 "},[new J({checked:e.selected,class:"mr-2",onChange:()=>t(e)})]),D({class:"p-4 "},[r({class:"text-muted-foreground"},e.status)]),D({class:"p-4 "},e.email),D({class:"p-4 text-right"},`$${e.amount.toFixed(2)}`)]),xo=()=>p({title:"Data Tables",description:"Data tables are used to display data in a structured format. They can be used to display a list of items, a grid of items, or a table of items."},[a({title:"Usage",description:"The data table component is used to display data in a structured format. It can be used to display a list of items, a grid of items, or a table of items.",preview:[new ye({headers:go,rows:ho,rowItem:bo,key:"id"})],code:`import { DataTable } from "@components/organisms/lists/data-table.js";
...
})`}),a({title:"Dropdown",description:'The Dropdown component is used to render a list of items within the dropdown menu. This uses the parent data "groups" to render the items.',preview:[new N({setData(){return new _({groups:[[{icon:s.user.default,label:"Profile",shortcut:"⌘P",value:"profile"},{icon:s.creditCard,label:"Billing",shortcut:"⌘B",value:"billing"},{icon:s.cog.six,label:"Settings",shortcut:"⌘S",value:"settings"},{icon:s.computerDesktop,label:"Keyboard shortcuts",shortcut:"⌘K",value:"shortcuts"}],[{icon:s.user.multiple,label:"Team",value:"team"},{icon:s.user.plus,label:"Invite users",value:"invite"},{icon:s.plus,label:"New Team",shortcut:"⌘T",value:"new_team"}],[{icon:s.github,label:"GitHub",value:"github"},{icon:s.helpCircle,label:"Support",value:"support"},{icon:s.api,label:"API",value:"api"}]]})}},[Ee({onSelect:e=>{console.log("Selected item:",e)}})])],code:`import { Icons } from "@components/icons/icons.js";
...
])`}),a({title:"Preferences Form",description:"A preferences form with a select input and a checkbox.",preview:[z([$o()])],code:`import { Button, Checkbox, Select } from "@components/atoms/form/input.js";
import { Form, FormField } from "@components/molecules/form/form.js";
...
])`}),a({title:"Contact Form",description:"A contact form with a phone input and a textarea for messages.",preview:[z([Eo()])],code:`import { Button, TelInput, Textarea } from "@components/atoms/form/input.js";
import { Form, FormField } from "@components/molecules/form/form.js";
...
])`}),a({title:"Settings Form",description:"A settings form with a toggle and a range slider.",preview:[z([No()])],code:`import { Button, Toggle, RangeSlider } from "@components/atoms/form/input.js";
import { Form, FormField } from "@components/molecules/form/form.js";
...
])`})]),Ro=({click:e})=>M({class:"flex items-center justify-center w-10 h-10 bg-muted rounded-full hover:bg-accent",click:e},[g(s.circleMinus)]),zo=({click:e})=>M({class:"flex items-center justify-center w-10 h-10 bg-muted rounded-full hover:bg-accent",click:e},[g(s.circlePlus)]),qo=({bind:e})=>o({class:"flex-grow text-center"},[le("count",t=>L({value:t,bind:e,class:"text-lg font-medium bg-transparent text-center border-none pointer-events-none",readonly:!0}))]),Uo=ce({state(){return{count:{state:this.initialCount??0,callBack(e){this.change&&this.change(e)}}}},render(){const e=this.class??"";return o({class:`flex items-center space-x-4 p-4 bg-background rounded-md shadow-md ${e}`},[Ro({click:()=>this.state.decrement("count")}),qo({bind:this.bind}),zo({click:()=>this.state.increment("count")})])}}),Wo=[{value:"next.js",label:"Next.js"},{value:"sveltekit",label:"SvelteKit"},{value:"nuxt.js",label:"Nuxt.js"},{value:"remix",label:"Remix"},{value:"astro",label:"Astro"}],f=b((e,t)=>o({...e,class:"flex flex-auto items-center justify-center w-full max-w-[350px]"},t)),me=({label:e,description:t,active:n,onChange:i})=>o({class:"flex items-center justify-between p-4 border rounded-md bg-muted/10 border-muted-foreground/20 mb-4"},[o({class:"flex flex-col pr-8"},[w({class:"font-semibold"},e),c({class:"text-sm text-muted-foreground"},t)]),new G({active:n,change:i})]),Oo=[{label:"Apple",value:"apple"},{label:"Banana",value:"banana"},{label:"Cherry",value:"cherry"},{label:"Date",value:"date"},{label:"Elderberry",value:"elderberry"},{label:"Fig",value:"fig"},{label:"Grape",value:"grape"},{label:"Honeydew",value:"honeydew"}],_o=()=>p({title:"Inputs",description:"Inputs are essential for gathering user data in forms."},[a({title:"Usage",description:"Import the input atom and use it in your components. The input can be of various types: text, password, email, etc.",preview:[o({class:"grid gap-2 w-full max-w-[350px]"},[C({type:"text",placeholder:"Enter your text here...",change:e=>console.log(e.target.value)}),ee({}),te({}),H({placeholder:"Enter your text here..."})])],code:`import { Input, EmailInput, TelInput, Textarea } from '@components/atoms/form/input.js';
...
Textarea({
    placeholder: 'Enter your text here...'
})`}),a({title:"Search Dropdown",description:"This is a search dropdown.",preview:[o({class:"relative w-full max-w-md"},[new et({options:Oo,onSelect:e=>console.log(e)})])],code:`import { SearchDropdown } from "@components/organisms/search/search-dropdown.js";
...
})`}),a({title:"Select",description:"This is a select input.",preview:[f([k({options:Wo,change:e=>console.log(e.target.value)})])],code:`import { Select } from "@components/atoms/form/select.js";
...
})`}),a({title:"Range Slider",description:"This is a range slider input.",preview:[f([new Uo({initialCount:5,change:e=>console.log(e)})])],code:`
...
`})]),Ko=()=>p({title:"Notifications",description:"Displays a notification message to the user."},[a({title:"Default Notification",description:"This is a standard notification without any specific type.",preview:[new F({title:"Default Notification",description:"This is a default notification.",icon:s.information,duration:"infinite"})],code:`app.notify({
    title: 'Default Notification',
    description: 'This is a default notification.',
    icon: Icons.info,
    duration: 'infinite'
})`}),c({class:"text-muted-foreground"},'The notification can either be a link with an "href" attribute or a button with an "onClick" event.'),a({title:"Info Notification",description:"An informational notification to inform users about general information.",preview:[new F({title:"Heads up!",description:"You can add components to your app using the CLI.",icon:s.information,type:"info",duration:"infinite"})],code:`app.notify({
    title: 'Heads up!',
    description: 'You can add components to your app using the CLI.',
    icon: Icons.information,
    type: 'info',
    duration: 'infinite'
})`}),a({title:"Warning Notification",description:"A warning notification to caution the user about potential issues.",preview:[new F({title:"Warning!",description:"Please check your input before proceeding.",icon:s.warning,type:"warning",duration:"infinite"})],code:`app.notify({
    title: 'Warning!',
    description: 'Please check your input before proceeding.',
    icon: Icons.warning,
    type: 'warning',
    duration: 5000
})`}),a({title:"Destructive Notification",description:"A destructive notification to alert the user of a serious issue or error.",preview:[new F({title:"Error!",description:"Something went wrong. Please try again later.",icon:s.shield,type:"destructive",duration:"infinite"})],code:`app.notify({
    title: 'Error!',
    description: 'Something went wrong. Please try again later.',
    icon: Icons.error,
    type: 'destructive',
    duration: 'infinite'
})`}),a({title:"Success Notification",description:"A success notification to confirm a successful action or process.",preview:[new F({title:"Success!",description:"The action was successful.",icon:s.check,type:"success",duration:"infinite"})],code:`app.notify({
    title: 'Success!',
    description: 'The action was successful.',
    icon: Icons.check,
    type: 'success',
    duration: 'infinite'
})`}),a({title:"Notification with Actions",description:"This notification includes primary and secondary buttons for user actions.",preview:[new F({title:"Action Required",description:"Would you like to proceed with this action?",icon:s.information,type:"info",primary:"Proceed",primaryAction:()=>console.log(1),secondary:"Cancel",secondaryAction:()=>console.log(1),duration:"infinite"})],code:`app.notify({
...
})`})]),Zo=e=>!e||isNaN(e)?null:e,fe=(e,t)=>{const n=e,i=16,d=2*Math.PI*i,j=n/100*d,$=`
...
LoadingAvatar();`})]);class na extends ae{render(){return o({class:"tab-panel"},[new Ce({class:this.class,options:this.options}),y({class:"tab-content",switch:this.addGroup()})])}addGroup(){let t;const n=[],i=this.options;for(let d=0,j=i.length;d<j;d++)t=i[d],n.push({uri:t.uri||t.href,component:t.component,title:t.title||null,persist:!0});return n}}const ge=b((e,t)=>o({class:"py-4"},t)),ra=()=>p({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[a({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new Ie({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:ge([])},{label:"Code",value:"code",layout:ge([])}]})],code:`
...
Tooltip({ content: 'This is a tooltip.' }, [
    ...
    Button('Hover me')
])`}),c({class:"text-muted-foreground text-sm mt-4"},"The tooltip position can be set to: top, top-right, top-left, bottom, bottom-right, bottom-left, left, right.")]),he=(e,t,n)=>(n="Icons"+(n?"."+n:""),o({class:"flex flex-auto flex-col items-center gap-2 w-full max-w-[150px] h-[8.5rem] cursor-pointer"},[o({class:"flex flex-auto w-full h-full justify-center items-center flex-wrap rounded-lg border bg-card text-base shadow-sm hover:bg-accent hover:text-accent-foreground",click:()=>{navigator.clipboard.writeText(`${n}.${t}`),app.notify({title:"Icon copied",description:`The icon '${n}.${t}' has been copied to your clipboard.`,icon:s.clipboard.checked})}},[g(e)]),o({class:"text-muted-foreground"},t)])),He=(e,t,n)=>{const i=typeof e=="object";i&&t.push(c({class:"text-muted-foreground"},"path: "+n+".{icon}"));const d=[];if(t.push(o({class:"flex flex-auto flex-wrap gap-2 my-8"},d)),i===!1)d.push(he(e,n));else for(var j in e){if(e.hasOwnProperty(j)===!1)continue;const $=e[j];if(typeof $!="object"){d.push(he($,j,n));continue}const Re=`${n}.${j}`;He($,t,Re)}},la=e=>{if(!e||typeof e!="object")return;const t=[];for(let[n,i]of Object.entries(e)){if(n==="parse")continue;t.push(oe({id:n.toLowerCase(),class:"text-2xl font-bold"},ht.titleCase(n))),He(i,t,n)}return t},ca=()=>p({title:"Icons",description:"The icons are from the Hericon library. They are SVG icons that can be used in your project. This icon set uses the outline style."},[T({href:"https://heroicons.com/",target:"_blank",class:"bttn link"},"link: Hericons"),a({title:"Icons",description:"This is an icon.",preview:[V({html:s.home})],code:`
import { Icons } from '@components/icons/icons.js';
import { I } from '@base-framework/atoms';

export const HomeIcon = () => (
    I({ html: Icons.home} )
);`}),a({title:"Icon Atom",description:"An Icon is a helper atom that makes it easier to use icons in your project. ",preview:[g(s.home)],code:`
import { Icon } from '@components/atoms/icon.js';

Icon(Icons.home);`}),a({title:"Icon Sizes",description:"Icons can be rendered in various sizes using the `class` property to apply Tailwind CSS classes. The following sizes are available: `xs`, `sm`, `md`, `lg`, `xl`, `2xl`, and `3xl`.",preview:[o({class:"flex flex-wrap gap-4 items-center"},[o({class:"flex flex-col items-center justify-center"},[g({size:"xs"},s.home),r({class:"text-sm text-muted-foreground"},"xs")]),o({class:"flex flex-col items-center justify-center"},[g({size:"sm"},s.home),r({class:"text-sm text-muted-foreground"},"sm")]),o({class:"flex flex-col items-center justify-center"},[g({size:"md"},s.home),r({class:"text-sm text-muted-foreground"},"md")]),o({class:"flex flex-col items-center justify-center"},[g({size:"lg"},s.home),r({class:"text-sm text-muted-foreground"},"lg")]),o({class:"flex flex-col items-center justify-center"},[g({size:"xl"},s.home),r({class:"text-sm text-muted-foreground"},"xl")]),o({class:"flex flex-col items-center justify-center"},[g({size:"2xl"},s.home),r({class:"text-sm text-muted-foreground"},"2xl")]),o({class:"flex flex-col items-center justify-center"},[g({size:"3xl"},s.home),r({class:"text-sm text-muted-foreground"},"3xl")])])],code:`
import { Icon } from '@components/atoms/icon.js';
...
});`)]),y({class:"space-y-4 mt-12"},[w({class:"text-lg font-bold"},"Contributors and Community"),c({class:"text-muted-foreground"},[r("The App Shell is an open-source project, and contributions from the community are welcome. The project is maintained by a dedicated developer who aims to continuously enhance its functionality.")]),c({class:"text-muted-foreground"},[r("For information on contributing, check the "),T({href:"https://github.com/chrisdurfee/next-app-shell",class:"underline",target:"_blank"},"GitHub repository"),r(" and join the community discussions to collaborate and innovate.")])])]),ua=e=>o({class:"flex flex-auto flex-col items-center gap-2 max-w-[150px] h-[8.5rem] cursor-pointer"},[o({class:`flex flex-auto w-full h-full min-h-[136px] justify-center items-center flex-wrap rounded-lg border text-base shadow-sm ${e.class}`,click:()=>{navigator.clipboard.writeText(`${e.class}`),app.notify({title:"Color copied",description:`The color '${e.class}' has been copied to your clipboard.`,icon:s.clipboard.checked})}}),o({class:"text-sm text-muted-foreground"},e.var)]),x=(e,t)=>y({class:"flex flex-auto flex-col gap-2"},[c({class:"text-base text-muted-foreground"},e),o({class:"flex flex-auto flex-wrap gap-2 my-2",map:[t,ua]})]),ma=e=>o({class:"flex flex-auto flex-col gap-12"},[oe({class:"text-2xl font-bold"},"Theme Toggle"),new bt,oe({class:"text-2xl font-bold"},"Color Guide"),x("Default background color of <body />...etc",[{var:"--backround",class:"bg-backround"},{var:"--foreground",class:"bg-foreground"}]),x("Muted backgrounds such as <TabsList />, <Skeleton /> and <Switch />",[{var:"--muted",class:"bg-muted"},{var:"--muted-foreground",class:"bg-muted-forground"}]),x("Background color for <Card />",[{var:"--card",class:"bg-card"},{var:"--card-foreground",class:"bg-card-foreground"}]),x("Background color for popovers such as <DropdownMenu />, <HoverCard />, <Popover />",[{var:"--popover",class:"bg-popover"},{var:"--popover-foreground",class:"bg-popover-foreground"}]),x("Default border color",[{var:"--border",class:"bg-border"}]),x("Border color for inputs such as <Input />, <Select />, <Textarea />",[{var:"--input",class:"bg-input"}]),x("Primary colors for <Button />",[{var:"--primary",class:"bg-primary"},{var:"--primary-foreground",class:"bg-primary-foreground"}]),x("Secondary colors for <Button />",[{var:"--secondary",class:"bg-secondary"},{var:"--secondary-foreground",class:"bg-secondary-foreground"}]),x("Used for accents such as hover effects on <DropdownMenuItem>, <SelectItem>...etc",[{var:"--accent",class:"bg-accent"},{var:"--accent-foreground",class:"bg-accent-foreground"}]),x('Used for destructive actions such as <Button variant="destructive">',[{var:"--destructive",class:"bg-destructive"},{var:"--destructive-foreground",class:"bg-destructive-foreground"}]),x('Used for warning actions such as <Button variant="warning">',[{var:"--warning",class:"bg-warning"},{var:"--warning-foreground",class:"bg-warning-foreground"}]),x("Used for focus ring",[{var:"--ring",class:"bg-ring"}]),x("Border radius for card, input and buttons",[{var:"--radius",class:"bg-radius"}])]),pa=()=>p({title:"Theme",description:"The theme is using Tailwind CSS and is based on Shadcn UI. The theme is customizable and can be extended. It comes with light and dark theme support."},[c({class:"text-muted-foreground"},{html:'To learn about Shandcn UI, visit the official documentation: <a href="https://ui.shadcn.com/docs/theming" class="underline" target="_blank">Shadcn Documentation'}),o({class:"my-20"},[re({class:"text-2xl font-bold"},"Default Styles"),c({class:"text-muted-foreground"},"The default styles are defined in the Tailwind CSS configuration file and in the base CSS file. Here's the list of variables available for customization:")]),ma(),o({class:"flex flex-auto flex-col gap-2 mt-20"},[o({class:"flex flex-auto flex-col gap-2"},[w({class:"text-2xl font-bold"},"Text Sizes"),c({class:"text-muted-foreground text-3xl"},"Text-3xl A test sentence."),c({class:"text-muted-foreground text-2xl"},"Text-2xl A test sentence."),c({class:"text-muted-foreground text-xl"},"Text-xl A test sentence."),c({class:"text-muted-foreground text-lg"},"Text-lg A test sentence."),c({class:"text-muted-foreground text-base"},"Text-base A test sentence."),c({class:"text-muted-foreground text-sm"},"Text-sm A test sentence."),c({class:"text-muted-foreground text-xs"},"Text-xs A test sentence.")])])]),m=(e,t,n)=>({uri:e,title:t,component:n()}),fa=e=>[m(`${e}`,"Introduction",da),m(`${e}/theme`,"Theme",pa),m(`${e}/icons`,"Icons",ca),m(`${e}/components/buttons*`,"Buttons",qt),m(`${e}/components/badges*`,"Badges",Mt),m(`${e}/components/tabs*`,"Tabs",ra),m(`${e}/components/modals*`,"Modals",Yo),m(`${e}/components/notifications*`,"Notifications",Ko),m(`${e}/components/dialogs*`,"Modals",ko),m(`${e}/components/cards*`,"Cards",ro),m(`${e}/components/calendars*`,"Calendars",Wt),m(`${e}/components/avatars*`,"Avatars",Pt),m(`${e}/components/inputs*`,"Inputs",_o),m(`${e}/components/forms*`,"Forms",Ho),m(`${e}/components/alerts*`,"Alerts",Bt),m(`${e}/components/comboboxes*`,"Comboboxes",po),m(`${e}/components/lists*`,"Lists",Vo),m(`${e}/components/data-tables*`,"Data Tables",xo),m(`${e}/components/breadcrumbs*`,"Breadcrumbs",zt),m(`${e}/components/navigations*`,"Navigations",Qo),m(`${e}/components/progress-bars*`,"Progress Bars",oa),m(`${e}/components/skeletons*`,"Skeletons",sa),m(`${e}/components/tooltips*`,"Tooltips",ia),m(`${e}/components/dropdown-menus*`,"Dropdown Menus",Fo)],ga=e=>[{href:`${e}`,label:"Introduction",exact:!0},{href:`${e}/theme`,label:"Theme",exact:!0},{href:`${e}/icons`,label:"Icons"},{group:"Components",options:[{label:"Buttons",href:`${e}/components/buttons`},{label:"Badges",href:`${e}/components/badges`},{label:"Tabs",href:`${e}/components/tabs`},{label:"Modals",href:`${e}/components/modals`},{label:"Notifications",href:`${e}/components/notifications`},{label:"Dialogs",href:`${e}/components/dialogs`},{label:"Cards",href:`${e}/components/cards`},{label:"Calendars",href:`${e}/components/calendars`},{label:"Avatars",href:`${e}/components/avatars`},{label:"Inputs",href:`${e}/components/inputs`},{label:"Forms",href:`${e}/components/forms`},{label:"Alerts",href:`${e}/components/alerts`},{label:"Comboboxes",href:`${e}/components/comboboxes`},{label:"Lists",href:`${e}/components/lists`},{label:"Data Tables",href:`${e}/components/data-tables`},{label:"Breadcrumbs",href:`${e}/components/breadcrumbs`},{label:"Navigations",href:`${e}/components/navigations`},{label:"Progress Bars",href:`${e}/components/progress-bars`},{label:"Skeletons",href:`${e}/components/skeletons`},{label:"Tooltips",href:`${e}/components/tooltips`},{label:"Dropdown Menus",href:`${e}/components/dropdown-menus`}]}],ha=()=>new xt({backHref:"aside/"},[new N([o([R([xe("Overlay")]),o({class:"contained"},[wt()])])])]),ba=e=>[{uri:`${e}/overlay-test`,component:ha()}],W="docs",ya=()=>new ze({title:"Documentation",basePath:W,routes:ba(W),switch:fa(W),links:ga(W)});export{ya as DocumentationPage,ya as default};
