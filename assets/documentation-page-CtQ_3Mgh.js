...
})`})]),$o=e=>at.render(e,app.appShell.panel),No=({title:e})=>B({class:"flex flex-auto items-center"},[K({class:"text-lg font-semibold"},e)]),Ro=u((e,t)=>Ie({class:`fixed z-30 w-[98%] md:w-full max-w-lg gap-4 border bg-background text-foreground p-6 pb-12 md:pb-6 shadow-lg duration-200
