import{Z as x,M as fe,N as he,o as s,Y as o,w as ge,u as m,l as W,s as se,G as i,y as Fe,e as $e,A as F,m as k,B as l,z as r,C as Ee,E as Re,H as b,I as Ne,O as ze,r as n,a as be,P as He,Q as Ue,R as qe,U as We,W as Oe,X as Ge,a0 as D,$ as w,a1 as j,f as d,a2 as X,a3 as O,a4 as ie,_ as we,a5 as _e,c as C,a6 as S,a7 as E,a8 as xe,a9 as Ye,h as ve,aa as Ve,i as ee,ab as Je,ac as V,j as P,k as G,ad as ye,ae as re,af as ke,K as q,ag as Ke,ah as Qe,L as R,ai as te,aj as oe,ak as Te,al as Ze,am as Xe,an as J,ao as et,ap as tt,aq as ot,ar as at,as as st,at as it,au as rt,av as nt,aw as lt,ax as ct,ay as mt,T as dt,az as ut,p as pt,aA as ft,aB as ht,x as _,aC as gt,aD as ne,aE as $,aF as bt,aG as wt,F as xt,aH as L,aI as vt,aJ as yt,V as I,aK as kt,b as Tt,q as St,D as A,J as B,aL as It,aM as ae,v as Ct,aN as Dt,aO as At}from"./index-DcH4BkhD.js";const y=x((e,a)=>fe({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces break-all cursor-pointer"},[he({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(a[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:s.clipboard.checked})}},a)])),Bt=x((e,a)=>o({class:"flex flex-auto p-4 min-h-[350px] max-h-[650px] overflow-x-auto max-w-[90vw] rounded-lg border bg-card"},[o({class:"preview flex flex-auto justify-center items-center"},a)])),le=x((e,a)=>o({class:"py-4"},a)),Pt=e=>new ge({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:le([Bt(e.preview)])},{label:"Code",value:"code",layout:le([y(e.code)])}]}),jt=x(({title:e,description:a})=>W({class:"flex flex-col"},[se({class:"scroll-m-20 text-2xl font-bold tracking-tight"},e),a&&i({class:"text-base text-muted-foreground py-2 max-w-[700px]"},a)])),t=x((e,a)=>m({class:"grid py-4"},[jt({title:e.title,description:e.description}),Pt({preview:e.preview,code:e.code})])),Mt=x(({title:e,description:a})=>W({class:"flex flex-col"},[$e({class:"scroll-m-20 text-3xl font-bold tracking-tight"},e),i({class:"text-base text-muted-foreground py-2 max-w-[700px]"},a)])),Lt=x((e,a)=>o({class:"contained py-8"},[Mt(e),m({class:"pb-12 pt-8"},a)])),f=x((e,a)=>new Fe([Lt(e,a)])),Ft=()=>f({title:"Alerts",description:"Alerts are used to provide feedback to the user about the outcome of an action or to inform them of important information."},[t({title:"Default Alert",description:"This is a standard alert without any specific type.",preview:[F({title:"Notice",description:"This is a default alert without a specific type.",icon:s.information})],code:`import {  Alert  } from "@base-framework/ui/molecules";
...
})`})]),M=({title:e,description:a})=>W({class:"text-left"},[be({class:"font-semibold tracking-tight text-2xl"},e),i({class:"text-sm text-muted-foreground"},a)]),qt=()=>o({class:"flex items-center justify-center gap-4"},[n({variant:"outline",class:"gap-2 w-full",click:()=>console.log("Sign in with Github"),"aria-label":"Sign in with Github"},[w(s.companies.gitHub),r("Github")]),n({variant:"outline",class:"gap-2 w-full",click:()=>console.log("Sign in with Google"),"aria-label":"Sign in with Google"},[w(s.companies.google),r("Google")])]),Wt=()=>j({class:"space-y-4",submit:e=>{e.preventDefault(),console.log("Account created")}},[new d({name:"email",label:"Email"},[X({type:"email",placeholder:"m@example.com",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),new d({name:"password",label:"Password"},[X({type:"password",placeholder:"Your password",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),n({type:"submit",class:"w-full mt-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition"},"Create account")]),Se=()=>D({class:"w-full max-w-md mx-auto p-8 bg-card space-y-6"},[M({title:"Create an account",description:"Enter your email below to create your account"}),qt(),o({class:"relative"},[o({class:"absolute inset-0 flex items-center"},[r({class:"flex-grow border-t"})]),o({class:"relative flex justify-center text-xs uppercase"},[r({class:"bg-background px-2 text-muted-foreground"},"or continue with")])]),Wt()]),K=({title:e,description:a,defaultState:c,onChange:u})=>o({class:"flex items-start justify-between gap-2"},[o({class:"text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70 flex flex-col space-y-1"},[r({class:"font-medium text-foreground"},e),r({class:"font-normal leading-snug text-muted-foreground"},a)]),new O({active:c,change:u})]),Ie=()=>D({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[M({title:"Cookie Settings",description:"Manage your cookie settings here."}),o({class:"pt-0 grid gap-6"},[K({title:"Strictly Necessary",description:"These cookies are essential in order to use the website and use its features.",defaultState:!0,onChange:e=>console.log("Strictly Necessary:",e)}),K({title:"Functional Cookies",description:"These cookies allow the website to provide personalized functionality.",defaultState:!1,onChange:e=>console.log("Functional Cookies:",e)}),K({title:"Performance Cookies",description:"These cookies help to improve the performance of the website.",defaultState:!1,onChange:e=>console.log("Performance Cookies:",e)})]),n({variant:"outline",class:"w-full",click:()=>console.log("Preferences saved")},"Save preferences")]),Ce=({startDate:e})=>D({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[M({title:"Pick a Date",description:"When is the event?"}),o({class:"font-medium text-foreground"},[new ie({selectedDate:e,selectedCallBack:a=>console.log(a)})])]),Q=x(({value:e,label:a,icon:c})=>_e({class:'text-sm gap-1 font-medium leading-none disabled:cursor-not-allowed disabled:opacity-70 flex flex-col items-center justify-between rounded-md border-2 border-muted bg-popover p-4 hover:bg-muted data-[state="active"]:border-primary [&:has([data-state="active"])]:border-primary',onState:["method",{active:e}],dataSet:["method",["state",e,"active"]],click:(u,{state:g})=>g.method=e},[w(c),r(a)])),Ot=we({render(){return o({class:"flex flex-auto flex-col"},[o({class:"grid grid-cols-3 gap-4"},[Q({label:"Card",value:"card",icon:s.creditCard}),Q({label:"Paypal",value:"paypal",icon:s.companies.paypal}),Q({label:"Apple",value:"apple",icon:s.companies.apple})])])},state(){return{method:null}}}),Gt=()=>o({class:"flex items-center justify-center gap-4"},[new Ot]),_t=()=>j({class:"space-y-4",submit:e=>{e.preventDefault(),console.log("Payment method added")}},[new d({name:"name",label:"Name"},[C({type:"text",placeholder:"First Last",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),new d({name:"card_number",label:"Card number"},[C({type:"text",placeholder:"1234 5678 9012 3456",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})]),o({class:"flex gap-4 mt-4"},[new d({name:"month",label:"Expires"},[S({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"",label:"Month",disabled:!0},...Array.from({length:12},(e,a)=>({value:`${a+1}`,label:`${a+1}`.padStart(2,"0")}))]})]),new d({name:"year",label:"Year"},[S({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"",label:"Year",disabled:!0},...Array.from({length:10},(e,a)=>({value:`${new Date().getFullYear()+a}`,label:`${new Date().getFullYear()+a}`}))]})]),new d({name:"cvc",label:"CVC"},[C({type:"text",placeholder:"CVC",required:!0,class:"border p-2 rounded-md w-full bg-background placeholder-muted-foreground text-foreground"})])]),n({type:"submit",class:"w-full mt-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition"},"Continue")]),De=()=>D({class:"w-full max-w-md mx-auto p-8 bg-card space-y-6"},[M({title:"Payment Method",description:"Add a new payment method to your account."}),Gt(),o({class:"space-y-4"},[_t()])]),Yt=({name:e,description:a,stars:c,language:u,lastUpdated:g})=>o({class:"flex items-start justify-between py-4 border-b border-muted last:border-b-0"},[o({class:"flex flex-col"},[r({class:"font-semibold text-foreground"},e),r({class:"text-sm text-muted-foreground"},a),o({class:"flex space-x-4 text-sm text-muted-foreground mt-3"},[o({class:"flex items-center gap-2"},[w({class:" text-blue-500"},s.document.text),r(` ${u}`)]),o({class:"flex items-center"},[w(s.star),r(` ${c}`)]),o(`Updated ${g}`)])]),n({variant:"secondary",class:"px-3 py-1 gap-1 flex items-center rounded-md",click:()=>console.log(`Starred ${e}`)},[w(s.star),r("Star")])]),Vt=({projects:e})=>o({class:"space-y-3"},e.map(a=>Yt(a))),Jt=[{name:"shadcn/ui",description:"Beautifully designed components that you can copy and paste into your apps. Accessible. Customizable. Open Source.",stars:"20k",language:"TypeScript",lastUpdated:"April 2023"},{name:"base-framework",description:"A robust framework for building and structuring large-scale applications with ease.",stars:"2",language:"JavaScript",lastUpdated:"June 2024"}],Kt=()=>D({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[o({class:"font-semibold text-lg text-foreground"},"Projects"),Vt({projects:Jt})]),Qt=()=>j({class:"space-y-4",submit:e=>{e.preventDefault(),console.log("Issue reported")}},[o({class:"flex flex-auto w-full gap-4"},[new d({name:"area",label:"Area"},[S({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"billing",label:"Billing"},{value:"technical",label:"Technical"},{value:"account",label:"Account"},{value:"other",label:"Other"}],defaultValue:"billing",change:e=>console.log(`Area selected: ${e.target.value}`)})]),new d({name:"security_level",label:"Security Level"},[S({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"severity_1",label:"Severity 1"},{value:"severity_2",label:"Severity 2"},{value:"severity_3",label:"Severity 3"}],defaultValue:"severity_2",change:e=>console.log(`Security Level selected: ${e.target.value}`)})])]),new d({name:"subject",label:"Subject"},[C({type:"text",placeholder:"I need help with...",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),new d({name:"description",label:"Description"},[E({placeholder:"Please include all information relevant to your issue.",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),o({class:"flex justify-end gap-4 mt-4"},[n({variant:"outline",class:"px-4 py-2",click:()=>console.log("Cancel clicked")},"Cancel"),n({type:"submit",class:"px-4 py-2 bg-primary text-primary-foreground rounded-md font-medium hover:bg-primary/90 transition"},"Submit")])]),Ae=()=>D({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[M({title:"Report an issue",description:"What area are you having problems with?"}),Qt()]),Zt=({link:e})=>o({class:"flex items-center gap-4 py-2"},[X({type:"text",value:e,readOnly:!0,class:"border p-2 rounded-md w-full bg-background text-foreground"}),n({variant:"secondary",class:"px-4 py-2",click:()=>{navigator.clipboard.writeText(e),app.notify({title:"Link copied",description:"The link has been copied to your clipboard.",icon:s.clipboard.checked})}},"Copy Link")]),Xt=({name:e,email:a,access:c,image:u})=>o({class:"flex items-center justify-between gap-4 py-2"},[o({class:"flex items-center gap-3"},[k({src:u,alt:e,fallbackText:e.split(" ").map(g=>g[0]).join("")}),o({},[r({class:"font-medium text-foreground"},e),r({class:"block text-sm text-muted-foreground"},a)])]),S({class:"border rounded-md bg-background text-foreground px-3 py-1",options:[{value:"edit",label:"Can edit"},{value:"view",label:"Can view"},{value:"comment",label:"Can comment"}],defaultValue:c,change:g=>console.log(`Access level changed for ${e}: ${g.target.value}`)})]),eo=({people:e})=>o({class:"space-y-3"},e.map(a=>Xt(a))),Be=({link:e,people:a})=>D({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[M({title:"Share this document",description:"Anyone with the link can view this document."}),Zt({link:e}),o({class:"border-t my-4"}),o({class:"font-medium text-foreground"},"People with access"),eo({people:a})]),to=e=>e.split(" ").map(c=>c[0]).join(""),oo=({name:e,email:a,role:c,image:u})=>o({class:"flex items-center justify-between gap-4 py-2"},[o({class:"flex items-center gap-3"},[k({src:u,alt:e,fallbackText:to(e)}),o({},[r({class:"font-medium text-foreground"},e),r({class:"block text-sm text-muted-foreground"},a)])]),S({class:"border rounded-md bg-background text-foreground px-3 py-1",options:[{value:"owner",label:"Owner"},{value:"member",label:"Member"}],defaultValue:c,change:g=>console.log(`Role changed for ${e}: ${g.target.value}`)})]),ao=({members:e})=>o({class:"space-y-3"},e.map(a=>oo(a))),Pe=({members:e})=>D({class:"w-full max-w-md mx-auto p-6 bg-card space-y-6"},[M({title:"Team Member",description:"Invite your team members to collaborate."}),ao({members:e})]),so=()=>f({title:"Cards",description:"Cards are a great way to display content in a concise and organized manner."},[t({title:"Usage",description:"Import the card atom and use it in your components.",preview:[D()],code:`import {  Button  } from "@base-framework/ui/atoms";
...
`)])]),H=[{label:"Large",buttonStyle:"primary",size:"lg"},{label:"Small",buttonStyle:"secondary",size:"sm"},{label:"Medium",buttonStyle:"destructive",size:"md"},{label:"XL",buttonStyle:"primary",size:"xl"},{label:"Right",buttonStyle:"ghost",type:"right"},{label:"Left",buttonStyle:"link",type:"left"}],U=({label:e,buttonStyle:a,size:c,type:u})=>n({text:e,class:`m-1 ${a}`,click:()=>new _({title:"Are you absolutely sure?",size:c,type:u},[o({class:"flex flex-col max-w-lg lg:p-4 space-y-8"},[new d({name:"popover-test",label:"Popover Test"},[new ie]),new d({name:"dialog-test",label:"Dialog Test"},[n({click:()=>{new re({title:"Are you absolutely sure?",description:"This action cannot be undone.",confirmTextLabel:"Save",confirmed:()=>{app.notify({icon:s.trash,title:"Action complete",description:"You confirmed your selection.",type:"destructive"})}}).open()}},"Confirm")])])]).open()}),Po=({size:e="md",type:a="center"})=>new _({title:"Report an Issue",icon:s.warning,description:"What area are you having problems with?",size:e,type:a,onSubmit:()=>console.log("Form submitted")},[o({class:"flex flex-col lg:p-4 space-y-8"},[R({legend:"Issue Details"},[o({class:"flex flex-auto w-full gap-4"},[new d({name:"area",label:"Area"},[S({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"billing",label:"Billing"},{value:"technical",label:"Technical"},{value:"account",label:"Account"},{value:"other",label:"Other"}],defaultValue:"billing"})]),new d({name:"security_level",label:"Security Level"},[S({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"severity_1",label:"Severity 1"},{value:"severity_2",label:"Severity 2"},{value:"severity_3",label:"Severity 3"}],defaultValue:"severity_2"})])]),new d({name:"subject",label:"Subject"},[C({type:"text",placeholder:"I need help with...",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),new d({name:"description",label:"Description"},[E({placeholder:"Please include all information relevant to your issue.",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})])])])]),de=({label:e,buttonStyle:a,size:c,type:u})=>n({text:e,class:`m-1 ${a}`,click:()=>Po({size:c,type:u}).open()}),je=()=>[new ke({icon:s.ellipsis.vertical,groups:[[{icon:s.mapPin,label:"Track Item",value:"track-item"},{icon:s.trash,label:"Delete Item",value:"delete-item"}]],onSelect:e=>{console.log("Selected item from header:",e)}})],jo=()=>new _({title:"Detail Example",description:"This is a detailed view of an item.",icon:s.information,size:"md",headerOptions:je,hidePrimaryButton:!0},[gt([ne({title:"Overview"},[$("Label","Value"),$("Date","2024-11-02"),o({class:"my-2 border-t"}),$("Status","Pending")]),ne({title:"More Info"},[$("Description","This is a multi-line snippet."),$("Comments","No comments available.")])])]),Mo=()=>n({text:"Detail Modal",variant:"outline",click:()=>jo().open()}),Lo=()=>f({title:"Modals",description:"Displays modals or modal-like components with various sizes, forms, and header options."},[t({title:"Detail Modal Atoms",description:"Demonstrates usage of DetailBody, DetailSection, and SplitRow within a modal.",preview:[Mo()],code:`
...
Tooltip({ content: 'This is a tooltip.' }, [
    ...
    Button('Hover me')
])`}),i({class:"text-muted-foreground text-sm mt-4"},"The tooltip position can be set to: top, top-right, top-left, bottom, bottom-right, bottom-left, left, right.")]),T=x((e,a)=>fe({...e,class:`flex p-4 max-h-[650px] max-w-[1024px] overflow-x-auto
...
});`),i({class:"text-muted-foreground"},"Example usage of the import alias:"),T(`/**
...
<meta name="msapplication-TileColor" content="#09090b">`),l({class:"text-lg font-bold"},"Manifest Colors and Settings"),i({class:"text-muted-foreground"},{html:`
  ...
  "background_color": "#09090b"
						...
						SVG logo to customize the branding.`})]),m({class:"space-y-4 mt-12"},[l({class:"text-lg font-bold mt-12"},"Authentication"),i({class:"text-muted-foreground"},`The shell supports authentication flows with "signed in" and "signed out"
