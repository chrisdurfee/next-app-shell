import{J as h,Y as o,ar as I,o as c,d as n,z as r,e as g,G as u,aq as b,aj as y}from"./index-CM1IEHgP.js";import{D as f}from"./doc-section-1HDPv0lU.js";import{D as w}from"./doc-page-Cjx708Nb.js";import"./sidebar-menu-page-nCAVFk3R-Di2_rNMK.js";const x=(s,t,e=null)=>(e="Icons"+(e?"."+e:""),o({class:"flex flex-auto flex-col items-center gap-2 w-full max-w-[150px] h-[8.5rem] cursor-pointer"},[o({class:"flex flex-auto w-full h-full justify-center items-center flex-wrap rounded-lg border bg-card text-base shadow-sm hover:bg-muted/50",click:()=>{navigator.clipboard.writeText(`${e}.${t}`),app.notify({title:"Icon copied",description:`The icon '${e}.${t}' has been copied to your clipboard.`,icon:c.clipboard.checked})}},[n(s)]),o({class:"text-muted-foreground"},t)])),d=(s,t,e)=>{const l=typeof s=="object";l&&t.push(u({class:"text-muted-foreground"},"path: "+e+".{icon}"));const i=[];if(t.push(o({class:"flex flex-auto flex-wrap gap-2 my-8"},i)),l===!1)i.push(x(s,e));else for(var a in s){if(s.hasOwnProperty(a)===!1)continue;const m=s[a];if(typeof m!="object"){i.push(x(m,a,e));continue}const p=`${e}.${a}`;d(m,t,p)}},z=s=>{if(!s||typeof s!="object")return;const t=[];for(let[e,l]of Object.entries(s)){if(e==="parse")continue;t.push(b({id:e.toLowerCase(),class:"text-2xl font-bold"},y.titleCase(e))),d(l,t,e)}return t},T=()=>w({title:"Icons",description:"The icons are from the Hericon library. They are SVG icons that can be used in your project. This icon set uses the outline style."},[h({href:"https://heroicons.com/",target:"_blank",class:"bttn link"},"link: Hericons"),f({title:"Icons",description:"This is an icon.",preview:[I({html:c.home})],code:`
