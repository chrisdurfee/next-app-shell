import{z as o,i as r,e as n,aW as s,aA as c,al as f,aX as b,s as v,aY as w,aZ as k,a_ as l,a$ as I,b0 as x,b1 as T,b2 as y,b3 as C,b4 as S,b5 as D,b6 as E,aC as R,ar as P,a7 as j,aB as N,b7 as L,l as U,ao as F,b8 as H,a4 as W,am as u,u as m,K as A,az as M,H as d,v as G}from"./index-CJnrX494.js";import{F as B}from"./signature-panel-h1ranAet-MInGxwdh.js";import{D as a}from"./doc-section-Db3WSn-1.js";import{D as K}from"./doc-page-L49zK9-d.js";import"./sidebar-menu-page-BImgFKeY-Cx7z5SsA.js";import"./full-page-CgVI1G7F-CdDt1lPX.js";import"./mobile-nav-wrapper-C7cKTxaV-C6uLGK7P.js";import"./sidebar-menu-Dz2oh95a-BJu2S9D5.js";const z=[{value:"next.js",label:"Next.js"},{value:"sveltekit",label:"SvelteKit"},{value:"nuxt.js",label:"Nuxt.js"},{value:"remix",label:"Remix"},{value:"astro",label:"Astro"}],t=G((e,i)=>o({...e,class:"flex flex-auto items-center justify-center w-full max-w-[350px]"},i)),p=({label:e,description:i,active:g,onChange:h})=>o({class:"flex items-center justify-between p-4 border rounded-md bg-muted/10 border-muted-foreground/20 mb-4"},[o({class:"flex flex-col pr-8"},[m({class:"font-semibold"},e),d({class:"text-sm text-muted-foreground"},i)]),new u({active:g,change:h})]),$=[{label:"Apple",value:"apple"},{label:"Banana",value:"banana"},{label:"Cherry",value:"cherry"},{label:"Date",value:"date"},{label:"Elderberry",value:"elderberry"},{label:"Fig",value:"fig"},{label:"Grape",value:"grape"},{label:"Honeydew",value:"honeydew"}],_=()=>K({title:"Inputs",description:"Inputs are essential for gathering user data in forms."},[a({title:"Usage",description:"Import the input atom and use it in your components. The input can be of various types: text, password, email, etc.",preview:[o({class:"grid gap-2 w-full max-w-[350px]"},[r({type:"text",placeholder:"Enter your text here...",change:e=>console.log(e.target.value)}),n({}),s({}),c({placeholder:"Enter your text here..."})])],code:`import {  Input, EmailInput, TelInput, Textarea  } from "@base-framework/ui/atoms";
...
Textarea({
    placeholder: 'Enter your text here...'
})`}),a({title:"Search Dropdown",description:"This is a search dropdown.",preview:[o({class:"relative w-full max-w-md"},[new f({options:$,onSelect:e=>console.log(e)})])],code:`import {  SearchDropdown  } from "@base-framework/ui/organisms";
...
})`}),a({title:"Select",description:"This is a select input.",preview:[t([N({options:z,change:e=>console.log(e.target.value)})])],code:`import {  Select  } from "@base-framework/ui/atoms";
...
Textarea({
    placeholder: 'Enter your text here...'
})`}),a({title:"Time Picker",description:"This is a time picker input.",preview:[t([new L({selectedTime:"12:00 am",change:e=>console.log(e)})])],code:`
...
})`}),a({title:"Date Picker",description:"This is a date picker input.",preview:[t([new U({blockPriorDates:!1,selectedDate:"2022-01-01",onChange:e=>console.log(e)})])],code:`
