import{b as s,a9 as o,M as e,a as r,H as a,ab as l,ac as d,o as c}from"./index-BZvTxwmY.js";import{D as u}from"./doc-page-B48XD3RA.js";import"./sidebar-menu-page-D4WMgz5U-DxjO_GSu.js";import"./mobile-nav-wrapper-Dm9DinRD-JwKwCUMn.js";const t=r((i,n)=>l({...i,class:`flex p-4 max-h-[650px] max-w-[1024px] overflow-x-auto
					 rounded-lg border bg-muted whitespace-break-spaces
					 break-all cursor-pointer mt-4 ${i.class}`},[d({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(n[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:c.clipboard.checked})}},n)])),g=()=>u({title:"Get Started",description:"Learn how to install, configure, and begin working with the App Shell project."},[s({class:"flex flex-col gap-y-4"},[o({class:"text-lg font-bold"},"About the Project"),e({class:"text-muted-foreground"},`This project is a Progressive Web App (PWA) framework designed to serve as a
