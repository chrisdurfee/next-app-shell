import{h as e,o as t}from"./index-BVqyJ8Xe.js";import{D as i}from"./doc-section-DgdxOvIT.js";import{D as o}from"./doc-page-DEz4XFR9.js";import"./sidebar-menu-page-nCAVFk3R-BZ2Tnlh9.js";import"./mobile-nav-wrapper-BE_hr65B-FQj-Yrro.js";const p=()=>o({title:"Alerts",description:"Alerts are used to provide feedback to the user about the outcome of an action or to inform them of important information."},[i({title:"Default Alert",description:"This is a standard alert without any specific type.",preview:[e({title:"Notice",description:"This is a default alert without a specific type.",icon:t.information})],code:`import {  Alert  } from "@base-framework/ui/molecules";
...
Alert({
    ...
    icon: Icons.error,
    type: 'destructive'
})`})]);export{p as AlertPage,p as default};
