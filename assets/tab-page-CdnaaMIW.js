import{as as l,av as n,a0 as a,y as p,aa as i,Z as m,Y as r}from"./index-DTTsA-UX.js";import{D as e}from"./doc-section-DiAFggAh.js";import{D as c}from"./doc-page-jt23TrgE.js";const t=m((o,s)=>r({class:"py-4"},s)),T=()=>c({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[e({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new l({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:t([])},{label:"Code",value:"code",layout:t([])}]})],code:`
