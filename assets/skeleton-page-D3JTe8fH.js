import{z as e,U as l,K as s,S as i,_ as r,H as n}from"./index-CJnrX494.js";import{o as t}from"./skeleton-BlY3opxG-v3Vih6J2.js";import{D as a}from"./doc-section-Db3WSn-1.js";import{D as h}from"./doc-page-L49zK9-d.js";import"./signature-panel-h1ranAet-MInGxwdh.js";import"./sidebar-menu-page-BImgFKeY-Cx7z5SsA.js";import"./full-page-CgVI1G7F-CdDt1lPX.js";import"./mobile-nav-wrapper-C7cKTxaV-C6uLGK7P.js";import"./sidebar-menu-Dz2oh95a-BJu2S9D5.js";const d=l({state:{loaded:!1},render(){return e({class:"flex flex-auto flex-col max-w-[350px]"},[e({class:"my-8"},[s({variant:"outline",click:()=>this.state.toggle("loaded")},"Toggle Loaded")]),e({class:"flex items-center bg-card rounded-md border shadow-md w-full max-w-md"},[e({class:"flex flex-auto gap-4 p-4",onState:["loaded",o=>o?[i({src:"https://github.com/shadcn.png",alt:"@shadcn",fallbackText:"CN",size:"md"}),e({class:"flex flex-auto flex-col"},[r({class:"text-lg font-semibold text-foreground"},"Leslie Alexander"),n({class:"text-sm text-muted-foreground m-0"},"leslie.alexander@example.com")])]:[t({shape:"circle",width:"w-12",height:"h-12"}),e({class:"flex flex-auto flex-col gap-2"},[t({width:"w-3/4",height:"h-6"}),t({width:"w-1/2",height:"h-4"})])]]})])])}}),v=()=>h({title:"Skeletons",description:"Skeletons are components that are used to show a placeholder for content that is loading."},[a({title:"Usage",description:"The skeleton component is used to show a placeholder for content that is loading.",preview:[e({class:"flex flex-auto gap-x-4 w-full max-w-64"},[t({shape:"circle",width:"w-10",height:"h-10"}),e({class:"flex flex-auto flex-col gap-y-2"},[t({width:"w-3/4",height:"h-4"}),t({width:"w-1/2",height:"h-4"})])])],code:`import {  Skeleton  } from "@base-framework/ui/atoms";
...
])`}),a({title:"Skeleton Post",description:"This is a skeleton post.",preview:[e({class:"gap-y-4 flex flex-auto flex-col w-full max-w-64"},[t({width:"w-full",height:"h-32",shape:"rectangle"}),e({class:"gap-y-2"},[t({width:"w-3/4",height:"h-4"}),t({width:"w-1/2",height:"h-4"})])])],code:`import {  Skeleton  } from "@base-framework/ui/atoms";
import { Div } from '@base-framework/atoms';
...
])`}),a({title:"Skeleton with Avatar Loading",description:"This example demonstrates a skeleton loading animation that transitions to an avatar and user info after 3 seconds.",preview:[new d],code:`import {  Skeleton  } from "@base-framework/ui/atoms";
...
LoadingAvatar();`})]);export{v as SkeletonPage,v as default};
