...
})`}),a({title:"Select",description:"This is a select input.",preview:[t([q({options:Y,change:e=>console.log(e.target.value)})])],code:`import {  Select  } from "@base-framework/ui/atoms";
...
})`}),a({title:"Signature Pad",description:"This is a signature pad input.",preview:[t([new J({lineWidth:1,lineColor:"#CCCCCC",baseLineWidth:1,baseStrokeColor:"#333333"})])],code:`
