import{S as qe}from"./sidebar-menu-page-10EOLjI0.js";import{o as ae,Y as o,u as y,p as he,Z as se,q as ne,w as W,Q as h,x as Ue,N as We,a as n,l as H,s as re,G as c,y as Oe,E as _e,r as xe,H as $,A as v,K as w,z as r,L as Ge,_ as O,R as _,J as T,B as l,b as we,U as Ve,V as Je,W as Ye,X as Qe,$ as Ke,a0 as I,I as b,a1 as B,F as u,a2 as L,a3 as G,a4 as ie,c as C,a5 as k,a6 as N,a7 as V,a8 as le,a9 as ve,aa as Ze,D as ye,ab as Xe,i as X,ac as et,ad as Y,j as D,C as J,ae as Te,af as ke,P as E,ag as ce,ah as ee,ai as te,aj as tt,ak as ot,al as Q,am as at,an as st,ao as nt,ap as rt,aq as it,ar as lt,as as ct,at as dt,au as ut,av as mt,M as Se,aw as pt,ax as ft,f as gt,ay as F,S,k as Ce,T as bt,d as A,az as oe,v as ht,aA as xt,O as wt,m as vt}from"./index-DCHhbhBb.js";import{U as yt}from"./user-list-DsBYypXN.js";const Tt=e=>ne({class:"inline-flex flex-auto items-center justify-center whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm",dataSet:["selected",["state",e.value,"active"]]},[W({class:"flex flex-auto justify-center items-center px-3 py-1.5",onSet:["selected",{selected:e.value}],click:t=>e.callBack(e.value)},e.label)]),kt=(e,t)=>(e.callBack=t,Tt(e)),St=e=>he({class:`tab items-center justify-center rounded-md bg-muted p-1 text-muted-foreground ${e.class}`},[se({class:"flex flex-auto flex-row",map:[e.options,t=>kt(t,e.callBack)]})]);class Ie extends ae{render(){const t=this.select.bind(this);return o({class:""},[St({class:this.class,options:this.options,callBack:t}),y({class:"tab-content",onState:["selected",this.updateContent.bind(this)]})])}getFirstValue(){var t;return(t=this.options[0])==null?void 0:t.value}update(){const t=this.state.get("selected");this.select(null),this.select(t)}select(t){this.state.selected=t}updateContent(t){const s=this.options;if(!s||s.length<1)return;const i=s[0];for(const d of s)if(d.value===t)return d.layout;return i.layout}setupStates(){const t=this.callBack,s=typeof t;return{selected:{state:this.getFirstValue(),callBack(i){s==="function"&&t(i)}}}}}const je=h((e,t)=>Ue({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces break-all cursor-pointer"},[We({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(t[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:n.clipboard.checked})}},t)])),Ct=h((e,t)=>o({class:"flex flex-auto p-4 min-h-[350px] max-h-[650px] overflow-x-auto max-w-[90vw] rounded-lg border bg-card"},[o({class:"preview flex flex-auto justify-center items-center"},t)])),de=h((e,t)=>o({class:"py-4"},t)),It=e=>new Ie({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:de([Ct(e.preview)])},{label:"Code",value:"code",layout:de([je(e.code)])}]}),jt=h(({title:e,description:t})=>H({class:"flex flex-col"},[re({class:"scroll-m-20 text-2xl font-bold tracking-tight"},e),t&&c({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),a=h((e,t)=>y({class:"grid py-4"},[jt({title:e.title,description:e.description}),It({preview:e.preview,code:e.code})]));class At extends Oe{render(){return _e([o({class:"contained px-4 flex flex-auto flex-col"},this.children)])}}const Dt=h(({title:e,description:t})=>H({class:"flex flex-col"},[xe({class:"scroll-m-20 text-3xl font-bold tracking-tight"},e),c({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),Bt=h((e,t)=>o({class:"contained py-8"},[Dt(e),y({class:"pb-12 pt-8"},t)])),p=h((e,t)=>new At([Bt(e,t)])),Pt=()=>p({title:"Alerts",description:"Alerts are used to provide feedback to the user about the outcome of an action or to inform them of important information."},[a({title:"Default Alert",description:"This is a standard alert without any specific type.",preview:[$({title:"Notice",description:"This is a default alert without a specific type.",icon:n.information})],code:`import { Alert } from "@components/molecules/alert.js";
...
new RangeSlider({
    ...
    value: 50,
    change: (value) => console.log(value)
})`}),a({title:"Toggle Switch",description:"Toggle switches to control various settings.",preview:[o({class:"p-4"},[w({class:"text-lg font-bold mb-4"},"Email Notifications"),me({label:"Marketing emails",description:"Receive emails about new products, features, and more.",active:!1,onChange:e=>console.log("Marketing emails:",e)}),me({label:"Security emails",description:"Receive emails about your account security.",active:!1,onChange:e=>console.log("Security emails:",e)}),l({text:"Submit",class:"mt-4"})])],code:`
...
})`})]),Xo=e=>!e||isNaN(e)?null:e,fe=(e,t)=>{const s=e,i=16,d=2*Math.PI*i,j=s/100*d,M=`
