import{ag as e,o as t}from"./index-CM1IEHgP.js";import{D as i}from"./doc-section-1HDPv0lU.js";import{D as o}from"./doc-page-Cjx708Nb.js";import"./sidebar-menu-page-nCAVFk3R-Di2_rNMK.js";const a=()=>o({title:"Alerts",description:"Alerts are used to provide feedback to the user about the outcome of an action or to inform them of important information."},[i({title:"Default Alert",description:"This is a standard alert without any specific type.",preview:[e({title:"Notice",description:"This is a default alert without a specific type.",icon:t.information})],code:`import {  Alert  } from "@base-framework/ui/molecules";
...
Alert({
    ...
    icon: Icons.error,
    type: 'destructive'
})`})]);export{a as AlertPage,a as default};
