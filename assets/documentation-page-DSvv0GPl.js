import{O,A as E}from"./overlay-fUgnwqVJ.js";import{a as l,b as f,y as G,w as $,m as s,R as k,c as H,D as V,H as R,p as F,d as N,U as w,I,S as y,F as _,C as P,h as q,e as B,f as U,V as Y,g as X,i as J,P as h,T as K,q as A,M as Q,v as W,G as Z}from"./index-CGrF4E3h.js";const p=t=>l((e,o)=>f({...t,...e,class:`bttn ${t.class} ${e.class||""}`},o)),T={primary:p({class:"primary"}),secondary:p({class:"secondary"}),destructive:p({class:"destructive"}),outline:p({class:"outline"}),ghost:p({class:"ghost"}),link:p({class:"link"})},c=l((t,e)=>(T[t.variant]||T.primary)(t,e)),C={gray:{backgroundColor:"bg-gray-50",textColor:"text-gray-600",ringColor:"ring-gray-500/10"},red:{backgroundColor:"bg-red-50",textColor:"text-red-700",ringColor:"ring-red-600/10"},yellow:{backgroundColor:"bg-yellow-50",textColor:"text-yellow-800",ringColor:"ring-yellow-600/20"},green:{backgroundColor:"bg-green-50",textColor:"text-green-700",ringColor:"ring-green-600/20"},blue:{backgroundColor:"bg-blue-50",textColor:"text-blue-700",ringColor:"ring-blue-700/10"},indigo:{backgroundColor:"bg-indigo-50",textColor:"text-indigo-700",ringColor:"ring-indigo-700/10"},purple:{backgroundColor:"bg-purple-50",textColor:"text-purple-700",ringColor:"ring-purple-700/10"},pink:{backgroundColor:"bg-pink-50",textColor:"text-pink-700",ringColor:"ring-pink-700/10"}},tt=t=>C[t]||C.gray,et=t=>{const{backgroundColor:e,textColor:o,ringColor:n}=tt(t);return`inline-flex items-center rounded-md px-2 py-1 text-xs font-medium ring-1 ring-inset ${e} ${o} ${n}`},r=l((t,e)=>{const o=et(t==null?void 0:t.type);return G({...t,class:o},e)}),ot=t=>R({class:"inline-flex flex-auto items-center justify-center whitespace-nowrap rounded-sm px-3 py-1.5 text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm",dataSet:["selected",["state",t.value,"active"]]},[f({class:"flex flex-auto justify-center items-center",onSet:["selected",{selected:t.value}],click:e=>t.callBack(t.value)},t.label)]),st=(t,e)=>(t.callBack=e,ot(t)),at=t=>H({class:`tab items-center justify-center rounded-md bg-muted p-1 text-muted-foreground ${t.class}`},[V({class:"flex flex-auto flex-row",map:[t.options,e=>st(e,t.callBack)]})]);class D extends ${render(){const e=this.select.bind(this);return s({class:""},[at({class:this.class,options:this.options,callBack:e}),k({class:"tab-content",onState:["selected",this.updateContent.bind(this)]})])}afterSetup(){const e=this.options[0].value;this.select(e)}update(){const e=this.state.get("selected");this.select(null),this.select(e)}select(e){this.state.selected=e}updateContent(e){const o=this.options;if(!o||o.length<1)return;const n=o[0];for(const i of o)if(i.value===e)return i.layout;return n.layout}setupStates(){const e=this.callBack,o=typeof e;return{selected:{state:null,callBack(n){o==="function"&&e(n)}}}}}const nt=l((t,e)=>F({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces"},[N({class:"font-mono text-sm"},e)])),lt=l((t,e)=>s({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-card"},[s({class:"preview flex w-full justify-center items-center"},e)])),j=l((t,e)=>s({class:"py-4"},e)),rt=t=>new D({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:j([lt(t.preview)])},{label:"Code",value:"code",layout:j([nt(t.code)])}]}),it=l(({title:t,description:e})=>w({class:"flex flex-col"},[I({class:"scroll-m-20 text-2xl font-bold tracking-tight"},t),e&&y({class:"text-base text-muted-foreground py-2 max-w-[700px]"},e)])),a=l((t,e)=>k({class:"py-4"},[it({title:t.title,description:t.description}),rt({preview:t.preview,code:t.code})])),ct=l(({title:t,description:e})=>w({class:"flex flex-col"},[P({class:"scroll-m-20 text-3xl font-bold tracking-tight"},t),y({class:"text-base text-muted-foreground py-2 max-w-[700px]"},e)])),pt=l((t,e)=>s({class:"contained py-8"},[ct(t),k({class:"pb-12 pt-8"},e)])),d=l((t,e)=>new _([pt(t,e)])),mt=()=>d({title:"Badges",description:"Badges can be used to display a status or a count."},[a({title:"Badge",description:"This is a badge.",preview:[s({class:"flex gap-2"},[r({type:"gray"},"Text"),r({type:"red"},"Text"),r({type:"yellow"},"Text"),r({type:"green"},"Text"),r({type:"blue"},"Text"),r({type:"indigo"},"Text"),r({type:"purple"},"Text"),r({type:"pink"},"Text")])],code:`
