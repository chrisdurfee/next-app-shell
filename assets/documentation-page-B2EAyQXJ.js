...
})`}),n({title:"Checkbox",description:"This is a checkbox input.",preview:[new et({label:"Check me",check:e=>console.log()})],code:`
import { Button } from '@components/atoms/form/input.js';
...
new InlineNavigation({
...
})`})]),pt=()=>l({title:"Notifications",description:"Displays a notification message to the user."},[n({title:"In App Notifications",description:"Notifications can be displayed in the app to inform users about important events or updates. They are a global notification container that can be called from anywhere in the app.",preview:[new fe({title:"Notification Title",description:"This is a notification.",icon:m.warning,duration:"infinite"})],code:`app.notify({
    ...
    type: 'warning', // 'success', 'destructive', 'info', 'warning'
    duration: 5000 // in milliseconds, leave it blank for 4 seconds, infinite is also a value to prevent it from going away
})`})]),L=u((e,t)=>s({class:"py-4"},t)),mt=()=>l({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[n({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new q({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:L([])},{label:"Code",value:"code",layout:L([])}]})],code:`
