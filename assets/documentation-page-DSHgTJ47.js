...
})`})]),Co=({id:e,checked:t,bind:a,required:n})=>Te({id:e,cache:"checkbox",class:"absolute opacity-0 w-full h-full cursor-pointer pointer-events-none",aria:{checked:["checked"]},required:n,checked:t,bind:a}),Io=()=>l({class:"absolute text-xs pointer-events-none",onState:["checked",e=>e?P({class:"w-2 h-2 pointer-events-none",html:i.check}):null]}),jo=({id:e,bind:t,checked:a,required:n,clickHandler:d})=>o({class:"relative flex items-center justify-center w-5 h-5 rounded-md transition-colors duration-200 border hover:border-accent-foreground",onState:["checked",{"bg-primary":!0,"text-primary-foreground":!0}],role:"checkbox",aria:{checked:["checked"]},tabIndex:0,click:d},[Co({bind:t,checked:a,id:e,required:n}),Io()]),Ao=({id:e,label:t,clickHandler:a})=>ke({class:"text-base cursor-pointer",htmlFor:e,click:a},t),X=H({state(){return{checked:this.checked??!1}},after(){this.state.checked=this.checkbox.checked},clickHandler(){this.state.toggle("checked"),this.checkbox.checked=this.state.checked,typeof this.onChange=="function"&&this.onChange(this.state.checked)},render(){const e=this.getId();return o({class:`flex items-center space-x-2 cursor-pointer ${this.class}`},[jo({id:e,bind:this.bind,checked:this.state.checked,required:this.required,clickHandler:()=>this.clickHandler()}),this.label&&Ao({id:e,label:this.label,clickHandler:()=>this.clickHandler()})])}}),Do=e=>tt([Ce({class:"text-muted-foreground border-b",map:[e.headers,t=>{if(t.label==="checkbox")return me({class:"cursor-pointer py-3 px-4 text-base"},[new X({class:"mr-2",onChange:e.toggle})]);const a=t.align||"items-center justify-start";return me({class:"cursor-pointer py-3 px-4 text-base",click:t.sortable&&(()=>e.sort(t.key))},[o({class:`flex flex-auto w-full items-center ${a}`},[l(t.label),t.sortable&&P({class:"ml-2",html:i.arrows.upDown})])])}]})]),Bo=({key:e,rows:t,selectRow:a,rowItem:n})=>new ot({cache:"table",key:e,items:t,rowItem:d=>n(d,a),class:"divide-y divide-border"}),Lo=L({setData(){return new q({selectedRows:[]})},toggleAllSelectedRows(){const e=this.table.getRows(),t=this.data.selectedRows.length===e.length,a=t?[]:e;this.data.selectedRows=a,this.updateTable(!t)},updateTable(e){const t=this.table.getRows();t.forEach(a=>a.selected=e),this.table.setRows(t)},selectRow(e){const t=e.selected??!1;e.selected=!t;const a=this.data.get("selectedRows"),n=e.selected?[...a,e]:a.filter(d=>d!==e);this.data.selectedRows=n},render(){const e=this.rows;return o({class:"w-full"},[o({class:"w-full rounded-md border"},[et({class:"w-full"},[this.headers&&Do({headers:this.headers,sort:t=>this.sortRows(t),toggle:()=>this.toggleAllSelectedRows()}),Bo({key:this.key,rows:e,selectRow:this.selectRow.bind(this),rowItem:this.rowItem})])])])},remove(e){this.table.remove(e)},setRows(e){this.table.setRows(e)},append(e){this.table.append(e)},mingle(e,t=!1){this.table.mingle(e,t)},prepend(e){this.table.prepend(e)},beforeDestroy(){this.data.selectedRows=[]}}),Mo=[{label:"checkbox",key:""},{label:"Status",key:"status"},{label:"Email",key:"email"},{label:"Amount",key:"amount",align:"justify-end"}],Fo=[{id:1,status:"Success",email:"ken99@yahoo.com",amount:316,selected:!1},{id:2,status:"Success",email:"abe45@gmail.com",amount:242,selected:!1},{id:3,status:"Processing",email:"monserrat44@gmail.com",amount:837,selected:!1},{id:4,status:"Success",email:"silas22@gmail.com",amount:874,selected:!1},{id:5,status:"Failed",email:"carmella@hotmail.com",amount:721,selected:!1}],Po=(e,t)=>Ce({class:"items-center px-4 py-2 hover:bg-muted"},[U({class:"p-4 "},[new X({checked:e.selected,class:"mr-2",onChange:()=>t(e)})]),U({class:"p-4 "},[l({class:"text-muted-foreground"},e.status)]),U({class:"p-4 "},e.email),U({class:"p-4 text-right"},`$${e.amount.toFixed(2)}`)]),Eo=()=>f({title:"Data Tables",description:"Data tables are used to display data in a structured format. They can be used to display a list of items, a grid of items, or a table of items."},[s({title:"Usage",description:"The data table component is used to display data in a structured format. It can be used to display a list of items, a grid of items, or a table of items.",preview:[new Lo({headers:Mo,rows:Fo,rowItem:Po,key:"id"})],code:`import { DataTable } from "@components/organisms/lists/data-table.js";
...
ColorInput({
    change: (e) => console.log(e.target.value),
});`}),s({title:"Date Input",description:"This is a date input field.",preview:[g([lt({change:e=>console.log(e.target.value)})])],code:`import { DateInput } from '@components/atoms/form/input.js';

DateInput({
    change: (e) => console.log(e.target.value),
});`}),s({title:"Time Input",description:"This is a time input field.",preview:[g([rt({change:e=>console.log(e.target.value)})])],code:`import { TimeInput } from '@components/atoms/form/input.js';
