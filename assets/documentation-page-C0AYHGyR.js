import{O as ie,A as le}from"./overlay-DvXz8ZXl.js";import{w as A,m as s,R as P,a as Q,D as N,H as R,b as C,X as p,p as ce,c as de,U as y,I as D,S as u,B as ue,d as me,C as X,A as pe,e as r,f as fe,y as m,g,h as M,T as z,i as d,j as H,L as he,k as Z,l as U,u as $,q as x,O as be,n as ge,z as xe,Z as we,o as ee,J as G,r as ve,s as B,t as ye,v as te,V as oe,x as ke,E as Te,K as W,M as Ce,N as L,Q as Ie,W as Be,Y as Se,$ as je,a0 as E,a1 as De,a2 as $e,a3 as Ae,P as j,a4 as se,a5 as Pe,G as Me}from"./index-BWg_EOhZ.js";const Le=e=>R({class:"inline-flex flex-auto items-center justify-center whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-background data-[state=active]:text-foreground data-[state=active]:shadow-sm",dataSet:["selected",["state",e.value,"active"]]},[C({class:"flex flex-auto justify-center items-center px-3 py-1.5",onSet:["selected",{selected:e.value}],click:t=>e.callBack(e.value)},e.label)]),Ee=(e,t)=>(e.callBack=t,Le(e)),Ne=e=>Q({class:`tab items-center justify-center rounded-md bg-muted p-1 text-muted-foreground ${e.class}`},[N({class:"flex flex-auto flex-row",map:[e.options,t=>Ee(t,e.callBack)]})]);class ne extends A{render(){const t=this.select.bind(this);return s({class:""},[Ne({class:this.class,options:this.options,callBack:t}),P({class:"tab-content",onState:["selected",this.updateContent.bind(this)]})])}getFirstValue(){var t;return(t=this.options[0])==null?void 0:t.value}update(){const t=this.state.get("selected");this.select(null),this.select(t)}select(t){this.state.selected=t}updateContent(t){const o=this.options;if(!o||o.length<1)return;const a=o[0];for(const i of o)if(i.value===t)return i.layout;return a.layout}setupStates(){const t=this.callBack,o=typeof t;return{selected:{state:this.getFirstValue(),callBack(a){o==="function"&&t(a)}}}}}const Re=p((e,t)=>ce({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces cursor-pointer"},[de({class:"font-mono text-sm",click:()=>navigator.clipboard.writeText(t[0].textContent)},t)])),ze=p((e,t)=>s({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-card"},[s({class:"preview flex w-full justify-center items-center"},t)])),K=p((e,t)=>s({class:"py-4"},t)),He=e=>new ne({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:K([ze(e.preview)])},{label:"Code",value:"code",layout:K([Re(e.code)])}]}),Oe=p(({title:e,description:t})=>y({class:"flex flex-col"},[D({class:"scroll-m-20 text-2xl font-bold tracking-tight"},e),t&&u({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),n=p((e,t)=>P({class:"py-4"},[Oe({title:e.title,description:e.description}),He({preview:e.preview,code:e.code})]));class Fe extends ue{render(){return me([s({class:"contained px-4 flex flex-auto flex-col"},this.children)])}}const Ue=p(({title:e,description:t})=>y({class:"flex flex-col"},[X({class:"scroll-m-20 text-3xl font-bold tracking-tight"},e),u({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),Ge=p((e,t)=>s({class:"contained py-8"},[Ue(e),P({class:"pb-12 pt-8"},t)])),c=p((e,t)=>new Fe([Ge(e,t)])),We=()=>c({title:"Alerts",description:"Alerts are used to provide feedback to the user about the outcome of an action or to inform them of important information."},[n({title:"Usage",description:"To use the Alert component, import it from the components library and use it in your application.",preview:[pe({title:"Heads up!",description:"You can add components to your app using the cli.",icon:r.information})],code:`import { Alert } from "@components/molecules/alert.js";
...
])`})]),V=p((e,t)=>s({class:"py-4"},t)),so=()=>c({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[n({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new ne({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:V([])},{label:"Code",value:"code",layout:V([])}]})],code:`
