import{av as l,r as n,ay as p,a5 as a,E as i,ae as r,Y as m}from"./index-_7WSbQ4O.js";import{D as e}from"./doc-section-C2y7sPou.js";import{D as c}from"./doc-page-CXHVkmT8.js";const t=n((o,s)=>m({class:"py-4"},s)),T=()=>c({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[e({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new l({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:t([])},{label:"Code",value:"code",layout:t([])}]})],code:`
