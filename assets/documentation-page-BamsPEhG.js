...
})`}),t({title:"Select",description:"This is a select input.",preview:[h([T({options:Do,change:e=>console.log(e.target.value)})])],code:`import {  Select  } from "@base-framework/ui/atoms";
...
LoadingAvatar();`})]),de=v((e,a)=>o({class:"py-4"},a)),Ho=()=>f({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[t({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new pe({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:de([])},{label:"Code",value:"code",layout:de([])}]})],code:`
