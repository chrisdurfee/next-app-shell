import{A as Oe}from"./aside-page-XIgp35x1.js";import{w as N,m as o,R as k,q as xe,D as _,H as G,e as V,Q as f,r as Re,s as qe,a as n,U as B,c as ne,S as c,t as He,i as We,C as we,A as M,u as w,y as i,_ as z,f as Q,T as y,B as l,F as J,v as Ue,x as _e,z as de,h as te,E as j,I as h,J as $,K as re,l as S,M as E,L as v,N as Y,W as ie,G as Ge,X as O,Y as Ve,Z as ve,$ as ye,a0 as ke,a1 as oe,a2 as ae,a3 as Qe,a4 as Z,a5 as Je,a6 as Ye,a7 as Ke,a8 as Ze,a9 as Xe,aa as et,ab as tt,ac as ot,ad as at,ae as st,af as nt,ag as rt,ah as F,b as I,j as Te,P as U,ai as se,aj as it,O as lt,o as ct}from"./index-Bu2G6uy7.js";import{F as D,a as u,b as K,S as C,T as dt}from"./toggle-fB1irUhH.js";import{C as le}from"./checkbox-CdDOk1sr.js";import{D as mt,U as ut}from"./data-table-COKmZiYZ.js";import{S as pt}from"./sidebar-menu-CvkN4kd-.js";import{T as ft}from"./tab-group-BEyZ5A98.js";import{T as A}from"./tooltip-C865ts28.js";const gt=e=>G({class:"inline-flex flex-auto items-center justify-center whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm",dataSet:["selected",["state",e.value,"active"]]},[V({class:"flex flex-auto justify-center items-center px-3 py-1.5",onSet:["selected",{selected:e.value}],click:t=>e.callBack(e.value)},e.label)]),ht=(e,t)=>(e.callBack=t,gt(e)),bt=e=>xe({class:`tab items-center justify-center rounded-md bg-muted p-1 text-muted-foreground ${e.class}`},[_({class:"flex flex-auto flex-row",map:[e.options,t=>ht(t,e.callBack)]})]);class Se extends N{render(){const t=this.select.bind(this);return o({class:""},[bt({class:this.class,options:this.options,callBack:t}),k({class:"tab-content",onState:["selected",this.updateContent.bind(this)]})])}getFirstValue(){var t;return(t=this.options[0])==null?void 0:t.value}update(){const t=this.state.get("selected");this.select(null),this.select(t)}select(t){this.state.selected=t}updateContent(t){const s=this.options;if(!s||s.length<1)return;const r=s[0];for(const d of s)if(d.value===t)return d.layout;return r.layout}setupStates(){const t=this.callBack,s=typeof t;return{selected:{state:this.getFirstValue(),callBack(r){s==="function"&&t(r)}}}}}const Ce=f((e,t)=>Re({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces break-all cursor-pointer"},[qe({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(t[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:n.clipboard.checked})}},t)])),xt=f((e,t)=>o({class:"flex flex-auto p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-card"},[o({class:"preview flex flex-auto justify-center items-center"},t)])),me=f((e,t)=>o({class:"py-4"},t)),wt=e=>new Se({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:me([xt(e.preview)])},{label:"Code",value:"code",layout:me([Ce(e.code)])}]}),vt=f(({title:e,description:t})=>B({class:"flex flex-col"},[ne({class:"scroll-m-20 text-2xl font-bold tracking-tight"},e),t&&c({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),a=f((e,t)=>k({class:"grid py-4"},[vt({title:e.title,description:e.description}),wt({preview:e.preview,code:e.code})]));class yt extends He{render(){return We([o({class:"contained px-4 flex flex-auto flex-col"},this.children)])}}const kt=f(({title:e,description:t})=>B({class:"flex flex-col"},[we({class:"scroll-m-20 text-3xl font-bold tracking-tight"},e),c({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),Tt=f((e,t)=>o({class:"contained py-8"},[kt(e),k({class:"pb-12 pt-8"},t)])),p=f((e,t)=>new yt([Tt(e,t)])),St=()=>p({title:"Alerts",description:"Alerts are used to provide feedback to the user about the outcome of an action or to inform them of important information."},[a({title:"Default Alert",description:"This is a standard alert without any specific type.",preview:[M({title:"Notice",description:"This is a default alert without a specific type.",icon:n.information})],code:`import { Alert } from "@components/molecules/alert.js";
...
});`}),v({class:"text-lg font-bold"},"Description"),c({class:"text-muted-foreground"},"The List component can be used to display a list of items in a structured format. Each item can be customized to show different information. The List component supports appending, prepending, mingling, and deleting or items. "),v({class:"text-lg font-bold"},"Performance"),c({class:"text-muted-foreground"},"The list will only update or re-render the items that have changed, improving performance. It uses a key to know when to update an item.")]),Vo=({title:e,description:t,back:s,icon:r})=>B({class:"modal-header flex items-center pt-4 px-6"},[s&&l({variant:"icon",icon:n.arrows.left,class:"mr-2 p-0 flex sm:hidden",click:(d,T)=>T.close()}),r&&o({class:"mr-2 w-12 h-12 rounded-full bg-muted flex items-center justify-center"},[h(r)]),o({class:"flex flex-auto flex-col ml-2"},[J({class:"text-lg font-semibold m-0"},e),t&&o({class:"text-sm text-muted-foreground"},t)])]),Qo=f((e,t)=>o({popover:"manual",class:`modal m-auto top-0 right-0 bottom-0 left-0 fixed z-20 grid w-full h-full gap-4 lg:border bg-background text-foreground shadow-xl break-words overflow-hidden p-0 ${e.class}`,pointerdown:(s,r)=>{s.target===r.panel&&(s.preventDefault(),s.stopPropagation(),r.state.open=!1)}},[D({class:"modal-content flex flex-auto flex-col",submit:s=>e.onSubmit&&e.onSubmit()},[Vo(e),o({class:"modal-body flex flex-auto flex-col overflow-y-auto py-0 px-6"},t),ve({class:"modal-footer flex justify-between pb-4 px-6"},e.buttons)])])),Jo=e=>ye.render(e,app.appShell.panel);class Ee extends N{render(){const t=this.getMainClass(),s=this.title||"",r=this.description||null;return Qo({class:t,title:s,description:r,buttons:this.getButtons(),onSubmit:this.submit,icon:this.icon,back:this.back??!1,aria:{expanded:["open"]}},this.children)}setupStates(){return{open:{state:!1,callBack:t=>{t||this.close()}}}}getButtons(){return[l({variant:"outline",click:()=>this.close()},"Cancel"),l({variant:"primary",type:"submit"},"Save")]}isOutsideClick(t){return!this.panel.contains(t)}getSizeClass(){switch(this.size){case"lg":return"lg max-w-[900px]";case"xl":return"xl max-w-[1400px]";default:return"md max-w-[760px]"}}getTypeClass(){switch(this.type){case"right":return"right right-0";case"left":return"left left-0";default:return""}}getMainClass(){return this.getSizeClass()+" "+this.getTypeClass()}open(){Jo(this),this.panel.showPopover(),this.state.open=!0}close(){this.state.open=!1,this.panel.hidePopover(),this.destroy()}}const q=[{label:"Large",buttonStyle:"primary",size:"lg"},{label:"Small",buttonStyle:"secondary",size:"sm"},{label:"Medium",buttonStyle:"destructive",size:"md"},{label:"XL",buttonStyle:"primary",size:"xl"},{label:"Right",buttonStyle:"ghost",type:"right"},{label:"Left",buttonStyle:"link",type:"left"}],H=({label:e,buttonStyle:t,size:s,type:r})=>l({text:e,class:`m-1 ${t}`,click:()=>new Ee({title:"Are you absolutely sure?",size:s,type:r},[o({class:"flex flex-auto flex-col items-center justify-center p-4"},[new re,l({click:()=>{new Fe({title:"Are you absoultely sure?",description:"This action cannot be undone. This will permanently delete your account and remove your data from our servers.",confirmTextLabel:"Save",confirmed:()=>{app.notify({icon:n.trash,title:"Account deleted",description:"Your account has been successfully deleted.",type:"destructive"})}}).open()}},"Confirm")])]).open()}),Yo=({size:e="md",type:t="center"})=>new Ee({title:"Report an Issue",icon:n.warning,description:"What area are you having problems with?",size:e,type:t,onSubmit:()=>console.log("Form submitted")},[o({class:"flex flex-col max-w-lg lg:p-4 space-y-8"},[o({class:"flex flex-auto w-full gap-4"},[new u({name:"area",label:"Area"},[C({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"billing",label:"Billing"},{value:"technical",label:"Technical"},{value:"account",label:"Account"},{value:"other",label:"Other"}],defaultValue:"billing",change:s=>console.log(`Area selected: ${s.target.value}`)})]),new u({name:"security_level",label:"Security Level"},[C({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"severity_1",label:"Severity 1"},{value:"severity_2",label:"Severity 2"},{value:"severity_3",label:"Severity 3"}],defaultValue:"severity_2",change:s=>console.log(`Security Level selected: ${s.target.value}`)})])]),new u({name:"subject",label:"Subject"},[S({type:"text",placeholder:"I need help with...",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),new u({name:"description",label:"Description"},[E({placeholder:"Please include all information relevant to your issue.",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})])])]),fe=({label:e,buttonStyle:t,size:s,type:r})=>l({text:e,class:`m-1 ${t}`,click:()=>Yo({size:s,type:r}).open()}),Ko=()=>p({title:"Modals",description:"Displays a modal or a component that looks like a modal."},[a({title:"Extra Large Modal",description:"This is an extra large modal.",preview:[H(q[3])],code:`
...
})`})]),ea=e=>!e||isNaN(e)?null:e,ge=(e,t)=>{const s=e,r=16,d=2*Math.PI*r,T=s/100*d,L=`
...
new ProgressBar({ cache: 'progress', progress: 20 })`}),a({title:"Circle Progress Bar",description:"The progress bar can also be displayed as a semi circle.",preview:[ta({cache:"progress",progress:50,class:"stroke-gray-300"})],code:`import { ProgressBar } from "@components/atoms/progress/progress-bar.js";
...
LoadingAvatar();`})]);class ia extends N{render(){return o({class:"tab-panel"},[new Te({class:this.class,options:this.options}),k({class:"tab-content",switch:this.addGroup()})])}addGroup(){let t;const s=[],r=this.options;for(let d=0,T=r.length;d<T;d++)t=r[d],s.push({uri:t.uri||t.href,component:t.component,title:t.title||null,persist:!0});return s}}const he=f((e,t)=>o({class:"py-4"},t)),la=()=>p({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[a({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new Se({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:he([])},{label:"Code",value:"code",layout:he([])}]})],code:`
