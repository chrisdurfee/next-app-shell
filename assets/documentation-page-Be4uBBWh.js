import{S as ze}from"./sidebar-menu-page-DNfD-y3B.js";import{o as ae,Y as o,u as y,p as he,Z as se,q as ne,w as W,Q as h,x as qe,N as Ue,a as n,l as H,s as re,G as c,y as We,E as Oe,r as xe,H as $,A as v,K as w,z as r,L as _e,_ as O,R as _,J as T,B as l,b as we,U as Ge,V as Ve,W as Je,X as Ye,$ as Qe,a0 as I,I as b,a1 as B,F as u,a2 as L,a3 as G,a4 as ie,c as C,a5 as k,a6 as N,a7 as V,a8 as le,a9 as ve,aa as Ke,D as ye,ab as Ze,i as X,ac as Xe,ad as Y,j as D,C as J,ae as Te,af as ke,P as E,ag as ce,ah as ee,ai as te,aj as et,ak as tt,al as Q,am as ot,an as at,ao as st,ap as nt,aq as rt,ar as it,as as lt,at as ct,au as dt,av as ut,M as Se,aw as mt,ax as pt,f as ft,ay as F,S,k as Ce,T as gt,d as A,az as oe,v as bt,aA as ht,O as xt,m as wt}from"./index-CceQXppY.js";import{U as vt}from"./user-list-C0WrbW03.js";const yt=e=>ne({class:"inline-flex flex-auto items-center justify-center whitespace-nowrap rounded-sm text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 data-[state=active]:bg-primary data-[state=active]:text-primary-foreground data-[state=active]:shadow-sm",dataSet:["selected",["state",e.value,"active"]]},[W({class:"flex flex-auto justify-center items-center px-3 py-1.5",onSet:["selected",{selected:e.value}],click:t=>e.callBack(e.value)},e.label)]),Tt=(e,t)=>(e.callBack=t,yt(e)),kt=e=>he({class:`tab items-center justify-center rounded-md bg-muted p-1 text-muted-foreground ${e.class}`},[se({class:"flex flex-auto flex-row",map:[e.options,t=>Tt(t,e.callBack)]})]);class Ie extends ae{render(){const t=this.select.bind(this);return o({class:""},[kt({class:this.class,options:this.options,callBack:t}),y({class:"tab-content",onState:["selected",this.updateContent.bind(this)]})])}getFirstValue(){var t;return(t=this.options[0])==null?void 0:t.value}update(){const t=this.state.get("selected");this.select(null),this.select(t)}select(t){this.state.selected=t}updateContent(t){const s=this.options;if(!s||s.length<1)return;const i=s[0];for(const d of s)if(d.value===t)return d.layout;return i.layout}setupStates(){const t=this.callBack,s=typeof t;return{selected:{state:this.getFirstValue(),callBack(i){s==="function"&&t(i)}}}}}const je=h((e,t)=>qe({class:"flex p-4 min-h-[350px] max-h-[650px] overflow-x-auto rounded-lg border bg-muted whitespace-break-spaces break-all cursor-pointer"},[Ue({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(t[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:n.clipboard.checked})}},t)])),St=h((e,t)=>o({class:"flex flex-auto p-4 min-h-[350px] max-h-[650px] overflow-x-auto max-w-[90vw] rounded-lg border bg-card"},[o({class:"preview flex flex-auto justify-center items-center"},t)])),de=h((e,t)=>o({class:"py-4"},t)),Ct=e=>new Ie({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:de([St(e.preview)])},{label:"Code",value:"code",layout:de([je(e.code)])}]}),It=h(({title:e,description:t})=>H({class:"flex flex-col"},[re({class:"scroll-m-20 text-2xl font-bold tracking-tight"},e),t&&c({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),a=h((e,t)=>y({class:"grid py-4"},[It({title:e.title,description:e.description}),Ct({preview:e.preview,code:e.code})]));class jt extends We{render(){return Oe([o({class:"contained px-4 flex flex-auto flex-col"},this.children)])}}const At=h(({title:e,description:t})=>H({class:"flex flex-col"},[xe({class:"scroll-m-20 text-3xl font-bold tracking-tight"},e),c({class:"text-base text-muted-foreground py-2 max-w-[700px]"},t)])),Dt=h((e,t)=>o({class:"contained py-8"},[At(e),y({class:"pb-12 pt-8"},t)])),p=h((e,t)=>new jt([Dt(e,t)])),Bt=()=>p({title:"Alerts",description:"Alerts are used to provide feedback to the user about the outcome of an action or to inform them of important information."},[a({title:"Default Alert",description:"This is a standard alert without any specific type.",preview:[$({title:"Notice",description:"This is a default alert without a specific type.",icon:n.information})],code:`import { Alert } from "@components/molecules/alert.js";
...
})`}),a({title:"Counter",description:"This is a counter input.",preview:[f([new Uo({class:"max-w-[300px]",initialCount:5,readonly:!1,bind:"count",change:e=>console.log(e)})])],code:`
...
})`})]),Zo=e=>!e||isNaN(e)?null:e,fe=(e,t)=>{const s=e,i=16,d=2*Math.PI*i,j=s/100*d,M=`
