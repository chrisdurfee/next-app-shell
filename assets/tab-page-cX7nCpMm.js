import{at as l,r as n,aw as p,a2 as a,A as i,ab as r,Y as m}from"./index-B1V06mH8.js";import{D as e}from"./doc-section-BdXroFeL.js";import{D as c}from"./doc-page-DJab-6My.js";const t=n((o,s)=>m({class:"py-4"},s)),T=()=>c({title:"Tabs",description:"Displays a tab or a component that looks like a tab."},[e({title:"Button Tab",description:"This is a button tab. The buttons to not route.",preview:[new l({class:"mt-4 max-w-[400px]",options:[{label:"Preview",value:"preview",layout:t([])},{label:"Code",value:"code",layout:t([])}]})],code:`
