import{b as r,ae as d,af as h,o,J as s,T as a,H as g,an as y,ag as M,ah as p,ai as i,az as v}from"./index-CFDbfNLc.js";import{L as k,b,i as D,q as x}from"./tooltip-Cok_NM7z-Me-b7npL.js";import{D as e}from"./doc-section-Del9k7Kh.js";import{D as S}from"./doc-page-TkUmvqza.js";import"./signature-panel-BEO99NlI-B8MbYZWJ.js";import"./sidebar-menu-page-BtUJdw-T-BNhGV-ta.js";import"./mobile-nav-wrapper-C7RyGC5a-B2iBIcUi.js";const n=[{label:"Large",buttonStyle:"primary",size:"lg"},{label:"Small",buttonStyle:"secondary",size:"sm"},{label:"Medium",buttonStyle:"destructive",size:"md"},{label:"XL",buttonStyle:"primary",size:"xl"},{label:"Right",buttonStyle:"ghost",type:"right"},{label:"Left",buttonStyle:"link",type:"left"}],m=({label:t,buttonStyle:l,size:c,type:u})=>r({text:t,class:`m-1 ${l}`,click:()=>new d({title:"Are you absolutely sure?",size:c,type:u},[s({class:"flex flex-col max-w-lg lg:p-4 space-y-8"},[new a({name:"popover-test",label:"Popover Test"},[new g]),new a({name:"dialog-test",label:"Dialog Test"},[r({click:()=>{new y({title:"Are you absolutely sure?",description:"This action cannot be undone.",confirmTextLabel:"Save",confirmed:()=>{app.notify({icon:o.trash,title:"Action complete",description:"You confirmed your selection.",type:"destructive"})}}).open()}},"Confirm")])])]).open()}),B=({size:t="md",type:l="center"})=>new d({title:"Report an Issue",icon:o.warning,description:"What area are you having problems with?",size:t,type:l,onSubmit:()=>console.log("Form submitted")},[s({class:"flex flex-col lg:p-4 space-y-8"},[k({legend:"Issue Details"},[s({class:"flex flex-auto w-full gap-4"},[new a({name:"area",label:"Area"},[b({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"billing",label:"Billing"},{value:"technical",label:"Technical"},{value:"account",label:"Account"},{value:"other",label:"Other"}],defaultValue:"billing"})]),new a({name:"security_level",label:"Security Level"},[b({required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground",options:[{value:"severity_1",label:"Severity 1"},{value:"severity_2",label:"Severity 2"},{value:"severity_3",label:"Severity 3"}],defaultValue:"severity_2"})])]),new a({name:"subject",label:"Subject"},[D({type:"text",placeholder:"I need help with...",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})]),new a({name:"description",label:"Description"},[x({placeholder:"Please include all information relevant to your issue.",required:!0,class:"border p-2 rounded-md w-full bg-background text-foreground placeholder-muted-foreground"})])])])]),f=({label:t,buttonStyle:l,size:c,type:u})=>r({text:t,class:`m-1 ${l}`,click:()=>B({size:c,type:u}).open()}),w=()=>[new h({icon:o.ellipsis.vertical,groups:[[{icon:o.mapPin,label:"Track Item",value:"track-item"},{icon:o.trash,label:"Delete Item",value:"delete-item"}]],onSelect:t=>{console.log("Selected item from header:",t)}})],z=()=>new d({title:"Detail Example",description:"This is a detailed view of an item.",icon:o.information,size:"md",headerOptions:w,hidePrimaryButton:!0},[M([p({title:"Overview"},[i("Label","Value"),i("Date","2024-11-02"),s({class:"my-2 border-t"}),i("Status","Pending")]),p({title:"Details"},[v("Label text","Value")]),p({title:"More Info"},[i("Description","This is a multi-line snippet."),i("Comments","No comments available.")])])]),I=()=>r({text:"Detail Modal",variant:"outline",click:()=>z().open()}),H=()=>S({title:"Modals",description:"Displays modals or modal-like components with various sizes, forms, and header options."},[e({title:"Detail Modal Atoms",description:"Demonstrates usage of DetailBody, DetailSection, and SplitRow within a modal.",preview:[I()],code:`
