import{u as s,a2 as o,G as e,z as a,Z as r,M as l,N as d,o as c}from"./index-COLoF6lA.js";import{D as u}from"./doc-page-DamZRU1v.js";const t=r((i,n)=>l({...i,class:`flex p-4 max-h-[650px] max-w-[1024px] overflow-x-auto
					 rounded-lg border bg-muted whitespace-break-spaces
					 break-all cursor-pointer mt-4 ${i.class}`},[d({class:"font-mono flex-auto text-sm text-wrap",click:()=>{navigator.clipboard.writeText(n[0].textContent),app.notify({title:"Code copied",description:"The code has been copied to your clipboard.",icon:c.clipboard.checked})}},n)])),h=()=>u({title:"Get Started",description:"Learn how to install, configure, and begin working with the App Shell project."},[s({class:"space-y-4"},[o({class:"text-lg font-bold"},"About the Project"),e({class:"text-muted-foreground"},`This project is a Progressive Web App (PWA) framework designed to serve as a
...
[
	'./',
	'./index.html'
];`)])]);export{h as GetStartedPage,h as default};
